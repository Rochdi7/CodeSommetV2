...
return [
    ...
    'faq_a1' => 'Nous n\'avons pas de bureau à Riyad : notre équipe travaille à distance depuis le Maroc et collabore avec ses clients entièrement en ligne (appels vidéo, Slack, suivi de projet en temps réel). Cela nous permet de rester réactifs quel que soit votre fuseau horaire, sans coût de structure locale répercuté sur votre projet.',
    'faq_a2' => 'Oui, tout se passe en ligne : appels vidéo pour le cadrage et les validations, collaboration sur Slack au quotidien et suivi de projet en temps réel. Nous adaptons nos créneaux au fuseau horaire de Riyad et vous gardez une visibilité complète sur l\'avancement à chaque étape.',
    ...
    'faq_a4' => 'Nous concevons des sites conformes aux bonnes pratiques de protection des données : consentement aux cookies, politique de confidentialité, sécurisation des formulaires et des données. Pour les exigences propres à Arabie saoudite ou à votre secteur, nous adaptons les mentions et les fonctionnalités avec vous lors du cadrage.',
    ...
    'faq_a6' => 'Oui. Nous vous conseillons sur le choix du nom de domaine (.sa ou .com selon votre cible), nous vous guidons pour l\'enregistrement auprès d\'un registrar et nous configurons le DNS, le certificat SSL et les redirections pour que le site soit prêt dès la mise en ligne.',
    'faq_q1' => 'Avez-vous un bureau physique à Riyad ?',
    'faq_q2' => 'Pouvez-vous travailler avec les entreprises de Riyad à distance ?',
    'faq_q3' => 'Quels modes de paiement acceptez-vous à Riyad ?',
    'faq_q4' => 'Comprenez-vous les lois de conformité et de protection des données en Arabie Saoudite ?',
    'faq_q5' => 'En combien de temps pouvez-vous lancer un site web pour mon entreprise à Riyad ?',
