...
return [
    ...
    'faq_q1' => 'Pourquoi choisir CodeSommet parmi les nombreuses agences de développement web de Stockholm ?',
    'faq_q2' => 'Travaillez-vous avec les startups et entreprises early-stage de Stockholm ?',
    'faq_q3' => 'Quelles technologies utilisez-vous pour les projets ? Stockholm ?',
    'faq_q4' => 'Pouvez-vous vous intégrer aux systèmes existants utilisés par les entreprises de Stockholm ?',
    'faq_q5' => 'Comment fonctionne le modèle ? révisions illimitées pour Stockholm ?',
    'faq_q6' => 'Fournissez-vous un support continu pour Stockholm après le lancement ?',
];
