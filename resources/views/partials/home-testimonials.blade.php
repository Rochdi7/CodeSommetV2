...
<section class="w-full py-12 md:py-16 bg-[#F5F5F5]">
    ...
    <div class="w-full overflow-hidden pt-8 pb-32">
        <div class="flex gap-4 md:gap-8 py-4 overflow-x-auto scrollbar-hide md:justify-center px-4 md:px-0">
            ...
            <div class="block">
                <div class="testimonial-card flex-shrink-0 w-[340px] md:w-[450px] bg-[#FEFEFE] rounded-3xl overflow-hidden my-2 p-2 transition-all duration-300 hover:-translate-y-2" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 10px 40px, rgba(0, 0, 0, 0.06) 0px 2px 8px;">
                    <div class="relative h-64 md:h-80 overflow-hidden transition-all duration-500 rounded-[16px]" style="background: rgb(245, 245, 245);">
