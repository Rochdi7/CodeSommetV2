...
<div id="cal-modal-overlay" class="cal-modal-overlay" style="display:none;">
    <div class="cal-modal-container">
        <button id="cal-modal-close" class="cal-modal-close" aria-label="Close booking modal">
        ...
        <div class="cal-modal-body">
            ...
            <iframe
                id="cal-modal-iframe"
                data-cal-src="https://cal.com/codesommet/discovery?layout=month_view&theme=light"
                frameborder="0"
                allowfullscreen
                allow="payment"
                style="width:100%;height:100%;border:none;border-radius:12px;position:relative;z-index:1;"
            ></iframe>
        </div>
    </div>
</div>
