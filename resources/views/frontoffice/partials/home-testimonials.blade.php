...
<section class="w-full py-12 md:py-16 bg-[#F5F5F5]">
    ...
    <div class="w-full overflow-hidden pt-8 pb-32">
        <div class="flex gap-4 md:gap-8 py-4 overflow-x-auto scrollbar-hide md:justify-center px-4 md:px-0">

            {{-- Card 1: Morocco Quest DMC --}}
            <div class="block">
                        ...
                        <div class="relative h-full">
                            <div class="flex h-full gap-2 md:gap-3 px-4 md:px-8">
                                <div class="flex-1 relative overflow-hidden flex flex-col justify-end"
                                    ...
                                    <img alt="Morocco Quest DMC maquette du haut"
                                        class="w-full h-auto flex-shrink-0 testimonial-img-top" loading="lazy"
                                        src="{{ asset('mockups/morocco-quest-top.png') }}"
                                ...
                                <div class="flex-1 relative overflow-hidden"
                                    ...
                                    <img alt="Morocco Quest DMC maquette du bas"
                                        class="w-full h-auto testimonial-img-bottom" loading="lazy"
                                        src="{{ asset('mockups/morocco-quest-bottom.png') }}"
                    ...
                    <div class="px-4 md:px-6 pt-4 md:pt-6 pb-3 md:pb-4">
                        <div class="relative bg-[#F5F5F5] rounded-3xl px-4 md:px-5 py-2.5 md:py-3 mb-2">
                            ...
                            <p
                                ...
                                "Travailler avec CodeSommet a complètement transformé notre présence en ligne. Au-delà
                                de la création d'un site moderne et rapide, ils ont géré toute notre stratégie SEO avec
                        ...
                        <div class="flex items-start gap-2.5 md:gap-3">
                            ...
                            <div class="flex flex-col justify-center min-h-[40px] md:min-h-[48px]">
                                <p
                                    ...
                                    Mounir Akajia</p>
                                <p class="text-xs md:text-sm text-[var(--text-secondary)] leading-tight">Fondateur
                                    &bull; Morocco Quest DMC</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial-card flex-shrink-0 w-[340px] md:w-[450px] bg-[#FEFEFE] rounded-3xl overflow-hidden my-2 p-2 transition-all duration-300 hover:-translate-y-2"
                    ...
                    <div class="relative h-64 md:h-80 overflow-hidden transition-all duration-500 rounded-[16px]"
                        ...
                        <div class="relative h-full">
                            <div class="flex h-full gap-2 md:gap-3 px-4 md:px-8">
                                <div class="flex-1 relative overflow-hidden flex flex-col justify-end"
                                    style="border-radius: 5px 5px 0px 0px; line-height: 0;">
                                    <img alt="Dental Pro maquette du haut"
                                        class="w-full h-auto flex-shrink-0 testimonial-img-top" loading="lazy"
                                        src="{{ asset('mockups/dental-pro-top.png') }}"
                                        style="border-radius: 5px 5px 0px 0px; display: block; max-height: calc(100% + 100px); box-shadow: rgba(0, 0, 0, 0.15) 0px 4px 12px; transform: translateY(0px); transition: transform 2s ease-in-out;">
                                </div>
                                <div class="flex-1 relative overflow-hidden"
                                    style="border-radius: 0px 0px 5px 5px; line-height: 0;">
                                    <img alt="Dental Pro maquette du bas" class="w-full h-auto testimonial-img-bottom"
                                        loading="lazy" src="{{ asset('mockups/dental-pro-bottom.png') }}"
                                        style="border-radius: 0px 0px 5px 5px; display: block; vertical-align: top; box-shadow: rgba(0, 0, 0, 0.15) 0px 4px 12px; transform: translateY(-20px); transition: transform 2s ease-in-out;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="px-4 md:px-6 pt-4 md:pt-6 pb-3 md:pb-4">
                        <div class="relative bg-[#F5F5F5] rounded-3xl px-4 md:px-5 py-2.5 md:py-3 mb-2">
                            ...
                            <p
                                class="relative text-[var(--text-primary)] text-xs md:text-sm leading-relaxed italic mb-0">
                                "CodeSommet a développé l'ensemble de notre plateforme e-commerce. Le site est rapide,
                                sécurisé et parfaitement optimisé. Grâce à leur structuration produit et à leurs
                ...
                <div class="testimonial-card flex-shrink-0 w-[340px] md:w-[450px] bg-[#FEFEFE] rounded-3xl overflow-hidden my-2 p-2 transition-all duration-300 hover:-translate-y-2"
                    ...
                    <div class="relative h-64 md:h-80 overflow-hidden transition-all duration-500 rounded-[16px]"
                        ...
                        <div class="relative h-full">
                            <div class="flex h-full gap-2 md:gap-3 px-4 md:px-8">
                                <div class="flex-1 relative overflow-hidden flex flex-col justify-end"
                                    style="border-radius: 5px 5px 0px 0px; line-height: 0;">
                                    <img alt="GLS Sprachenzentrum maquette du haut"
                                        class="w-full h-auto flex-shrink-0 testimonial-img-top" loading="lazy"
                                        src="{{ asset('mockups/gls-top.png') }}"
                                        style="border-radius: 5px 5px 0px 0px; display: block; max-height: calc(100% + 100px); box-shadow: rgba(0, 0, 0, 0.15) 0px 4px 12px; transform: translateY(0px); transition: transform 2s ease-in-out;">
                                </div>
                                <div class="flex-1 relative overflow-hidden"
                                    style="border-radius: 0px 0px 5px 5px; line-height: 0;">
                                    <img alt="GLS Sprachenzentrum maquette du bas"
                                        class="w-full h-auto testimonial-img-bottom" loading="lazy"
                                        src="{{ asset('mockups/gls-bottom.png') }}"
                                        style="border-radius: 0px 0px 5px 5px; display: block; vertical-align: top; box-shadow: rgba(0, 0, 0, 0.15) 0px 4px 12px; transform: translateY(-20px); transition: transform 2s ease-in-out;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="px-4 md:px-6 pt-4 md:pt-6 pb-3 md:pb-4">
                        <div class="relative bg-[#F5F5F5] rounded-3xl px-4 md:px-5 py-2.5 md:py-3 mb-2">
                            ...
                            <p
                                class="relative text-[var(--text-primary)] text-xs md:text-sm leading-relaxed italic mb-0">
                                "Notre site est désormais moderne, rapide et parfaitement adapté aux étudiants à travers
                        ...
                        <div class="flex items-start gap-2.5 md:gap-3">
                            ...
                            <div class="flex flex-col justify-center min-h-[40px] md:min-h-[48px]">
                                <p
                                    class="font-semibold text-[var(--text-primary)] text-sm md:text-base leading-tight mb-0.5">
                                    Rafiq</p>
                                <p class="text-xs md:text-sm text-[var(--text-secondary)] leading-tight">Administration
                                    &bull; GLS Sprachenzentrum</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial-card flex-shrink-0 w-[340px] md:w-[450px] bg-[#FEFEFE] rounded-3xl overflow-hidden my-2 p-2 transition-all duration-300 hover:-translate-y-2"
                    ...
                    <div class="relative h-64 md:h-80 overflow-hidden transition-all duration-500 rounded-[16px]"
                        ...
                        <div class="relative h-full">
                            <div class="flex h-full gap-2 md:gap-3 px-4 md:px-8">
                                <div class="flex-1 relative overflow-hidden flex flex-col justify-end"
                                    style="border-radius: 5px 5px 0px 0px; line-height: 0;">
                                    <img alt="Local Morocco Tours maquette du haut"
                                        class="w-full h-auto flex-shrink-0 testimonial-img-top" loading="lazy"
                                        src="{{ asset('mockups/local-morocco-tours-top.png') }}"
                                        style="border-radius: 5px 5px 0px 0px; display: block; max-height: calc(100% + 100px); box-shadow: rgba(0, 0, 0, 0.15) 0px 4px 12px; transform: translateY(0px); transition: transform 2s ease-in-out;">
                                </div>
                                <div class="flex-1 relative overflow-hidden"
                                    style="border-radius: 0px 0px 5px 5px; line-height: 0;">
                                    <img alt="Local Morocco Tours maquette du bas"
                                        class="w-full h-auto testimonial-img-bottom" loading="lazy"
                                        src="{{ asset('mockups/local-morocco-tours-bottom.png') }}"
                                        style="border-radius: 0px 0px 5px 5px; display: block; vertical-align: top; box-shadow: rgba(0, 0, 0, 0.15) 0px 4px 12px; transform: translateY(-20px); transition: transform 2s ease-in-out;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="px-4 md:px-6 pt-4 md:pt-6 pb-3 md:pb-4">
                        <div class="relative bg-[#F5F5F5] rounded-3xl px-4 md:px-5 py-2.5 md:py-3 mb-2">
                            ...
                            <p
                                class="relative text-[var(--text-primary)] text-xs md:text-sm leading-relaxed italic mb-0">
                                "Merci à CodeSommet d'avoir développé notre site Local Morocco Tours. Le design est
                                moderne, rapide et parfaitement adapté aux besoins des voyageurs. L'optimisation SEO
                        ...
                        <div class="flex items-start gap-2.5 md:gap-3">
                            ...
                            <div class="flex flex-col justify-center min-h-[40px] md:min-h-[48px]">
                                ...
                                <p class="text-xs md:text-sm text-[var(--text-secondary)] leading-tight">Guide &
                                    Propriétaire &bull; Local Morocco Tours</p>
                            </div>
                        </div>
                    </div>
                </div>
