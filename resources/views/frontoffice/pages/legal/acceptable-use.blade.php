        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div class="max-w-4xl mx-auto text-center space-y-6">
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#00AEEF]/10 rounded-full"><svg
                    ...
                    </svg><span class="text-sm font-medium text-[#0F0F0F]">{{ __('legal/acceptable-use.text_0') }}</span>
                </div>
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-semibold text-[#0F0F0F] leading-tight"
                    style="font-family:var(--font-heading)">Politique d'Utilisation Acceptable</h1>
                <p class="text-lg md:text-xl text-[#0F0F0F]/70 max-w-2xl mx-auto">{{ __('legal/acceptable-use.text_1') }}
                </p>
                <div class="flex flex-wrap justify-center gap-3 pt-4"><a href="#permitted-uses"
                        class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">{{ __('legal/acceptable-use.text_2') }}</a><a
                        href="#prohibited-uses"
                        class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">Utilisations
                        interdites</a><a href="#violations"
                        class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">Violations</a>
                </div>
            </div>
        </div>
    </section>
    <section class="w-full py-16 md:py-24 bg-[#F8F8F8]">
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                    ...
                    <div class="prose prose-lg max-w-none text-[#0F0F0F]/70 space-y-4">
                        ...
                        <p>{{ __('legal/acceptable-use.text_4') }} <a class="text-[#00AEEF] hover:underline"
                                href="{{ route('terms-of-service') }}">Conditions d'Utilisation</a>
                            {{ __('legal/acceptable-use.text_5') }}</p>
                        <div
                            class="
                ...
                <div id="permitted-uses" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]"
                            style="font-family:var(--font-heading)">{{ __('legal/acceptable-use.text_7') }}</h2>
                    </div>
                    <div class="space-y-4 text-[#0F0F0F]/70">
                        <p>{{ __('legal/acceptable-use.text_8') }}</p>
                        <ul class="list-disc pl-6 space-y-3">
                            <li><strong>{{ __('legal/acceptable-use.text_9') }}</strong>
                                {{ __('legal/acceptable-use.text_10') }}</li>
                            <li><strong>E-commerce :</strong> {{ __('legal/acceptable-use.text_11') }}</li>
                            <li><strong>{{ __('legal/acceptable-use.text_226') }}</strong>
                                {{ __('legal/acceptable-use.text_12') }}</li>
                            <li><strong>{{ __('legal/acceptable-use.text_13') }}</strong>
                                {{ __('legal/acceptable-use.text_14') }}</li>
                            <li><strong>Services professionnels :</strong> {{ __('legal/acceptable-use.text_15') }}</li>
                            <li><strong>{{ __('legal/acceptable-use.text_16') }}</strong>
                                {{ __('legal/acceptable-use.text_17') }}</li>
                            <li><strong>{{ __('legal/acceptable-use.text_18') }}</strong>
                                {{ __('legal/acceptable-use.text_19') }}</li>
                        </ul>
                        <div
                            class="
        flex items-start gap-3 p-4 rounded-lg border backdrop-blur-sm
      ...
      ">
                ...
                <div id="prohibited-uses" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="w-12 h-12 rounded-lg bg-[#EF4444]/10 flex items-center justify-center"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-circle-x w-6 h-6 text-[#EF4444]"
                                aria-hidden="true">
                                <circle cx="12" cy="12" r="10"></circle>
                        ...
                        <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]"
                            style="font-family:var(--font-heading)">Utilisations interdites</h2>
                    </div>
      ...
      ">
                                <div
                                    class="absolute top-0 right-0 w-32 h-32 bg-[#EF4444]/10 rounded-full blur-3xl opacity-30 -mr-16 -mt-16">
                                </div>
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        <div class="bg-[#EF4444]/10 rounded-lg p-2"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-circle-x w-5 h-5 text-[#EF4444]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m15 9-6 6"></path>
                                                <path d="m9 9 6 6"></path>
                                            </svg></div>
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_22') }}</h4>
                                    </div>
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_228') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
                                        <ul class="list-disc pl-6 space-y-2">
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_34') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
                                        <ul class="list-disc pl-6 space-y-2">
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_41') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
                                        <ul class="list-disc pl-6 space-y-2">
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_230') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
                                        <ul class="list-disc pl-6 space-y-2">
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_231') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
                                        <ul class="list-disc pl-6 space-y-2">
                                        ...
                                        <p class="mt-3 text-sm font-medium text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_60') }}</p>
                                    </div>
                                </div>
                            </div>
                            <div
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_61') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
                                        <ul class="list-disc pl-6 space-y-2">
      ...
      ">
                ...
                <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6"
                        style="font-family:var(--font-heading)">{{ __('legal/acceptable-use.text_68') }}</h2>
                    <div class="space-y-4 text-[#0F0F0F]/70">
                        <p>{{ __('legal/acceptable-use.text_69') }}</p>
                        <ul class="list-disc pl-6 space-y-2">
                            <li><strong>{{ __('legal/acceptable-use.text_70') }}</strong>
                                {{ __('legal/acceptable-use.text_71') }}</li>
                            <li><strong>{{ __('legal/acceptable-use.text_72') }}</strong>
                                {{ __('legal/acceptable-use.text_73') }}</li>
                            <li><strong>{{ __('legal/acceptable-use.text_74') }}</strong>
                                {{ __('legal/acceptable-use.text_75') }}</li>
                            <li><strong>Signalement rapide :</strong> {{ __('legal/acceptable-use.text_76') }}</li>
                            <li><strong>{{ __('legal/acceptable-use.text_77') }}</strong>
                                {{ __('legal/acceptable-use.text_78') }}</li>
                ...
                <div id="violations" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="w-12 h-12 rounded-lg bg-[#00AEEF]/10 flex items-center justify-center"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-circle-alert w-6 h-6 text-[#00AEEF]"
                                aria-hidden="true">
                                <circle cx="12" cy="12" r="10"></circle>
                                <line x1="12" x2="12" y1="8" y2="12"></line>
                                <line x1="12" x2="12.01" y1="16" y2="16"></line>
                        ...
                        <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]"
                            style="font-family:var(--font-heading)">{{ __('legal/acceptable-use.text_86') }}</h2>
                    </div>
                    <div class="space-y-6 text-[#0F0F0F]/70">
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_233') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_234') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_91') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_235') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 class="text-lg font-semibold text-[#0F0F0F]">
                                            {{ __('legal/acceptable-use.text_94') }}</h4>
                                    </div>
                                    <div class="text-[#0F0F0F]/80">
                ...
                <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="w-12 h-12 rounded-lg bg-[#00AEEF]/10 flex items-center justify-center"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-flag w-6 h-6 text-[#00AEEF]"
                                aria-hidden="true">
                                <path
                        ...
                        <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]"
                            style="font-family:var(--font-heading)">{{ __('legal/acceptable-use.text_100') }}</h2>
                    </div>
                    <div class="space-y-4 text-[#0F0F0F]/70">
                        <p>{{ __('legal/acceptable-use.text_101') }}</p>
                        <div class="bg-[#00AEEF]/5 rounded-lg p-6 border border-[#00AEEF]/20">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-3">
                                {{ __('legal/acceptable-use.text_102') }}</h3>
                            <p class="mb-3">{{ __('legal/acceptable-use.text_103') }} <a
                                    href="mailto:codesommet@gmail.com"
                                    class="text-[#00AEEF] hover:underline font-medium"><span class="__cf_email__"
                                        data-cfemail="0c64696060634c7c65676d7f7f637f7879686563226f6361">{{ __('legal/acceptable-use.text_438') }}</span></a>
                                {{ __('legal/acceptable-use.text_104') }}</p>
      ...
      ">
                ...
                <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6"
                        style="font-family:var(--font-heading)">{{ __('legal/acceptable-use.text_111') }}</h2>
                    <div class="space-y-4 text-[#0F0F0F]/70">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]"
                            style="font-family:var(--font-heading)">{{ __('legal/acceptable-use.text_118') }}</h2>
                    </div>
                    <div class="space-y-4 text-[#0F0F0F]/70">
                            ...
                            <div class="space-y-2">
                                <p><strong>Email :</strong> <a href="mailto:codesommet@gmail.com"
                                        class="text-[#00AEEF] hover:underline"><span class="__cf_email__"
                                            data-cfemail="3e565b5252517e4e57555f4d4d514d4a4b5a5751105d5153">{{ __('legal/acceptable-use.text_439') }}</span></a>
                                </p>
                ...
                <div class="mt-12 text-center">
                    ...
                    <div class="flex flex-wrap justify-center gap-3"><a
                            ...
                            href="{{ route('privacy-policy') }}">{{ __('legal/acceptable-use.text_126') }}</a><a
                            class="px-6 py-3 text-sm font-medium text-[#00AEEF] border-2 border-[#00AEEF] hover:bg-[#00AEEF] hover:text-white rounded-full transition-colors"
                            href="{{ route('terms-of-service') }}">Conditions d'Utilisation</a><a
                            class="px-6 py-3 text-sm font-medium text-[#00AEEF] border-2 border-[#00AEEF] hover:bg-[#00AEEF] hover:text-white rounded-full transition-colors"
                            href="{{ route('cookie-policy') }}">{{ __('legal/acceptable-use.text_237') }}</a><a
                            class="px-6 py-3 text-sm font-medium text-[#00AEEF] border-2 border-[#00AEEF] hover:text-white rounded-full transition-colors"
                            href="{{ route('refund-policy') }}">{{ __('legal/acceptable-use.text_238') }}</a></div>
                </div>
            </div>
        </div>
    </section>
