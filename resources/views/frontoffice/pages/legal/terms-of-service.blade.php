    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        <div class="max-w-4xl mx-auto text-center space-y-6">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#00AEEF]/10 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-scale w-4 h-4 text-[#00AEEF]" aria-hidden="true">
                ...
                </svg><span class="text-sm font-medium text-[#0F0F0F]">{{ __('legal/terms-of-service.text_0') }}</span></div>
            ...
            <p class="text-lg md:text-xl text-[#0F0F0F]/70 max-w-2xl mx-auto">{{ __('legal/terms-of-service.text_1') }}</p>
            <div class="flex flex-wrap justify-center gap-3 pt-4"><a href="#services" class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">Services</a><a href="#payment" class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">{{ __('legal/terms-of-service.text_330') }}</a><a href="#intellectual-property" class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">{{ __('legal/terms-of-service.text_2') }}</a></div>
        </div>
    </div>
</section>
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-4" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_3') }}</h2>
                <div class="prose prose-lg max-w-none text-[#0F0F0F]/70 space-y-4">
                    <p>{{ __('legal/terms-of-service.text_4') }}</p>
                    <p class="font-medium text-[#0F0F0F]">{{ __('legal/terms-of-service.text_5') }} <a class="text-[#00AEEF] hover:underline" href="{{ route('home') }}">codesommet.com</a>{{ __('legal/terms-of-service.text_6') }}</p>
      ...
      ">
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_9') }}</h2>
                <div class="space-y-3 text-[#0F0F0F]/70">
                    ...
                    <p><strong>{{ __('legal/terms-of-service.text_331') }}</strong> {{ __('legal/terms-of-service.text_13') }}</p>
                    <p><strong>&quot;Forfait&quot;</strong> {{ __('legal/terms-of-service.text_14') }}</p>
                    <p><strong>{{ __('legal/terms-of-service.text_332') }}</strong> {{ __('legal/terms-of-service.text_15') }}</p>
                </div>
            </div>
            <div id="services" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                ...
                <div class="space-y-6 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_333') }}</h3>
                        <div class="space-y-4">
                            <div>
                                <h4 class="font-semibold text-[#0F0F0F] mb-2">{{ __('legal/terms-of-service.text_334') }}</h4>
                            ...
                            <div>
                                <h4 class="font-semibold text-[#0F0F0F] mb-2">{{ __('legal/terms-of-service.text_25') }}</h4>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_31') }}</h3>
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_46') }}</h2>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <p>{{ __('legal/terms-of-service.text_47') }}</p>
                    <ul class="list-disc pl-6 space-y-3">
                        <li><strong>{{ __('legal/terms-of-service.text_48') }}</strong> {{ __('legal/terms-of-service.text_49') }}</li>
                        <li><strong>{{ __('legal/terms-of-service.text_50') }}</strong> {{ __('legal/terms-of-service.text_51') }}</li>
                        <li><strong>{{ __('legal/terms-of-service.text_52') }}</strong> {{ __('legal/terms-of-service.text_53') }}</li>
                        <li><strong>{{ __('legal/terms-of-service.text_54') }}</strong> {{ __('legal/terms-of-service.text_55') }}</li>
                        <li><strong>{{ __('legal/terms-of-service.text_56') }}</strong> {{ __('legal/terms-of-service.text_57') }}</li>
                        <li><strong>{{ __('legal/terms-of-service.text_58') }}</strong> {{ __('legal/terms-of-service.text_59') }}</li>
                    </ul>
                    <div class="
        flex items-start gap-3 p-4 rounded-lg border backdrop-blur-sm
      ...
      ">
            ...
            <div id="payment" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_338') }}</h2>
                </div>
                <div class="space-y-6 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_339') }}</h3>
                        <p class="mb-3">{{ __('legal/terms-of-service.text_61') }}</p>
                        <ul class="list-disc pl-6 space-y-2">
                            <li><strong>{{ __('legal/terms-of-service.text_340') }}</strong> {{ __('legal/terms-of-service.text_62') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_63') }}</strong> {{ __('legal/terms-of-service.text_64') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_65') }}</strong> {{ __('legal/terms-of-service.text_66') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_67') }}</strong> {{ __('legal/terms-of-service.text_68') }}</li>
                        </ul>
                        <p class="mt-3 text-sm italic">{{ __('legal/terms-of-service.text_69') }}</p>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_341') }}</h3>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_342') }}</h3>
                        <div class="space-y-3">
                            <div>
                                <h4 class="font-semibold text-[#0F0F0F] mb-1">{{ __('legal/terms-of-service.text_343') }}</h4>
                                <p>{{ __('legal/terms-of-service.text_75') }}</p>
                            </div>
                            <div>
                                <h4 class="font-semibold text-[#0F0F0F] mb-1">{{ __('legal/terms-of-service.text_76') }}</h4>
                                <ul class="list-disc pl-6 space-y-1">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_344') }}</h3>
                    ...
                    <div>
                        ...
                        <p>{{ __('legal/terms-of-service.text_85') }} <a class="text-[#00AEEF] hover:underline" href="{{ route('refund-policy') }}">{{ __('legal/terms-of-service.text_345') }}</a> {{ __('legal/terms-of-service.text_86') }}</p>
                    </div>
                    <div>
            ...
            <div id="intellectual-property" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_88') }}</h2>
                <div class="space-y-6 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_89') }}</h3>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_95') }}</h3>
                        <p class="mb-3">{{ __('legal/terms-of-service.text_96') }}</p>
                        <ul class="list-disc pl-6 space-y-2">
                            <li><strong>{{ __('legal/terms-of-service.text_346') }}</strong> {{ __('legal/terms-of-service.text_97') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_98') }}</strong> {{ __('legal/terms-of-service.text_99') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_100') }}</strong> {{ __('legal/terms-of-service.text_101') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_102') }}</strong> {{ __('legal/terms-of-service.text_103') }}</li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_104') }}</h3>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_111') }}</h3>
                        <p>{{ __('legal/terms-of-service.text_112') }}</p>
                    </div>
                    <div class="bg-[#00AEEF]/5 rounded-lg p-6 border border-[#00AEEF]/20">
                        <h4 class="font-semibold text-[#0F0F0F] mb-2">{{ __('legal/terms-of-service.text_113') }}</h4>
                        <p>{{ __('legal/terms-of-service.text_114') }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_347') }}</h2>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_115') }}</h3>
                        <ul class="list-disc pl-6 space-y-2">
                            <li><strong>{{ __('legal/terms-of-service.text_116') }}</strong> {{ __('legal/terms-of-service.text_117') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_118') }}</strong> {{ __('legal/terms-of-service.text_119') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_120') }}</strong> {{ __('legal/terms-of-service.text_121') }}</li>
                        </ul>
      ...
      ">
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_125') }}</h2>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_126') }}</h3>
                        <ul class="list-disc pl-6 space-y-2">
                            <li><strong>{{ __('legal/terms-of-service.text_348') }}</strong> {{ __('legal/terms-of-service.text_127') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_128') }}</strong> {{ __('legal/terms-of-service.text_129') }}</li>
                        </ul>
                        <p class="mt-3 text-sm italic">{{ __('legal/terms-of-service.text_130') }}</p>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_131') }}</h3>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_133') }}</h3>
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_141') }}</h2>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_142') }}</h3>
                        <ul class="list-disc pl-6 space-y-2">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_147') }}</h3>
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_152') }}</h2>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <div class="bg-[#F8F8F8] rounded-lg p-6 border-2 border-[#0F0F0F]/20">
                        ...
                        <ul class="list-disc pl-6 space-y-3">
                            <li><strong>{{ __('legal/terms-of-service.text_153') }}</strong> {{ __('legal/terms-of-service.text_154') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_155') }}</strong> {{ __('legal/terms-of-service.text_156') }}</li>
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_166') }}</h2>
                <div class="space-y-6 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_167') }}</h3>
                        <ul class="list-disc pl-6 space-y-2">
                            <li><strong>{{ __('legal/terms-of-service.text_356') }}</strong> {{ __('legal/terms-of-service.text_168') }}</li>
                            <li><strong>{{ __('legal/terms-of-service.text_169') }}</strong> {{ __('legal/terms-of-service.text_170') }}</li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_171') }}</h3>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_176') }}</h3>
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_182') }}</h2>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <p>{{ __('legal/terms-of-service.text_183') }}</p>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_184') }}</h3>
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_196') }}</h2>
                <div class="space-y-6 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_197') }}</h3>
                        <p>{{ __('legal/terms-of-service.text_198') }} <a href="mailto:codesommet@gmail.com" class="text-[#00AEEF] hover:underline"><span class="__cf_email__" data-cfemail="462e232a2a2906362f2d27353529353233222f296825292b">{{ __('legal/terms-of-service.text_561') }}</span></a> {{ __('legal/terms-of-service.text_199') }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_204') }}</h3>
                        <div class="bg-[#F8F8F8] rounded-lg p-6 border border-[#0F0F0F]/10">
                            <p class="font-semibold text-[#0F0F0F] mb-2">{{ __('legal/terms-of-service.text_205') }}</p>
                            <p>{{ __('legal/terms-of-service.text_206') }}</p>
                        </div>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/terms-of-service.text_207') }}</h3>
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                ...
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-lg font-semibold text-[#0F0F0F] mb-2">{{ __('legal/terms-of-service.text_212') }}</h3>
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-[#0F0F0F] mb-2">{{ __('legal/terms-of-service.text_215') }}</h3>
            ...
            <div class="bg-gradient-to-br from-[#00AEEF]/10 to-[#0071BC]/10 rounded-xl p-8 md:p-10 border border-[#00AEEF]/20">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('legal/terms-of-service.text_221') }}</h2>
                </div>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    ...
                    <div class="bg-white rounded-lg p-6 space-y-3">
                        ...
                        <div class="space-y-2">
                            <p><strong>Email :</strong> <a href="mailto:codesommet@gmail.com" class="text-[#00AEEF] hover:underline"><span class="__cf_email__" data-cfemail="c1a9a4adadae81b1a8aaa0b2b2aeb2b5b4a5a8aeefa2aeac">{{ __('legal/terms-of-service.text_562') }}</span></a></p>
                            <p><strong>{{ __('legal/terms-of-service.text_224') }}</strong> <a href="tel:+212632582096" class="text-[#00AEEF] hover:underline">+212 6 32 58 20 96</a></p>
                            <p><strong>{{ __('legal/terms-of-service.text_225') }}</strong> <a href="tel:+212632582096" class="text-[#00AEEF] hover:underline">+212 6 32 58 20 96</a></p>
                        </div>
                        <div>
            ...
            <div class="mt-12 text-center">
                ...
                <div class="flex flex-wrap justify-center gap-3"><a class="px-6 py-3 text-sm font-medium text-[#00AEEF] border-2 border-[#00AEEF] hover:bg-[#00AEEF] hover:text-white rounded-full transition-colors" href="{{ route('privacy-policy') }}">{{ __('legal/terms-of-service.text_230') }}</a><a class="px-6 py-3 text-sm font-medium text-[#00AEEF] border-2 border-[#00AEEF] hover:bg-[#00AEEF] hover:text-white rounded-full transition-colors" href="{{ route('cookie-policy') }}">{{ __('legal/terms-of-service.text_360') }}</a><a class="px-6 py-3 text-sm font-medium text-[#00AEEF] border-2 border-[#00AEEF] hover:bg-[#00AEEF] hover:text-white rounded-full transition-colors" href="{{ route('refund-policy') }}">{{ __('legal/terms-of-service.text_361') }}</a><a class="px-6 py-3 text-sm font-medium text-[#00AEEF] border-2 border-[#00AEEF] hover:bg-[#00AEEF] hover:text-white rounded-full transition-colors" href="{{ route('acceptable-use') }}">Politique d'Utilisation Acceptable</a></div>
            </div>
        </div>
    </div>
</section>
