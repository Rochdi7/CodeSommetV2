    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        <div class="max-w-4xl mx-auto text-center space-y-6">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#00AEEF]/10 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-cookie w-4 h-4 text-[#00AEEF]" aria-hidden="true">
                ...
                </svg><span class="text-sm font-medium text-[#0F0F0F]">{{ __('legal/cookie-policy.text_0') }}</span></div>
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-semibold text-[#0F0F0F] leading-tight" style="font-family:var(--font-heading)">{{ __('legal/cookie-policy.text_213') }}</h1>
            <p class="text-lg md:text-xl text-[#0F0F0F]/70 max-w-2xl mx-auto">{{ __('legal/cookie-policy.text_1') }}</p>
            <div class="flex flex-wrap justify-center gap-3 pt-4"><a href="#what-are-cookies" class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">{{ __('legal/cookie-policy.text_2') }}</a><a href="#types-of-cookies" class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">{{ __('legal/cookie-policy.text_214') }}</a><a href="#manage-cookies" class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">{{ __('legal/cookie-policy.text_3') }}</a></div>
        </div>
    </div>
</section>
<section class="w-full py-16 md:py-24 bg-[#F8F8F8]">
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                ...
                <div class="prose prose-lg max-w-none text-[#0F0F0F]/70 space-y-4">
                    <p>{{ __('legal/cookie-policy.text_4') }} <a class="text-[#00AEEF] hover:underline" href="{{ route('home') }}">codesommet.com</a>.</p>
            ...
            <div id="what-are-cookies" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('legal/cookie-policy.text_7') }}</h2>
                </div>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <p>{{ __('legal/cookie-policy.text_8') }}</p>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/cookie-policy.text_215') }}</h3>
                        <ul class="list-disc pl-6 space-y-2">
                            ...
                            <li><strong>{{ __('legal/cookie-policy.text_216') }}</strong> {{ __('legal/cookie-policy.text_12') }}</li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/cookie-policy.text_13') }}</h3>
                        <ul class="list-disc pl-6 space-y-2">
                            <li><strong>{{ __('legal/cookie-policy.text_217') }}</strong> {{ __('legal/cookie-policy.text_14') }}</li>
            ...
            <div id="types-of-cookies" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('legal/cookie-policy.text_16') }}</h2>
                </div>
      ...
      ">
                        ...
                        <div class="relative p-6">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h4 class="text-lg font-semibold text-[#0F0F0F]">{{ __('legal/cookie-policy.text_17') }}</h4>
                            </div>
                            <div class="text-[#0F0F0F]/80">
                                <p class="mb-2"><strong>Objectif :</strong> {{ __('legal/cookie-policy.text_18') }}</p>
                                ...
                                <p class="mt-3"><strong>{{ __('legal/cookie-policy.text_23') }}</strong> {{ __('legal/cookie-policy.text_24') }}</p>
      ...
      ">
                        ...
                        <div class="relative p-6">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h4 class="text-lg font-semibold text-[#0F0F0F]">{{ __('legal/cookie-policy.text_218') }}</h4>
                            </div>
                            <div class="text-[#0F0F0F]/80">
                                <p class="mb-2"><strong>Objectif :</strong> {{ __('legal/cookie-policy.text_26') }}</p>
                                ...
                                <p class="mt-2"><strong>{{ __('legal/cookie-policy.text_33') }}</strong> {{ __('legal/cookie-policy.text_34') }}</p>
                                <p class="mt-2 text-sm">{{ __('legal/cookie-policy.text_35') }} <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" class="text-[#00AEEF] hover:underline">{{ __('legal/cookie-policy.text_36') }}</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="
      ...
      ">
                        ...
                        <div class="relative p-6">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h4 class="text-lg font-semibold text-[#0F0F0F]">{{ __('legal/cookie-policy.text_37') }}</h4>
                            </div>
                            <div class="text-[#0F0F0F]/80">
                                <p class="mb-2"><strong>Objectif :</strong> {{ __('legal/cookie-policy.text_38') }}</p>
                                ...
                                <p class="mt-3"><strong>{{ __('legal/cookie-policy.text_44') }}</strong> {{ __('legal/cookie-policy.text_45') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="
      ...
      ">
                        ...
                        <div class="relative p-6">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h4 class="text-lg font-semibold text-[#0F0F0F]">{{ __('legal/cookie-policy.text_46') }}</h4>
                            </div>
                            <div class="text-[#0F0F0F]/80">
                                <p class="mb-2"><strong>Objectif :</strong> {{ __('legal/cookie-policy.text_47') }}</p>
                                ...
                                <p class="mt-3"><strong>{{ __('legal/cookie-policy.text_52') }}</strong> {{ __('legal/cookie-policy.text_53') }}</p>
                ...
                <div class="space-y-4 text-[#0F0F0F]/70">
                    ...
                    <div class="space-y-4">
                        <div class="bg-[#F8F8F8] rounded-lg p-6">
                            ...
                            <p class="mb-2"><strong>{{ __('legal/cookie-policy.text_56') }}</strong> {{ __('legal/cookie-policy.text_57') }}</p>
                            <p class="mb-2"><strong>{{ __('legal/cookie-policy.text_58') }}</strong> <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" class="text-[#00AEEF] hover:underline">{{ __('legal/cookie-policy.text_59') }}</a></p>
                            <p><strong>{{ __('legal/cookie-policy.text_60') }}</strong> <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" class="text-[#00AEEF] hover:underline">{{ __('legal/cookie-policy.text_61') }}</a></p>
                        </div>
                        <div class="bg-[#F8F8F8] rounded-lg p-6">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-2">{{ __('legal/cookie-policy.text_62') }}</h3>
                            <p class="mb-2"><strong>Objectif :</strong> {{ __('legal/cookie-policy.text_63') }}</p>
                            <p class="mb-2"><strong>{{ __('legal/cookie-policy.text_64') }}</strong> {{ __('legal/cookie-policy.text_65') }}</p>
                            <p class="mb-2"><strong>{{ __('legal/cookie-policy.text_66') }}</strong> <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" class="text-[#00AEEF] hover:underline">{{ __('legal/cookie-policy.text_67') }}</a></p>
      ...
      ">
            ...
            <div id="manage-cookies" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('legal/cookie-policy.text_70') }}</h2>
                </div>
                <div class="space-y-6 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/cookie-policy.text_71') }}</h3>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/cookie-policy.text_77') }}</h3>
                        <div class="space-y-3">
                            <div class="bg-[#F8F8F8] rounded-lg p-4">
                                <h4 class="font-semibold text-[#0F0F0F] mb-2">Google Chrome</h4>
                                <p class="text-sm">{{ __('legal/cookie-policy.text_78') }}</p><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" class="text-sm text-[#00AEEF] hover:underline">{{ __('legal/cookie-policy.text_79') }}</a>
                            </div>
                            <div class="bg-[#F8F8F8] rounded-lg p-4">
                                <h4 class="font-semibold text-[#0F0F0F] mb-2">Mozilla Firefox</h4>
                                <p class="text-sm">{{ __('legal/cookie-policy.text_80') }}</p><a href="https://support.mozilla.org/en-US/kb/clear-cookies-and-site-data-firefox" target="_blank" rel="noopener noreferrer" class="text-sm text-[#00AEEF] hover:underline">{{ __('legal/cookie-policy.text_81') }}</a>
                            </div>
                            <div class="bg-[#F8F8F8] rounded-lg p-4">
                                <h4 class="font-semibold text-[#0F0F0F] mb-2">Safari</h4>
                                <p class="text-sm">{{ __('legal/cookie-policy.text_82') }}</p><a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" target="_blank" rel="noopener noreferrer" class="text-sm text-[#00AEEF] hover:underline">{{ __('legal/cookie-policy.text_83') }}</a>
                            </div>
                            <div class="bg-[#F8F8F8] rounded-lg p-4">
                                <h4 class="font-semibold text-[#0F0F0F] mb-2">Microsoft Edge</h4>
                                <p class="text-sm">{{ __('legal/cookie-policy.text_84') }}</p><a href="https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" class="text-sm text-[#00AEEF] hover:underline">{{ __('legal/cookie-policy.text_85') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="
      ...
      ">
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/cookie-policy.text_87') }}</h2>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <p>{{ __('legal/cookie-policy.text_88') }}</p>
                    <ul class="list-disc pl-6 space-y-2">
                        <li><strong>{{ __('legal/cookie-policy.text_89') }}</strong> {{ __('legal/cookie-policy.text_90') }}</li>
                        <li><strong>{{ __('legal/cookie-policy.text_91') }}</strong> {{ __('legal/cookie-policy.text_92') }}</li>
                        <li><strong>{{ __('legal/cookie-policy.text_93') }}</strong> {{ __('legal/cookie-policy.text_94') }}</li>
                    </ul>
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/cookie-policy.text_101') }}</h2>
                <div class="space-y-4 text-[#0F0F0F]/70">
            ...
            <div class="bg-gradient-to-br from-[#00AEEF]/10 to-[#0071BC]/10 rounded-xl p-8 md:p-10 border border-[#00AEEF]/20">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('legal/cookie-policy.text_105') }}</h2>
                </div>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    ...
                    <div class="bg-white rounded-lg p-6 space-y-3">
                        ...
                        <div class="space-y-2">
                            <p><strong>Email :</strong> <a href="mailto:codesommet@gmail.com" class="text-[#00AEEF] hover:underline"><span class="__cf_email__" data-cfemail="bed6dbd2d2d1feced7d5dfcdcdd1cdcacbdad7d190ddd1d3">{{ __('legal/cookie-policy.text_421') }}</span></a></p>
                            <p><strong>{{ __('legal/cookie-policy.text_108') }}</strong> <a href="tel:+212632582096" class="text-[#00AEEF] hover:underline">+212 6 32 58 20 96</a></p>
                            <p><strong>{{ __('legal/cookie-policy.text_109') }}</strong> <a href="tel:+212632582096" class="text-[#00AEEF] hover:underline">+212 6 32 58 20 96</a></p>
                        </div>
                        <div>
