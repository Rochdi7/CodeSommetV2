    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        <div class="max-w-4xl mx-auto text-center space-y-6">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#00AEEF]/10 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-dollar-sign w-4 h-4 text-[#00AEEF]" aria-hidden="true">
                ...
                </svg><span class="text-sm font-medium text-[#0F0F0F]">{{ __('legal/refund-policy.text_0') }}</span></div>
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-semibold text-[#0F0F0F] leading-tight" style="font-family:var(--font-heading)">{{ __('legal/refund-policy.text_263') }}</h1>
            <p class="text-lg md:text-xl text-[#0F0F0F]/70 max-w-2xl mx-auto">{{ __('legal/refund-policy.text_1') }}</p>
            <div class="flex flex-wrap justify-center gap-3 pt-4"><a href="#retainer-refunds" class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">Remboursements Forfait</a><a href="#project-refunds" class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">{{ __('legal/refund-policy.text_264') }}</a><a href="#how-to-request" class="px-4 py-2 text-sm font-medium text-[#00AEEF] hover:bg-[#00AEEF]/5 rounded-lg transition-colors">{{ __('legal/refund-policy.text_265') }}</a></div>
        </div>
    </div>
</section>
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-4" style="font-family:var(--font-heading)">{{ __('legal/refund-policy.text_2') }}</h2>
                <div class="prose prose-lg max-w-none text-[#0F0F0F]/70 space-y-4">
                    <p>{{ __('legal/refund-policy.text_3') }}</p>
                    <p>{{ __('legal/refund-policy.text_4') }} <strong>Stripe</strong>{{ __('legal/refund-policy.text_5') }}</p>
            ...
            <div id="retainer-refunds" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('legal/refund-policy.text_266') }}</h2>
                </div>
                <div class="space-y-6 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">Conditions d'annulation</h3>
                        <ul class="list-disc pl-6 space-y-2">
                            <li><strong>{{ __('legal/refund-policy.text_8') }}</strong> {{ __('legal/refund-policy.text_9') }}</li>
                            <li><strong>{{ __('legal/refund-policy.text_10') }}</strong> {{ __('legal/refund-policy.text_11') }} <a href="mailto:codesommet@gmail.com" class="text-[#00AEEF] hover:underline"><span class="__cf_email__" data-cfemail="1c74797070735c6c75777d6f6f736f6869787573327f7371">{{ __('legal/refund-policy.text_480') }}</span></a> {{ __('legal/refund-policy.text_12') }}</li>
                            <li><strong>Date d'effet :</strong> {{ __('legal/refund-policy.text_13') }}</li>
                            <li><strong>{{ __('legal/refund-policy.text_14') }}</strong> {{ __('legal/refund-policy.text_15') }}</li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-4">{{ __('legal/refund-policy.text_16') }}</h3>
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-5">
                                        ...
                                        <h4 class="text-xl font-semibold text-[#0F0F0F]">{{ __('legal/refund-policy.text_17') }}</h4>
                                    </div>
                                    <div class="space-y-3">
                                        <div class="flex items-start gap-3 group">
                                            ...
                                            <div class="flex-1"><span class="font-semibold text-[#0F0F0F]">{{ __('legal/refund-policy.text_267') }}<!-- -->:</span> <span class="text-[#0F0F0F]/70">{{ __('legal/refund-policy.text_18') }}</span></div>
                                        </div>
                                        <div class="flex items-start gap-3 group">
                                            <div class="bg-[#22C55E]/10 rounded-md p-1 flex-shrink-0 mt-1 transition-transform group-hover:scale-110">
                                                <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div>
                                            </div>
                                            <div class="flex-1"><span class="font-semibold text-[#0F0F0F]">{{ __('legal/refund-policy.text_19') }}<!-- -->:</span> <span class="text-[#0F0F0F]/70">{{ __('legal/refund-policy.text_20') }}</span></div>
                                        </div>
                                        <div class="flex items-start gap-3 group">
                                            <div class="bg-[#22C55E]/10 rounded-md p-1 flex-shrink-0 mt-1 transition-transform group-hover:scale-110">
                                                <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div>
                                            </div>
                                            <div class="flex-1"><span class="font-semibold text-[#0F0F0F]">Doubles facturations<!-- -->:</span> <span class="text-[#0F0F0F]/70">{{ __('legal/refund-policy.text_21') }}</span></div>
                                        </div>
                                        <div class="flex items-start gap-3 group">
                                            <div class="bg-[#22C55E]/10 rounded-md p-1 flex-shrink-0 mt-1 transition-transform group-hover:scale-110">
                                                <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div>
                                            </div>
                                            <div class="flex-1"><span class="font-semibold text-[#0F0F0F]">Service non fourni<!-- -->:</span> <span class="text-[#0F0F0F]/70">{{ __('legal/refund-policy.text_22') }}</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
      ...
      ">
                                ...
                                <div class="relative p-6">
                                    <div class="flex items-center gap-3 mb-5">
                                        ...
                                        <h4 class="text-xl font-semibold text-[#0F0F0F]">{{ __('legal/refund-policy.text_23') }}</h4>
                                    </div>
                                    <div class="space-y-3">
                                        <div class="flex items-start gap-3 group">
                                            ...
                                            <div class="flex-1"><span class="font-semibold text-[#0F0F0F]">{{ __('legal/refund-policy.text_24') }}<!-- -->:</span> <span class="text-[#0F0F0F]/70">{{ __('legal/refund-policy.text_25') }}</span></div>
                                        </div>
                                        <div class="flex items-start gap-3 group">
                                            <div class="bg-[#EF4444]/10 rounded-md p-1 flex-shrink-0 mt-1 transition-transform group-hover:scale-110">
                                                <div class="w-1.5 h-1.5 rounded-full bg-[#EF4444]"></div>
                                            </div>
                                            <div class="flex-1"><span class="font-semibold text-[#0F0F0F]">{{ __('legal/refund-policy.text_26') }}<!-- -->:</span> <span class="text-[#0F0F0F]/70">{{ __('legal/refund-policy.text_27') }}</span></div>
                                        </div>
                                        <div class="flex items-start gap-3 group">
                                            <div class="bg-[#EF4444]/10 rounded-md p-1 flex-shrink-0 mt-1 transition-transform group-hover:scale-110">
                                                <div class="w-1.5 h-1.5 rounded-full bg-[#EF4444]"></div>
                                            </div>
                                            <div class="flex-1"><span class="font-semibold text-[#0F0F0F]">Changement d'avis<!-- -->:</span> <span class="text-[#0F0F0F]/70">{{ __('legal/refund-policy.text_268') }}</span></div>
                                        </div>
                                        <div class="flex items-start gap-3 group">
                                            <div class="bg-[#EF4444]/10 rounded-md p-1 flex-shrink-0 mt-1 transition-transform group-hover:scale-110">
                                                <div class="w-1.5 h-1.5 rounded-full bg-[#EF4444]"></div>
                                            </div>
                                            <div class="flex-1"><span class="font-semibold text-[#0F0F0F]">{{ __('legal/refund-policy.text_28') }}<!-- -->:</span> <span class="text-[#0F0F0F]/70">{{ __('legal/refund-policy.text_29') }}</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-4">{{ __('legal/refund-policy.text_30') }}</h3>
                        <div class="
        relative overflow-hidden rounded-xl border backdrop-blur-sm
      ...
      ">
                            ...
                            <div class="relative p-6">
                                <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <h4 class="text-lg font-semibold text-[#0F0F0F]">{{ __('legal/refund-policy.text_31') }}</h4>
                                </div>
                                <div class="text-[#0F0F0F]/80">
                                    <p>{{ __('legal/refund-policy.text_32') }} <strong>{{ __('legal/refund-policy.text_33') }}</strong> {{ __('legal/refund-policy.text_34') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_35') }}</h3>
                        <ul class="list-disc pl-6 space-y-2">
            ...
            <div id="project-refunds" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('legal/refund-policy.text_41') }}</h2>
                </div>
                <div class="space-y-6 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_269') }}</h3>
                        <ul class="list-disc pl-6 space-y-2">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_45') }}</h3>
                        <div class="space-y-4">
                            <div class="bg-[#F8F8F8] rounded-lg p-6 border border-[#0F0F0F]/10">
                                <h4 class="font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_46') }}</h4>
                                <ul class="list-disc pl-6 space-y-1">
                                    <li><strong>{{ __('legal/refund-policy.text_47') }}</strong> {{ __('legal/refund-policy.text_48') }}</li>
                                    <li><strong>{{ __('legal/refund-policy.text_270') }}</strong> {{ __('legal/refund-policy.text_49') }}</li>
                                    <li><strong>{{ __('legal/refund-policy.text_50') }}</strong> {{ __('legal/refund-policy.text_51') }}</li>
                                </ul>
                            </div>
                            <div class="bg-[#F8F8F8] rounded-lg p-6 border border-[#0F0F0F]/10">
                                <h4 class="font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_52') }}</h4>
                                <ul class="list-disc pl-6 space-y-1">
                                    <li><strong>{{ __('legal/refund-policy.text_271') }}</strong> {{ __('legal/refund-policy.text_53') }}</li>
                            ...
                            <div class="bg-[#F8F8F8] rounded-lg p-6 border border-[#0F0F0F]/10">
                                <h4 class="font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_56') }}</h4>
                                <ul class="list-disc pl-6 space-y-1">
                                    <li><strong>{{ __('legal/refund-policy.text_272') }}</strong> {{ __('legal/refund-policy.text_57') }}</li>
                            ...
                            <div class="bg-[#F8F8F8] rounded-lg p-6 border border-[#0F0F0F]/10">
                                <h4 class="font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_60') }}</h4>
                                <ul class="list-disc pl-6 space-y-1">
                                    <li><strong>{{ __('legal/refund-policy.text_61') }}</strong> {{ __('legal/refund-policy.text_62') }}</li>
                                    <li><strong>Raison :</strong> {{ __('legal/refund-policy.text_63') }}</li>
                                    <li><strong>Alternative :</strong> {{ __('legal/refund-policy.text_64') }}</li>
                                </ul>
                            </div>
                            <div class="bg-[#F8F8F8] rounded-lg p-6 border border-[#0F0F0F]/10">
                                <h4 class="font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_65') }}</h4>
                                <ul class="list-disc pl-6 space-y-1">
                                    <li><strong>{{ __('legal/refund-policy.text_273') }}</strong> {{ __('legal/refund-policy.text_66') }}</li>
                                    <li><strong>Garantie post-lancement :</strong> {{ __('legal/refund-policy.text_67') }}</li>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_69') }}</h3>
      ...
      ">
                            ...
                            <div class="flex-1 text-sm text-[#0F0F0F]/80">
                                <p class="font-medium text-[#0F0F0F]"><strong>Exemple :</strong> {{ __('legal/refund-policy.text_75') }}</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_274') }}</h3>
                        <div class="
        flex items-start gap-3 p-4 rounded-lg border backdrop-blur-sm
      ...
      ">
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/refund-policy.text_78') }}</h2>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_79') }}</h3>
                        <p class="mb-2">{{ __('legal/refund-policy.text_80') }}</p>
                        <ul class="list-disc pl-6 space-y-2">
                            <li><strong>{{ __('legal/refund-policy.text_81') }}</strong> {{ __('legal/refund-policy.text_82') }}</li>
                            ...
                            <li><strong>{{ __('legal/refund-policy.text_85') }}</strong> {{ __('legal/refund-policy.text_86') }}</li>
                        </ul>
                        <p class="mt-3 text-sm italic">{{ __('legal/refund-policy.text_87') }}</p>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_88') }}</h3>
                        <p>{{ __('legal/refund-policy.text_89') }}</p>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_275') }}</h3>
                        <div class="
        flex items-start gap-3 p-4 rounded-lg border backdrop-blur-sm
      ...
      ">
                            ...
                            <div class="flex-1 text-sm text-[#0F0F0F]/80">
                                ...
                                <p class="mt-3 font-medium">{{ __('legal/refund-policy.text_95') }} <a href="mailto:codesommet@gmail.com" class="text-[#00AEEF] hover:underline"><span class="__cf_email__" data-cfemail="a6cec3cacac9e6d6cfcdc7d5d5c9d5d2d3c2cfc988c5c9cb">{{ __('legal/refund-policy.text_481') }}</span></a> {{ __('legal/refund-policy.text_96') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="how-to-request" class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('legal/refund-policy.text_97') }}</h2>
                </div>
                <div class="space-y-6 text-[#0F0F0F]/70">
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_98') }}</h3>
                        <ol class="list-decimal pl-6 space-y-3">
                            <li><strong>{{ __('legal/refund-policy.text_99') }}</strong> {{ __('legal/refund-policy.text_100') }} <a href="mailto:codesommet@gmail.com" class="text-[#00AEEF] hover:underline"><span class="__cf_email__" data-cfemail="caa2afa6a6a58abaa3a1abb9b9a5b9bebfaea3a5e4a9a5a7">{{ __('legal/refund-policy.text_482') }}</span></a></li>
                            ...
                            <li><strong>{{ __('legal/refund-policy.text_107') }}</strong> {{ __('legal/refund-policy.text_108') }}</li>
                            <li><strong>{{ __('legal/refund-policy.text_109') }}</strong> {{ __('legal/refund-policy.text_110') }}</li>
                            <li><strong>Traitement :</strong> {{ __('legal/refund-policy.text_111') }}</li>
                            <li><strong>{{ __('legal/refund-policy.text_112') }}</strong> {{ __('legal/refund-policy.text_113') }}</li>
                        </ol>
                    </div>
                    <div class="bg-[#00AEEF]/5 rounded-lg p-6 border border-[#00AEEF]/20">
                        ...
                        <ul class="list-disc pl-6 space-y-1">
                            <li><strong>{{ __('legal/refund-policy.text_115') }}</strong> {{ __('legal/refund-policy.text_116') }}</li>
                            <li><strong>{{ __('legal/refund-policy.text_783') }}</strong> {{ __('legal/refund-policy.text_117') }}</li>
                            <li><strong>Mode alternatif :</strong> {{ __('legal/refund-policy.text_118') }}</li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_119') }}</h3>
                        ...
                        <ol class="list-decimal pl-6 space-y-2">
                            ...
                            <li>{{ __('legal/refund-policy.text_124') }} <a class="text-[#00AEEF] hover:underline" href="/legal/terms-of-service#dispute-resolution">{{ __('legal/refund-policy.text_125') }}</a> {{ __('legal/refund-policy.text_126') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/refund-policy.text_127') }}</h2>
                <div class="space-y-6 text-[#0F0F0F]/70">
                    <div>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_134') }}</h3>
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-[#0F0F0F] mb-3">{{ __('legal/refund-policy.text_141') }}</h3>
            ...
            <div class="bg-gradient-to-br from-[#00AEEF]/10 to-[#0071BC]/10 rounded-xl p-8 md:p-10 border border-[#00AEEF]/20">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('legal/refund-policy.text_143') }}</h2>
                </div>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    ...
                    <div class="bg-white rounded-lg p-6 space-y-3">
                        ...
                        <div class="space-y-2">
                            <p><strong>Email :</strong> <a href="mailto:codesommet@gmail.com" class="text-[#00AEEF] hover:underline"><span class="__cf_email__" data-cfemail="cfa7aaa3a3a08fbfa6a4aebcbca0bcbbbaaba6a0e1aca0a2">{{ __('legal/refund-policy.text_483') }}</span></a></p>
                            <p><strong>{{ __('legal/refund-policy.text_146') }}</strong> <a href="tel:+212632582096" class="text-[#00AEEF] hover:underline">+212 6 32 58 20 96</a></p>
                            <p><strong>{{ __('legal/refund-policy.text_147') }}</strong> <a href="tel:+212632582096" class="text-[#00AEEF] hover:underline">+212 6 32 58 20 96</a></p>
                        </div>
                        <div>
      ...
      ">
            ...
            <div class="bg-white rounded-xl p-8 md:p-10 shadow-sm mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-[#0F0F0F] mb-6" style="font-family:var(--font-heading)">{{ __('legal/refund-policy.text_153') }}</h2>
                <div class="space-y-4 text-[#0F0F0F]/70">
                    <div class="bg-[#F8F8F8] rounded-lg p-6 border border-[#0F0F0F]/10">
                        <ul class="space-y-3">
                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-alert w-5 h-5 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                    ...
                                    <line x1="12" x2="12" y1="8" y2="12"></line>
                                    <line x1="12" x2="12.01" y1="16" y2="16"></line>
                                </svg><span><strong>{{ __('legal/refund-policy.text_278') }}</strong> {{ __('legal/refund-policy.text_154') }}</span></li>
                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-alert w-5 h-5 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <line x1="12" x2="12" y1="8" y2="12"></line>
                                    <line x1="12" x2="12.01" y1="16" y2="16"></line>
                                </svg><span><strong>Droit applicable :</strong> {{ __('legal/refund-policy.text_155') }} <a class="text-[#00AEEF] hover:underline" href="{{ route('terms-of-service') }}">Conditions d'Utilisation</a> {{ __('legal/refund-policy.text_156') }}</span></li>
                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-alert w-5 h-5 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <line x1="12" x2="12" y1="8" y2="12"></line>
                                    <line x1="12" x2="12.01" y1="16" y2="16"></line>
                                </svg><span><strong>Conditions Stripe :</strong> {{ __('legal/refund-policy.text_157') }} <a href="https://stripe.com/legal/consumer" target="_blank" rel="noopener noreferrer" class="text-[#00AEEF] hover:underline">{{ __('legal/refund-policy.text_279') }}</a>.</span></li>
                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-alert w-5 h-5 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <line x1="12" x2="12" y1="8" y2="12"></line>
                                    <line x1="12" x2="12.01" y1="16" y2="16"></line>
                                </svg><span><strong>{{ __('legal/refund-policy.text_158') }}</strong> {{ __('legal/refund-policy.text_159') }}</span></li>
                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-alert w-5 h-5 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <line x1="12" x2="12" y1="8" y2="12"></line>
                                    <line x1="12" x2="12.01" y1="16" y2="16"></line>
                                </svg><span><strong>{{ __('legal/refund-policy.text_160') }}</strong> {{ __('legal/refund-policy.text_161') }} <a class="text-[#00AEEF] hover:underline" href="/legal/terms-of-service#dispute-resolution">{{ __('legal/refund-policy.text_162') }}</a>.</span></li>
                        </ul>
                    </div>
                </div>
            </div>
