    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        <div class="grid lg:grid-cols-[1.3fr_0.7fr] gap-6 lg:gap-8 items-center">
            ...
            <div class="hidden lg:flex relative h-[500px] items-center justify-center">
                <div class="absolute inset-0 bg-gradient-to-br from-[var(--color-primary-orange)]/5 to-transparent rounded-3xl">
                </div><img src="{{ asset('images/hero-image-1.webp') }}" alt="Développeur créatif construisant des expériences web exceptionnelles" class="relative w-full max-w-lg object-contain animate-float drop-shadow-2xl" loading="eager" fetchPriority="high" />
            </div>
        </div>
        <div class="mt-8 lg:mt-12 relative">
            <div class="hidden lg:block absolute inset-0 bg-gradient-to-r from-[var(--color-primary-orange)]/20 via-[var(--color-purple)]/20 to-[var(--color-orange-hover)]/20 blur-3xl -z-10">
            </div>
            <div class="hidden lg:block relative bg-white/20 backdrop-blur-md border border-white/40 rounded-2xl p-5 shadow-[0_8px_32px_rgba(0,174,239,0.15),inset_0_1px_0_rgba(255,255,255,0.4)]">
                <div class="grid grid-cols-3 gap-5">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-xl bg-white/30 backdrop-blur-sm flex items-center justify-center flex-shrink-0 border border-white/50">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock w-5 h-5 text-[var(--color-primary-orange)]" aria-hidden="true">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-xl bg-white/30 backdrop-blur-sm flex items-center justify-center flex-shrink-0 border border-white/50">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-square w-5 h-5 text-[var(--color-primary-orange)]" aria-hidden="true">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-xl bg-white/30 backdrop-blur-sm flex items-center justify-center flex-shrink-0 border border-white/50">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-medal w-5 h-5 text-[var(--color-primary-orange)]" aria-hidden="true">
            ...
            <div class="lg:hidden grid grid-cols-1 gap-3">
                <div class="bg-white border-2 border-dashed border-[#E5E5E5] rounded-xl px-4 py-3 flex items-center gap-2.5">
                    <div class="w-10 h-10 rounded-lg bg-[#F5F5F5] flex items-center justify-center flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock w-5 h-5 text-[var(--text-primary)]" aria-hidden="true">
                            <path d="M12 6v6l4 2"></path>
                            <circle cx="12" cy="12" r="10"></circle>
                ...
                <div class="bg-white border-2 border-dashed border-[#E5E5E5] rounded-xl px-4 py-3 flex items-center gap-2.5">
                    <div class="w-10 h-10 rounded-lg bg-[#F5F5F5] flex items-center justify-center flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-square w-5 h-5 text-[var(--text-primary)]" aria-hidden="true">
                            <path d="M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z">
                            </path>
                ...
                <div class="bg-white border-2 border-dashed border-[#E5E5E5] rounded-xl px-4 py-3 flex items-center gap-2.5">
                    <div class="w-10 h-10 rounded-lg bg-[#F5F5F5] flex items-center justify-center flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-medal w-5 h-5 text-[var(--text-primary)]" aria-hidden="true">
                            <path d="M7.21 15 2.66 7.14a2 2 0 0 1 .13-2.2L4.4 2.8A2 2 0 0 1 6 2h12a2 2 0 0 1 1.6.8l1.6 2.14a2 2 0 0 1 .14 2.2L16.79 15">
                            </path>
                            <path d="M11 12 5.12 2.2"></path>
                            <path d="m13 12 5.88-9.8"></path>
        ...
        <div class="mt-8 md:mt-16">
            <div class="jsx-fbe667a4dcceba66 relative w-full overflow-hidden">
                <div class="jsx-fbe667a4dcceba66 absolute left-0 top-0 bottom-0 w-16 md:w-32 bg-gradient-to-r from-[var(--bg-primary)] via-[var(--bg-primary)]/80 to-transparent z-10 pointer-events-none">
                </div>
...
<section class="w-full py-12 md:py-16 bg-[#F5F5F5]" id="work">
    ...
    <div class="jsx-2447671171 relative w-full py-4 md:py-8">
        <div class="jsx-2447671171 absolute left-0 top-0 bottom-0 w-16 md:w-32 bg-gradient-to-r from-[#F5F5F5] via-[#F5F5F5]/80 to-transparent z-10 pointer-events-none">
        </div>
            ...
            <div class="flex-shrink-0 w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5" style="opacity:0;transform:translateY(30px)" data-delay="2">
                <div class="relative h-64 overflow-hidden rounded-[14px] bg-[#F3F4F6]">
                    <div class="absolute inset-0 flex items-center justify-center pt-[92px]">
                        <div class="relative flex items-center justify-center"><span class="font-bold leading-none z-0">4+</span>
                            <div class="absolute bg-white px-3 py-1.5 rounded-full shadow-md text-xs font-medium whitespace-nowrap z-10" style="left:calc(50% + 140px);top:calc(50% + -50px);transform:translate(-50%, -50%)">
                                Design Web</div>
            ...
            <div class="flex-shrink-0 w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5" style="opacity:0;transform:translateY(30px)" data-delay="3">
                <div class="relative h-64 overflow-hidden rounded-[14px] bg-[#F3F4F6]">
                    <div class="absolute inset-0 p-2 flex flex-col">
                        ...
                        <div class="flex-1 relative -mx-4 -mb-4" style="overflow:visible"><svg width="calc(100% + 80px)" height="100%" viewBox="70 20 450 500" preserveAspectRatio="none">
                                <defs>
                                    <linearGradient id="savingsGradient" x1="50%" x2="50%" y1="0%" y2="100%">
                                        <stop offset="0%" stop-color="rgba(0, 174, 239, 0.6)"></stop>
                                        <stop offset="100%" stop-color="rgba(0, 174, 239, 0)"></stop>
                                    </linearGradient>
                                </defs>
                                <path d="M 53.822 170.122 C 29.189 152.204 27.801 174.942 20.839 174.892 L 3.089 174.764 L 4.869 279.745 L 489.248 283.23 L 489.248 5.489 C 450.411 67.986 400.334 97.664 374.382 97.664 C 343.334 97.664 333.834 78.489 306.334 78.489 C 270.376 78.489 256.769 133.668 239.781 135.692 C 211.601 139.05 204.045 106.821 181.936 126.692 C 160.817 145.673 145.501 144.542 128.933 138.472 C 109.017 131.175 97.916 147.548 92.857 156.811 C 86.727 168.036 78.454 188.04 53.822 170.122 Z" fill="url(#savingsGradient)" stroke="#00AEEF" stroke-width="4.5"></path>
                            </svg></div>
                    </div>
                </div>
                <div class="px-5 py-4">
...
<section id="premium-features" class="py-16 md:py-24 bg-black relative overflow-hidden">
    <div class="absolute inset-0 pointer-events-none" style="z-index:0">
        <div class="absolute inset-0 w-full h-full" style="background-image:linear-gradient(to right, rgba(255, 255, 255, 0.1) 1px, transparent 1px),
    ...
    <div class="relative z-10">
        ...
        <div class="space-y-4">
            <div class="relative w-full">
                <div class="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-black via-black/60 to-transparent z-10 pointer-events-none">
                </div>
                <div class="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-black via-black/60 to-transparent z-10 pointer-events-none">
                </div>
                <div class="overflow-hidden">
                    <div class="flex gap-4 w-fit" style="animation:scroll-left 40s linear infinite;animation-play-state:running">
                        <div class="group relative inline-block md:cursor-pointer flex-shrink-0">
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bot w-4 h-4 text-white" aria-hidden="true">
                                            ...
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">Chatbots
                                                IA</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar w-4 h-4 text-white" aria-hidden="true">
                                                    <path d="M8 2v4"></path>
                                                    <path d="M16 2v4"></path>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-credit-card w-4 h-4 text-white" aria-hidden="true">
                                                    <rect width="20" height="14" x="2" y="5" rx="2">
                                                    </rect>
                                                    <line x1="2" x2="22" y1="10" y2="10"></line>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">Passerelle de
                                                Paiement</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-circle w-4 h-4 text-white" aria-hidden="true">
                                                    <path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719">
                                                    </path>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">WhatsApp
                                                Business</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-layout-dashboard w-4 h-4 text-white" aria-hidden="true">
                                            ...
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">Tableaux de Bord
                                                Utilisateur</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trending-up w-4 h-4 text-white" aria-hidden="true">
                                                    <path d="M16 7h6v6"></path>
                                                    <path d="m22 7-8.5 8.5-5-5L2 17"></path>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">Optimisation
                                                SEO</span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="relative w-full">
                ...
                <div class="overflow-hidden">
                    <div class="flex gap-4 w-fit" style="animation:scroll-right 35s linear infinite;animation-play-state:running">
                        <div class="group relative inline-block md:cursor-pointer flex-shrink-0">
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chart-column w-4 h-4 text-white" aria-hidden="true">
                                                    <path d="M3 3v16a2 2 0 0 0 2 2h16"></path>
                                                    <path d="M18 17V9"></path>
                                                    <path d="M13 17V5"></path>
                                                    <path d="M8 17v-3"></path>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">Analytiques
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users w-4 h-4 text-white" aria-hidden="true">
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-zap w-4 h-4 text-white" aria-hidden="true">
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shopping-cart w-4 h-4 text-white" aria-hidden="true">
                                                    <circle cx="8" cy="21" r="1"></circle>
                                                    <circle cx="19" cy="21" r="1"></circle>
                                                    <path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12">
                                                    </path>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">E-commerce</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-lock w-4 h-4 text-white" aria-hidden="true">
                                                    <rect width="18" height="11" x="3" y="11" rx="2" ry="2"></rect>
                                                    <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">Authentification</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bell w-4 h-4 text-white" aria-hidden="true">
                                                    <path d="M10.268 21a2 2 0 0 0 3.464 0"></path>
                                                    <path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326">
                                                    </path>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">Notifications
                                                Push</span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="relative w-full">
                ...
                <div class="overflow-hidden">
                    <div class="flex gap-4 w-fit" style="animation:scroll-left 45s linear infinite;animation-play-state:running">
                        <div class="group relative inline-block md:cursor-pointer flex-shrink-0">
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail w-4 h-4 text-white" aria-hidden="true">
                                                    <path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path>
                                                    <rect x="2" y="4" width="20" height="16" rx="2"></rect>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">Automatisation
                                                Email</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-languages w-4 h-4 text-white" aria-hidden="true">
                                            ...
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">Multilingue</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-smartphone w-4 h-4 text-white" aria-hidden="true">
                                                    <rect width="14" height="20" x="5" y="2" rx="2" ry="2"></rect>
                                                    <path d="M12 18h.01"></path>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">PWA
                                                Mobile</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sparkles w-4 h-4 text-white" aria-hidden="true">
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search w-4 h-4 text-white" aria-hidden="true">
                                                    <path d="m21 21-4.34-4.34"></path>
                                                    <circle cx="11" cy="11" r="8"></circle>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">Recherche
                                                Intelligente</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="relative">
                                <div class="relative rounded-full p-[1px] bg-gradient-to-r from-orange-600/60 via-orange-500/60 to-orange-600/60">
                                    <div class="relative px-5 py-3 rounded-full bg-black/90 backdrop-blur-sm">
                                        <div class="relative flex items-center gap-2.5">
                                            <div class="w-7 h-7 flex items-center justify-center rounded-full bg-orange-600/80">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-globe w-4 h-4 text-white" aria-hidden="true">
                                                    <circle cx="12" cy="12" r="10"></circle>
                                                    <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                                                    <path d="M2 12h20"></path>
                                                </svg>
                                            </div><span class="text-sm font-medium text-white whitespace-nowrap tracking-tight">CDN
                                                Mondial</span>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            ...
            <div class="hidden lg:grid grid-cols-3 gap-6" style="opacity:0;transform:translateY(30px)">
                ...
                <div class="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-3xl p-6 relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 border-teal-100">
                    <div class="flex items-center justify-between h-full">
                        <div class="relative z-10 flex-1">
        ...
        <a href="{{ $homeAd3->link_url ?: '#' }}" class="promo-banner group relative block w-full overflow-hidden rounded-2xl" style="aspect-ratio:21/9">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-6 md:p-8 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-400">
                <span class="inline-flex items-center gap-2 text-white text-sm md:text-base font-semibold tracking-wide uppercase">
                    Voir l'offre
                    <svg class="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                </span>
            </div>
        </a>
    </div>
