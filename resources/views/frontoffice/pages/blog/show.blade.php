...
@section('title', ($post->meta_title ?: $post->title) . ' - Blog | CodeSommet')
...
<section class="relative pt-24 md:pt-28 lg:pt-32 pb-12 md:pb-16 lg:pb-24 overflow-hidden">
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        ...
        <div class="max-w-4xl mx-auto text-center">
            ...
            @if($post->excerpt)
            <p class="text-lg md:text-xl text-[var(--text-secondary)] max-w-2xl mx-auto mb-8">{{ $post->excerpt }}</p>
            @endif
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[860px]">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="https://twitter.com/intent/tweet?text={{ urlencode($post->title) }}&url={{ urlencode(route('blog.show', $post->slug)) }}" target="_blank" rel="noopener" class="w-9 h-9 rounded-full border border-[var(--border-light)] flex items-center justify-center text-[var(--text-secondary)] hover:border-[#00AEEF] hover:text-[#00AEEF] hover:bg-[#00AEEF]/5 transition-all">
                ...
                <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(route('blog.show', $post->slug)) }}&title={{ urlencode($post->title) }}" target="_blank" rel="noopener" class="w-9 h-9 rounded-full border border-[var(--border-light)] flex items-center justify-center text-[var(--text-secondary)] hover:border-[#00AEEF] hover:text-[#00AEEF] hover:bg-[#00AEEF]/5 transition-all">
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            @if($relatedPosts->isNotEmpty())
                ...
                <article style="opacity:0;transform:translateY(30px)" data-delay="{{ $loop->index + 1 }}">
                    <a href="{{ route('blog.show', $related->slug) }}" class="block group">
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5 hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] transition-shadow duration-300">
                            <div class="relative aspect-[16/10] overflow-hidden rounded-[14px] bg-[#F3F4F6]">
                                ...
                                @else
                                <div class="w-full h-full bg-gradient-to-br from-[#00AEEF]/20 to-[#0071BC]/10 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#00AEEF" stroke-width="1" class="opacity-30">
            ...
            @else
                ...
                <article style="opacity:0;transform:translateY(30px)" data-delay="{{ $index + 1 }}">
                    <a href="{{ route('blog') }}" class="block group">
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5 hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] transition-shadow duration-300">
                            <div class="relative aspect-[16/10] overflow-hidden rounded-[14px] bg-[#F3F4F6]">
                                ...
                                <div class="absolute top-4 right-4 px-3 py-1.5 backdrop-blur-md rounded-full border border-white/30" style="background:rgba(255,255,255,0.2)">
