...
<section class="relative pt-24 md:pt-28 lg:pt-32 pb-12 md:pb-16 lg:pb-24 overflow-hidden">
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        ...
        <div class="mb-6 md:mb-8">
            <a href="{{ route('blog') }}">
                <button class="inline-flex items-center justify-center font-medium cursor-pointer disabled:pointer-events-none disabled:opacity-50 relative overflow-hidden transform-gpu focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-primary)] border border-[var(--border-default)] text-[var(--text-primary)] bg-transparent hover:border-[var(--color-primary-orange)] hover:text-[var(--color-primary-orange)] hover:bg-[var(--hover-primary)] h-10 px-6 rounded-full group hover:shadow-lg transition-all duration-300 text-sm md:text-base" tabindex="0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-3.5 h-3.5 md:w-4 md:h-4 mr-2 group-hover:-translate-x-1 transition-transform" aria-hidden="true">
            ...
            <div class="flex flex-wrap items-center justify-center gap-4 md:gap-6 mb-8">
                <div class="flex items-center gap-2.5">
                    <div class="w-10 h-10 rounded-full bg-[#00AEEF]/10 flex items-center justify-center flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00AEEF" stroke-width="2"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                    </div>
                    <div class="text-left">
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[860px]">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <span class="text-xs font-semibold text-[var(--text-tertiary)] uppercase tracking-wider">Partager</span>
                <a href="#" class="w-9 h-9 rounded-full border border-[var(--border-light)] flex items-center justify-center text-[var(--text-secondary)] hover:border-[#00AEEF] hover:text-[#00AEEF] hover:bg-[#00AEEF]/5 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path></svg>
                </a>
                <a href="#" class="w-9 h-9 rounded-full border border-[var(--border-light)] flex items-center justify-center text-[var(--text-secondary)] hover:border-[#00AEEF] hover:text-[#00AEEF] hover:bg-[#00AEEF]/5 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                </a>
                <button onclick="navigator.clipboard.writeText(window.location.href);this.querySelector('span').textContent='Copié!';setTimeout(()=>this.querySelector('span').textContent='',2000)" class="h-9 px-3 rounded-full border border-[var(--border-light)] flex items-center justify-center gap-1.5 text-[var(--text-secondary)] hover:border-[#00AEEF] hover:text-[#00AEEF] hover:bg-[#00AEEF]/5 transition-all text-xs font-medium">
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[860px]">
        <div class="bg-white rounded-3xl p-8 md:p-10 shadow-[0_4px_20px_rgba(0,0,0,0.06)] border border-gray-100">
            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-5">
                <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#00AEEF]/20 to-[#0071BC]/10 flex items-center justify-center flex-shrink-0">
...
<section class="py-16 md:py-20 bg-white">
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            @php
            $relatedStatic = [
                ['title' => 'Guide Complet du SEO Technique pour Laravel', 'excerpt' => 'Optimisez votre site Laravel pour les moteurs de recherche avec ce guide pratique.', 'category' => 'SEO', 'date' => '20 Mars 2026', 'read_time' => '12 min', 'gradient' => 'from-[#10B981]/20 to-[#059669]/5', 'badge_bg' => 'bg-[#10B981]/80'],
                ['title' => 'Les 10 Tendances du Design Web en 2026', 'excerpt' => 'Du bento grid au glassmorphism avancé, les tendances visuelles qui dominent le web.', 'category' => 'Design', 'date' => '22 Mars 2026', 'read_time' => '6 min', 'gradient' => 'from-[#8B5CF6]/20 to-[#7C3AED]/5', 'badge_bg' => 'bg-[#8B5CF6]/80'],
                ['title' => 'Créer une API RESTful avec Laravel 12', 'excerpt' => 'Architecture, authentification Sanctum, pagination et documentation automatique.', 'category' => 'Développement', 'date' => '8 Mars 2026', 'read_time' => '15 min', 'gradient' => 'from-[#00AEEF]/20 to-[#0071BC]/5', 'badge_bg' => 'bg-[#00AEEF]/80'],
            ];
            @endphp
                ...
                <a href="#" class="block group">
                    <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5 hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] transition-shadow duration-300">
                        <div class="relative aspect-[16/10] overflow-hidden rounded-[14px] bg-[#F3F4F6]">
                            <div class="w-full h-full bg-gradient-to-br {{ $related['gradient'] }} flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="opacity-20 text-[var(--text-primary)]"><path d="M12 20h9"></path><path d="M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.838a.5.5 0 0 1-.62-.62l.838-2.872a2 2 0 0 1 .506-.854z"></path></svg>
                            </div>
                            <div class="absolute top-4 right-4 px-3 py-1.5 {{ $related['badge_bg'] }} backdrop-blur-md rounded-full border border-white/30">
