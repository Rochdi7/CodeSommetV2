            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
                <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                    <div class="space-y-6 lg:space-y-8 text-center">
                        ...
                        <div class="space-y-6">
                            <h1 class="leading-[1.15] tracking-tight uppercase text-[28px] sm:text-[40px] lg:text-[56px] font-extrabold max-w-5xl mx-auto"
                                ...
                                {{ __('locations/web-development-company-cairo.text_1') }}<!-- --> <span
                    ...
                    rgba(0, 0, 0, 0.02) 0px 150px 150px -3.75px"
                                ...
                                href="#"><span
                                    class="relative text-[15px] font-semibold text-white z-10">{{ __('locations/web-development-company-cairo.ml_881') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">{{ __('locations/web-development-company-cairo.text_168') }}</span>
                            </div>
                            <div class="w-px h-4 bg-[#0F0F0F]/20"></div>
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                            ...
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">
                                        {{ __('locations/web-development-company-cairo.text_169') }}</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('locations/web-development-company-cairo.ml_882') }}</p>
                        ...
                        <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">
                                        {{ __('locations/web-development-company-cairo.ml_883') }}</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('locations/web-development-company-cairo.ml_884') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">
                                        {{ __('locations/web-development-company-cairo.ml_885') }}</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('locations/web-development-company-cairo.ml_886') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Service Complet de Bout
                                        en Bout</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('locations/web-development-company-cairo.ml_887') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">
                                        {{ __('locations/web-development-company-cairo.ml_888') }}</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('locations/web-development-company-cairo.ml_889') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Stack Technologique
                                        Moderne</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('locations/web-development-company-cairo.ml_890') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-[#00AEEF] flex-shrink-0"></div><span
                                class="font-semibold text-[#0F0F0F] whitespace-nowrap">{{ __('locations/web-development-company-cairo.text_6') }}</span>
                        </div>
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                            ...
                            <div
                                ...
                                <div class="px-5 py-4 flex flex-col flex-grow">
                                    ...
                                    <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-3 line-clamp-2">
                                        {{ __('locations/web-development-company-cairo.ml_893') }}</p>
                                    <ul class="space-y-1.5 mb-4 flex-grow">
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                                class="mr-2"
                                                style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-cairo.ml_894') }}</span>
                                        </li>
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                        ...
                                        style="color: rgb(255, 101, 0);">{{ __('locations/web-development-company-cairo.text_9') }}<svg
                        ...
                        <div class="block h-full">
                            <div
                                ...
                                <div class="px-5 py-4 flex flex-col flex-grow">
                                    ...
                                    <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-3 line-clamp-2">
                                        {{ __('locations/web-development-company-cairo.ml_895') }}</p>
                                    <ul class="space-y-1.5 mb-4 flex-grow">
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                        ...
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                                class="mr-2"
                                                style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-cairo.ml_896') }}</span>
                                        </li>
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                                class="mr-2"
                                                style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-cairo.ml_897') }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="px-5 py-4 flex flex-col flex-grow">
                                    <h3 class="text-xl font-semibold text-[var(--text-primary)] mb-1.5">
                                        {{ __('locations/web-development-company-cairo.text_10') }}</h3>
                                    <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-3 line-clamp-2">
                                        {{ __('locations/web-development-company-cairo.ml_898') }}</p>
                                    <ul class="space-y-1.5 mb-4 flex-grow">
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                                class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>Portails
                                                patients</span></li>
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                                class="mr-2"
                                                style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-cairo.ml_899') }}</span>
                                        </li>
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                                class="mr-2"
                                                style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-cairo.ml_900') }}</span>
                                        </li>
                                    </ul><a class="inline-flex items-center text-sm font-medium hover:underline mt-auto"
                                        href="/our-work/dental-pro"
                                        style="color: rgb(255, 101, 0);">{{ __('locations/web-development-company-cairo.sw_2868') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div style="opacity: 1; transform: none;">
                        <div class="block h-full">
                            <div
                                ...
                                <div class="px-5 py-4 flex flex-col flex-grow">
                                    <h3 class="text-xl font-semibold text-[var(--text-primary)] mb-1.5">
                                        {{ __('locations/web-development-company-cairo.text_170') }}</h3>
                                    <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-3 line-clamp-2">
                                        {{ __('locations/web-development-company-cairo.ml_901') }}</p>
                                    <ul class="space-y-1.5 mb-4 flex-grow">
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                                class="mr-2"
                                                style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-cairo.ml_902') }}</span>
                                        </li>
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                        ...
                        <div class="block h-full">
                            <div
                                ...
                                <div class="px-5 py-4 flex flex-col flex-grow">
                                    ...
                                    <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-3 line-clamp-2">
                                        {{ __('locations/web-development-company-cairo.ml_903') }}</p>
                                    <ul class="space-y-1.5 mb-4 flex-grow">
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                                class="mr-2"
                                        ...
                                        <li class="flex items-start text-xs text-[var(--text-secondary)]"><span
                                                class="mr-2"
                                                style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-cairo.text_11') }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="mt-10 text-center">
                    <p class="text-[#0F0F0F]/70 mb-4">{{ __('locations/web-development-company-cairo.sw_2863') }}</p><a
                        class="inline-flex items-center gap-2 text-[#00AEEF] font-semibold hover:gap-3 transition-all"
                        href="{{ route('contact') }}"><span>{{ __('locations/web-development-company-cairo.text_12') }}</span><svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <div
                                ...
                                <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video
                                    ...
                                    <div
                                        class="absolute top-5 right-5 px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30">
                                        <span
                                            class="text-xs font-bold text-white tracking-wide uppercase">{{ __('locations/web-development-company-cairo.text_16') }}</span>
                                    </div>
                                    <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span
                                            class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg
                                                class="w-3 h-3" fill="none" viewBox="0 0 24 24"
                            ...
                            <div
                                ...
                                <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video
                                    ...
                                    <div
                                        class="absolute top-5 right-5 px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30">
                                        <span
                                            class="text-xs font-bold text-white tracking-wide uppercase">{{ __('locations/web-development-company-cairo.text_18') }}</span>
                                    </div>
                                    <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span
                                            class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg
                                                class="w-3 h-3" fill="none" viewBox="0 0 24 24"
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>{{ __('locations/web-development-company-cairo.ml_905') }}
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">{{ __('locations/web-development-company-cairo.ml_906') }}
                    </h2>
                    <div class="flex items-center justify-center gap-6 text-sm text-[#0F0F0F]/60 flex-wrap">
                        <div class="flex items-center gap-2"><span
                                class="font-semibold text-[#0F0F0F]">{{ __('locations/web-development-company-cairo.ml_907') }}</span>
                        </div><span>•</span>
                        <div class="flex items-center gap-2">
                            <span>{{ __('locations/web-development-company-cairo.text_171') }}</span>
                        </div><span>•</span>
                ...
                <div class="relative w-full max-w-5xl mx-auto mb-12">
                    <div class="relative aspect-[16/9]"><img
                            alt="{{ __('locations/web-development-company-cairo.attr_1459') }}" decoding="async"
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-xl font-bold text-[#0F0F0F]" style="font-family:var(--font-heading)">
                                {{ __('locations/web-development-company-cairo.ml_908') }}</h3>
                        </div>
                        <p class="text-[#0F0F0F]/70 leading-relaxed">
                            {{ __('locations/web-development-company-cairo.ml_909') }}</p>
                    </div>
                    <div
                        class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/10 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300">
                        <div class="flex items-center gap-3 mb-4">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <p class="text-base font-medium leading-snug">
                                {{ __('locations/web-development-company-cairo.ml_911') }}</p>
                        </div>
                        <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <p class="text-base font-medium leading-snug">
                                {{ __('locations/web-development-company-cairo.ml_912') }}</p>
                        </div>
                        <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <p class="text-base font-medium leading-snug">
                                {{ __('locations/web-development-company-cairo.ml_913') }}</p>
                        </div>
                        <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <p class="text-base font-medium leading-snug">
                                {{ __('locations/web-development-company-cairo.ml_914') }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/10 mb-12">
                    <h3 class="text-lg font-semibold text-[#0F0F0F] mb-4 text-center">
                        {{ __('locations/web-development-company-cairo.text_20') }}</h3>
                ...
                <div
                    ...
                    <div class="relative z-10 max-w-3xl">
                        <p class="text-xl md:text-2xl leading-relaxed mb-6 italic font-light text-white">
                            {{ __('locations/web-development-company-cairo.sw_2864') }}</p>
                        <div class="flex items-center gap-4">
                            <div class="w-px h-12 bg-[#00AEEF]"></div>
                            <div>
                                <div class="font-semibold text-lg text-white">
                                    {{ __('locations/web-development-company-cairo.text_21') }}</div>
                                <div class="text-[#00AEEF] text-sm font-medium">
                                    {{ __('locations/web-development-company-cairo.ml_915') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-12 md:mb-16">
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-black mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('locations/web-development-company-cairo.text_22') }}</h2>
                    <p class="text-lg md:text-xl text-black/70 max-w-3xl mx-auto">
                        {{ __('locations/web-development-company-cairo.ml_916') }}</p>
                </div>
                        ...
                        <div class="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path d="M16 7h6v6"></path>
                                    <path d="m22 7-8.5 8.5-5-5L2 17"></path>
                                </svg>{{ __('locations/web-development-company-cairo.ml_917') }}
                            </div>
                        </div>
                        <div class="relative rounded-[20px] p-6 md:p-8 mb-3 bg-[#1a1a1a] border border-transparent">
                            <div class="flex items-start justify-between mb-6">
                                <div class="flex items-center gap-3">
                                    ...
                                    <h3 class="text-3xl md:text-4xl font-bold text-white">
                                        {{ __('locations/web-development-company-cairo.text_23') }}</h3>
                                </div>
                            </div>
                            ...
                            <div class="divide-y divide-white/10">
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="text-white/80">{{ __('locations/web-development-company-cairo.ml_919') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('locations/web-development-company-cairo.ml_920') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="text-white/80">{{ __('locations/web-development-company-cairo.text_24') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('locations/web-development-company-cairo.text_25') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="text-white/80">{{ __('locations/web-development-company-cairo.text_26') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('locations/web-development-company-cairo.text_27') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-green-400 font-medium">{{ __('locations/web-development-company-cairo.ml_921') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="px-6 md:px-8 pb-3">
                            <div class="mb-6">
                                <div class="flex flex-col"><span
                                        class="text-lg md:text-xl font-medium text-white/70 mb-1">{{ __('locations/web-development-company-cairo.text_28') }}</span>
                                    <div class="flex items-end gap-2"><span
                                            class="text-5xl md:text-6xl font-bold">{{ __('locations/web-development-company-cairo.text_29') }}</span><span
                                            class="text-white/50 text-xl mb-2">{{ __('locations/web-development-company-cairo.text_30') }}</span>
                                    </div>
                                    <p class="text-white/60 text-sm mt-2">
                                        {{ __('locations/web-development-company-cairo.ml_922') }}</p>
                                </div>
                            </div>
                            <div class="flex flex-col sm:flex-row gap-3"><a
                                    ...
                                    href="{{ route('get-quote') }}">{{ __('locations/web-development-company-cairo.text_31') }}</a><a
                        ...
                        <div
                            ...
                            <div class="flex items-start justify-between gap-4 mb-6">
                                <div class="flex items-center gap-3 flex-shrink-0">
                                    ...
                                    <div class="relative rounded-full transition-all duration-400 ease-out w-11 h-7 bg-black/20"
                                        ...
                                        class="text-sm whitespace-nowrap overflow-hidden transition-all duration-400 ease-out opacity-100 w-auto">{{ __('locations/web-development-company-cairo.ml_923') }}</span>
                                </button>
                            </div>
                            <div class="mb-6 p-4 rounded-2xl bg-black/5 flex items-center gap-3"><svg
                                ...
                                <p class="text-black/70 transition-all duration-300">
                                    {{ __('locations/web-development-company-cairo.ml_924') }}</p>
                            </div>
                            <div class="divide-y divide-black/10">
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="text-black/80">{{ __('locations/web-development-company-cairo.text_32') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('locations/web-development-company-cairo.ml_925') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('locations/web-development-company-cairo.text_33') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('locations/web-development-company-cairo.text_34') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('locations/web-development-company-cairo.text_35') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('locations/web-development-company-cairo.text_36') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('locations/web-development-company-cairo.text_37') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('locations/web-development-company-cairo.text_38') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('locations/web-development-company-cairo.text_39') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="px-6 md:px-8 pb-3">
                            <div class="mb-6">
                                <div class="flex flex-col"><span
                                        class="text-lg md:text-xl font-medium text-black/60 mb-1">{{ __('locations/web-development-company-cairo.text_40') }}</span>
                                    <div class="flex items-end gap-2">
                                        <div class="relative overflow-hidden" style="height:fit-content"><span
                                                class="text-5xl md:text-6xl font-bold block transition-all duration-500 ease-in-out translate-y-full opacity-0 absolute top-0 left-0">{{ __('locations/web-development-company-cairo.text_41') }}</span><span
                                                class="text-5xl md:text-6xl font-bold block transition-all duration-500 ease-in-out translate-y-0 opacity-100">{{ __('locations/web-development-company-cairo.text_42') }}</span>
                                        </div><span
                                            class="text-black/50 text-xl mb-2">{{ __('locations/web-development-company-cairo.text_172') }}</span>
                                    </div>
                                    <p class="text-black/60 text-sm mt-2">
                                        {{ __('locations/web-development-company-cairo.text_43') }}</p>
                                </div>
                            </div>
                            <div class="flex flex-col sm:flex-row gap-3"><button
                                    ...
                                    data-cal-config="{"layout":"month_view","useSlotsViewOnSmallScreen":"true"}"
                                    class="flex-1 h-11 px-5 rounded-full inline-flex items-center justify-center whitespace-nowrap bg-black text-white text-sm font-semibold hover:bg-black/90 transition-colors">{{ __('locations/web-development-company-cairo.ml_926') }}</button><a
                                    href="https://wa.me/212632582096?text=Hi%20CodeSommet!%20I'm%20interested%20in%20learning%20more%20about%20your%20web%20development%20services."
                                    target="_blank" rel="noopener noreferrer"
                ...
                <div class="max-w-4xl mx-auto">
                    <div
                        ...
                        <h2 class="analyzer-cta__title text-2xl md:text-3xl lg:text-4xl font-bold mb-4"
                            style="font-family:var(--font-heading)">
                            {{ __('locations/web-development-company-cairo.text_44') }}</h2>
                        <p class="analyzer-cta__text text-base md:text-lg mb-6 max-w-2xl mx-auto">
                            {{ __('locations/web-development-company-cairo.ml_927') }}</p>
                        <div class="flex flex-wrap gap-3 justify-center mb-4">
                            ...
                            <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                                ...
                                <span>{{ __('locations/web-development-company-cairo.ml_928') }}</span>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                                <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div>
                                <span>{{ __('locations/web-development-company-cairo.text_173') }}</span>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                                <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div>
                                <span>{{ __('locations/web-development-company-cairo.ml_929') }}</span>
                            </div>
                        </div><a
                        ...
                        <p class="text-xs text-[var(--text-secondary)] mt-4">
                            {{ __('locations/web-development-company-cairo.ml_930') }}</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="max-w-5xl mx-auto">
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-4 bg-[#F8F8F8] border-b border-[#0F0F0F]/10">
                                <div class="p-3 md:p-4 font-semibold text-[#0F0F0F]/60 text-xs md:text-sm">
                                    {{ __('locations/web-development-company-cairo.ml_932') }}</div>
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('locations/web-development-company-cairo.ml_933') }}</div>
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('locations/web-development-company-cairo.ml_934') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"
                                        stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-cairo.ml_935') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-cairo.text_47') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                                ...
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-cairo.ml_936') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-cairo.ml_937') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('locations/web-development-company-cairo.ml_938') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"
                                        stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('locations/web-development-company-cairo.text_48') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">{{ __('locations/web-development-company-cairo.text_49') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-cairo.text_50') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-cairo.text_51') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('locations/web-development-company-cairo.ml_939') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"
                                        stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-cairo.ml_940') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                                ...
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-cairo.ml_941') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                    ...
                    <div class="mt-8 text-center">
                        <p class="text-sm text-[#0F0F0F]/60 mb-4">
                            {{ __('locations/web-development-company-cairo.sw_2865') }}</p>
                        <div
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                ...
                <div class="relative max-w-5xl mx-auto"><button
                        ...
                        aria-label="{{ __('locations/web-development-company-cairo.aria_69') }}"><svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                        ...
                        <div class="testimonial-slide grid grid-cols-1 lg:grid-cols-2 gap-8" data-slide="0">
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('locations/web-development-company-cairo.qb_2059') }}</blockquote>
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('locations/web-development-company-cairo.qb_2060') }}</blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                        ...
                        <div class="testimonial-slide grid grid-cols-1 lg:grid-cols-2 gap-8" data-slide="1"
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('locations/web-development-company-cairo.qb_2061') }}</blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('locations/web-development-company-cairo.text_55') }}</div>
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('locations/web-development-company-cairo.qb_2062') }}</blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('locations/web-development-company-cairo.ml_945') }}</div>
                ...
                <div class="mt-10 text-center">
                    <p class="text-sm text-[#0F0F0F]/60">
                        {{ __('locations/web-development-company-cairo.text_56') }}<!-- --> <a
                            href="{{ route('our-work') }}"
                            class="text-[#00AEEF] font-semibold hover:underline">{{ __('locations/web-development-company-cairo.ml_946') }}</a>
                    </p>
                </div>
            </div>
        </section>
        <script>
            (function() {
                ...
                var prevBtn = wrapper ? wrapper.querySelector(
                    '[aria-label="{{ __('locations/web-development-company-cairo.aria_70') }}"]') : null;
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>{{ __('locations/web-development-company-cairo.ml_947') }}
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('locations/web-development-company-cairo.sw_2867') }}</h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">
                        {{ __('locations/web-development-company-cairo.sw_2866') }}</p>
                </div>
                <div class="max-w-4xl mx-auto bg-white rounded-2xl border border-[#0F0F0F]/10 p-6">
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-1"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-cairo.faq_q1') }}</h3>
                            </div>
                        ...
                        <div id="faq-answer-1" class="faq-answer overflow-hidden" style="max-height:0;transition:max-height 0.3s ease"><div class="px-6 pb-6"><p class="text-[#0F0F0F]/70 text-base leading-relaxed">{{ __('locations/web-development-company-cairo.faq_a1') }}</p></div></div></div>
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-2"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-cairo.faq_q2') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div id="faq-answer-2" class="faq-answer overflow-hidden" style="max-height:0;transition:max-height 0.3s ease"><div class="px-6 pb-6"><p class="text-[#0F0F0F]/70 text-base leading-relaxed">{{ __('locations/web-development-company-cairo.faq_a2') }}</p></div></div></div>
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-3"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-cairo.faq_q3') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div id="faq-answer-3" class="faq-answer overflow-hidden" style="max-height:0;transition:max-height 0.3s ease"><div class="px-6 pb-6"><p class="text-[#0F0F0F]/70 text-base leading-relaxed">{{ __('locations/web-development-company-cairo.faq_a3') }}</p></div></div></div>
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-4"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-cairo.faq_q4') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div id="faq-answer-4" class="faq-answer overflow-hidden" style="max-height:0;transition:max-height 0.3s ease"><div class="px-6 pb-6"><p class="text-[#0F0F0F]/70 text-base leading-relaxed">{{ __('locations/web-development-company-cairo.faq_a4') }}</p></div></div></div>
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-5"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-cairo.faq_q5') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div id="faq-answer-5" class="faq-answer overflow-hidden" style="max-height:0;transition:max-height 0.3s ease"><div class="px-6 pb-6"><p class="text-[#0F0F0F]/70 text-base leading-relaxed">{{ __('locations/web-development-company-cairo.faq_a5') }}</p></div></div></div>
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-6"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-cairo.faq_q6') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div id="faq-answer-6" class="faq-answer overflow-hidden" style="max-height:0;transition:max-height 0.3s ease"><div class="px-6 pb-6"><p class="text-[#0F0F0F]/70 text-base leading-relaxed">{{ __('locations/web-development-company-cairo.faq_a6') }}</p></div></div></div>
                </div>
                <div class="mt-10 text-center">
        ...
        <section class="w-full bg-[#F5F5F5] py-16 md:py-20">
            <div class="max-w-7xl mx-auto px-4 md:px-6">
                ...
                <div class="text-center mt-8 md:mt-10"><a
                        ...
                        href="{{ route('locations') }}">{{ __('locations/web-development-company-cairo.text_61') }}<svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <div class="max-w-7xl mx-auto px-4 md:px-6">
                <div class="text-center mb-10">
                    <h2 class="text-3xl md:text-4xl font-semibold text-[var(--text-primary)] mb-3"
                        style="font-family:var(--font-heading)">
                        {{ __('locations/web-development-company-cairo.text_62') }}</h2>
                    <p class="text-lg text-[var(--text-secondary)]">
                        {{ __('locations/web-development-company-cairo.ml_952') }}</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6"><a
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">
                                {{ __('locations/web-development-company-cairo.ml_953') }}</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#00AEEF">{{ __('locations/web-development-company-cairo.text_63') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <h3
                                ...
                                Voir Nos Projets</h3>
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">
                                {{ __('locations/web-development-company-cairo.ml_954') }}</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#00AEEF">{{ __('locations/web-development-company-cairo.text_64') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <h3
                                class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">
                                {{ __('locations/web-development-company-cairo.ml_955') }}</h3>
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">
                                {{ __('locations/web-development-company-cairo.ml_956') }}</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#8B5CF6">{{ __('locations/web-development-company-cairo.text_65') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#10B981">{{ __('locations/web-development-company-cairo.text_66') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <h3
                                class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">
                                {{ __('locations/web-development-company-cairo.ml_957') }}</h3>
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">Explorez tous nos services et
                                offres</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#3B82F6">{{ __('locations/web-development-company-cairo.text_67') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
            ...
            <div class="max-w-7xl mx-auto">
                ...
                rgba(10, 10, 10, 0.95) 100%
                    ...
                    <div class="relative z-10 text-center space-y-3 md:space-y-4">
                        <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white px-4 pb-6 md:pb-8"
                            style="font-family:var(--font-display)">
                            {{ __('locations/web-development-company-cairo.text_68') }}</h2>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px"
                                    ...
                                    <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('locations/web-development-company-cairo.ml_958') }}</span>
                                </a><a
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px">
                                    ...
                                    <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black"
                                        style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('locations/web-development-company-cairo.ml_959') }}</span>
                                </button><a
                                ...
                                <div class="absolute pointer-events-none animate-cursor-stops" style="left:50%;top:50%">
                                    ...
                                    <div class="absolute left-0 top-0 -translate-x-1/2 px-3 py-1 rounded-full border border-white/80 bg-black/90"
                                        style="font-size:10px"><span
                                            class="text-white font-medium whitespace-nowrap">{{ __('locations/web-development-company-cairo.text_174') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/40">{{ __('locations/web-development-company-cairo.text_475') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/40">{{ __('locations/web-development-company-cairo.text_476') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/40">{{ __('locations/web-development-company-cairo.text_477') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/90">{{ __('locations/web-development-company-cairo.text_478') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/90">{{ __('locations/web-development-company-cairo.text_479') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/90">{{ __('locations/web-development-company-cairo.text_480') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
