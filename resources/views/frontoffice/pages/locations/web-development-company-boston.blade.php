                    ...
                    <div class="relative bg-white rounded-[32px] p-3 text-black border border-black/10">
                        ...
                        <div class="px-6 md:px-8 pb-3">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3"><button
                                    ...
                                    data-cal-config="{"layout":"month_view","useSlotsViewOnSmallScreen":"true"}"
                                    class="flex-1 px-4 py-3.5 rounded-full bg-black text-white text-sm font-semibold hover:bg-black/90 transition-colors text-center leading-tight">{{ __('locations/web-development-company-boston.ml_925') }}</button><a
                                    href="https://wa.me/212632582096?text=Hi%20CodeSommet!%20I'm%20interested%20in%20learning%20more%20about%20your%20web%20development%20services."
                                    target="_blank" rel="noopener noreferrer"
                                    ...
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('locations/web-development-company-boston.text_53') }}</div>
                                ...
                                <div
                                    ...
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('locations/web-development-company-boston.ml_943') }}</div>
                                            <div class="flex items-center gap-1.5 text-xs text-[#0F0F0F]/50"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
