...
@section('title', __('locations/web-development-company-riyadh.title'))
@section('meta_description', __('locations/web-development-company-riyadh.meta_description'))
@section('meta_keywords', __('locations/web-development-company-riyadh.meta_keywords'))
@section('og_title', __('locations/web-development-company-riyadh.og_title'))
@section('og_description', __('locations/web-development-company-riyadh.og_description'))
@section('twitter_description', __('locations/web-development-company-riyadh.twitter_description'))
            ...
            <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                <div class="space-y-6 lg:space-y-8 text-center">
                    <nav class="flex items-center justify-center gap-2 text-xs text-gray-400" aria-label="Breadcrumb"><a class="hover:text-gray-600 transition-colors" aria-label="Home" href="{{ route('home') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house w-3 h-3" aria-hidden="true">
                            ...
                            </svg></a><span>/</span><a class="hover:text-gray-600 transition-colors" href="{{ route('locations') }}">Emplacements</a><span>/</span><span class="text-gray-600">Riyadh</span></nav>
                    ...
                    rgba(0, 0, 0, 0.02) 0px 150px 150px -3.75px" data-cal-link="code-sommet/new-client-meeting" data-cal-namespace="new-client-meeting" data-cal-config='{"layout":"month_view","useSlotsViewOnSmallScreen":"true"}' href="#"><span class="relative text-[15px] font-semibold text-white z-10">{{ __('locations/web-development-company-riyadh.ml_1087') }}</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-5 h-5 text-white relative z-10 group-hover:translate-x-1 transition-transform" aria-hidden="true">
                                ...
                                de Riyadh</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-5 h-5 text-[#0F0F0F] group-hover:translate-x-1 transition-transform" aria-hidden="true">
                                <path d="M5 12h14"></path>
                                <path d="m12 5 7 7-7 7"></path>
                            </svg></a></div>
                    <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.text_1') }} <!-- -->Riyadh</span>
                        </div>
                        <div class="w-px h-4 bg-[#0F0F0F]/20"></div>
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.text_2') }}</span>
                        </div>
                        <div class="w-px h-4 bg-[#0F0F0F]/20"></div>
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.text_3') }} <!-- -->Riyadh<!-- --></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">{{ __('locations/web-development-company-riyadh.text_4') }} <!-- -->Riyadh<!-- -->?</h2>
                    ...
                    <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">{{ __('locations/web-development-company-riyadh.text_158') }}</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">{{ __('locations/web-development-company-riyadh.text_364') }}
                                </p>
                    ...
                    <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">{{ __('locations/web-development-company-riyadh.ml_1088') }}</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">{{ __('locations/web-development-company-riyadh.text_365') }}</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">{{ __('locations/web-development-company-riyadh.ml_1089') }}</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">{{ __('locations/web-development-company-riyadh.ml_1090') }}</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Service Complet de Bout
                                    en Bout</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">{{ __('locations/web-development-company-riyadh.ml_1091') }}</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">{{ __('locations/web-development-company-riyadh.ml_1092') }}</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">{{ __('locations/web-development-company-riyadh.text_366') }}</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Stack Technologique
                                    Moderne</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">{{ __('locations/web-development-company-riyadh.ml_1093') }}</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center">
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-8" style="font-family:var(--font-heading)">{{ __('locations/web-development-company-riyadh.text_5') }} <!-- -->Riyadh<!-- --> Entreprises</h2>
                <div class="flex flex-wrap items-center justify-center gap-3 md:gap-6 lg:gap-8 text-sm md:text-base lg:text-lg mb-6">
                    <div class="flex items-center gap-2">
                        <div class="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F] whitespace-nowrap">{{ __('locations/web-development-company-riyadh.text_6') }}</span>
                    </div>
                ...
                <p class="text-xs md:text-sm text-[#0F0F0F]/60 max-w-xl mx-auto px-4">Résultats concrets d'entreprises
                    basées à <!-- -->Riyadh<!-- --> {{ __('locations/web-development-company-riyadh.text_7') }}</p>
            </div>
        </div>
    </section>
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Riyadh<!-- --> {{ __('locations/web-development-company-riyadh.text_8') }}</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Une expertise approfondie dans les secteurs clés
                    de <!-- -->Riyadh<!-- -->{{ __('locations/web-development-company-riyadh.ml_1094') }}</p>
            </div>
                    ...
                    <div class="block h-full">
                        <div class="flex-shrink-0 w-full h-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5 flex flex-col cursor-pointer">
                            ...
                            <div class="px-5 py-4 flex flex-col flex-grow">
                                ...
                                <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-3 line-clamp-2">{{ __('locations/web-development-company-riyadh.ml_1095') }}</p>
                                <ul class="space-y-1.5 mb-4 flex-grow">
                                    <li class="flex items-start text-xs text-[var(--text-secondary)]"><span class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-riyadh.ml_1096') }}</span></li>
                                    ...
                                    <li class="flex items-start text-xs text-[var(--text-secondary)]"><span class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>Applications
                                            wallet</span></li>
                                </ul><a class="inline-flex items-center text-sm font-medium hover:underline mt-auto" href="/our-work/glamworlds" style="color: rgb(255, 101, 0);">{{ __('locations/web-development-company-riyadh.text_9') }}<svg class="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="block h-full">
                        <div class="flex-shrink-0 w-full h-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5 flex flex-col cursor-pointer">
                            ...
                            <div class="px-5 py-4 flex flex-col flex-grow">
                                ...
                                <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-3 line-clamp-2">{{ __('locations/web-development-company-riyadh.ml_1097') }}</p>
                                <ul class="space-y-1.5 mb-4 flex-grow">
                                    <li class="flex items-start text-xs text-[var(--text-secondary)]"><span class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>Portfolio de
                                            services</span></li>
                                    <li class="flex items-start text-xs text-[var(--text-secondary)]"><span class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-riyadh.ml_1098') }}</span></li>
                                    <li class="flex items-start text-xs text-[var(--text-secondary)]"><span class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-riyadh.ml_1099') }}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div style="opacity: 1; transform: none;">
                    <div class="block h-full">
                        <div class="flex-shrink-0 w-full h-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5 flex flex-col cursor-pointer">
                            ...
                            <div class="px-5 py-4 flex flex-col flex-grow">
                                <h3 class="text-xl font-semibold text-[var(--text-primary)] mb-1.5">{{ __('locations/web-development-company-riyadh.text_10') }}</h3>
                                <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-3 line-clamp-2">{{ __('locations/web-development-company-riyadh.ml_1100') }}</p>
                                <ul class="space-y-1.5 mb-4 flex-grow">
                                    <li class="flex items-start text-xs text-[var(--text-secondary)]"><span class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>Portails
                                            patients</span></li>
                                    <li class="flex items-start text-xs text-[var(--text-secondary)]"><span class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-riyadh.ml_1101') }}</span></li>
                                    <li class="flex items-start text-xs text-[var(--text-secondary)]"><span class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-riyadh.ml_1102') }}</span></li>
                ...
                <div style="opacity: 1; transform: none;">
                    <div class="block h-full">
                        <div class="flex-shrink-0 w-full h-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5 flex flex-col cursor-pointer">
                            ...
                            <div class="px-5 py-4 flex flex-col flex-grow">
                                <h3 class="text-xl font-semibold text-[var(--text-primary)] mb-1.5">{{ __('locations/web-development-company-riyadh.text_159') }}</h3>
                                <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-3 line-clamp-2">{{ __('locations/web-development-company-riyadh.ml_1103') }}</p>
                                <ul class="space-y-1.5 mb-4 flex-grow">
                                    <li class="flex items-start text-xs text-[var(--text-secondary)]"><span class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-riyadh.ml_1104') }}</span></li>
                    ...
                    <div class="block h-full">
                        <div class="flex-shrink-0 w-full h-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5 flex flex-col cursor-pointer">
                            ...
                            <div class="px-5 py-4 flex flex-col flex-grow">
                                ...
                                <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-3 line-clamp-2">{{ __('locations/web-development-company-riyadh.ml_1105') }}</p>
                                <ul class="space-y-1.5 mb-4 flex-grow">
                                    ...
                                    <li class="flex items-start text-xs text-[var(--text-secondary)]"><span class="mr-2" style="color: rgb(255, 101, 0);">•</span><span>{{ __('locations/web-development-company-riyadh.text_11') }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="mt-10 text-center">
                <p class="text-[#0F0F0F]/70 mb-4">Vous ne voyez pas votre secteur ? Nous travaillons avec des
                    entreprises de tous les secteurs à <!-- -->Riyadh<!-- -->.</p><a class="inline-flex items-center gap-2 text-[#00AEEF] font-semibold hover:gap-3 transition-all" href="{{ route('contact') }}"><span>{{ __('locations/web-development-company-riyadh.text_12') }}</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-5 h-5" aria-hidden="true">
                        <path d="M5 12h14"></path>
                        <path d="m12 5 7 7-7 7"></path>
                    </svg></a>
            </div>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4">
                    ...
                    </svg>{{ __('locations/web-development-company-riyadh.text_13') }} <!-- -->Riyadh
                </div>
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">{{ __('locations/web-development-company-riyadh.text_14') }} <!-- -->Riyadh</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Des projets réels, des résultats concrets.
                    Découvrez comment nous avons aidé des entreprises basées à <!-- -->Riyadh<!-- -->{{ __('locations/web-development-company-riyadh.ml_1106') }}</p>
            </div>
                        ...
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video src="{{ asset('images/our-work/glamworlds/glamworlds-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video>
                                ...
                                <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        </svg>{{ __('locations/web-development-company-riyadh.text_15') }}</span></div>
                            </div>
                            <div class="px-5 py-4">
                ...
                <div><a class="block" href="{{ route('case-study', 'mon-asso') }}">
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video src="{{ asset('images/our-work/mon-asso/mon-asso-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video>
                                <div class="absolute top-5 right-5 px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30">
                                    <span class="text-xs font-bold text-white tracking-wide uppercase">{{ __('locations/web-development-company-riyadh.text_16') }}</span>
                                </div>
                                <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                        </svg>{{ __('locations/web-development-company-riyadh.text_17') }}</span></div>
                            </div>
                            <div class="px-5 py-4">
                ...
                <div><a class="block" href="{{ route('case-study', 'morocco-quest') }}">
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video src="{{ asset('images/our-work/morocco-quest/morocco-quest-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video>
                                <div class="absolute top-5 right-5 px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30">
                                    <span class="text-xs font-bold text-white tracking-wide uppercase">{{ __('locations/web-development-company-riyadh.text_18') }}</span>
                                </div>
                                <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                        </svg>{{ __('locations/web-development-company-riyadh.text_160') }}</span></div>
                            </div>
                            <div class="px-5 py-4">
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4">
                    ...
                    </svg>{{ __('locations/web-development-company-riyadh.ml_1107') }}</div>
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">{{ __('locations/web-development-company-riyadh.ml_1108') }}</h2>
                <div class="flex items-center justify-center gap-6 text-sm text-[#0F0F0F]/60 flex-wrap">
                    <div class="flex items-center gap-2"><span class="font-semibold text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.ml_1109') }}</span></div><span>•</span>
                    <div class="flex items-center gap-2"><span>{{ __('locations/web-development-company-riyadh.text_161') }}</span></div><span>•</span>
                    <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock w-4 h-4 text-[#00AEEF]" aria-hidden="true">
                        ...
                        </svg><span>{{ __('locations/web-development-company-riyadh.text_162') }}</span></div>
                </div>
            </div>
            <div class="relative w-full max-w-5xl mx-auto mb-12">
                <div class="relative aspect-[16/9]"><img alt="Comment nous avons aidé une plateforme immobilière ? Riyadh ? générer plus de 250 prospects qualifiés par mois" decoding="async" class="object-contain" style="position:absolute;height:100%;width:100%;left:0;top:0;right:0;bottom:0;color:transparent" sizes="100vw" src="{{ asset('images/success-story-proptech64d2.jpeg') }}" /></div>
            </div>
            <div class="grid lg:grid-cols-2 gap-8 mb-12">
                <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/10 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="text-xl font-bold text-[#0F0F0F]" style="font-family:var(--font-heading)">{{ __('locations/web-development-company-riyadh.ml_1110') }}</h3>
                    </div>
                    <p class="text-[#0F0F0F]/70 leading-relaxed">{{ __('locations/web-development-company-riyadh.text_367') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/10 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center gap-3 mb-4">
                    ...
                    <p class="text-[#0F0F0F]/70 leading-relaxed">{{ __('locations/web-development-company-riyadh.text_368') }}</p>
                </div>
            </div>
            <div class="bg-gradient-to-br from-[#00AEEF] to-[#0071BC] rounded-3xl p-8 md:p-10 text-white mb-12">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                        ...
                        <p class="text-base font-medium leading-snug">{{ __('locations/web-development-company-riyadh.ml_1111') }}</p>
                    </div>
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                            <path d="m9 12 2 2 4-4"></path>
                        </svg>
                        <p class="text-base font-medium leading-snug">{{ __('locations/web-development-company-riyadh.ml_1112') }}</p>
                    </div>
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                            <path d="m9 12 2 2 4-4"></path>
                        </svg>
                        <p class="text-base font-medium leading-snug">{{ __('locations/web-development-company-riyadh.ml_1113') }}</p>
                    </div>
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                            <path d="m9 12 2 2 4-4"></path>
                        </svg>
                        <p class="text-base font-medium leading-snug">{{ __('locations/web-development-company-riyadh.ml_1114') }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/10 mb-12">
                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-4 text-center">{{ __('locations/web-development-company-riyadh.text_19') }}</h3>
            ...
            <div class="relative bg-gradient-to-br from-[#0F0F0F] to-[#1A1A1A] rounded-3xl p-8 md:p-12 text-white overflow-hidden">
                ...
                <div class="relative z-10 max-w-3xl">
                    <p class="text-xl md:text-2xl leading-relaxed mb-6 italic font-light text-white">
                        &quot;<!-- -->{{ __('locations/web-development-company-riyadh.text_369') }}<!-- -->&quot;</p>
                    <div class="flex items-center gap-4">
                        <div class="w-px h-12 bg-[#00AEEF]"></div>
                        <div>
                            <div class="font-semibold text-lg text-white">{{ __('locations/web-development-company-riyadh.text_20') }}</div>
                            <div class="text-[#00AEEF] text-sm font-medium">{{ __('locations/web-development-company-riyadh.ml_1115') }}</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="pricing" class="relative w-full py-16 md:py-24 bg-[#F5F5F5]">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12 md:mb-16">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-black mb-4" style="font-family:var(--font-heading)">{{ __('locations/web-development-company-riyadh.text_21') }}</h2>
                <p class="text-lg md:text-xl text-black/70 max-w-3xl mx-auto">{{ __('locations/web-development-company-riyadh.ml_1116') }}</p>
            </div>
                    ...
                    <div class="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
                        <div class="bg-[var(--color-primary-orange)] text-white px-4 py-1.5 rounded-full text-sm font-semibold shadow-lg flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trending-up w-4 h-4" aria-hidden="true">
                                <path d="M16 7h6v6"></path>
                                <path d="m22 7-8.5 8.5-5-5L2 17"></path>
                            </svg>{{ __('locations/web-development-company-riyadh.ml_1117') }}</div>
                    </div>
                    <div class="relative rounded-[20px] p-6 md:p-8 mb-3 bg-[#1a1a1a] border border-transparent">
                        <div class="flex items-start justify-between mb-6">
                            <div class="flex items-center gap-3">
                                ...
                                <h3 class="text-3xl md:text-4xl font-bold text-white">{{ __('locations/web-development-company-riyadh.text_22') }}</h3>
                            </div>
                        </div>
                        <div class="mb-6 p-4 rounded-2xl bg-white/5">
                            <p class="text-white/70">{{ __('locations/web-development-company-riyadh.ml_1118') }}</p>
                        </div>
                        <div class="divide-y divide-white/10">
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                ...
                                </svg><span class="text-white/80">{{ __('locations/web-development-company-riyadh.text_370') }}</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-white/80">{{ __('locations/web-development-company-riyadh.ml_1119') }}</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-white/80">Design responsive mobile-first</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-white/80">{{ __('locations/web-development-company-riyadh.text_23') }}</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-white/80">{{ __('locations/web-development-company-riyadh.text_24') }}</span>
                            </div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                            ...
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-white/80">{{ __('locations/web-development-company-riyadh.text_25') }}</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-white/80">{{ __('locations/web-development-company-riyadh.text_26') }}</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-green-400 font-medium">{{ __('locations/web-development-company-riyadh.ml_1120') }}</span></div>
                        </div>
                    </div>
                    <div class="px-6 md:px-8 pb-3">
                        <div class="mb-6">
                            <div class="flex flex-col"><span class="text-lg md:text-xl font-medium text-white/70 mb-1">{{ __('locations/web-development-company-riyadh.text_27') }}</span>
                                <div class="flex items-end gap-2"><span class="text-5xl md:text-6xl font-bold">Sur
                                        Mesure</span><span class="text-white/50 text-xl mb-2">{{ __('locations/web-development-company-riyadh.text_28') }}</span></div>
                                <p class="text-white/60 text-sm mt-2">{{ __('locations/web-development-company-riyadh.ml_1121') }}</p>
                            </div>
                        </div>
                        <div class="flex flex-col sm:flex-row gap-3"><a class="flex-1 px-4 py-3.5 rounded-full bg-white text-black text-sm font-semibold hover:bg-white/90 transition-colors text-center leading-tight" href="{{ route('get-quote') }}">{{ __('locations/web-development-company-riyadh.text_29') }}</a><a href="https://wa.me/212632582096?text=Hi%20CodeSommet!%20I'm%20interested%20in%20learning%20more%20about%20your%20web%20development%20services." target="_blank" rel="noopener noreferrer" class="flex-1 px-4 py-3.5 rounded-full border-2 border-white/20 text-white text-sm font-semibold hover:bg-white/10 transition-colors text-center inline-flex items-center justify-center leading-tight">{{ __('locations/web-development-company-riyadh.ml_1122') }}</a></div>
                    </div>
                </div>
                    ...
                    <div class="relative rounded-[20px] p-6 md:p-8 mb-3 transition-all duration-700 ease-in-out bg-[#F5F5F5] overflow-hidden border border-transparent">
                        <div class="flex items-start justify-between gap-4 mb-6">
                            <div class="flex items-center gap-3 flex-shrink-0">
                                ...
                                </div><span class="text-sm whitespace-nowrap overflow-hidden transition-all duration-400 ease-out opacity-100 w-auto">{{ __('locations/web-development-company-riyadh.ml_1123') }}</span>
                            </button>
                        </div>
                        <div class="mb-6 p-4 rounded-2xl bg-black/5 flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sparkles w-5 h-5 transition-all duration-300 text-transparent" aria-hidden="true">
                            ...
                            <p class="text-black/70 transition-all duration-300">{{ __('locations/web-development-company-riyadh.ml_1124') }}</p>
                        </div>
                        <div class="divide-y divide-black/10">
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">{{ __('locations/web-development-company-riyadh.text_30') }}</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">{{ __('locations/web-development-company-riyadh.text_371') }}</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">{{ __('locations/web-development-company-riyadh.text_31') }}</span>
                            </div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">{{ __('locations/web-development-company-riyadh.text_32') }}</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">{{ __('locations/web-development-company-riyadh.text_372') }}</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">{{ __('locations/web-development-company-riyadh.text_33') }}</span>
                            </div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">{{ __('locations/web-development-company-riyadh.text_34') }}</span>
                            </div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">{{ __('locations/web-development-company-riyadh.text_35') }}</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">{{ __('locations/web-development-company-riyadh.text_36') }}</span></div>
                        </div>
                    </div>
                    <div class="px-6 md:px-8 pb-3">
                        <div class="mb-6">
                            <div class="flex flex-col"><span class="text-lg md:text-xl font-medium text-black/60 mb-1">{{ __('locations/web-development-company-riyadh.text_37') }}</span>
                                ...
                                <p class="text-black/60 text-sm mt-2">{{ __('locations/web-development-company-riyadh.text_38') }}</p>
                            </div>
                        </div>
                        <div class="flex flex-col sm:flex-row gap-3"><button data-cal-link="code-sommet/new-client-meeting" data-cal-namespace="new-client-meeting" data-cal-config="{"layout":"month_view","useSlotsViewOnSmallScreen":"true"}" class="flex-1 px-4 py-3.5 rounded-full bg-black text-white text-sm font-semibold hover:bg-black/90 transition-colors text-center leading-tight">{{ __('locations/web-development-company-riyadh.ml_1125') }}</button><a href="https://wa.me/212632582096?text=Hi%20CodeSommet!%20I'm%20interested%20in%20learning%20more%20about%20your%20web%20development%20services." target="_blank" rel="noopener noreferrer" class="flex-1 px-4 py-3.5 rounded-full border-2 border-black/20 text-black text-sm font-semibold hover:bg-black/5 transition-colors text-center inline-flex items-center justify-center leading-tight">{{ __('locations/web-development-company-riyadh.ml_1126') }}</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="max-w-4xl mx-auto">
                <div class="bg-gradient-to-br from-[#00AEEF]/5 to-orange-50 rounded-3xl p-8 md:p-12 border-2 border-[#00AEEF]/20 text-center">
                    ...
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[var(--text-primary)]" style="font-family:var(--font-heading)">{{ __('locations/web-development-company-riyadh.text_39') }}</h2>
                    <p class="text-base md:text-lg text-[var(--text-secondary)] mb-6 max-w-2xl mx-auto">{{ __('locations/web-development-company-riyadh.ml_1127') }}</p>
                    <div class="flex flex-wrap gap-3 justify-center mb-4">
                        <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div><span>Audit SEO</span>
                        </div>
                        <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div><span>{{ __('locations/web-development-company-riyadh.ml_1128') }}</span>
                        </div>
                        <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div><span>{{ __('locations/web-development-company-riyadh.text_163') }}</span>
                        </div>
                        <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div><span>{{ __('locations/web-development-company-riyadh.text_373') }}</span>
                        </div>
                    ...
                    <p class="text-xs text-[var(--text-secondary)] mt-4">{{ __('locations/web-development-company-riyadh.ml_1129') }}</p>
                </div>
            </div>
        </div>
    </section>
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">CodeSommet <!-- -->Riyadh<!-- --> vs Others</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">{{ __('locations/web-development-company-riyadh.text_40') }} <!-- -->Riyadh<!-- -->{{ __('locations/web-development-company-riyadh.ml_1130') }}</p>
            </div>
            <div class="max-w-5xl mx-auto">
                <div class="overflow-x-auto -mx-4 md:mx-0 px-4 md:px-0">
                    <div class="bg-white rounded-2xl border border-[#0F0F0F]/10 overflow-hidden shadow-xl min-w-[600px]">
                        <div class="grid grid-cols-4 bg-[#F8F8F8] border-b border-[#0F0F0F]/10">
                            <div class="p-3 md:p-4 font-semibold text-[#0F0F0F]/60 text-xs md:text-sm">{{ __('locations/web-development-company-riyadh.ml_1131') }}</div>
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.ml_1132') }}</div>
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.ml_1133') }}</div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 mx-auto text-[#22C55E]" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="m9 12 2 2 4-4"></path>
                                </svg></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-riyadh.ml_1134') }}</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-riyadh.text_41') }}</span></div>
                        </div>
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            ...
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-riyadh.ml_1135') }}</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-riyadh.ml_1136') }}</span></div>
                        </div>
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.text_42') }}</div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 mx-auto text-[#22C55E]" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="m9 12 2 2 4-4"></path>
                                </svg></div>
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.text_43') }}</div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span class="text-sm font-bold text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.text_44') }}</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Custom/month</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Custom/month</span></div>
                        </div>
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.ml_1137') }}</div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 mx-auto text-[#22C55E]" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="m9 12 2 2 4-4"></path>
                                </svg></div>
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            ...
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-riyadh.ml_1138') }}</span></div>
                        </div>
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">{{ __('locations/web-development-company-riyadh.ml_1139') }}</div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 mx-auto text-[#22C55E]" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="m9 12 2 2 4-4"></path>
                                </svg></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-riyadh.ml_1140') }}</span></div>
                            <div class="p-3 md:p-4 text-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-x w-6 h-6 text-[#EF4444]/40 mx-auto" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="m15 9-6 6"></path>
                                    <path d="m9 9 6 6"></path>
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-[#0F0F0F]/60 mb-4">* Comparaison basée sur les prix moyens et les offres de
                        services des 10 meilleures agences ? <!-- -->Riyadh</p>
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full text-sm font-semibold text-[#22C55E]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                            <path d="m9 12 2 2 4-4"></path>
                        </svg>{{ __('locations/web-development-company-riyadh.text_45') }} <!-- -->Riyadh<!-- --> Entreprises
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4">
                    ...
                    </svg>{{ __('locations/web-development-company-riyadh.ml_1141') }}</div>
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">{{ __('locations/web-development-company-riyadh.text_46') }} <!-- -->Riyadh<!-- --> disent de
                    nous</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Ne nous croyez pas sur parole. Écoutez les entreprises de
                    <!-- -->Riyadh<!-- -->{{ __('locations/web-development-company-riyadh.ml_1142') }}</p>
            </div>
            <div class="relative max-w-5xl mx-auto"><button class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 lg:-translate-x-12 z-10 w-12 h-12 bg-white rounded-full shadow-lg hover:shadow-xl border border-[#0F0F0F]/10 hover:border-[#00AEEF]/30 flex items-center justify-center transition-all duration-300 hover:scale-110" aria-label="{{ __('locations/web-development-company-riyadh.aria_59') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-left w-6 h-6 text-[#00AEEF]" aria-hidden="true">
                            ...
                            <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/5 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300 h-full">
                                ...
                                <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img src="{{ asset('images/testimonials/mohammed-al-raba.webp') }}" alt="Mohammed GlamWorlds" class="w-12 h-12 rounded-full object-cover flex-shrink-0 border-2 border-[#00AEEF]/20" />
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="text-sm text-[#0F0F0F]/60 mb-2">{{ __('locations/web-development-company-riyadh.text_47') }}</div>
                            ...
                            <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/5 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300 h-full">
                                ...
                                <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img src="{{ asset('images/testimonials/sarah-al-mansouri.webp') }}" alt="Dr. Sarah Al-Mansouri" class="w-12 h-12 rounded-full object-cover flex-shrink-0 border-2 border-[#00AEEF]/20" />
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="text-sm text-[#0F0F0F]/60 mb-2">{{ __('locations/web-development-company-riyadh.ml_1143') }}</div>
                                        <div class="flex items-center gap-1.5 text-xs text-[#0F0F0F]/50"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin w-3.5 h-3.5" aria-hidden="true">
                                                <path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0">
                                                </path>
                                                <circle cx="12" cy="10" r="3"></circle>
                                            </svg><span>Riyadh Healthcare City, Saudi Arabia</span></div>
                                    </div>
                                </div>
                                <div class="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-[#00AEEF]/5 to-transparent rounded-bl-3xl rounded-tr-2xl">
                                </div>
                    ...
                    <div class="testimonial-slide grid grid-cols-1 lg:grid-cols-2 gap-8" data-slide="1" style="display: none;">
                        <div class="relative">
                            <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/5 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300 h-full">
                                ...
                                <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">{{ __('locations/web-development-company-riyadh.text_374') }}</blockquote>
                                <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img src="{{ asset('images/testimonials/james-thornton.webp') }}" alt="James Thornton" class="w-12 h-12 rounded-full object-cover flex-shrink-0 border-2 border-[#00AEEF]/20" />
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="text-sm text-[#0F0F0F]/60 mb-2">{{ __('locations/web-development-company-riyadh.text_48') }}</div>
                                        <div class="flex items-center gap-1.5 text-xs text-[#0F0F0F]/50"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin w-3.5 h-3.5" aria-hidden="true">
                                                <path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0">
                                                </path>
                                                <circle cx="12" cy="10" r="3"></circle>
                            ...
                            <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/5 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300 h-full">
                                ...
                                <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img src="{{ asset('images/testimonials/fatima-benali.webp') }}" alt="Fatima Zahra Benali" class="w-12 h-12 rounded-full object-cover flex-shrink-0 border-2 border-[#00AEEF]/20" />
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="text-sm text-[#0F0F0F]/60 mb-2">{{ __('locations/web-development-company-riyadh.ml_1144') }}</div>
                                        <div class="flex items-center gap-1.5 text-xs text-[#0F0F0F]/50"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin w-3.5 h-3.5" aria-hidden="true">
                                                <path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0">
                                                </path>
                                                <circle cx="12" cy="10" r="3"></circle>
            ...
            <div class="mt-10 text-center">
                <p class="text-sm text-[#0F0F0F]/60">{{ __('locations/web-development-company-riyadh.text_49') }}<!-- --> <a href="{{ route('our-work') }}" class="text-[#00AEEF] font-semibold hover:underline">{{ __('locations/web-development-company-riyadh.ml_1145') }}</a></p>
            </div>
        </div>
    </section>
    <script>
        (function() {
            ...
            var prevBtn = wrapper ? wrapper.querySelector('[aria-label="{{ __('locations/web-development-company-riyadh.aria_60') }}"]') : null;
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4">
                    ...
                    </svg>{{ __('locations/web-development-company-riyadh.ml_1146') }}</div>
                ...
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Des questions ? Nous avons les réponses. Voici
                    les questions les plus courantes des entreprises de <!-- -->Riyadh<!-- -->.</p>
            </div>
            <div class="max-w-4xl mx-auto bg-white rounded-2xl border border-[#0F0F0F]/10 p-6">
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-riyadh.ml_1147') }}</h3>
                        </div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-riyadh.ml_1148') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-riyadh.ml_1149') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-riyadh.ml_1150') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-riyadh.ml_1151') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('locations/web-development-company-riyadh.text_375') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
            ...
            <div class="mt-10 text-center">
                <p class="text-sm text-[#0F0F0F]/60 mb-2">{{ __('locations/web-development-company-riyadh.text_50') }}</p><a href="{{ route('contact') }}" class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2">Contactez
                    notre équipe <!-- -->Riyadh<!-- --><svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section class="w-full bg-[#F5F5F5] py-16 md:py-20">
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="text-center mb-8 md:mb-10">
                <h2 class="text-2xl md:text-3xl lg:text-4xl font-semibold text-[var(--text-primary)] mb-3 px-4" style="font-family:var(--font-heading)">{{ __('locations/web-development-company-riyadh.text_51') }}</h2>
                <p class="text-base md:text-lg text-[var(--text-secondary)] max-w-2xl mx-auto px-4">{{ __('locations/web-development-company-riyadh.text_376') }}</p>
            </div>
    ...
    <section class="w-full bg-[#F5F5F5] py-16 md:py-20">
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="text-center mb-10">
                ...
                <p class="text-lg text-[var(--text-secondary)]">{{ __('locations/web-development-company-riyadh.ml_1152') }}</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6"><a class="group bg-white rounded-2xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-transparent hover:border-gray-200" href="{{ route('tool', 'website-analyzer') }}">
                    <div class="flex flex-col h-full">
                        ...
                        <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">{{ __('locations/web-development-company-riyadh.ml_1153') }}</p>
                        <div class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                            <span style="color:#00AEEF">{{ __('locations/web-development-company-riyadh.text_53') }}</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" aria-hidden="true" style="color:#00AEEF">
                                <path d="M5 12h14"></path>
                                <path d="m12 5 7 7-7 7"></path>
                            </svg>
                        </div>
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <h3 class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">
                            Voir Nos Projets</h3>
                        <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">{{ __('locations/web-development-company-riyadh.ml_1154') }}</p>
                        <div class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                            <span style="color:#00AEEF">{{ __('locations/web-development-company-riyadh.text_54') }}</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" aria-hidden="true" style="color:#00AEEF">
                                <path d="M5 12h14"></path>
                                <path d="m12 5 7 7-7 7"></path>
                            </svg>
                        </div>
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <h3 class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">{{ __('locations/web-development-company-riyadh.ml_1155') }}</h3>
                        <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">{{ __('locations/web-development-company-riyadh.ml_1156') }}</p>
                        <div class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                            <span style="color:#8B5CF6">{{ __('locations/web-development-company-riyadh.text_55') }}</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" aria-hidden="true" style="color:#8B5CF6">
                                <path d="M5 12h14"></path>
                                <path d="m12 5 7 7-7 7"></path>
                            </svg>
                        </div>
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">Contactez-nous pour vos besoins
                            de projet</p>
                        <div class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                            <span style="color:#10B981">{{ __('locations/web-development-company-riyadh.text_56') }}</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" aria-hidden="true" style="color:#10B981">
                                <path d="M5 12h14"></path>
                                <path d="m12 5 7 7-7 7"></path>
                            </svg>
                        </div>
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <h3 class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">{{ __('locations/web-development-company-riyadh.ml_1157') }}</h3>
                        <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">Explorez tous nos services et
                            offres</p>
                        <div class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                            <span style="color:#3B82F6">{{ __('locations/web-development-company-riyadh.text_57') }}</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" aria-hidden="true" style="color:#3B82F6">
                                <path d="M5 12h14"></path>
                                <path d="m12 5 7 7-7 7"></path>
                            </svg>
                        </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="relative overflow-hidden rounded-[24px] md:rounded-[32px] px-6 py-6 md:py-8" style="background:linear-gradient(135deg, #1a1a1a 0%, #0a0a0a 100%)">
                ...
                <div class="relative z-10 text-center space-y-3 md:space-y-4">
                    <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white px-4 pb-6 md:pb-8" style="font-family:var(--font-display)">{{ __('locations/web-development-company-riyadh.text_58') }}</h2>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px" data-cal-link="code-sommet/new-client-meeting" data-cal-namespace="new-client-meeting" data-cal-config='{"layout":"month_view","useSlotsViewOnSmallScreen":"true"}' href="#">
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-rocket w-5 h-5 text-black" aria-hidden="true">
                                        ...
                                        <path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"></path>
                                        <path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path>
                                    </svg></div><span class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black" style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('locations/web-development-company-riyadh.ml_1158') }}</span>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px">
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-rocket w-5 h-5 text-black" aria-hidden="true">
                                        ...
                                        <path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"></path>
                                        <path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path>
                                    </svg></div><span class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black" style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('locations/web-development-company-riyadh.ml_1159') }}</span>
                        ...
                        <div class="relative mt-2 h-16">
                            <div class="absolute pointer-events-none animate-cursor-stops" style="left:50%;top:50%">
                                ...
                                <div class="absolute left-0 top-0 -translate-x-1/2 px-3 py-1 rounded-full border border-white/80 bg-black/90" style="font-size:10px"><span class="text-white font-medium whitespace-nowrap">{{ __('locations/web-development-company-riyadh.text_164') }}</span></div>
                            </div>
                        </div>
                    </div>
                    <p class="text-base md:text-lg text-white/70 font-medium">{{ __('locations/web-development-company-riyadh.text_377') }}</p>
                    <p class="text-sm md:text-base text-white/50">{{ __('locations/web-development-company-riyadh.text_378') }}</p>
                    <div class="mt-6">
                                    ...
                                    <ul class="flex items-center gap-3 list-none m-0 p-0 animate-marquee-left" style="position:relative;flex-direction:row;will-change:transform">
                                        ...
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                                ...
                                                </div><span class="text-[10px] font-medium text-white/40">{{ __('locations/web-development-company-riyadh.text_679') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                        ...
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                                ...
                                                </div><span class="text-[10px] font-medium text-white/40">{{ __('locations/web-development-company-riyadh.text_680') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                        ...
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                                ...
                                                </div><span class="text-[10px] font-medium text-white/40">{{ __('locations/web-development-company-riyadh.text_681') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                    ...
                                    <ul class="flex items-center gap-3 list-none m-0 p-0 animate-marquee-left" style="position:relative;flex-direction:row;will-change:transform">
                                        ...
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                                ...
                                                </div><span class="text-[10px] font-medium text-white/90">{{ __('locations/web-development-company-riyadh.text_682') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                        ...
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                                ...
                                                </div><span class="text-[10px] font-medium text-white/90">{{ __('locations/web-development-company-riyadh.text_683') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                        ...
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                                ...
                                                </div><span class="text-[10px] font-medium text-white/90">{{ __('locations/web-development-company-riyadh.text_684') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
