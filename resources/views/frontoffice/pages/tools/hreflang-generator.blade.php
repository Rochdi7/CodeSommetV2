...
@section('title', 'Générateur de Balises Hreflang - Outil SEO International Gratuit | CodeSommet')
@section('meta_description', 'Générez des balises hreflang pour les sites multilingues et multi-régionaux. Configuration SEO internationale en secondes. Générateur hreflang gratuit.')
@section('meta_keywords', 'hreflang generator,hreflang tags,international SEO,multilingual SEO,hreflang tag generator,multi-regional SEO')
@section('og_title', 'Générateur de Balises Hreflang - Outil SEO International Gratuit')
@section('og_description', 'Générez des balises hreflang correctes pour les sites multilingues instantanément')
@section('twitter_description', 'Générez des balises hreflang correctes pour les sites multilingues instantanément')
...
<section class="relative overflow-hidden pt-28 pb-16 bg-white">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <nav class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-8"><a class="hover:text-[#00AEEF] transition-colors" href="/">Accueil</a><span>/</span><a class="hover:text-[#00AEEF] transition-colors" href="/tools">Outils</a><span>/</span><span class="text-black font-medium">Générateur de Balises Hreflang</span></nav>
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">Générateur de Balises Hreflang</h1>
            <p class="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">Générez des balises hreflang pour les sites multilingues et multi-régionaux</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border-2 border-gray-200 p-8">
            <div class="space-y-6">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mb-4">Ajoutez toutes les versions linguistiques/régionales de la même page. Incluez x-default par défaut.</p>
                </div>
                <div class="space-y-3">
                    <div class="flex items-start gap-3">
                        <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div><input type="url" placeholder="https://example.com/en/page" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#00AEEF] focus:outline-none text-sm" value="" /></div>
                            <div><input type="text" placeholder="en-US or x-default" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#00AEEF] focus:outline-none text-sm" value="" /></div>
                        </div><button class="p-3 rounded-xl border-2 border-gray-200 hover:border-red-300 hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trash2 lucide-trash-2 w-5 h-5 text-gray-600" aria-hidden="true">
        ...
        <div class="bg-gradient-to-br from-gray-50 to-white rounded-2xl border-2 border-gray-200 p-6">
            ...
            <div class="space-y-4">
                <div class="flex items-start gap-3">
                    ...
                    <p class="text-sm text-gray-700">Ajoutez les URL de toutes les versions linguistiques/régionales</p>
                </div>
                <div class="flex items-start gap-3">
                    ...
                    <p class="text-sm text-gray-700">Spécifiez les codes de langue (en, es, fr) ou variantes régionales (en-US, es-MX)</p>
                </div>
                <div class="flex items-start gap-3">
                    ...
                    <p class="text-sm text-gray-700">Incluez une entrée x-default pointant vers votre version par défaut</p>
                </div>
                <div class="flex items-start gap-3">
                    ...
                    <p class="text-sm text-gray-700">Copiez les balises et ajoutez-les à la section <!-- -->&lt;head&gt;<!-- --> de TOUTES les versions</p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4 md:p-6">
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Que sont les balises hreflang et pourquoi en ai-je besoin ?</h3>
                        </div>
                ...
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Quelle différence entre codes de langue (en) et codes régionaux (en-US) ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Qu'est-ce que x-default et quand l'utiliser ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                    ...
                    <div class="faq-answer hidden px-4 pb-6 text-sm text-gray-700 leading-relaxed" style="padding-left:3.5rem">
                        <p>x-default est une URL de repli que Google affiche aux utilisateurs dont les préférences linguistiques ne correspondent à aucune de vos variations hreflang. C'est une bonne pratique de toujours inclure x-default, pointant généralement vers votre version de langue principale ou une page de sélection de langue.</p>
                    </div>
                </div>
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Dois-je utiliser des balises HTML ou des en-têtes HTTP pour hreflang ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                    ...
                    <div class="faq-answer hidden px-4 pb-6 text-sm text-gray-700 leading-relaxed" style="padding-left:3.5rem">
                        <p>Les balises HTML (dans la section
                            ...
                            <head>) sont les plus courantes et les plus faciles à implémenter. Les en-têtes HTTP sont utiles pour les fichiers non-HTML comme les PDF. Les deux méthodes sont également valides d'un point de vue SEO, mais n'utilisez pas les deux simultanément pour la même page.
                        </p>
                    </div>
                </div>
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Dois-je ajouter des balises hreflang à chaque version ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                    ...
                    <div class="faq-answer hidden px-4 pb-6 text-sm text-gray-700 leading-relaxed" style="padding-left:3.5rem">
                        <p>Oui ! Chaque version linguistique doit inclure l'ensemble complet des balises hreflang pointant vers toutes les autres versions ET vers elle-même. C'est ce qu'on appelle le lien bidirectionnel. Si la page A fait référence à la page B, alors la page B doit également faire référence à la page A.</p>
                    </div>
                </div>
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Comment vérifier que mon implémentation hreflang est correcte ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                    ...
                    <div class="faq-answer hidden px-4 pb-6 text-sm text-gray-700 leading-relaxed" style="padding-left:3.5rem">
                        <p>Utilisez le rapport de Ciblage international de Google Search Console pour vérifier les erreurs hreflang. Les problèmes courants incluent les liens retour manquants, les codes de langue incorrects ou les URL erronées. Le rapport montre les erreurs spécifiques et les pages concernées.</p>
                    </div>
                </div>
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Quelles sont les erreurs hreflang les plus courantes ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
...
<script src="{{ asset('js/tools/hreflang-generator.js') }}" defer></script>
@endpush