            ...
            <div class="bg-white rounded-2xl border-2 border-gray-200 p-8">
                <div class="space-y-6">
                    <div class="space-y-2"><label
                            class="block text-sm font-medium text-black">{{ __('tools/qr-code-generator.label_152') }}<span
                        ...
                        <div class="relative">
                            <div class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"><svg
                                    ...
                                    stroke-linejoin="round" class="lucide lucide-qr-code w-5 h-5" aria-hidden="true">
                                ...
                                </svg></div><input type="text" placeholder="https://example.com or any text"
                                required=""
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-2"><label
                                class="block text-sm font-medium text-black">{{ __('tools/qr-code-generator.text_653') }}</label>
                            <div class="relative"><select
                                    ...
                                    <option value="" disabled="">{{ __('tools/qr-code-generator.text_5') }}
                                    </option>
                                    <option value="128" class="text-black">{{ __('tools/qr-code-generator.text_6') }}
                                    </option>
                                    <option value="256" class="text-black" selected="">
                                        {{ __('tools/qr-code-generator.text_7') }}</option>
                                    <option value="384" class="text-black">{{ __('tools/qr-code-generator.text_8') }}
                                    </option>
                                    <option value="512" class="text-black">{{ __('tools/qr-code-generator.text_9') }}
                                    </option>
                                </select>
                                <div class="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        class="lucide lucide-chevron-down w-5 h-5" aria-hidden="true">
                        ...
                        <div class="space-y-2"><label
                                class="block text-sm font-medium text-black">{{ __('tools/qr-code-generator.label_153') }}</label>
                            <div class="relative"><select
                                    class="h-12 w-full px-4 pr-10 rounded-lg appearance-none bg-white border border-gray-200 text-black transition-all duration-200 focus:border-[#00AEEF] focus:ring-2 focus:ring-[#00AEEF]/20 focus:outline-none disabled:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer">
                                    <option value="" disabled="">{{ __('tools/qr-code-generator.text_10') }}
                                    </option>
                                    <option value="L" class="text-black">{{ __('tools/qr-code-generator.text_11') }}
                                    </option>
                                    <option value="M" class="text-black">{{ __('tools/qr-code-generator.text_12') }}
                                    </option>
                                    <option value="Q" class="text-black">{{ __('tools/qr-code-generator.text_13') }}
                                    </option>
                                    <option value="H" class="text-black" selected="">
                                        {{ __('tools/qr-code-generator.text_14') }}</option>
                                </select>
                                <div class="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <div class="flex gap-3"><button
                            ...
                            tabindex="0">{{ __('tools/qr-code-generator.text_16') }}</button></div>
                </div>
            </div>
                    ...
                    <div class="space-y-2">
                        <p class="text-sm font-semibold text-gray-900">Contact >Contact &amp; Text<amp; Texte</p>
                                <ul class="text-sm text-gray-600 space-y-1">
                                    ...
                                    <li>{{ __('tools/qr-code-generator.text_22') }}<a href="mailto:codesommet@gmail.com"
                                            class="__cf_email__"
                                            data-cfemail="147c7178787b54716c75796478713a777b79">{{ __('tools/qr-code-generator.text_353') }}</a>)
                                    </li>
            ...
            <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-6 md:p-8">
                <div class="mb-6">
                    <div class="flex items-center gap-2 mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <h3 class="text-xl md:text-2xl font-bold text-black">{{ __('tools/qr-code-generator.text_25') }}
                        </h3>
                    </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-4 md:p-6">
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/qr-code-generator.text_27') }}</h3>
                            </div>
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/qr-code-generator.text_29') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/qr-code-generator.text_31') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/qr-code-generator.text_33') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/qr-code-generator.text_35') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/qr-code-generator.text_37') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/qr-code-generator.text_39') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 mb-2">{{ __('tools/qr-code-generator.text_41') }}</p><a
                        href="/contact"
                        class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2 text-sm md:text-base">{{ __('tools/qr-code-generator.text_42') }}<svg
        ...
        <div class="max-w-5xl mx-auto px-4">
            <div class="text-center mb-10">
                <h2 class="text-2xl md:text-3xl font-bold text-black mb-3" style="font-family:var(--font-heading)">
                    {{ __('tools/qr-code-generator.text_43') }}</h2>
            ...
            <div class="text-center"><a
                    ...
                    href="/tools">{{ __('tools/qr-code-generator.text_48') }} <!-- -->41<!-- --> Outils Gratuits<svg
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <div class="relative overflow-hidden rounded-2xl px-6 py-8 md:py-10"
                ...
                <div class="relative z-10 text-center space-y-6">
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white"
                        style="font-family:var(--font-display)">{{ __('tools/qr-code-generator.text_49') }}</h2>
                    <p class="text-base md:text-lg text-white/70 max-w-2xl mx-auto">
                        {{ __('tools/qr-code-generator.text_50') }}</p>
                    <div class="pt-2"><a target="_blank" rel="noopener noreferrer"
                      ...
                      rgba(0, 0, 0, 0.063) 0px 18.1088px 18.1088px -1.875px"
                            ...
                            <div class="absolute inset-[3px] rounded-[114px] bg-white z-0"></div><span
                                ...
                                style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('tools/qr-code-generator.text_51') }}</span>
                        </a></div>
