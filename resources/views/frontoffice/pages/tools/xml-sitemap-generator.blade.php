...
@section('title', __('tools/xml-sitemap-generator.title'))
@section('meta_description', __('tools/xml-sitemap-generator.meta_description'))
@section('meta_keywords', __('tools/xml-sitemap-generator.meta_keywords'))
@section('og_title', __('tools/xml-sitemap-generator.og_title'))
@section('og_description', __('tools/xml-sitemap-generator.og_description'))
@section('twitter_description', __('tools/xml-sitemap-generator.twitter_description'))
    ...
    <section class="relative overflow-hidden pt-28 pb-16 bg-white">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
            ...
            <div
                ...
                </div><span class="text-green-700 font-medium">{{ __('tools/xml-sitemap-generator.text_3') }}</span>
            </div>
        </div>
    </section>
    <section class="max-w-5xl mx-auto px-4 py-12">
        <div class="space-y-8">
            <div class="bg-white rounded-2xl border-2 border-gray-200 p-8">
                <div class="space-y-6">
                    <div class="space-y-2"><label class="block text-sm font-medium text-black">URLs <span
                                class="text-[#00AEEF]">*</span></label>
                        <textarea
                            placeholder="https://example.com https://example.com/about https://example.com/contact  Enter one URL per line..."
                            rows="8"
                            class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-black placeholder:text-gray-400 focus:border-[#00AEEF] focus:ring-2 focus:ring-[#00AEEF]/20 focus:outline-none transition-all duration-200 resize-none"></textarea>
                        <p class="text-xs text-gray-500">{{ __('tools/xml-sitemap-generator.text_4') }}</p>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2"><label
                                class="block text-sm font-medium text-black">{{ __('tools/xml-sitemap-generator.text_5') }}</label><select
                                class="h-12 w-full px-4 bg-white border border-gray-200 rounded-xl text-black focus:border-[#00AEEF] focus:ring-2 focus:ring-[#00AEEF]/20 focus:outline-none transition-all duration-200">
                                <option value="always">{{ __('tools/xml-sitemap-generator.opt_355') }}</option>
                                <option value="hourly">{{ __('tools/xml-sitemap-generator.opt_356') }}</option>
                                <option value="daily">{{ __('tools/xml-sitemap-generator.opt_357') }}</option>
                                <option value="weekly" selected="">{{ __('tools/xml-sitemap-generator.text_6') }}
                                </option>
                                <option value="monthly">{{ __('tools/xml-sitemap-generator.opt_358') }}</option>
                                <option value="yearly">{{ __('tools/xml-sitemap-generator.opt_359') }}</option>
                                <option value="never">{{ __('tools/xml-sitemap-generator.opt_360') }}</option>
                            </select>
                            <p class="text-xs text-gray-500">{{ __('tools/xml-sitemap-generator.text_7') }}</p>
                        </div>
                        <div class="space-y-2"><label class="block text-sm font-medium text-black">Priority:
                                <!-- -->0.8</label><input type="range" min="0" max="1" step="0.1"
                                class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[#00AEEF]"
                                value="0.8" />
                            <div class="flex justify-between text-xs text-gray-500"><span>0.0 (Low)</span><span>0.5
                                    (Medium)</span><span>1.0 (High)</span></div>
                            <p class="text-xs text-gray-500">{{ __('tools/xml-sitemap-generator.text_8') }}</p>
                        </div>
                    </div><button
                        ...
                        tabindex="0">{{ __('tools/xml-sitemap-generator.text_9') }}</button>
                </div>
            </div>
            <div class="bg-gradient-to-br from-gray-50 to-white rounded-2xl border-2 border-gray-200 p-6">
                <h3 class="text-lg font-semibold text-black mb-4">{{ __('tools/xml-sitemap-generator.text_10') }}</h3>
                <div class="space-y-4">
                    <div class="flex items-start gap-3">
                        <div
                            class="w-6 h-6 rounded-full bg-[#00AEEF] text-white flex items-center justify-center flex-shrink-0 text-sm font-bold mt-0.5">
                            1</div>
                        <div>
                            <p class="text-sm font-medium text-black">{{ __('tools/xml-sitemap-generator.text_11') }}</p>
                            <p class="text-sm text-gray-600">{{ __('tools/xml-sitemap-generator.text_12') }}</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <div
                            ...
                            2</div>
                        <div>
                            <p class="text-sm font-medium text-black">{{ __('tools/xml-sitemap-generator.text_13') }}</p>
                            <p class="text-sm text-gray-600">{{ __('tools/xml-sitemap-generator.text_14') }}</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <div
                            ...
                            3</div>
                        <div>
                            <p class="text-sm font-medium text-black">{{ __('tools/xml-sitemap-generator.text_15') }}</p>
                            <p class="text-sm text-gray-600">Click &quot;Generate&quot; to create your sitemap.xml file,
                                then download it</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <div
                            ...
                            4</div>
                        <div>
                            <p class="text-sm font-medium text-black">{{ __('tools/xml-sitemap-generator.text_16') }}</p>
                            <p class="text-sm text-gray-600">{{ __('tools/xml-sitemap-generator.text_17') }}</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <div
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Envoyer your sitemap in Google Search Console for faster
                                indexing</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl border-2 border-gray-200 p-6">
                <h3 class="text-lg font-semibold text-black mb-4">{{ __('tools/xml-sitemap-generator.text_18') }}</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-3">
                        <div class="flex items-start gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0 mt-2"></div>
                            <div>
                                <p class="text-sm font-medium text-black">{{ __('tools/xml-sitemap-generator.text_19') }}
                                </p>
                                <p class="text-xs text-gray-600">{{ __('tools/xml-sitemap-generator.text_20') }}</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0 mt-2"></div>
                            <div>
                                <p class="text-sm font-medium text-black">{{ __('tools/xml-sitemap-generator.text_155') }}
                                </p>
                                <p class="text-xs text-gray-600">{{ __('tools/xml-sitemap-generator.text_21') }}</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0 mt-2"></div>
                            <div>
                                <p class="text-sm font-medium text-black">{{ __('tools/xml-sitemap-generator.text_22') }}
                                </p>
                                <p class="text-xs text-gray-600">{{ __('tools/xml-sitemap-generator.text_23') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="space-y-3">
                        <div class="flex items-start gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0 mt-2"></div>
                            <div>
                                <p class="text-sm font-medium text-black">{{ __('tools/xml-sitemap-generator.text_24') }}
                                </p>
                                <p class="text-xs text-gray-600">{{ __('tools/xml-sitemap-generator.text_25') }}</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0 mt-2"></div>
                            <div>
                                ...
                                <p class="text-xs text-gray-600">{{ __('tools/xml-sitemap-generator.text_26') }}</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0 mt-2"></div>
                            <div>
                                ...
                                <p class="text-xs text-gray-600">{{ __('tools/xml-sitemap-generator.text_27') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-br from-orange-50 to-white rounded-2xl border-2 border-orange-200 p-6">
                <h3 class="text-lg font-semibold text-black mb-4">{{ __('tools/xml-sitemap-generator.text_28') }}</h3>
                <div class="space-y-4">
                    <div>
                        <p class="text-sm font-semibold text-black mb-2">Change Frequency</p>
                        <div class="text-sm text-gray-700 space-y-1">
                            <p><span class="font-medium">always:</span> Documents that change each time they&#x27;re
                                accessed</p>
                ...
                <div class="mb-6">
                    <div class="flex items-center gap-2 mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <h3 class="text-xl md:text-2xl font-bold text-black">
                            {{ __('tools/xml-sitemap-generator.text_29') }}</h3>
                    </div>
                    <p class="text-sm md:text-base text-gray-600">{{ __('tools/xml-sitemap-generator.text_30') }}</p>
                </div>
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/xml-sitemap-generator.text_31') }}</h3>
                            </div>
                        ...
                        <div class="faq-answer hidden pr-4 pb-6 pt-1 pl-4 sm:pl-14 text-sm md:text-[15px] text-gray-700 leading-[1.7]">
                            <p>{{ __('tools/xml-sitemap-generator.text_32') }}</p>
                        </div>
                    </div>
                    <div class="border-b border-gray-200 last:border-0"><button
                            class="w-full py-5 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/xml-sitemap-generator.text_33') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="faq-answer hidden pr-4 pb-6 pt-1 pl-4 sm:pl-14 text-sm md:text-[15px] text-gray-700 leading-[1.7]">
                            <p>{{ __('tools/xml-sitemap-generator.text_34') }}</p>
                        </div>
                    </div>
                    <div class="border-b border-gray-200 last:border-0"><button
                            class="w-full py-5 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/xml-sitemap-generator.text_35') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="faq-answer hidden pr-4 pb-6 pt-1 pl-4 sm:pl-14 text-sm md:text-[15px] text-gray-700 leading-[1.7]">
                            <p>Log in to Google Search Console, select your property, go to 'Sitemaps' in the left sidebar,
                                and enter your sitemap URL (e.g., https://example.com/sitemap.xml). Click 'Envoyer' and
                                Google will start crawling your pages. You can check the status to see if there are any
                                errors or warnings that need attention.</p>
                        </div>
                    </div>
                    <div class="border-b border-gray-200 last:border-0"><button
                            class="w-full py-5 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/xml-sitemap-generator.text_36') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="faq-answer hidden pr-4 pb-6 pt-1 pl-4 sm:pl-14 text-sm md:text-[15px] text-gray-700 leading-[1.7]">
                            <p>{{ __('tools/xml-sitemap-generator.text_37') }}</p>
                        </div>
                    </div>
                    <div class="border-b border-gray-200 last:border-0"><button
                            class="w-full py-5 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/xml-sitemap-generator.text_38') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="faq-answer hidden pr-4 pb-6 pt-1 pl-4 sm:pl-14 text-sm md:text-[15px] text-gray-700 leading-[1.7]">
                            <p>{{ __('tools/xml-sitemap-generator.text_39') }}</p>
                        </div>
                    </div>
                    <div class="border-b border-gray-200 last:border-0"><button
                            class="w-full py-5 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/xml-sitemap-generator.text_40') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="faq-answer hidden pr-4 pb-6 pt-1 pl-4 sm:pl-14 text-sm md:text-[15px] text-gray-700 leading-[1.7]">
                            <p>{{ __('tools/xml-sitemap-generator.text_41') }}</p>
                        </div>
                    </div>
                    <div class="border-b border-gray-200 last:border-0"><button
                            class="w-full py-5 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/xml-sitemap-generator.text_42') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="faq-answer hidden pr-4 pb-6 pt-1 pl-4 sm:pl-14 text-sm md:text-[15px] text-gray-700 leading-[1.7]">
                            <p>{{ __('tools/xml-sitemap-generator.text_43') }}</p>
                        </div>
                    </div>
                </div>
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 mb-2">{{ __('tools/xml-sitemap-generator.text_44') }}</p><a
                        href="/contact"
                        class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2 text-sm md:text-base">{{ __('tools/xml-sitemap-generator.text_45') }}<svg
        ...
        <div class="max-w-5xl mx-auto px-4">
            <div class="text-center mb-10">
                <h2 class="text-2xl md:text-3xl font-bold text-black mb-3" style="font-family:var(--font-heading)">
                    {{ __('tools/xml-sitemap-generator.text_46') }}</h2>
                <p class="text-gray-600 text-lg">{{ __('tools/xml-sitemap-generator.text_47') }}</p>
            </div>
            <div class="grid md:grid-cols-3 gap-6 mb-8"><a
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed mb-4">{{ __('tools/xml-sitemap-generator.text_48') }}
                    </p>
                    <div
                    ...
                    <div class="mb-4">
                        <div class="inline-flex p-3 rounded-xl bg-[#00AEEF]/10 group-hover:bg-[#00AEEF] transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                                class="lucide lucide-file-text w-6 h-6 text-[#00AEEF] group-hover:text-white transition-colors"
                                aria-hidden="true">
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed mb-4">{{ __('tools/xml-sitemap-generator.text_49') }}
                    </p>
                    <div
                        class="flex items-center gap-2 text-[#00AEEF] font-semibold text-sm group-hover:gap-3 transition-all">
                        <span>Essayez gratuitement</span><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed mb-4">{{ __('tools/xml-sitemap-generator.text_50') }}
                    </p>
                    <div
                        class="flex items-center gap-2 text-[#00AEEF] font-semibold text-sm group-hover:gap-3 transition-all">
                        <span>Essayez gratuitement</span><svg xmlns="http://www.w3.org/2000/svg" width="24"
            ...
            <div class="text-center"><a
                    ...
                    href="/tools">{{ __('tools/xml-sitemap-generator.text_51') }} <!-- -->41<!-- --> Outils Gratuits<svg
            ...
            <div class="relative overflow-hidden rounded-2xl px-6 py-8 md:py-10"
                ...
                <div class="relative z-10 text-center space-y-6">
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white"
                        style="font-family:var(--font-display)">{{ __('tools/xml-sitemap-generator.text_52') }}</h2>
                    <p class="text-base md:text-lg text-white/70 max-w-2xl mx-auto">
                        {{ __('tools/xml-sitemap-generator.text_53') }}</p>
                    <div class="pt-2"><a target="_blank" rel="noopener noreferrer"
                      ...
                      rgba(0, 0, 0, 0.063) 0px 18.1088px 18.1088px -1.875px"
                            ...
                            <div class="absolute inset-[3px] rounded-[114px] bg-white z-0"></div><span
                                ...
                                style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('tools/xml-sitemap-generator.text_54') }}</span>
                        </a></div>
                    <p class="text-sm text-white/50 pt-2">{{ __('tools/xml-sitemap-generator.text_55') }}</p>
                </div>
            </div>
        </div>
    </section>
