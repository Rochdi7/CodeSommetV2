        ...
        <div class="space-y-8">
            <div class="flex justify-center">
                <div class="bg-white rounded-2xl border-2 border-gray-200 p-2 inline-flex items-center gap-2"><button
                        class="px-6 py-3 rounded-full font-semibold transition-all bg-[#00AEEF] text-white shadow-md">Encoder</button><svg
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="lucide lucide-arrow-right-left w-4 h-4 text-gray-400" aria-hidden="true">
                        <path d="m16 3 4 4-4 4"></path>
                        <path d="M20 7H4"></path>
                        <path d="m8 21-4-4 4-4"></path>
                        <path d="M4 17h16"></path>
                    </svg><button
                        class="px-6 py-3 rounded-full font-semibold transition-all text-[#0F0F0F] hover:bg-gray-50">{{ __('tools/base64-encoder.text_4') }}</button>
                </div>
            </div>
            <div class="bg-white rounded-2xl border-2 border-gray-200 p-8">
                <div class="space-y-6">
                    <div class="flex items-center justify-between"><label
                            class="text-sm font-medium text-[#0F0F0F]">{{ __('tools/base64-encoder.text_5') }}</label><span
                            class="text-xs text-gray-500">0<!-- --> {{ __('tools/base64-encoder.text_6') }}</span></div>
                    <textarea placeholder="{{ __('tools/base64-encoder.placeholder_48') }}" rows="8"
                        ...
                        tabindex="0">{{ __('tools/base64-encoder.text_148') }}</button>
                </div>
            </div>
            <div class="bg-gradient-to-br from-gray-50 to-white rounded-2xl border-2 border-gray-200 p-6">
                ...
                <div class="space-y-4 text-sm text-gray-700">
                    ...
                    <ul class="space-y-2 ml-6 list-disc">
                        <li><strong>{{ __('tools/base64-encoder.text_9') }}</strong>
                            {{ __('tools/base64-encoder.text_10') }}</li>
                        <li><strong>{{ __('tools/base64-encoder.text_11') }}</strong>
                            {{ __('tools/base64-encoder.text_12') }}</li>
                        <li><strong>{{ __('tools/base64-encoder.text_13') }}</strong>
                            {{ __('tools/base64-encoder.text_14') }}</li>
                    ...
                    <div class="bg-white rounded-lg p-4 border border-gray-200 mt-4">
                        ...
                        <div class="space-y-1 font-mono text-xs">
                            <p class="text-gray-900"><span
                                    class="text-[#00AEEF] font-semibold">{{ __('tools/base64-encoder.text_18') }}</span>
                                Hello World!</p>
                            <p class="text-gray-900"><span class="text-[#00AEEF] font-semibold">Base64:</span>
                                SGVsbG8gV29ybGQh</p>
                        </div>
                    </div>
                    <p class="text-xs text-gray-500 mt-4">💡 <strong>Tip:</strong> Use Cmd+Enter (Mac) or Ctrl+Enter
                        (Windows) to quickly encode/decode</p>
                </div>
            </div>
            <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-6 md:p-8">
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-4 md:p-6">
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/base64-encoder.text_21') }}</h3>
                            </div>
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/base64-encoder.text_23') }}</h3>
                            </div>
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/base64-encoder.text_25') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/base64-encoder.text_27') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/base64-encoder.text_29') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/base64-encoder.text_31') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/base64-encoder.text_33') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 mb-2">{{ __('tools/base64-encoder.text_35') }}</p><a href="/contact"
                        class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2 text-sm md:text-base">{{ __('tools/base64-encoder.text_36') }}<svg
        ...
        <div class="max-w-5xl mx-auto px-4">
            <div class="text-center mb-10">
                <h2 class="text-2xl md:text-3xl font-bold text-black mb-3" style="font-family:var(--font-heading)">
                    {{ __('tools/base64-encoder.text_37') }}</h2>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8"><a
                    ...
                    <h3 class="text-lg font-bold text-black mb-2 group-hover:text-[#00AEEF] transition-colors"
                        style="font-family:var(--font-heading)">{{ __('tools/base64-encoder.text_40') }}</h3>
            ...
            <div class="text-center"><a
                    ...
                    href="/tools">{{ __('tools/base64-encoder.text_43') }} <!-- -->41<!-- --> Outils Gratuits<svg
            ...
            <div class="relative overflow-hidden rounded-2xl px-6 py-8 md:py-10"
                ...
                <div class="relative z-10 text-center space-y-6">
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white"
                        style="font-family:var(--font-display)">{{ __('tools/base64-encoder.text_44') }}</h2>
                    <p class="text-base md:text-lg text-white/70 max-w-2xl mx-auto">
                        {{ __('tools/base64-encoder.text_45') }}</p>
                    <div class="pt-2"><a target="_blank" rel="noopener noreferrer"
                      ...
                      rgba(0, 0, 0, 0.063) 0px 18.1088px 18.1088px -1.875px"
                            ...
                            <div class="absolute inset-[3px] rounded-[114px] bg-white z-0"></div><span
                                ...
                                style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('tools/base64-encoder.text_46') }}</span>
                        </a></div>
