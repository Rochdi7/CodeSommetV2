...
@section('content')
    ...
    <section class="max-w-5xl mx-auto px-4 py-12">
        <div class="space-y-6">
            <div><label
                    class="block text-sm font-semibold text-gray-700 mb-2">{{ __('tools/schema-generator.label_131') }}</label>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-2"><button type="button" data-schema-type="Article"
                        class="px-4 py-2 rounded-lg font-medium transition-colors bg-[#00AEEF] text-white">Article</button><button
                        type="button" data-schema-type="Product"
                        class="px-4 py-2 rounded-lg font-medium transition-colors bg-gray-100 text-gray-700 hover:bg-gray-200">Product</button><button
                        type="button" data-schema-type="Organization"
                        class="px-4 py-2 rounded-lg font-medium transition-colors bg-gray-100 text-gray-700 hover:bg-gray-200">Organization</button><button
                        type="button" data-schema-type="LocalBusiness"
                        class="px-4 py-2 rounded-lg font-medium transition-colors bg-gray-100 text-gray-700 hover:bg-gray-200">LocalBusiness</button><button
                        type="button" data-schema-type="Review"
                        class="px-4 py-2 rounded-lg font-medium transition-colors bg-gray-100 text-gray-700 hover:bg-gray-200">Review</button><button
                        type="button" data-schema-type="WebSite"
                        class="px-4 py-2 rounded-lg font-medium transition-colors bg-gray-100 text-gray-700 hover:bg-gray-200">WebSite</button>
                </div>
            </div>
            <div class="space-y-4">
                <div class="space-y-2"><label class="block text-sm font-medium text-black">Titre<span
                            class="text-[#00AEEF] ml-1">*</span></label>
                    <div class="relative"><input type="text" placeholder="The Complete Guide to SEO in 2026"
                            required=""
                ...
                <div class="space-y-2"><label class="block text-sm font-medium text-black">Description</label>
                    <div class="relative"><input type="text"
                            placeholder="A comprehensive guide to search engine optimization..."
                            class="h-12 w-full px-4 rounded-lg bg-white border border-gray-200 text-black placeholder:text-gray-400 transition-all duration-200 focus:border-[#00AEEF] focus:ring-2 focus:ring-[#00AEEF]/20 focus:outline-none disabled:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
                            value="" /></div>
                    <p class="text-sm text-gray-500">{{ __('tools/schema-generator.text_4') }}</p>
                </div>
                <div class="space-y-2"><label
                        class="block text-sm font-medium text-black">{{ __('tools/schema-generator.label_132') }}</label>
                    <div class="relative"><input type="text" placeholder="https://example.com/image.jpg"
                            class="h-12 w-full px-4 rounded-lg bg-white border border-gray-200 text-black placeholder:text-gray-400 transition-all duration-200 focus:border-[#00AEEF] focus:ring-2 focus:ring-[#00AEEF]/20 focus:outline-none disabled:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
                            value="" /></div>
                    <p class="text-sm text-gray-500">{{ __('tools/schema-generator.text_5') }}</p>
                </div>
                <div class="space-y-2"><label
                        class="block text-sm font-medium text-black">{{ __('tools/schema-generator.label_133') }}<span
                            class="text-[#00AEEF] ml-1">*</span></label>
                    <div class="relative"><input type="date" required=""
                            class="h-12 w-full px-4 rounded-lg bg-white border border-gray-200 text-black placeholder:text-gray-400 transition-all duration-200 focus:border-[#00AEEF] focus:ring-2 focus:ring-[#00AEEF]/20 focus:outline-none disabled:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
                            value="" /></div>
                </div>
                <div class="space-y-2"><label
                        class="block text-sm font-medium text-black">{{ __('tools/schema-generator.label_134') }}</label>
                    <div class="relative"><input type="text" placeholder="John Doe"
                            class="h-12 w-full px-4 rounded-lg bg-white border border-gray-200 text-black placeholder:text-gray-400 transition-all duration-200 focus:border-[#00AEEF] focus:ring-2 focus:ring-[#00AEEF]/20 focus:outline-none disabled:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
                            value="" /></div>
                </div>
                <div class="space-y-2"><label
                        class="block text-sm font-medium text-black">{{ __('tools/schema-generator.text_6') }}</label>
                    <div class="relative"><input type="text" placeholder="Your Company Name"
                            class="h-12 w-full px-4 rounded-lg bg-white border border-gray-200 text-black placeholder:text-gray-400 transition-all duration-200 focus:border-[#00AEEF] focus:ring-2 focus:ring-[#00AEEF]/20 focus:outline-none disabled:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
                            value="" /></div>
                </div>
                <div class="space-y-2"><label
                        class="block text-sm font-medium text-black">{{ __('tools/schema-generator.text_7') }}</label>
                    <div class="relative"><input type="text" placeholder="https://example.com/logo.png"
                            class="h-12 w-full px-4 rounded-lg bg-white border border-gray-200 text-black placeholder:text-gray-400 transition-all duration-200 focus:border-[#00AEEF] focus:ring-2 focus:ring-[#00AEEF]/20 focus:outline-none disabled:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
                            value="" /></div>
                </div>
            </div><button
            ...
            <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-6 md:p-8">
                <div class="mb-6">
                    <div class="flex items-center gap-2 mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <h3 class="text-xl md:text-2xl font-bold text-black">{{ __('tools/schema-generator.text_9') }}
                        </h3>
                    </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-4 md:p-6">
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/schema-generator.text_11') }}</h3>
                            </div>
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/schema-generator.text_13') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="faq-answer hidden pr-4 pb-6 pt-1 pl-4 sm:pl-14 text-sm md:text-[15px] text-gray-700 leading-[1.7]">
                            <p>LInsert Headers and Footers' ou ajoutez au header.php de votre thème. Pour Next.js/React,
                                ajoutez à votre composant Head ou utilisez dangerouslySetInnerHTML. Pour les sites HTML,
                                collez directement dans la balise

                                <head>{{ __('tools/schema-generator.ml_534') }}
                            </p>
                        </div>
                    </div>
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/schema-generator.text_14') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/schema-generator.text_16') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/schema-generator.text_18') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 mb-2">{{ __('tools/schema-generator.text_20') }}</p><a
                        href="/contact"
                        class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2 text-sm md:text-base">{{ __('tools/schema-generator.text_21') }}<svg
        ...
        <div class="max-w-5xl mx-auto px-4">
            <div class="text-center mb-10">
                <h2 class="text-2xl md:text-3xl font-bold text-black mb-3" style="font-family:var(--font-heading)">
                    {{ __('tools/schema-generator.text_22') }}</h2>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8"><a
                    ...
                    href="/tools/local-business-schema">
                    <div class="mb-4">
                    ...
                    <h3 class="text-lg font-bold text-black mb-2 group-hover:text-[#00AEEF] transition-colors"
                        style="font-family:var(--font-heading)">{{ __('tools/schema-generator.text_25') }}</h3>
                    <p class="text-sm text-gray-600 leading-relaxed mb-4">Preview social media cards for 4 major platforms
                    </p>
                    <div
                        class="flex items-center gap-2 text-[#00AEEF] font-semibold text-sm group-hover:gap-3 transition-all">
                        <span>Essayez gratuitement</span><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <h3 class="text-lg font-bold text-black mb-2 group-hover:text-[#00AEEF] transition-colors"
                        style="font-family:var(--font-heading)">{{ __('tools/schema-generator.text_26') }}</h3>
            ...
            <div class="text-center"><a
                    ...
                    href="/tools">{{ __('tools/schema-generator.text_27') }} <!-- -->41<!-- --> Outils Gratuits<svg
            ...
            <div class="relative overflow-hidden rounded-2xl px-6 py-8 md:py-10"
                ...
                <div class="relative z-10 text-center space-y-6">
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white"
                        style="font-family:var(--font-display)">{{ __('tools/schema-generator.text_28') }}</h2>
                    <p class="text-base md:text-lg text-white/70 max-w-2xl mx-auto">
                        {{ __('tools/schema-generator.text_29') }}</p>
                    <div class="pt-2"><a target="_blank" rel="noopener noreferrer"
                      ...
                      rgba(0, 0, 0, 0.063) 0px 18.1088px 18.1088px -1.875px"
                            ...
                            <div class="absolute inset-[3px] rounded-[114px] bg-white z-0"></div><span
                                ...
                                style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('tools/schema-generator.text_30') }}</span>
                        </a></div>
