    ...
    <section class="relative overflow-hidden pt-28 pb-16 bg-white">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
            <nav class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-8"><a
                    ...
                    class="text-black font-medium">{{ __('tools/meta-refresh-generator.text_0') }}</span></nav>
            <div class="mb-8">
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">
                    {{ __('tools/meta-refresh-generator.text_1') }}</h1>
                <p class="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
                    {{ __('tools/meta-refresh-generator.text_2') }}</p>
            </div>
            <div
        ...
        <div class="space-y-8">
                ...
                <div class="space-y-6">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">
                            {{ __('tools/meta-refresh-generator.text_149') }}</h3>
                        <p class="text-sm text-gray-600 mb-4">{{ __('tools/meta-refresh-generator.text_4') }}</p>
                    </div>
                    <div class="space-y-2"><label
                            class="block text-sm font-medium text-black">{{ __('tools/meta-refresh-generator.label_148') }}<span
                        ...
                        <div class="relative">
                            <div class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"><svg
                                ...
                                </svg></div><input type="url" placeholder="https://example.com/new-page" required=""
                    ...
                    <div><label
                            class="block text-sm font-medium text-black mb-3">{{ __('tools/meta-refresh-generator.text_6') }}
                            <span class="text-[#00AEEF] font-bold">5<!-- --> second<!-- -->s</span></label><input
                            type="range" min="0" max="10"
                            class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[#00AEEF]"
                            style="background:linear-gradient(to right, #00AEEF 0%, #00AEEF 50%, #e5e5e5 50%, #e5e5e5 100%)"
                            value="5" />
                        <div class="flex justify-between text-xs text-gray-500 mt-2">
                            <span>{{ __('tools/meta-refresh-generator.text_7') }}</span><span>{{ __('tools/meta-refresh-generator.text_8') }}</span><span>10s
                                (Max)</span>
                        </div>
                    </div><button
                        ...
                        tabindex="0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            stroke-linejoin="round" class="lucide lucide-refresh-cw w-4 h-4 mr-2" aria-hidden="true">
            ...
            <div class="bg-yellow-50 border-2 border-yellow-200 rounded-2xl p-6">
                <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="lucide lucide-triangle-alert w-6 h-6 text-yellow-600 flex-shrink-0"
                        aria-hidden="true">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-yellow-800 leading-relaxed">{{ __('tools/meta-refresh-generator.text_10') }}
            ...
            <div class="bg-gradient-to-br from-gray-50 to-white rounded-2xl border-2 border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-900">{{ __('tools/meta-refresh-generator.text_15') }}
                            </p>
                    ...
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-900">{{ __('tools/meta-refresh-generator.text_17') }}
                            </p>
                    ...
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-900">{{ __('tools/meta-refresh-generator.text_151') }}
                            </p>
                    ...
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-triangle-alert w-5 h-5 text-red-600 flex-shrink-0 mt-0.5"
                            aria-hidden="true">
                            <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"></path>
                            <path d="M12 9v4"></path>
                            <path d="M12 17h.01"></path>
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-900">{{ __('tools/meta-refresh-generator.text_19') }}
                            </p>
            ...
            <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-6 md:p-8">
                <div class="mb-6">
                    <div class="flex items-center gap-2 mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <h3 class="text-xl md:text-2xl font-bold text-black">
                            {{ __('tools/meta-refresh-generator.text_21') }}</h3>
                    </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-4 md:p-6">
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/meta-refresh-generator.text_23') }}</h3>
                            </div>
                        ...
                        <div class="faq-answer hidden px-4 pb-6 text-sm text-gray-700 leading-relaxed"
                            ...
                            <p>Une redirection meta refresh est une redirection HTML qui utilise une balise
                                <meta> dans la section head de la page to automatically redirect users to another URL after
                                a specified delay. Unlike server-side redirects (301/302), meta refresh happens in the
                                browser after the page loads. The browser reads the meta tag, waits for the delay, and then
                                navigates to the destination URL.
                            </p>
                        </div>
                    </div>
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/meta-refresh-generator.text_24') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/meta-refresh-generator.text_26') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/meta-refresh-generator.text_28') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/meta-refresh-generator.text_30') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/meta-refresh-generator.text_32') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/meta-refresh-generator.text_34') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 mb-2">{{ __('tools/meta-refresh-generator.text_36') }}</p><a
                        href="/contact"
                        class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2 text-sm md:text-base">{{ __('tools/meta-refresh-generator.text_37') }}<svg
        ...
        <div class="max-w-5xl mx-auto px-4">
            <div class="text-center mb-10">
                <h2 class="text-2xl md:text-3xl font-bold text-black mb-3" style="font-family:var(--font-heading)">
                    {{ __('tools/meta-refresh-generator.text_38') }}</h2>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8"><a
                    ...
                    <h3 class="text-lg font-bold text-black mb-2 group-hover:text-[#00AEEF] transition-colors"
                        style="font-family:var(--font-heading)">{{ __('tools/meta-refresh-generator.text_40') }}</h3>
                    <p class="text-sm text-gray-600 leading-relaxed mb-4">{{ __('tools/meta-refresh-generator.text_41') }}
                    </p>
                    <div
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed mb-4">{{ __('tools/meta-refresh-generator.text_42') }}
                    </p>
                    <div
                        class="flex items-center gap-2 text-[#00AEEF] font-semibold text-sm group-hover:gap-3 transition-all">
                        <span>Essayer gratuitement</span><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed mb-4">{{ __('tools/meta-refresh-generator.text_43') }}
                    </p>
                    <div
                        class="flex items-center gap-2 text-[#00AEEF] font-semibold text-sm group-hover:gap-3 transition-all">
                        <span>Essayer gratuitement</span><svg xmlns="http://www.w3.org/2000/svg" width="24"
            ...
            <div class="text-center"><a
                    ...
                    href="/tools">{{ __('tools/meta-refresh-generator.text_44') }} <!-- -->41<!-- --> Outils Gratuits<svg
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <div class="relative overflow-hidden rounded-2xl px-6 py-8 md:py-10"
                ...
                <div class="relative z-10 text-center space-y-6">
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white"
                        style="font-family:var(--font-display)">{{ __('tools/meta-refresh-generator.text_45') }}</h2>
                    <p class="text-base md:text-lg text-white/70 max-w-2xl mx-auto">
                        {{ __('tools/meta-refresh-generator.text_46') }}</p>
                    <div class="pt-2"><a target="_blank" rel="noopener noreferrer"
                      ...
                      rgba(0, 0, 0, 0.063) 0px 18.1088px 18.1088px -1.875px"
                            ...
                            <div class="absolute inset-[3px] rounded-[114px] bg-white z-0"></div><span
                                ...
                                style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('tools/meta-refresh-generator.text_47') }}</span>
                        </a></div>
