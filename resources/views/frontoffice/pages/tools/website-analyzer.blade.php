...
<section class="relative overflow-hidden pt-28 pb-16 bg-white">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <nav class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-8"><a class="hover:text-[#00AEEF] transition-colors" href="/">Accueil</a><span>/</span><a class="hover:text-[#00AEEF] transition-colors" href="/tools">Outils</a><span>/</span><span class="text-black font-medium">{{ __('tools/website-analyzer.text_173') }}</span></nav>
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">{{ __('tools/website-analyzer.text_174') }}</h1>
            <p class="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">{{ __('tools/website-analyzer.text_0') }}</p>
        </div>
    ...
    <div class="space-y-6 sm:space-y-8 overflow-x-hidden">
        <div class="bg-white rounded-2xl border-2 border-gray-200 p-4 sm:p-6 lg:p-8">
            <div class="space-y-6">
                ...
                <div class="space-y-2"><label class="block text-sm font-medium text-black">{{ __('tools/website-analyzer.label_172') }}<span class="text-[#00AEEF] ml-1">*</span></label>
                    <div class="relative">
        ...
        <div class="space-y-6 sm:space-y-8">
                ...
                <div class="space-y-6">
                    <div class="flex gap-4 sm:gap-6 p-4 sm:p-6 bg-white rounded-xl border border-gray-200 hover:border-[#00AEEF] hover:shadow-md transition-all duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm sm:text-base text-gray-600 leading-relaxed">{{ __('tools/website-analyzer.text_6') }}</p>
                        </div>
                    </div>
                    <div class="flex gap-4 sm:gap-6 p-4 sm:p-6 bg-white rounded-xl border border-gray-200 hover:border-[#00AEEF] hover:shadow-md transition-all duration-200">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm sm:text-base text-gray-600 leading-relaxed">{{ __('tools/website-analyzer.text_7') }}</p>
                        </div>
                    </div>
                    <div class="flex gap-4 sm:gap-6 p-4 sm:p-6 bg-white rounded-xl border border-gray-200 hover:border-[#00AEEF] hover:shadow-md transition-all duration-200">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-4 mb-2">
                                <h3 class="text-lg sm:text-xl font-bold text-black">{{ __('tools/website-analyzer.text_8') }}</h3>
                                <div class="flex items-center gap-1.5 text-xs sm:text-sm text-gray-500 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock w-3.5 h-3.5" aria-hidden="true">
                                        <path d="M12 6v6l4 2"></path>
                                        <circle cx="12" cy="12" r="10"></circle>
                                    </svg><span>8 seconds</span></div>
                            </div>
                            <p class="text-sm sm:text-base text-gray-600 leading-relaxed">{{ __('tools/website-analyzer.text_9') }}</p>
                        </div>
                    </div>
                    <div class="flex gap-4 sm:gap-6 p-4 sm:p-6 bg-white rounded-xl border border-gray-200 hover:border-[#00AEEF] hover:shadow-md transition-all duration-200">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-4 mb-2">
                                <h3 class="text-lg sm:text-xl font-bold text-black">{{ __('tools/website-analyzer.text_10') }}</h3>
                                <div class="flex items-center gap-1.5 text-xs sm:text-sm text-gray-500 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock w-3.5 h-3.5" aria-hidden="true">
                                        <path d="M12 6v6l4 2"></path>
                                        <circle cx="12" cy="12" r="10"></circle>
                                    </svg><span>10 seconds</span></div>
                            </div>
                            <p class="text-sm sm:text-base text-gray-600 leading-relaxed">{{ __('tools/website-analyzer.text_11') }}</p>
                        </div>
                    </div>
                    <div class="flex gap-4 sm:gap-6 p-4 sm:p-6 bg-white rounded-xl border border-gray-200 hover:border-[#00AEEF] hover:shadow-md transition-all duration-200">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm sm:text-base text-gray-600 leading-relaxed">{{ __('tools/website-analyzer.text_12') }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-lg p-6 md:p-8">
                <div class="mb-8">
                    <h2 class="text-2xl md:text-3xl font-bold text-black mb-3">{{ __('tools/website-analyzer.text_14') }}</h2>
                ...
                <div class="space-y-3">
                    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden"><button class="w-full p-5 sm:p-6 flex items-center gap-4 hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <div class="flex-1 text-left min-w-0">
                                ...
                                <p class="text-sm text-gray-600">10<!-- --> {{ __('tools/website-analyzer.text_16') }}</p>
                            </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden"><button class="w-full p-5 sm:p-6 flex items-center gap-4 hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <div class="flex-1 text-left min-w-0">
                                <h3 class="text-lg sm:text-xl font-bold text-black mb-1">{{ __('tools/website-analyzer.text_17') }}</h3>
                                <p class="text-sm text-gray-600">8<!-- --> {{ __('tools/website-analyzer.text_18') }}</p>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                    <path d="m6 9 6 6 6-6"></path>
                                </svg></div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden"><button class="w-full p-5 sm:p-6 flex items-center gap-4 hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <div class="flex-1 text-left min-w-0">
                                <h3 class="text-lg sm:text-xl font-bold text-black mb-1">{{ __('tools/website-analyzer.text_19') }}</h3>
                                <p class="text-sm text-gray-600">7<!-- --> {{ __('tools/website-analyzer.text_20') }}</p>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                    <path d="m6 9 6 6 6-6"></path>
                                </svg></div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden"><button class="w-full p-5 sm:p-6 flex items-center gap-4 hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <div class="flex-1 text-left min-w-0">
                                <h3 class="text-lg sm:text-xl font-bold text-black mb-1">{{ __('tools/website-analyzer.text_21') }}</h3>
                                <p class="text-sm text-gray-600">7<!-- --> {{ __('tools/website-analyzer.text_22') }}</p>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                    <path d="m6 9 6 6 6-6"></path>
                                </svg></div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden"><button class="w-full p-5 sm:p-6 flex items-center gap-4 hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <div class="flex-1 text-left min-w-0">
                                <h3 class="text-lg sm:text-xl font-bold text-black mb-1">{{ __('tools/website-analyzer.text_23') }}</h3>
                                <p class="text-sm text-gray-600">8<!-- --> {{ __('tools/website-analyzer.text_24') }}</p>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                    <path d="m6 9 6 6 6-6"></path>
                                </svg></div>
                ...
                <div class="mt-6 p-4 bg-gradient-to-r from-[#00AEEF]/10 to-orange-50 border border-[#00AEEF]/20 rounded-lg">
                    <p class="text-sm text-gray-700"><strong class="text-black">{{ __('tools/website-analyzer.text_25') }}</strong> {{ __('tools/website-analyzer.text_26') }}</p>
                </div>
            </div>
            <div class="bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-lg p-6 md:p-8">
                <div class="mb-8">
                    <h2 class="text-2xl md:text-3xl font-bold text-black mb-3">{{ __('tools/website-analyzer.text_27') }}</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div class="p-6 rounded-xl bg-gradient-to-br from-pink-50 to-purple-50 border border-gray-200 hover:shadow-lg hover:scale-[1.02] transition-all duration-200">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-black mb-1">{{ __('tools/website-analyzer.text_28') }}</h3><span class="text-xs font-semibold text-pink-600 uppercase tracking-wide">Computer Vision</span>
                            </div>
                        </div>
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('tools/website-analyzer.text_29') }}</p>
                    </div>
                    <div class="p-6 rounded-xl bg-gradient-to-br from-blue-50 to-cyan-50 border border-gray-200 hover:shadow-lg hover:scale-[1.02] transition-all duration-200">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-black mb-1">{{ __('tools/website-analyzer.text_30') }}</h3><span class="text-xs font-semibold text-blue-600 uppercase tracking-wide">40+ checks</span>
                            </div>
                        </div>
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('tools/website-analyzer.text_31') }}</p>
                    </div>
                    <div class="p-6 rounded-xl bg-gradient-to-br from-orange-50 to-amber-50 border border-gray-200 hover:shadow-lg hover:scale-[1.02] transition-all duration-200">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-black mb-1">{{ __('tools/website-analyzer.text_32') }}</h3><span class="text-xs font-semibold text-[#00AEEF] uppercase tracking-wide">4-week plan</span>
                            </div>
                        </div>
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('tools/website-analyzer.text_33') }}</p>
                    </div>
                    <div class="p-6 rounded-xl bg-gradient-to-br from-green-50 to-emerald-50 border border-gray-200 hover:shadow-lg hover:scale-[1.02] transition-all duration-200">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-black mb-1">{{ __('tools/website-analyzer.text_34') }}</h3><span class="text-xs font-semibold text-green-600 uppercase tracking-wide">30 seconds total</span>
                            </div>
                        </div>
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('tools/website-analyzer.text_35') }}</p>
                    </div>
                    <div class="p-6 rounded-xl bg-gradient-to-br from-indigo-50 to-blue-50 border border-gray-200 hover:shadow-lg hover:scale-[1.02] transition-all duration-200">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-black mb-1">{{ __('tools/website-analyzer.text_36') }}</h3><span class="text-xs font-semibold text-indigo-600 uppercase tracking-wide">16+ industries</span>
                            </div>
                        </div>
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('tools/website-analyzer.text_37') }}</p>
                    </div>
                    <div class="p-6 rounded-xl bg-gradient-to-br from-teal-50 to-cyan-50 border border-gray-200 hover:shadow-lg hover:scale-[1.02] transition-all duration-200">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-black mb-1">{{ __('tools/website-analyzer.text_38') }}</h3><span class="text-xs font-semibold text-teal-600 uppercase tracking-wide">{{ __('tools/website-analyzer.text_39') }}</span>
                            </div>
                        </div>
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('tools/website-analyzer.text_40') }}</p>
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-6 md:p-8">
                <div class="mb-8">
                    <h2 class="text-2xl md:text-3xl font-bold text-black mb-3">{{ __('tools/website-analyzer.text_176') }}</h2>
                    ...
                    <table class="w-full border-collapse">
                        <thead>
                            <tr class="border-b-2 border-gray-200">
                                ...
                                <th class="text-left py-4 px-4 text-sm font-bold text-[#00AEEF] uppercase tracking-wide">{{ __('tools/website-analyzer.text_177') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="border-b border-gray-100 bg-white hover:bg-orange-50 transition-colors duration-200">
                                <td class="py-4 px-4 text-sm font-medium text-gray-900">{{ __('tools/website-analyzer.text_44') }}</td>
                                <td class="py-4 px-4 text-sm text-gray-600">15-20 items</td>
                                <td class="py-4 px-4">
                                    <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 text-green-600 flex-shrink-0" aria-hidden="true">
                                            <circle cx="12" cy="12" r="10"></circle>
                                            <path d="m9 12 2 2 4-4"></path>
                                        </svg><span class="text-sm font-semibold text-black">{{ __('tools/website-analyzer.text_45') }}</span></div>
                                </td>
                            </tr>
                            <tr class="border-b border-gray-100 bg-gray-50 hover:bg-orange-50 transition-colors duration-200">
                                <td class="py-4 px-4 text-sm font-medium text-gray-900">{{ __('tools/website-analyzer.text_178') }}</td>
                            ...
                            <tr class="border-b border-gray-100 bg-white hover:bg-orange-50 transition-colors duration-200">
                                ...
                                <td class="py-4 px-4 text-sm text-gray-600">{{ __('tools/website-analyzer.text_46') }}</td>
                                <td class="py-4 px-4">
                                    <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 text-green-600 flex-shrink-0" aria-hidden="true">
                                            <circle cx="12" cy="12" r="10"></circle>
                                            <path d="m9 12 2 2 4-4"></path>
                            ...
                            <tr class="border-b border-gray-100 bg-gray-50 hover:bg-orange-50 transition-colors duration-200">
                                ...
                                <td class="py-4 px-4">
                                    <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 text-green-600 flex-shrink-0" aria-hidden="true">
                                            <circle cx="12" cy="12" r="10"></circle>
                                            <path d="m9 12 2 2 4-4"></path>
                                        </svg><span class="text-sm font-semibold text-black">{{ __('tools/website-analyzer.text_47') }}</span></div>
                                </td>
                            </tr>
                            <tr class="border-b border-gray-100 bg-white hover:bg-orange-50 transition-colors duration-200">
                            ...
                            <tr class="border-b border-gray-100 bg-gray-50 hover:bg-orange-50 transition-colors duration-200">
                                ...
                                <td class="py-4 px-4 text-sm text-gray-600">{{ __('tools/website-analyzer.text_48') }}</td>
                                <td class="py-4 px-4">
                                    <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 text-green-600 flex-shrink-0" aria-hidden="true">
                                            <circle cx="12" cy="12" r="10"></circle>
                                            <path d="m9 12 2 2 4-4"></path>
                                        </svg><span class="text-sm font-semibold text-black">{{ __('tools/website-analyzer.text_49') }}</span></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-6 md:p-8">
            <div class="mb-6">
                <div class="flex items-center gap-2 mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-question-mark w-5 h-5 text-[#00AEEF]" aria-hidden="true">
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-black">{{ __('tools/website-analyzer.text_50') }}</h3>
                </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4 md:p-6">
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">{{ __('tools/website-analyzer.text_52') }}</h3>
                        </div>
                ...
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">{{ __('tools/website-analyzer.text_54') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">{{ __('tools/website-analyzer.text_56') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">{{ __('tools/website-analyzer.text_58') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">{{ __('tools/website-analyzer.text_60') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">{{ __('tools/website-analyzer.text_62') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">{{ __('tools/website-analyzer.text_64') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">{{ __('tools/website-analyzer.text_65') }}</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600 mb-2">{{ __('tools/website-analyzer.text_67') }}</p><a href="/contact" class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2 text-sm md:text-base">{{ __('tools/website-analyzer.text_68') }}<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="max-w-5xl mx-auto px-4">
        <div class="relative overflow-hidden rounded-2xl px-6 py-8 md:py-10" style="background:linear-gradient(135deg, #1a1a1a 0%, #0a0a0a 100%)">
            ...
            <div class="relative z-10 text-center space-y-6">
                <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white" style="font-family:var(--font-display)">{{ __('tools/website-analyzer.text_69') }}</h2>
                <p class="text-base md:text-lg text-white/70 max-w-2xl mx-auto">{{ __('tools/website-analyzer.text_70') }}</p>
                <div class="pt-2"><a target="_blank" rel="noopener noreferrer" class="group relative inline-flex items-center gap-3 px-8 py-4 rounded-full overflow-hidden transition-transform hover:scale-105" style="background-color:rgba(0, 0, 0, 0.11);border-radius:118px;box-shadow:rgba(0, 0, 0, 0.067) 0px 2.51941px 2.51941px -0.46875px,
                      ...
                      rgba(0, 0, 0, 0.063) 0px 18.1088px 18.1088px -1.875px" data-cal-link="code-sommet/new-client-meeting" data-cal-namespace="new-client-meeting" data-cal-config='{"layout":"month_view","useSlotsViewOnSmallScreen":"true"}' href="#">
                        <div class="absolute inset-[3px] rounded-[114px] bg-white z-0"></div><span class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black" style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('tools/website-analyzer.text_71') }}</span>
                    </a></div>
