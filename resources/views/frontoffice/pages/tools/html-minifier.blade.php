    ...
    <section class="relative overflow-hidden pt-28 pb-16 bg-white">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
            <nav class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-8"><a
                    ...
                    class="text-black font-medium">Minificateur HTML/CSS/JS</span></nav>
            <div class="mb-8">
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">Minificateur
                    HTML/CSS/JS</h1>
                <p class="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
                    {{ __('tools/html-minifier.text_0') }}</p>
            </div>
            <div
    ...
    <section class="max-w-5xl mx-auto px-4 py-12">
        <div class="space-y-6 mb-8">
            <div class="bg-white rounded-2xl border border-gray-100 p-2 flex gap-2"><button
                    class="flex-1 px-6 py-3 rounded-xl font-semibold transition-colors bg-[#00AEEF] text-white">HTML</button><button
                    class="flex-1 px-6 py-3 rounded-xl font-semibold transition-colors text-[#0F0F0F] hover:bg-[#F8F8F8]">CSS</button><button
                    class="flex-1 px-6 py-3 rounded-xl font-semibold transition-colors text-[#0F0F0F] hover:bg-[#F8F8F8]">JavaScript</button>
            </div>
            <div class="space-y-4">
                <div class="space-y-2"><label class="block text-sm font-medium text-black">Code HTML<!-- --><span
                            class="text-[#00AEEF] ml-1">*</span></label>
                    <textarea placeholder="{{ __('tools/html-minifier.placeholder_33') }}" rows="12"
                        class="w-full px-4 py-3 rounded-lg bg-white border border-gray-200 text-black placeholder:text-gray-400 transition-all duration-200 focus:border-[#00AEEF] focus:ring-2 focus:ring-[#00AEEF]/20 focus:outline-none disabled:bg-gray-50 disabled:cursor-not-allowed resize-y font-mono text-sm"></textarea>
                </div>
                <div class="bg-[#F8F8F8] rounded-xl p-4 space-y-3">
                    <div class="font-medium text-black mb-2">{{ __('tools/html-minifier.text_133') }}</div><label
                        class="flex items-center gap-3 cursor-pointer"><input type="checkbox"
                            class="w-4 h-4 text-[#00AEEF] border-gray-300 rounded focus:ring-[#00AEEF]"
                            checked="" /><span
                            class="text-sm text-gray-700">{{ __('tools/html-minifier.text_2') }}</span></label><label
                        class="flex items-center gap-3 cursor-pointer"><input type="checkbox"
                            class="w-4 h-4 text-[#00AEEF] border-gray-300 rounded focus:ring-[#00AEEF]"
                            checked="" /><span
                            class="text-sm text-gray-700">{{ __('tools/html-minifier.text_3') }}</span></label><label
                        class="flex items-center gap-3 cursor-pointer"><input type="checkbox"
                            class="w-4 h-4 text-[#00AEEF] border-gray-300 rounded focus:ring-[#00AEEF]" /><span
                            class="text-sm text-gray-700">{{ __('tools/html-minifier.text_4') }}</span></label>
                </div><button
                    ...
                    tabindex="0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        class="lucide lucide-minimize2 lucide-minimize-2 mr-2 h-4 w-4" aria-hidden="true">
            ...
            <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-6 md:p-8">
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-4 md:p-6">
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/html-minifier.text_7') }}</h3>
                            </div>
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/html-minifier.text_9') }}</h3>
                            </div>
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/html-minifier.text_11') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/html-minifier.text_13') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/html-minifier.text_15') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">
                                    {{ __('tools/html-minifier.text_17') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-gray-200 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base md:text-lg font-semibold text-black">Quand dois-je minifier mon code ?
                                </h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 mb-2">{{ __('tools/html-minifier.text_20') }}</p><a href="/contact"
                        class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2 text-sm md:text-base">{{ __('tools/html-minifier.text_21') }}<svg
        ...
        <div class="max-w-5xl mx-auto px-4">
            <div class="text-center mb-10">
                <h2 class="text-2xl md:text-3xl font-bold text-black mb-3" style="font-family:var(--font-heading)">
                    {{ __('tools/html-minifier.text_22') }}</h2>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8"><a
                    ...
                    <div class="mb-4">
                        <div class="inline-flex p-3 rounded-xl bg-[#00AEEF]/10 group-hover:bg-[#00AEEF] transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                class="lucide lucide-zap w-6 h-6 text-[#00AEEF] group-hover:text-white transition-colors"
                                aria-hidden="true">
                                <path
                    ...
                    <h3 class="text-lg font-bold text-black mb-2 group-hover:text-[#00AEEF] transition-colors"
                        style="font-family:var(--font-heading)">{{ __('tools/html-minifier.text_135') }}</h3>
                    ...
                    class="group relative bg-white rounded-xl border border-gray-200 p-6 hover:border-[#00AEEF] hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                    href="/tools/image-compression-analyzer">
                    <div class="mb-4">
                        <div class="inline-flex p-3 rounded-xl bg-[#00AEEF]/10 group-hover:bg-[#00AEEF] transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                                class="lucide lucide-image w-6 h-6 text-[#00AEEF] group-hover:text-white transition-colors"
                                aria-hidden="true">
                    ...
                    <h3 class="text-lg font-bold text-black mb-2 group-hover:text-[#00AEEF] transition-colors"
                        style="font-family:var(--font-heading)">{{ __('tools/html-minifier.text_26') }}</h3>
            ...
            <div class="text-center"><a
                    ...
                    href="/tools">{{ __('tools/html-minifier.text_28') }} <!-- -->41<!-- --> Outils Gratuits<svg
            ...
            <div class="relative overflow-hidden rounded-2xl px-6 py-8 md:py-10"
                ...
                <div class="relative z-10 text-center space-y-6">
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white"
                        style="font-family:var(--font-display)">{{ __('tools/html-minifier.text_29') }}</h2>
                    <p class="text-base md:text-lg text-white/70 max-w-2xl mx-auto">
                        {{ __('tools/html-minifier.text_30') }}</p>
                    <div class="pt-2"><a target="_blank" rel="noopener noreferrer"
                      ...
                      rgba(0, 0, 0, 0.063) 0px 18.1088px 18.1088px -1.875px"
                            ...
                            <div class="absolute inset-[3px] rounded-[114px] bg-white z-0"></div><span
                                ...
                                style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('tools/html-minifier.text_31') }}</span>
                        </a></div>
