...
<section class="max-w-5xl mx-auto px-4 py-12">
    <section class="max-w-4xl mx-auto mb-16">
        <div class="bg-white rounded-2xl border-2 border-gray-200 p-8 shadow-sm">
            <div class="space-y-6">
                <div class="border-2 border-dashed border-gray-300 rounded-xl p-12 text-center hover:border-[var(--color-primary-orange)] transition-colors cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-image w-16 h-16 mx-auto mb-4 text-gray-400" aria-hidden="true">
