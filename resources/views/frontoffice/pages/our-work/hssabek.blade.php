...
@section('title', __('our-work/hssabek.title'))
@section('meta_description', __('our-work/hssabek.meta_description'))
@section('meta_keywords', __('our-work/hssabek.meta_keywords'))
@section('og_title', __('our-work/hssabek.og_title'))
@section('og_description', __('our-work/hssabek.og_description'))
@section('twitter_description', __('our-work/hssabek.twitter_description'))
    ...
    <section class="relative pt-24 md:pt-28 lg:pt-32 pb-12 md:pb-16 lg:pb-24 overflow-hidden">
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div class="mb-6 md:mb-8"><a href="/our-work"><button
                        ...
                        </svg>{{ __('our-work/hssabek.text_0') }}</button></a></div>
            <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16">
                <div class="space-y-4 md:space-y-6">
                    <div class="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#00AEEF]/10 to-[#0071BC]/10 rounded-full border border-[#00AEEF]/20"
                        ...
                        <div class="w-2 h-2 rounded-full bg-[#00AEEF] animate-pulse"></div><span
                            class="text-sm font-semibold text-[#00AEEF]">{{ __('our-work/hssabek.text_1') }}</span>
                    </div>
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight"
                        style="font-family:var(--font-heading)">Hssabek</h1>
                    <p class="text-xl md:text-2xl text-[var(--text-secondary)] font-medium">
                        {{ __('our-work/hssabek.text_2') }}</p>
                    <p class="text-base md:text-lg text-[var(--text-secondary)] leading-relaxed">
                        {{ __('our-work/hssabek.text_3') }}</p>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide">
                                        {{ __('our-work/hssabek.text_4') }}</p>
                                    <p class="text-sm font-bold text-gray-900 truncate">8 semaines</p>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide">
                                        {{ __('our-work/hssabek.text_5') }}</p>
                                    <p class="text-sm font-bold text-gray-900 truncate">70%</p>
                                </div>
                            </div>
                        </div>
                        <div
                    ...
                    <div class="pt-2 md:pt-4"><a href="#" class="block w-full"><button
                                ...
                                tabindex="0"><span>{{ __('our-work/hssabek.text_145') }}</span><svg
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <video src="{{ asset('videos/hssabek-invoicing-saas-showcase.mp4') }}" autoplay
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div class="text-center mb-8 md:mb-12">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2 md:mb-3"
                    style="font-family:var(--font-heading)">{{ __('our-work/hssabek.text_146') }}</h2>
                <p class="text-gray-600 text-base md:text-lg">{{ __('our-work/hssabek.text_6') }}</p>
            </div>
                ...
                <div class="bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h3 class="text-xl font-bold text-gray-900" style="font-family:var(--font-heading)">
                            {{ __('our-work/hssabek.text_7') }}</h3>
                    </div>
                    <p class="text-gray-700 leading-relaxed text-[15px] mb-4">{{ __('our-work/hssabek.text_8') }}</p>
                    <ul class="space-y-2">
                        <li class="flex items-start gap-2 text-sm text-gray-700"><span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0"></span><span>{{ __('our-work/hssabek.defi_bullet_1') }}</span></li>
                        <li class="flex items-start gap-2 text-sm text-gray-700"><span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0"></span><span>{{ __('our-work/hssabek.defi_bullet_2') }}</span></li>
                        <li class="flex items-start gap-2 text-sm text-gray-700"><span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0"></span><span>{{ __('our-work/hssabek.defi_bullet_3') }}</span></li>
                    </ul>
                </div>
                <div class="bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                    <div class="flex items-center gap-3 mb-6">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li class="flex items-start gap-2 text-sm text-gray-700"><span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0"></span><span>{{ __('our-work/hssabek.solution_bullet_3') }}</span></li>
                        <li class="flex items-start gap-2 text-sm text-gray-700"><span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0"></span><span>{{ __('our-work/hssabek.solution_bullet_4') }}</span></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/hssabek.text_21') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 md:gap-8">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2"><span
                                ...
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                style="transform:scale(0.9)">Vite 7</span><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2"><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                style="transform:scale(0.9)">Laravel 12</span><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                    ...
                    <div>
                        <h4 class="font-bold text-gray-900 mb-4 capitalize text-sm flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div>{{ __('our-work/hssabek.ml_863') }}
                        </h4>
                        <div class="flex flex-wrap gap-2"><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                ...
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                style="transform:scale(0.9)">PHPWord</span><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                style="transform:scale(0.9)">Laravel Activity Log</span></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-8 md:mb-12">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3"
                    style="font-family:var(--font-heading)">{{ __('our-work/hssabek.text_24') }}</h2>
                <p class="text-gray-600 text-base md:text-lg">{{ __('our-work/hssabek.text_25') }}</p>
            </div>
            <div class="relative mb-8 md:mb-12 max-w-5xl mx-auto">
                <div
                    ...
                    <video src="{{ asset('videos/hssabek-invoicing-saas-showcase.mp4') }}" autoplay loop muted
            ...
            <div class="grid sm:grid-cols-2 gap-4 md:gap-6 max-w-3xl mx-auto">
                <div class="bg-[#F5F5F5] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center">
                    ...
                    <h3 class="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2"
                        style="font-family:var(--font-heading)">{{ __('our-work/hssabek.text_26') }}</h3>
                    <p class="text-xs md:text-sm text-gray-600">{{ __('our-work/hssabek.text_27') }}</p>
                </div>
                <div class="bg-[#F5F5F5] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center">
                    <div
                        class="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-white flex items-center justify-center mx-auto mb-3 md:mb-4 shadow-sm">
                    ...
                    <h3 class="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2"
                        style="font-family:var(--font-heading)">{{ __('our-work/hssabek.text_28') }}</h3>
                    <p class="text-xs md:text-sm text-gray-600">{{ __('our-work/hssabek.text_29') }}</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div>
                <div class="text-center mb-10 md:mb-12 lg:mb-16">
                    ...
                    <p class="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">{{ __('our-work/hssabek.text_30') }}
                    </p>
                </div>
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-lg md:text-xl font-bold text-gray-900 leading-tight">70%</p>
                                <p class="text-xs text-gray-600 font-medium">{{ __('our-work/hssabek.text_31') }}</p>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-lg md:text-xl font-bold text-gray-900 leading-tight">2x</p>
                                <p class="text-xs text-gray-600 font-medium">{{ __('our-work/hssabek.text_149') }}</p>
                            </div>
                        </div>
                    </div>
                    <div
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-600 font-medium">{{ __('our-work/hssabek.text_150') }}</p>
                            </div>
                        </div>
                    </div>
                    <div
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-lg md:text-xl font-bold text-gray-900 leading-tight">100% centralisé</p>
                                <p class="text-xs text-gray-600 font-medium">{{ __('our-work/hssabek.text_32') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="relative rounded-lg md:rounded-[16px] overflow-hidden"
                            ...
                            <div class="px-5 md:px-6 py-6 md:py-7"><svg class="w-8 h-8 md:w-10 md:h-10 text-white/30 mb-4"
                                ...
                                <blockquote
                                    ...
                                    &quot;<!-- -->{{ __('our-work/hssabek.text_36') }}<!-- -->&quot;</blockquote>
                                <div class="flex items-center gap-3">
                                    <div
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-4 max-w-4xl mx-auto"><a class="group"
                    ...
                    <div
                        ...
                        <p class="text-sm font-semibold text-white hidden md:block">{{ __('our-work/hssabek.text_38') }}
                        </p>
                    </div>
            ...
            <div class="relative overflow-hidden rounded-[24px] md:rounded-[32px] px-6 py-6 md:py-8"
                ...
                <div class="relative z-10 text-center space-y-3 md:space-y-4">
                    <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white px-4 pb-6 md:pb-8"
                        style="font-family:var(--font-display)">{{ __('our-work/hssabek.text_39') }}</h2>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px"
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/hssabek.text_40') }}</span>
                            </a><a
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/hssabek.text_41') }}</span>
                            </a></div>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px">
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black"
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/hssabek.text_42') }}</span>
                            </button><a
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    class="relative z-10 text-base md:text-lg font-medium tracking-tight text-white"
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/hssabek.text_43') }}</span>
                            </a></div>
                            ...
                            <div class="absolute pointer-events-none animate-cursor-stops" style="left:50%;top:50%">
                                ...
                                <div class="absolute left-0 top-0 -translate-x-1/2 px-3 py-1 rounded-full border border-white/80 bg-black/90"
                                    style="font-size:10px"><span
                                        class="text-white font-medium whitespace-nowrap">{{ __('our-work/hssabek.text_152') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <p class="text-base md:text-lg text-white/70 font-medium">{{ __('our-work/hssabek.text_44') }}</p>
                    <p class="text-sm md:text-base text-white/50">{{ __('our-work/hssabek.text_45') }}</p>
                    <div class="mt-6">
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/hssabek.text_153') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/hssabek.text_458') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/hssabek.text_154') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/hssabek.text_459') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/hssabek.text_155') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/hssabek.text_460') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/hssabek.text_156') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/hssabek.text_461') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/hssabek.text_157') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/hssabek.text_462') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/hssabek.text_158') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/hssabek.text_463') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
