...
@section('title', __('our-work/morocco-quest.title'))
@section('meta_description', __('our-work/morocco-quest.meta_description'))
@section('meta_keywords', __('our-work/morocco-quest.meta_keywords'))
...
<section class="relative pt-24 md:pt-28 lg:pt-32 pb-12 md:pb-16 lg:pb-24 overflow-hidden">
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        <div class="mb-6 md:mb-8"><a href="/our-work"><button class="inline-flex items-center justify-center font-medium cursor-pointer disabled:pointer-events-none disabled:opacity-50 relative overflow-hidden transform-gpu focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-primary)] border border-[var(--border-default)] text-[var(--text-primary)] bg-transparent hover:border-[var(--color-primary-orange)] hover:text-[var(--color-primary-orange)] hover:bg-[var(--hover-primary)] h-10 px-6 rounded-full group hover:shadow-lg transition-all duration-300 text-sm md:text-base" tabindex="0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-left w-3.5 h-3.5 md:w-4 md:h-4 mr-2 group-hover:-translate-x-1 transition-transform" aria-hidden="true">
                    ...
                    </svg>{{ __('our-work/morocco-quest.text_0') }}</button></a></div>
        <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16">
            <div class="space-y-4 md:space-y-6">
                <div class="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#00AEEF]/10 to-[#0071BC]/10 rounded-full border border-[#00AEEF]/20" style="transform:scale(0.9)">
                    <div class="w-2 h-2 rounded-full bg-[#00AEEF] animate-pulse"></div><span class="text-sm font-semibold text-[#00AEEF]">{{ __('our-work/morocco-quest.text_1') }}</span>
                </div>
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight" style="font-family:var(--font-heading)">Morocco Quest</h1>
                <p class="text-xl md:text-2xl text-[var(--text-secondary)] font-medium">{{ __('our-work/morocco-quest.text_2') }}</p>
                <p class="text-base md:text-lg text-[var(--text-secondary)] leading-relaxed">{{ __('our-work/morocco-quest.text_3') }}</p>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                    <div class="group relative p-4 bg-white rounded-2xl border border-gray-100 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-300">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="min-w-0">
                                <p class="text-xs text-gray-500 uppercase tracking-wide">{{ __('our-work/morocco-quest.text_4') }}</p>
                    ...
                    <div class="group relative p-4 bg-white rounded-2xl border border-gray-100 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-300">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="min-w-0">
                                <p class="text-xs text-gray-500 uppercase tracking-wide">{{ __('our-work/morocco-quest.text_5') }}</p>
...
<section class="relative py-12 md:py-16 lg:py-20 bg-[#F5F5F5] overflow-hidden">
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        <div class="text-center mb-8 md:mb-12">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2 md:mb-3" style="font-family:var(--font-heading)">{{ __('our-work/morocco-quest.text_153') }}</h2>
            <p class="text-gray-600 text-base md:text-lg">{{ __('our-work/morocco-quest.text_6') }}</p>
        </div>
        <div class="grid md:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-12 max-w-6xl mx-auto">
            <div class="bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900" style="font-family:var(--font-heading)">{{ __('our-work/morocco-quest.text_7') }}</h3>
                </div>
                <p class="text-gray-700 leading-relaxed text-[15px]">{{ __('our-work/morocco-quest.text_8') }}</p>
            </div>
            <div class="bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900" style="font-family:var(--font-heading)">{{ __('our-work/morocco-quest.text_9') }}</h3>
                </div>
                <p class="text-gray-700 leading-relaxed text-[15px]">{{ __('our-work/morocco-quest.text_10') }}</p>
            </div>
        </div>
        <div class="mb-8 md:mb-12 max-w-6xl mx-auto">
            <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-6 text-center" style="font-family:var(--font-heading)">{{ __('our-work/morocco-quest.text_11') }}</h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_12') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_13') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_14') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_15') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_16') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_17') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_18') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_19') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_20') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_21') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_22') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_23') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_24') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_25') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_26') }}</p>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100" style="transform:scale(0.95)">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/morocco-quest.text_27') }}</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-12 md:py-16 lg:py-20 bg-white">
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        <div class="text-center mb-8 md:mb-12">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3" style="font-family:var(--font-heading)">{{ __('our-work/morocco-quest.text_29') }}</h2>
            <p class="text-gray-600 text-base md:text-lg">{{ __('our-work/morocco-quest.text_30') }}</p>
        </div>
        <div class="flex justify-center gap-2 mb-8 flex-wrap"><button class="px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 bg-[#00AEEF] text-white shadow-md" style="transform:scale(0.95)">{{ __('our-work/morocco-quest.text_31') }}</button><button class="px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 bg-gray-100 text-gray-700 hover:bg-gray-200" style="transform:scale(0.95)">{{ __('our-work/morocco-quest.text_32') }}</button><button class="px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 bg-gray-100 text-gray-700 hover:bg-gray-200" style="transform:scale(0.95)">Hub d'Apprentissage Allemand</button><button class="px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 bg-gray-100 text-gray-700 hover:bg-gray-200" style="transform:scale(0.95)">{{ __('our-work/morocco-quest.text_33') }}</button><button class="px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 bg-gray-100 text-gray-700 hover:bg-gray-200" style="transform:scale(0.95)">Plateforme Employeur</button><button class="px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 bg-gray-100 text-gray-700 hover:bg-gray-200" style="transform:scale(0.95)">{{ __('our-work/morocco-quest.text_154') }}</button></div>
        ...
        <div class="grid sm:grid-cols-2 gap-4 md:gap-6 max-w-3xl mx-auto">
            <div class="bg-[#F5F5F5] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center">
                ...
                <h3 class="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2" style="font-family:var(--font-heading)">{{ __('our-work/morocco-quest.text_34') }}</h3>
                <p class="text-xs md:text-sm text-gray-600">{{ __('our-work/morocco-quest.text_35') }}</p>
            </div>
            <div class="bg-[#F5F5F5] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center">
                ...
                <h3 class="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2" style="font-family:var(--font-heading)">{{ __('our-work/morocco-quest.text_36') }}</h3>
                <p class="text-xs md:text-sm text-gray-600">{{ __('our-work/morocco-quest.text_37') }}</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        <div>
            <div class="text-center mb-10 md:mb-12 lg:mb-16">
                ...
                <p class="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">{{ __('our-work/morocco-quest.text_38') }}</p>
            </div>
                ...
                <div class="group relative bg-white rounded-lg p-3 shadow-lg hover:shadow-2xl transition-all duration-300">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-600 font-medium">{{ __('our-work/morocco-quest.text_39') }}</p>
                        </div>
                    </div>
                </div>
                <div class="group relative bg-white rounded-lg p-3 shadow-lg hover:shadow-2xl transition-all duration-300">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-600 font-medium">{{ __('our-work/morocco-quest.text_155') }}</p>
                        </div>
                    </div>
                </div>
                <div class="group relative bg-white rounded-lg p-3 shadow-lg hover:shadow-2xl transition-all duration-300">
                ...
                <div class="group relative bg-white rounded-lg p-3 shadow-lg hover:shadow-2xl transition-all duration-300">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-600 font-medium">{{ __('our-work/morocco-quest.text_156') }}</p>
                        </div>
                    </div>
                </div>
                <div class="group relative bg-white rounded-lg p-3 shadow-lg hover:shadow-2xl transition-all duration-300">
            ...
            <div class="max-w-4xl mx-auto mt-16 mb-12">
                <div class="bg-gradient-to-br from-[#00AEEF]/5 to-orange-50 rounded-3xl p-8 md:p-10 border-2 border-[#00AEEF]/20 text-center">
                    ...
                    <h3 class="text-2xl md:text-3xl font-bold mb-3 text-[var(--text-primary)]" style="font-family:var(--font-heading)">{{ __('our-work/morocco-quest.text_40') }}</h3>
                    <p class="text-base md:text-lg text-[var(--text-secondary)] mb-6 max-w-2xl mx-auto">{{ __('our-work/morocco-quest.text_41') }} <!-- -->Morocco Quest<!-- -->{{ __('our-work/morocco-quest.text_42') }}</p><a class="inline-flex items-center gap-2 px-7 py-3 rounded-full bg-[#00AEEF] hover:bg-[#0071BC] text-white font-medium transition-all shadow-[0_4px_20px_rgba(0,174,239,0.25)] hover:shadow-[0_6px_24px_rgba(0,174,239,0.35)] hover:scale-105 text-sm md:text-base" href="/tools/website-analyzer"><span>{{ __('our-work/morocco-quest.text_157') }}</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4" aria-hidden="true">
                ...
                <div class="bg-[#FEFEFE] rounded-2xl md:rounded-3xl overflow-hidden p-1.5 md:p-2 transition-all duration-300 hover:-translate-y-2" style="box-shadow:0 10px 40px rgba(0, 0, 0, 0.1), 0 2px 8px rgba(0, 0, 0, 0.06)">
                    <div class="relative rounded-lg md:rounded-[16px] overflow-hidden" style="background:linear-gradient(to top, #00AEEF 0%, #0071BC 100%);box-shadow:0 8px 20px rgba(0, 0, 0, 0.08), 0 3px 6px rgba(0, 0, 0, 0.04)">
                        <div class="px-5 md:px-6 py-6 md:py-7"><svg class="w-8 h-8 md:w-10 md:h-10 text-white/30 mb-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <blockquote class="text-base md:text-lg text-white leading-relaxed mb-6 font-normal italic">&quot;<!-- -->{{ __('our-work/morocco-quest.text_43') }}<!-- -->&quot;</blockquote>
                            <div class="flex items-center gap-3">
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        <div class="grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-4 max-w-4xl mx-auto"><a class="group" href="/our-work/mon-asso">
                <div class="bg-white rounded-2xl p-4 md:p-6 text-center hover:shadow-md transition-all duration-200 border border-gray-100"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-left w-6 h-6 md:w-5 md:h-5 text-gray-400 mx-auto mb-0 md:mb-2 group-hover:text-[#00AEEF] group-hover:-translate-x-1 transition-all" aria-hidden="true">
                    ...
                    <p class="text-sm font-semibold text-gray-700 hidden md:block">{{ __('our-work/morocco-quest.text_44') }}</p>
                </div>
                ...
                <div class="bg-[#00AEEF] rounded-2xl p-4 md:p-6 text-center hover:bg-[#0071BC] transition-all duration-200 shadow-md hover:shadow-lg">
                    ...
                    <p class="text-sm font-semibold text-white hidden md:block">{{ __('our-work/morocco-quest.text_45') }}</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="relative overflow-hidden rounded-[24px] md:rounded-[32px] px-6 py-6 md:py-8" style="background:linear-gradient(135deg, #1a1a1a 0%, #0a0a0a 100%)">
            ...
            <div class="relative z-10 text-center space-y-3 md:space-y-4">
                <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white px-4 pb-6 md:pb-8" style="font-family:var(--font-display)">{{ __('our-work/morocco-quest.text_46') }}</h2>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px" data-cal-link="code-sommet/new-client-meeting" data-cal-namespace="new-client-meeting" data-cal-config='{"layout":"month_view","useSlotsViewOnSmallScreen":"true"}' href="#">
                            ...
                            <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-rocket w-5 h-5 text-black" aria-hidden="true">
                                ...
                                </svg></div><span class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black" style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/morocco-quest.text_47') }}</span>
                            ...
                            <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-rocket w-5 h-5 text-white" aria-hidden="true">
                                    ...
                                    <path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"></path>
                                    <path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path>
                                </svg></div><span class="relative z-10 text-base md:text-lg font-medium tracking-tight text-white" style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/morocco-quest.text_48') }}</span>
                        </a></div>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px">
                            ...
                            <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-rocket w-5 h-5 text-black" aria-hidden="true">
                                    ...
                                    <path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"></path>
                                    <path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path>
                                </svg></div><span class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black" style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/morocco-quest.text_49') }}</span>
                            ...
                            <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-rocket w-5 h-5 text-white" aria-hidden="true">
                                    ...
                                    <path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"></path>
                                    <path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path>
                                </svg></div><span class="relative z-10 text-base md:text-lg font-medium tracking-tight text-white" style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/morocco-quest.text_50') }}</span>
                        </a></div>
                    <div class="relative mt-2 h-16">
                        <div class="absolute pointer-events-none animate-cursor-stops" style="left:50%;top:50%">
                            ...
                            <div class="absolute left-0 top-0 -translate-x-1/2 px-3 py-1 rounded-full border border-white/80 bg-black/90" style="font-size:10px"><span class="text-white font-medium whitespace-nowrap">{{ __('our-work/morocco-quest.text_158') }}</span></div>
                        </div>
                    </div>
                </div>
                <p class="text-base md:text-lg text-white/70 font-medium">{{ __('our-work/morocco-quest.text_51') }}</p>
                <p class="text-sm md:text-base text-white/50">{{ __('our-work/morocco-quest.text_52') }}</p>
                <div class="mt-6">
                                ...
                                <ul class="flex items-center gap-3 list-none m-0 p-0" style="position:relative;flex-direction:row;will-change:transform">
                                    ...
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                            <div class="relative w-5 h-5">
                                                <div class="absolute inset-0 rounded-full border-2 border-white/30"></div>
                                            </div><span class="text-[10px] font-medium text-white/40">{{ __('our-work/morocco-quest.text_159') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                            <div class="relative w-5 h-5">
                                                <div class="absolute inset-0 rounded-full border-2 border-white/30"></div>
                                            </div><span class="text-[10px] font-medium text-white/40">{{ __('our-work/morocco-quest.text_464') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                    ...
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                            <div class="relative w-5 h-5">
                                                <div class="absolute inset-0 rounded-full border-2 border-white/30"></div>
                                            </div><span class="text-[10px] font-medium text-white/40">{{ __('our-work/morocco-quest.text_160') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                            <div class="relative w-5 h-5">
                                                <div class="absolute inset-0 rounded-full border-2 border-white/30"></div>
                                            </div><span class="text-[10px] font-medium text-white/40">{{ __('our-work/morocco-quest.text_465') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                    ...
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                            <div class="relative w-5 h-5">
                                                <div class="absolute inset-0 rounded-full border-2 border-white/30"></div>
                                            </div><span class="text-[10px] font-medium text-white/40">{{ __('our-work/morocco-quest.text_161') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                            <div class="relative w-5 h-5">
                                                <div class="absolute inset-0 rounded-full border-2 border-white/30"></div>
                                            </div><span class="text-[10px] font-medium text-white/40">{{ __('our-work/morocco-quest.text_466') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-dashed border-white/20 bg-transparent">
                                ...
                                <ul class="flex items-center gap-3 list-none m-0 p-0" style="position:relative;flex-direction:row;will-change:transform">
                                    ...
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                            ...
                                            </div><span class="text-[10px] font-medium text-white/90">{{ __('our-work/morocco-quest.text_162') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                            ...
                                            </div><span class="text-[10px] font-medium text-white/90">{{ __('our-work/morocco-quest.text_467') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                    ...
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                            ...
                                            </div><span class="text-[10px] font-medium text-white/90">{{ __('our-work/morocco-quest.text_163') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                            ...
                                            </div><span class="text-[10px] font-medium text-white/90">{{ __('our-work/morocco-quest.text_468') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                    ...
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                            ...
                                            </div><span class="text-[10px] font-medium text-white/90">{{ __('our-work/morocco-quest.text_164') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
                                            ...
                                            </div><span class="text-[10px] font-medium text-white/90">{{ __('our-work/morocco-quest.text_469') }}</span>
                                        </div>
                                    </li>
                                    <li class="flex-shrink-0">
                                        <div class="flex items-center gap-3 whitespace-nowrap px-5 py-2.5 rounded-full border border-solid border-white/20 bg-transparent">
