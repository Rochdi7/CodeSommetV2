        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-12 max-w-6xl mx-auto">
                <div class="bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                    ...
                    <p class="text-gray-700 leading-relaxed text-[15px]">{{ __('our-work/gls-sprachenzentrum.text_7') }}</p>
                </div>
                <div class="bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                    <div class="flex items-center gap-3 mb-6">
                        <div
                    ...
                    <p class="text-gray-700 leading-relaxed text-[15px]">{{ __('our-work/gls-sprachenzentrum.text_9') }}</p>
                </div>
            </div>
    ...
    <section class="py-12 md:py-16 lg:py-20 bg-white">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            ...
            <div class="flex justify-center gap-2 mb-8 flex-wrap"><button
                    ...
                    style="transform:scale(0.95)">{{ __('our-work/gls-sprachenzentrum.text_23') }}</button><button
                    class="px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 bg-gray-100 text-gray-700 hover:bg-gray-200"
