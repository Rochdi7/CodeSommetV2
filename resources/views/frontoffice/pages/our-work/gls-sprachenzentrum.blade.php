...
@section('title', __('our-work/gls-sprachenzentrum.title'))
@section('meta_description', __('our-work/gls-sprachenzentrum.meta_description'))
@section('meta_keywords', __('our-work/gls-sprachenzentrum.meta_keywords'))
@section('og_title', __('our-work/gls-sprachenzentrum.og_title'))
@section('og_description', __('our-work/gls-sprachenzentrum.og_description'))
@section('twitter_description', __('our-work/gls-sprachenzentrum.twitter_description'))
    ...
    <section class="relative pt-24 md:pt-28 lg:pt-32 pb-12 md:pb-16 lg:pb-24 overflow-hidden">
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div class="mb-6 md:mb-8"><a href="/our-work"><button
                        ...
                        </svg>{{ __('our-work/gls-sprachenzentrum.text_0') }}</button></a></div>
            <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16">
                <div class="space-y-4 md:space-y-6">
                    <div class="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#00AEEF]/10 to-[#0071BC]/10 rounded-full border border-[#00AEEF]/20"
                        ...
                        <div class="w-2 h-2 rounded-full bg-[#00AEEF] animate-pulse"></div><span
                            class="text-sm font-semibold text-[#00AEEF]">{{ __('our-work/gls-sprachenzentrum.text_1') }}</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide">
                                        {{ __('our-work/gls-sprachenzentrum.text_3') }}</p>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide">
                                        {{ __('our-work/gls-sprachenzentrum.text_4') }}</p>
                    ...
                    <div class="pt-2 md:pt-4"><a href="https://gls-sprachzentrum.ma/" target="_blank" rel="noopener noreferrer"
                            class="block w-full"><button
                                ...
                                tabindex="0"><span>{{ __('our-work/gls-sprachenzentrum.text_144') }}</span><svg
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <video src="{{ asset('videos/gls-sprachenzentrum-language-school-showcase.mp4') }}" autoplay
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div class="text-center mb-8 md:mb-12">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2 md:mb-3"
                    style="font-family:var(--font-heading)">{{ __('our-work/gls-sprachenzentrum.text_145') }}</h2>
                <p class="text-gray-600 text-base md:text-lg">{{ __('our-work/gls-sprachenzentrum.text_5') }}</p>
            </div>
                ...
                <div class="bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h3 class="text-xl font-bold text-gray-900" style="font-family:var(--font-heading)">
                            {{ __('our-work/gls-sprachenzentrum.text_6') }}</h3>
                    </div>
                    <p class="text-gray-700 leading-relaxed text-[15px] mb-4">{{ __('our-work/gls-sprachenzentrum.text_7') }}</p>
                    <ul class="space-y-2">
                        <li class="flex items-start gap-2 text-sm text-gray-700"><span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0"></span><span>{{ __('our-work/gls-sprachenzentrum.defi_bullet_1') }}</span></li>
                        <li class="flex items-start gap-2 text-sm text-gray-700"><span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0"></span><span>{{ __('our-work/gls-sprachenzentrum.defi_bullet_2') }}</span></li>
                        <li class="flex items-start gap-2 text-sm text-gray-700"><span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0"></span><span>{{ __('our-work/gls-sprachenzentrum.defi_bullet_3') }}</span></li>
                    </ul>
                </div>
                <div class="bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                    <div class="flex items-center gap-3 mb-6">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li class="flex items-start gap-2 text-sm text-gray-700"><span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0"></span><span>{{ __('our-work/gls-sprachenzentrum.solution_bullet_3') }}</span></li>
                        <li class="flex items-start gap-2 text-sm text-gray-700"><span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00AEEF] flex-shrink-0"></span><span>{{ __('our-work/gls-sprachenzentrum.solution_bullet_4') }}</span></li>
                    </ul>
                </div>
            </div>
            <div class="mb-8 md:mb-12 max-w-6xl mx-auto">
                <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-6 text-center"
                    style="font-family:var(--font-heading)">{{ __('our-work/gls-sprachenzentrum.text_10') }}</h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/gls-sprachenzentrum.text_11') }}
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/gls-sprachenzentrum.text_12') }}
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/gls-sprachenzentrum.text_13') }}
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/gls-sprachenzentrum.text_14') }}
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/gls-sprachenzentrum.text_15') }}
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/gls-sprachenzentrum.text_16') }}
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/gls-sprachenzentrum.text_17') }}
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/gls-sprachenzentrum.text_18') }}
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/gls-sprachenzentrum.text_19') }}
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-700 leading-relaxed">{{ __('our-work/gls-sprachenzentrum.text_20') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 md:gap-8">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2"><span
                                ...
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                style="transform:scale(0.9)">Bootstrap 5</span></div>
                    </div>
                    <div>
                        <h4 class="font-bold text-gray-900 mb-4 capitalize text-sm flex items-center gap-2">
                    ...
                    <div>
                        <h4 class="font-bold text-gray-900 mb-4 capitalize text-sm flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div>{{ __('our-work/gls-sprachenzentrum.ml_861') }}
                        </h4>
                        <div class="flex flex-wrap gap-2"><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                style="transform:scale(0.9)">Hikvision Access Control</span><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                style="transform:scale(0.9)">DomPDF</span><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                style="transform:scale(0.9)">Simple QRCode</span><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                style="transform:scale(0.9)">Laravel Excel</span><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
                                style="transform:scale(0.9)">WhatsApp API</span></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-8 md:mb-12">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3"
                    style="font-family:var(--font-heading)">{{ __('our-work/gls-sprachenzentrum.text_21') }}</h2>
                <p class="text-gray-600 text-base md:text-lg">{{ __('our-work/gls-sprachenzentrum.text_22') }}</p>
            </div>
            ...
            <div class="grid sm:grid-cols-2 gap-4 md:gap-6 max-w-3xl mx-auto">
                <div class="bg-[#F5F5F5] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center">
                    ...
                    <h3 class="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2"
                        style="font-family:var(--font-heading)">{{ __('our-work/gls-sprachenzentrum.text_24') }}</h3>
                    <p class="text-xs md:text-sm text-gray-600">{{ __('our-work/gls-sprachenzentrum.text_25') }}</p>
                </div>
                <div class="bg-[#F5F5F5] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center">
                    <div
                        class="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-white flex items-center justify-center mx-auto mb-3 md:mb-4 shadow-sm">
                    ...
                    <h3 class="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2"
                        style="font-family:var(--font-heading)">{{ __('our-work/gls-sprachenzentrum.text_26') }}</h3>
                    <p class="text-xs md:text-sm text-gray-600">{{ __('our-work/gls-sprachenzentrum.text_27') }}</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div>
                <div class="text-center mb-10 md:mb-12 lg:mb-16">
                    ...
                    <p class="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
                        {{ __('our-work/gls-sprachenzentrum.text_28') }}</p>
                </div>
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-600 font-medium">{{ __('our-work/gls-sprachenzentrum.text_29') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-600 font-medium">{{ __('our-work/gls-sprachenzentrum.text_147') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-600 font-medium">{{ __('our-work/gls-sprachenzentrum.text_148') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-lg md:text-xl font-bold text-gray-900 leading-tight">2000+</p>
                                <p class="text-xs text-gray-600 font-medium">{{ __('our-work/gls-sprachenzentrum.text_30') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-600 font-medium">{{ __('our-work/gls-sprachenzentrum.text_31') }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="max-w-4xl mx-auto mt-16 mb-12">
                    <div
                        ...
                        <p class="analyzer-cta__text text-base md:text-lg mb-6 max-w-2xl mx-auto">
                            ...
                            href="/tools/website-analyzer"><span>{{ __('our-work/gls-sprachenzentrum.text_149') }}</span><svg
                        ...
                        <div class="relative rounded-lg md:rounded-[16px] overflow-hidden"
                            ...
                            <div class="px-5 md:px-6 py-6 md:py-7"><svg class="w-8 h-8 md:w-10 md:h-10 text-white/30 mb-4"
                                ...
                                <blockquote
                                    ...
                                    &quot;<!-- -->{{ __('our-work/gls-sprachenzentrum.text_35') }}<!-- -->&quot;</blockquote>
                                <div class="flex items-center gap-3">
                                    <div
            ...
            <div class="grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-4 max-w-4xl mx-auto"><a class="group"
                    ...
                    <div
                        ...
                        <p class="text-sm font-semibold text-gray-700 hidden md:block">
                            {{ __('our-work/gls-sprachenzentrum.text_36') }}</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-sm font-semibold text-white hidden md:block">
                            {{ __('our-work/gls-sprachenzentrum.text_37') }}</p>
                    </div>
            ...
            <div class="relative overflow-hidden rounded-[24px] md:rounded-[32px] px-6 py-6 md:py-8"
                ...
                <div class="relative z-10 text-center space-y-3 md:space-y-4">
                    <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white px-4 pb-6 md:pb-8"
                        style="font-family:var(--font-display)">{{ __('our-work/gls-sprachenzentrum.text_38') }}</h2>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px"
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/gls-sprachenzentrum.text_39') }}</span>
                            </a><a
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/gls-sprachenzentrum.text_40') }}</span>
                            </a></div>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px">
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black"
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/gls-sprachenzentrum.text_41') }}</span>
                            </button><a
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    class="relative z-10 text-base md:text-lg font-medium tracking-tight text-white"
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/gls-sprachenzentrum.text_42') }}</span>
                            </a></div>
                            ...
                            <div class="absolute pointer-events-none animate-cursor-stops" style="left:50%;top:50%">
                                ...
                                <div class="absolute left-0 top-0 -translate-x-1/2 px-3 py-1 rounded-full border border-white/80 bg-black/90"
                                    style="font-size:10px"><span
                                        class="text-white font-medium whitespace-nowrap">{{ __('our-work/gls-sprachenzentrum.text_150') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <p class="text-base md:text-lg text-white/70 font-medium">{{ __('our-work/gls-sprachenzentrum.text_43') }}
                    </p>
                    <p class="text-sm md:text-base text-white/50">{{ __('our-work/gls-sprachenzentrum.text_44') }}</p>
                    <div class="mt-6">
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/gls-sprachenzentrum.text_151') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/gls-sprachenzentrum.text_456') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/gls-sprachenzentrum.text_152') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/gls-sprachenzentrum.text_457') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/gls-sprachenzentrum.text_153') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/gls-sprachenzentrum.text_458') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/gls-sprachenzentrum.text_154') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/gls-sprachenzentrum.text_459') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/gls-sprachenzentrum.text_155') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/gls-sprachenzentrum.text_460') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/gls-sprachenzentrum.text_156') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/gls-sprachenzentrum.text_461') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
