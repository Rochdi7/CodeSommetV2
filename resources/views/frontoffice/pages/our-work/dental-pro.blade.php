                ...
                <div class="space-y-4 md:space-y-6">
                    <div class="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#00AEEF]/10 to-[#0071BC]/10 rounded-full border border-[#00AEEF]/20"
                        ...
                        <div class="w-2 h-2 rounded-full bg-[#00AEEF] animate-pulse"></div><span
                            class="text-sm font-semibold text-[#00AEEF]">{{ __('our-work/dental-pro.text_1') }}</span>
                    </div>
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight"
                        style="font-family:var(--font-heading)">Dental Pro</h1>
                    <p class="text-xl md:text-2xl text-[var(--text-secondary)] font-medium">
                        {{ __('our-work/dental-pro.text_2') }}</p>
                    <p class="text-base md:text-lg text-[var(--text-secondary)] leading-relaxed">
                        {{ __('our-work/dental-pro.text_3') }}</p>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide">
                                        {{ __('our-work/dental-pro.text_4') }}</p>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide">
                                        {{ __('our-work/dental-pro.text_5') }}</p>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div class="text-center mb-8 md:mb-12">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2 md:mb-3"
                    style="font-family:var(--font-heading)">{{ __('our-work/dental-pro.text_148') }}</h2>
            ...
            <div class="mb-8 md:mb-12 max-w-6xl mx-auto">
                <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-6 text-center"
                    style="font-family:var(--font-heading)">{{ __('our-work/dental-pro.text_11') }}</h3>
            ...
            <div
                ...
                <div class="grid md:grid-cols-3 gap-6 md:gap-8">
                    ...
                    <div>
                        <h4 class="font-bold text-gray-900 mb-4 capitalize text-sm flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div>{{ __('our-work/dental-pro.ml_866') }}
                        </h4>
                        <div class="flex flex-wrap gap-2"><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
            ...
            <div class="grid sm:grid-cols-2 gap-4 md:gap-6 max-w-3xl mx-auto">
                <div class="bg-[#F5F5F5] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center">
                    ...
                    <h3 class="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2"
                        style="font-family:var(--font-heading)">{{ __('our-work/dental-pro.text_26') }}</h3>
                ...
                <div class="bg-[#F5F5F5] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center">
                    ...
                    <h3 class="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2"
                        style="font-family:var(--font-heading)">{{ __('our-work/dental-pro.text_28') }}</h3>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div>
                <div class="text-center mb-10 md:mb-12 lg:mb-16">
                    ...
                    <p class="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">{{ __('our-work/dental-pro.text_30') }}
                    </p>
                </div>
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-lg md:text-xl font-bold text-gray-900 leading-tight">
                                    {{ __('our-work/dental-pro.text_33') }}</p>
                ...
                <div class="max-w-4xl mx-auto mt-16 mb-12">
                    <div
                        ...
                        <p class="analyzer-cta__text text-base md:text-lg mb-6 max-w-2xl mx-auto">
                            ...
                            href="/tools/website-analyzer"><span>{{ __('our-work/dental-pro.text_154') }}</span><svg
                        ...
                        <div class="relative rounded-lg md:rounded-[16px] overflow-hidden"
                            ...
                            <div class="px-5 md:px-6 py-6 md:py-7"><svg class="w-8 h-8 md:w-10 md:h-10 text-white/30 mb-4"
                                ...
                                <blockquote
                                    ...
                                    &quot;<!-- -->{{ __('our-work/dental-pro.text_37') }}<!-- -->&quot;</blockquote>
                                <div class="flex items-center gap-3">
                                    <div
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 gap-3 md:gap-4 max-w-4xl mx-auto"><a class="group" href="/our-work">
                    <div
                        ...
                        <p class="text-sm font-semibold text-white hidden md:block">
                            {{ __('our-work/dental-pro.text_40') }}</p>
                    </div>
            ...
            <div class="relative overflow-hidden rounded-[24px] md:rounded-[32px] px-6 py-6 md:py-8"
                ...
                <div class="relative z-10 text-center space-y-3 md:space-y-4">
                    <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white px-4 pb-6 md:pb-8"
                        style="font-family:var(--font-display)">{{ __('our-work/dental-pro.text_41') }}</h2>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px"
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/dental-pro.text_42') }}</span>
                            </a><a
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/dental-pro.text_43') }}</span>
                            </a></div>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px">
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black"
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/dental-pro.text_44') }}</span>
                            </button><a
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    class="relative z-10 text-base md:text-lg font-medium tracking-tight text-white"
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/dental-pro.text_45') }}</span>
                            </a></div>
                            ...
                            <div class="absolute pointer-events-none animate-cursor-stops" style="left:50%;top:50%">
                                ...
                                <div class="absolute left-0 top-0 -translate-x-1/2 px-3 py-1 rounded-full border border-white/80 bg-black/90"
                                    style="font-size:10px"><span
                                        class="text-white font-medium whitespace-nowrap">{{ __('our-work/dental-pro.text_155') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/dental-pro.text_156') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/dental-pro.text_461') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/dental-pro.text_157') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/dental-pro.text_462') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/dental-pro.text_158') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/dental-pro.text_463') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/dental-pro.text_159') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/dental-pro.text_464') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/dental-pro.text_160') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/dental-pro.text_465') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/dental-pro.text_161') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/dental-pro.text_466') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
