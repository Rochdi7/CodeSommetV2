        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            ...
            <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16">
                <div class="space-y-4 md:space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide">
                                        {{ __('our-work/glamworlds.text_3') }}</p>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide">
                                        {{ __('our-work/glamworlds.text_4') }}</p>
                    ...
                    <div class="pt-2 md:pt-4"><a href="https://al-raba-com.vercel.app/" target="_blank"
                            rel="noopener noreferrer" class="block w-full"><button
                                ...
                                tabindex="0"><span>{{ __('our-work/glamworlds.text_140') }}</span><svg
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <video src="{{ asset('images/our-work/glamworlds/glamworlds-hero.mp4') }}" autoPlay=""
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div class="text-center mb-8 md:mb-12">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2 md:mb-3"
                    style="font-family:var(--font-heading)">{{ __('our-work/glamworlds.text_141') }}</h2>
            ...
            <div
                ...
                <div class="grid md:grid-cols-3 gap-6 md:gap-8">
                    ...
                    <div>
                        <h4 class="font-bold text-gray-900 mb-4 capitalize text-sm flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div>{{ __('our-work/glamworlds.ml_858') }}
                        </h4>
                        <div class="flex flex-wrap gap-2"><span
                                class="px-4 py-2 bg-gray-50 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-[#00AEEF]/30 hover:bg-white transition-all duration-200"
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            ...
            <div class="relative mb-8 md:mb-12 max-w-5xl mx-auto">
                <div
                    ...
                    <img src="{{ asset('images/our-work/glamworlds/homepage.webp') }}" alt="Accueil"
            ...
            <div class="grid sm:grid-cols-2 gap-4 md:gap-6 max-w-3xl mx-auto">
                <div class="bg-[#F5F5F5] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center">
                    ...
                    <h3 class="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2"
                        style="font-family:var(--font-heading)">{{ __('our-work/glamworlds.text_19') }}</h3>
                ...
                <div class="bg-[#F5F5F5] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center">
                    ...
                    <h3 class="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2"
                        style="font-family:var(--font-heading)">{{ __('our-work/glamworlds.text_21') }}</h3>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div>
                <div class="text-center mb-10 md:mb-12 lg:mb-16">
                    ...
                    <p class="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">{{ __('our-work/glamworlds.text_23') }}
                    </p>
                </div>
                <div
                ...
                <div class="max-w-4xl mx-auto mt-16 mb-12">
                    <div
                        ...
                        <p class="text-base md:text-lg text-[var(--text-secondary)] mb-6 max-w-2xl mx-auto">
                            ...
                            href="/tools/website-analyzer"><span>{{ __('our-work/glamworlds.text_146') }}</span><svg
                        ...
                        <div class="relative rounded-lg md:rounded-[16px] overflow-hidden"
                            ...
                            <div class="px-5 md:px-6 py-6 md:py-7"><svg class="w-8 h-8 md:w-10 md:h-10 text-white/30 mb-4"
                                ...
                                <blockquote
                                    ...
                                    &quot;<!-- -->{{ __('our-work/glamworlds.text_30') }}<!-- -->&quot;</blockquote>
                                <div class="flex items-center gap-3">
                                    <div
                                    ...
                                    <div>
                                        ...
                                        <p class="text-white/90 text-xs md:text-sm">
                                            {{ __('our-work/glamworlds.text_31') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-4 max-w-4xl mx-auto"><a class="group"
                    ...
                    <div
                        ...
                        <p class="text-sm font-semibold text-gray-700 hidden md:block">
                            {{ __('our-work/glamworlds.text_32') }}</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-sm font-semibold text-white hidden md:block">
                            {{ __('our-work/glamworlds.text_33') }}</p>
                    </div>
            ...
            <div class="relative overflow-hidden rounded-[24px] md:rounded-[32px] px-6 py-6 md:py-8"
                ...
                <div class="relative z-10 text-center space-y-3 md:space-y-4">
                    <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white px-4 pb-6 md:pb-8"
                        style="font-family:var(--font-display)">{{ __('our-work/glamworlds.text_34') }}</h2>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px"
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/glamworlds.text_35') }}</span>
                            </a><a
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/glamworlds.text_36') }}</span>
                            </a></div>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px">
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black"
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/glamworlds.text_37') }}</span>
                            </button><a
                                ...
                                <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    class="relative z-10 text-base md:text-lg font-medium tracking-tight text-white"
                                    style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('our-work/glamworlds.text_38') }}</span>
                            </a></div>
                            ...
                            <div class="absolute pointer-events-none animate-cursor-stops" style="left:50%;top:50%">
                                ...
                                <div class="absolute left-0 top-0 -translate-x-1/2 px-3 py-1 rounded-full border border-white/80 bg-black/90"
                                    style="font-size:10px"><span
                                        class="text-white font-medium whitespace-nowrap">{{ __('our-work/glamworlds.text_147') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/glamworlds.text_148') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/glamworlds.text_453') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/glamworlds.text_149') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/glamworlds.text_454') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/glamworlds.text_150') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/40">{{ __('our-work/glamworlds.text_455') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/glamworlds.text_151') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/glamworlds.text_456') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/glamworlds.text_152') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/glamworlds.text_457') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                        ...
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/glamworlds.text_153') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
                                                ...
                                                <div class="relative w-5 h-5">
                                                    ...
                                                    class="text-[10px] font-medium text-white/90">{{ __('our-work/glamworlds.text_458') }}</span>
                                            </div>
                                        </li>
                                        <li class="flex-shrink-0">
                                            <div
