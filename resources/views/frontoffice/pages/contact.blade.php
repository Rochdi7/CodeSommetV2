...
@section('title', 'Contactez-Nous - Obtenez Votre Appel Stratégique Gratuit | CodeSommet')
@section('meta_description', 'Contactez CodeSommet pour le développement web propulsé par l\'IA au Maroc. Réservez un appel découverte gratuit ou contactez-nous par email, WhatsApp. Temps de réponse de 24 heures garanti.')
@section('meta_keywords', 'contact CodeSommet,devis développement web Maroc,embaucher développeurs web,consultation développement IA,appel stratégique gratuit,demande développement web')
@section('og_title', 'Contactez-Nous - CodeSommet')
@section('og_description', 'Contactez CodeSommet pour le développement web propulsé par l\'IA au Maroc. Réservez un appel découverte gratuit ou contactez-nous par email, WhatsApp. Temps de réponse de 24 heures.')
@section('twitter_description', 'Contactez-nous pour le développement web propulsé par l\'IA au Maroc. Réservez un appel découverte gratuit. Temps de réponse de 24 heures.')
...
<div class="min-h-screen bg-[var(--bg-primary)]">
    <section class="relative min-h-[70vh] md:min-h-[80vh] flex items-center overflow-hidden pt-28 lg:pt-32 pb-16 md:pb-20">
        ...
        <div class="absolute inset-0" style="background-image:linear-gradient(to right, rgba(180, 180, 180, 0.2) 1px, transparent 1px),
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div class="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 lg:gap-12 items-center">
                <div class="space-y-6 lg:space-y-8 text-center lg:text-left">
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#00AEEF]/10 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail w-4 h-4 text-[#00AEEF]" aria-hidden="true">
                            <path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path>
                            <rect x="2" y="4" width="20" height="16" rx="2"></rect>
                        </svg><span class="text-sm font-medium text-[#00AEEF]">Contactez-Nous</span></div>
                    <div class="space-y-4">
                        <h1 class="font-heading tracking-tight text-[var(--text-4xl)] md:text-[var(--text-5xl)] lg:text-[var(--text-6xl)] font-bold leading-tight" style="font-family:var(--font-display)">Construisons Votre Présence Digitale</h1>
                        <p class="font-body leading-relaxed font-normal text-[var(--text-secondary)] max-w-xl mx-auto lg:mx-0">Prêt à lancer un site web qui génère de vrais prospects ? Nous sommes là pour vous aider. Réservez un appel stratégique gratuit ou contactez-nous directement.</p>
                    </div>
                    <div class="space-y-4">
                        <div class="flex items-center gap-3 justify-center lg:justify-start">
                            <div class="w-10 h-10 rounded-xl bg-[#00AEEF]/10 flex items-center justify-center flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-zap w-5 h-5 text-[#00AEEF]" aria-hidden="true">
                                    <path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path>
                                </svg></div>
                            <div class="text-left">
                                <div class="font-semibold text-[var(--text-primary)]">Temps de Réponse Rapide</div>
                                <div class="text-sm text-[var(--text-secondary)]">Nous répondons sous 24 heures</div>
                            </div>
                        </div>
                        <div class="flex items-center gap-3 justify-center lg:justify-start">
                            <div class="w-10 h-10 rounded-xl bg-[#00AEEF]/10 flex items-center justify-center flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users w-5 h-5 text-[#00AEEF]" aria-hidden="true">
                            ...
                            <div class="text-left">
                                <div class="font-semibold text-[var(--text-primary)]">Équipe Basée au Maroc</div>
                                <div class="text-sm text-[var(--text-secondary)]">Expertise locale, standards internationaux</div>
                            </div>
                        </div>
                        <div class="flex items-center gap-3 justify-center lg:justify-start">
                            <div class="w-10 h-10 rounded-xl bg-[#00AEEF]/10 flex items-center justify-center flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-globe w-5 h-5 text-[#00AEEF]" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                                    <path d="M2 12h20"></path>
                                </svg></div>
                            <div class="text-left">
                                <div class="font-semibold text-[var(--text-primary)]">Portée Mondiale</div>
                                <div class="text-sm text-[var(--text-secondary)]">Au service de clients au Maroc et au-delà</div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start"><a target="_blank" rel="noopener noreferrer" class="md:hidden group relative inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full overflow-hidden w-full sm:w-auto" style="background-color:rgba(0, 0, 0, 0.08);border-radius:118px;box-shadow:rgba(0, 0, 0, 0.1) 0px 2.51941px 2.51941px -0.46875px,
                        ...
                        </button><a href="#contact-form" class="group relative inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full overflow-hidden w-full sm:w-auto bg-[#00AEEF] hover:bg-[#0071BC] transition-colors" style="box-shadow:0 4px 20px rgba(0, 174, 239, 0.25)"><span class="text-white font-medium text-base md:text-lg">Envoyez-Nous un Message</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail w-5 h-5 text-white" aria-hidden="true">
                                <path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path>
                                <rect x="2" y="4" width="20" height="16" rx="2"></rect>
                            </svg></a></div>
                </div>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                    <div class="w-12 h-12 rounded-xl bg-[#00AEEF]/10 flex items-center justify-center mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail w-6 h-6 text-[#00AEEF]" aria-hidden="true">
                            <path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path>
                            <rect x="2" y="4" width="20" height="16" rx="2"></rect>
                        </svg></div>
                    <h3 class="font-semibold text-[var(--text-primary)] mb-2">Envoyez-nous un Email</h3>
                    <p class="text-sm text-[var(--text-secondary)] mb-3">Écrivez-nous</p><a href="mailto:codesommet@gmail.com" class="text-[#00AEEF] font-medium hover:text-[#0071BC] transition-colors inline-flex items-center gap-2 group text-sm">Envoyer un Email<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4 group-hover:translate-x-1 transition-transform" aria-hidden="true">
                            <path d="M5 12h14"></path>
                            <path d="m12 5 7 7-7 7"></path>
                        </svg></a>
                </div>
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                    <div class="w-12 h-12 rounded-xl bg-[#25D366]/10 flex items-center justify-center mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-circle w-6 h-6 text-[#25D366]" aria-hidden="true">
                            <path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719"></path>
                        </svg></div>
                    <h3 class="font-semibold text-[var(--text-primary)] mb-2">WhatsApp</h3>
                    <p class="text-sm text-[var(--text-secondary)] mb-3">Discutez directement avec nous</p><a href="https://wa.me/212632582096?text=Hi%20CodeSommet!%20I'm%20interested%20in%20discussing%20a%20project%20with%20you." target="_blank" rel="noopener noreferrer" class="text-[#25D366] font-medium hover:text-[#20BA5A] transition-colors inline-flex items-center gap-2 group text-sm">Démarrer le Chat<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4 group-hover:translate-x-1 transition-transform" aria-hidden="true">
                            <path d="M5 12h14"></path>
                            <path d="m12 5 7 7-7 7"></path>
                        </svg></a>
                </div>
                <div class="bg-gradient-to-br from-[#00AEEF]/10 to-[#0071BC]/5 rounded-2xl p-6 border border-[#00AEEF]/20">
                    <div class="w-12 h-12 rounded-xl bg-white flex items-center justify-center mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock w-6 h-6 text-[#00AEEF]" aria-hidden="true">
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12" style="opacity:0;transform:translateY(30px)">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-globe w-4 h-4 mr-2" aria-hidden="true">
                        ...
                        <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                        <path d="M2 12h20"></path>
                    </svg>Notre Emplacement</div>
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Où Nous Trouver</h2>
                    ...
                    <div class="relative z-20 p-5 md:p-6 flex flex-col h-full justify-end text-white">
                        <div>
                            <div class="flex items-start gap-3 mb-4"><span class="text-3xl pt-0.5" role="img" aria-label="Drapeau du Maroc">&#x1F1F2;&#x1F1E6;</span>
                                <div>
                                    <h3 class="text-lg md:text-xl font-semibold mb-1.5 text-white drop-shadow-lg">Siège Maroc</h3>
                                    <address class="not-italic text-gray-200 text-xs md:text-sm leading-snug"><span class="block">Maroc</span><span class="block">Siège Social</span></address>
                                </div>
                            </div>
                            <div class="mt-4 pt-4 border-t border-white/20 space-y-2"><a href="mailto:codesommet@gmail.com" class="flex items-center gap-2 text-xs text-gray-300 hover:text-white transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail">
                                        <path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path>
                                        <rect x="2" y="4" width="20" height="16" rx="2"></rect>
                                    </svg>codesommet@gmail.com</a><a href="tel:+212632582096" class="flex items-center gap-2 text-xs text-gray-300 hover:text-white transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone">
                                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"></path>
                                    </svg>+212 6 32 58 20 96</a><a href="https://wa.me/212632582096" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-xs text-gray-300 hover:text-white transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-circle">
                                        <path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719"></path>
                                    </svg>WhatsApp</a></div>
                        </div>
                    </div>
                </div>
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 flex flex-col justify-center items-center text-center">
                    <div class="w-16 h-16 rounded-2xl bg-[#00AEEF]/10 flex items-center justify-center mx-auto mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail w-8 h-8 text-[#00AEEF]">
                            <path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path>
                            <rect x="2" y="4" width="20" height="16" rx="2"></rect>
                        </svg></div>
                    <h3 class="font-semibold text-lg text-[var(--text-primary)] mb-2">Contactez-Nous</h3>
                    <p class="text-sm text-[var(--text-secondary)] mb-4">Nous serions ravis d'en savoir plus sur votre projet. Contactez-nous et laissez-nous vous aider à construire quelque chose de formidable.</p><a href="mailto:codesommet@gmail.com" class="text-[#00AEEF] font-medium hover:text-[#0071BC] transition-colors text-sm">codesommet@gmail.com</a><a href="tel:+212632582096" class="block mt-2 text-[var(--text-secondary)] text-sm">+212 6 32 58 20 96</a>
                </div>
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 flex flex-col justify-center items-center text-center">
                    <div class="w-16 h-16 rounded-2xl bg-[#25D366]/10 flex items-center justify-center mx-auto mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-circle w-8 h-8 text-[#25D366]">
                            <path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719"></path>
                        </svg></div>
                    <h3 class="font-semibold text-lg text-[var(--text-primary)] mb-2">Discutez sur WhatsApp</h3>
                    <p class="text-sm text-[var(--text-secondary)] mb-4">Des questions rapides ? Vous préférez discuter ? Envoyez-nous un message directement sur WhatsApp pour une réponse rapide.</p><a href="https://wa.me/212632582096?text=Hi%20CodeSommet!%20I'm%20interested%20in%20discussing%20a%20project." target="_blank" rel="noopener noreferrer" class="text-[#25D366] font-medium hover:text-[#20BA5A] transition-colors text-sm inline-flex items-center gap-2">Démarrer le Chat WhatsApp<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right">
                            <path d="M5 12h14"></path>
                            <path d="m12 5 7 7-7 7"></path>
                        </svg></a>
                </div>
            ...
            <div class="max-w-3xl mx-auto">
                <div class="bg-white rounded-2xl p-6 sm:p-8 md:p-12 shadow-xl border border-gray-100">
                    <div class="mb-6 sm:mb-8">
                        <h2 class="text-xl sm:text-2xl md:text-3xl font-bold text-[var(--text-primary)] mb-2 sm:mb-3">Contactez-Nous</h2>
                        <p class="text-sm sm:text-base text-[var(--text-secondary)]">Remplissez le formulaire ci-dessous et nous vous répondrons sous 24 heures</p>
                    </div>
                    <form class="space-y-4 sm:space-y-6">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4 sm:gap-6">
                            <div><label for="company" class="block text-sm font-medium text-[var(--text-primary)] mb-2">Nom de l'Entreprise</label><input type="text" id="company" class="w-full px-4 py-3 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#00AEEF]/40 focus:border-[#00AEEF] transition-colors" style="border-radius:10px" placeholder="Votre Entreprise" name="company" value="" /></div>
                            <div><label for="budget" class="block text-sm font-medium text-[var(--text-primary)] mb-2">Taille du Projet (Optionnel)</label><select id="budget" name="budget" class="w-full px-4 py-3 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#00AEEF]/40 focus:border-[#00AEEF] transition-colors bg-white" style="border-radius:10px">
                                    <option value="" selected="">Sélectionner la taille du projet</option>
                                    <option value="small">Petit Projet</option>
                                    <option value="medium">Projet Moyen</option>
                                    <option value="large">Grand Projet</option>
                                    <option value="enterprise">Entreprise</option>
                                    <option value="not-sure">Pas encore sûr</option>
                                </select></div>
                        </div>
                        <div><label for="inquiryType" class="block text-sm font-medium text-[var(--text-primary)] mb-2">Comment pouvons-nous vous aider ? <span class="text-[#00AEEF]">*</span></label><select id="inquiryType" name="inquiryType" class="w-full px-4 py-3 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#00AEEF]/40 focus:border-[#00AEEF] transition-colors bg-white" style="border-radius:10px">
                                <option value="" selected="">Sélectionner le type de demande</option>
                                <option value="new-project">Demande de Nouveau Projet</option>
                                <option value="ai-features">Fonctionnalités IA &amp; Chatbots</option>
                                <option value="dashboard-saas">Développement de Tableau de Bord &amp; SaaS</option>
                                <option value="website">Développement de Site Web</option>
                                <option value="partnership">Opportunité de Partenariat</option>
                                <option value="general">Demande Générale</option>
                                <option value="support">Support &amp; Maintenance</option>
                                <option value="other">Autre</option>
                            </select></div>
                        <div><label for="message" class="block text-sm font-medium text-[var(--text-primary)] mb-2">Votre Message <span class="text-[#00AEEF]">*</span></label><textarea id="message" name="message" rows="5" class="w-full px-4 py-3 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#00AEEF]/40 focus:border-[#00AEEF] transition-colors resize-none" style="border-radius:10px" placeholder="Dites-nous en plus sur votre demande, vos objectifs, votre calendrier ou toute question spécifique..."></textarea>
                            <p class="mt-1 text-xs text-[var(--text-secondary)]">Minimum 20 caractères</p>
                        </div><button type="submit" class="w-full group relative inline-flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 rounded-full overflow-hidden transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed" style="background-color:#00AEEF;box-shadow:0 4px 20px rgba(0, 174, 239, 0.25)"><span class="text-white font-medium text-sm sm:text-base">Envoyer le Message</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-send w-4 sm:w-5 h-4 sm:h-5 text-white group-hover:translate-x-1 transition-transform" aria-hidden="true">
                                <path d="M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"></path>
                                <path d="m21.854 2.147-10.94 10.939"></path>
                            </svg></button>
                        <p class="text-xs sm:text-sm text-center text-[var(--text-secondary)]">En soumettant ce formulaire, vous acceptez notre<!-- --> <a href="{{ route('privacy-policy') }}" class="text-[#00AEEF] hover:text-[#0071BC] underline">Politique de Confidentialité</a></p>
                    </form>
                </div>
            </div>
        </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-12" style="opacity:0;transform:translateY(30px)">
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Que Se Passe-t-il Ensuite ?</h2>
                    <p class="font-body leading-relaxed font-normal text-[var(--text-secondary)]">Voici ce à quoi vous pouvez vous attendre lorsque vous nous contactez</p>
                </div>
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="text-center" style="opacity:0;transform:translateY(30px)" data-delay="1">
                        <div class="w-16 h-16 rounded-2xl bg-[#00AEEF]/10 flex items-center justify-center mx-auto mb-4"><span class="text-2xl font-bold text-[#00AEEF]">1</span></div>
                        <h3 class="font-semibold text-lg mb-2">Réponse Rapide</h3>
                        <p class="text-sm text-[var(--text-secondary)]">Nous vous répondrons sous 24 heures pour comprendre les besoins et objectifs de votre projet</p>
                    </div>
                    <div class="text-center" style="opacity:0;transform:translateY(30px)" data-delay="2">
                        <div class="w-16 h-16 rounded-2xl bg-[#00AEEF]/10 flex items-center justify-center mx-auto mb-4"><span class="text-2xl font-bold text-[#00AEEF]">2</span></div>
                        <h3 class="font-semibold text-lg mb-2">Appel Stratégique</h3>
                        <p class="text-sm text-[var(--text-secondary)]">Planifiez une consultation gratuite pour discuter de votre vision, calendrier et budget</p>
                    </div>
                    <div class="text-center" style="opacity:0;transform:translateY(30px)" data-delay="3">
                        <div class="w-16 h-16 rounded-2xl bg-[#00AEEF]/10 flex items-center justify-center mx-auto mb-4"><span class="text-2xl font-bold text-[#00AEEF]">3</span></div>
                        <h3 class="font-semibold text-lg mb-2">Proposition Personnalisée</h3>
                        <p class="text-sm text-[var(--text-secondary)]">Recevez une proposition détaillée avec calendrier, livrables et tarification personnalisée adaptée à la portée de votre projet</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="relative overflow-hidden rounded-[24px] md:rounded-[32px] px-6 py-6 md:py-8" style="background:linear-gradient(135deg, #1a1a1a 0%, #0a0a0a 100%)">
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px">
                    ...
                    <p class="text-sm md:text-base text-white/50">Discutons de la façon dont l'IA et le design moderne peuvent propulser votre entreprise</p>
                    <div class="mt-6">
