                    ...
                    <div
                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-[#00AEEF] flex-shrink-0"></div><span
                                class="font-semibold text-[#0F0F0F] whitespace-nowrap">{{ __('services/elearning-platform-development-agency.text_4') }}
                                <span class="count-up" data-target="25">0</span>
                                {{ __('services/elearning-platform-development-agency.text_5') }}</span>
                        </div>
                        <div class="hidden sm:block w-px h-4 bg-[#0F0F0F]/20"></div>
                        <div class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-[#00AEEF] flex-shrink-0"></div><span
                                class="font-semibold text-[#0F0F0F] whitespace-nowrap">{{ __('services/elearning-platform-development-agency.text_6') }}
                                <span class="count-up" data-target="250">0</span>% Complétion</span>
                        </div>
                        <div class="hidden sm:block w-px h-4 bg-[#0F0F0F]/20"></div>
                        <div class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-[#00AEEF] flex-shrink-0"></div><span
                                class="font-semibold text-[#0F0F0F] whitespace-nowrap">{{ __('services/elearning-platform-development-agency.text_7') }}
                                <span class="count-up" data-target="40">0</span> Clients</span>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">Plus de 25 plateformes
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">Propre plateforme (0%)</span></div>
                                <div class="p-3 md:p-4 text-center"><span
