                ...
                <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                        ...
                        <div class="flex justify-center">
                            <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full">
                                <div class="relative">
                                    ...
                                    <!-- -->{{ __('services/fintech-platform-development-agency.text_176') }}<!-- -->
                                    ...
                                    Services Financiers<!-- -->,
                                    <!-- -->{{ __('services/fintech-platform-development-agency.text_0') }}</span>
                            </div>
                        </div>
                        <div class="space-y-6">
                            <h1 class="leading-[1.15] tracking-tight uppercase text-[28px] sm:text-[40px] lg:text-[56px] font-extrabold max-w-5xl mx-auto"
                                ...
                                {{ __('services/fintech-platform-development-agency.text_1') }}<!-- -->
                                <span class="jsx-5c81c8c63985dc3f inline-block relative text-black"><span
                                        ...
                                        class="jsx-5c81c8c63985dc3f relative inline-flex items-center justify-center px-3 py-3"><span
                                            ...
                                            class="jsx-5c81c8c63985dc3f inline-block opacity-0 pointer-events-none">PASSERELLES
                                            DE PAIEMENT</span><span
                                            class="jsx-5c81c8c63985dc3f absolute inset-0 inline-flex items-center justify-center animate-[textFadeIn_0.3s_ease-in-out,textReveal_1.2s_cubic-bezier(0.22,1,0.36,1)]">PASSERELLES
                            ...
                            <p
                                ...
                                {{ __('services/fintech-platform-development-agency.ml_913') }}</p>
                        </div>
                    ...
                    rgba(0, 0, 0, 0.02) 0px 150px 150px -3.75px"
                                href="https://cal.com/pikasso/discovery"><span
                                    class="relative text-[15px] font-semibold text-white z-10">{{ __('services/fintech-platform-development-agency.ml_914') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">{{ __('services/fintech-platform-development-agency.text_2') }}
                                    <!-- -->FinTech et Services
                                    Financiers</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">{{ __('services/fintech-platform-development-agency.text_177') }}</span>
                            </div>
                            <div class="w-px h-4 bg-[#0F0F0F]/20"></div>
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                            ...
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">
                                        {{ __('services/fintech-platform-development-agency.ml_916') }}</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('services/fintech-platform-development-agency.ml_917') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Parcours de Paiement
                                        Complet</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('services/fintech-platform-development-agency.ml_918') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Optimisation des
                                        Transactions</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('services/fintech-platform-development-agency.ml_919') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Multi-Devises et
                                        Transfrontalier</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('services/fintech-platform-development-agency.ml_920') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">
                                        {{ __('services/fintech-platform-development-agency.ml_921') }}</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('services/fintech-platform-development-agency.ml_922') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center">
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-8"
                        ...
                        {{ __('services/fintech-platform-development-agency.text_3') }} <!-- -->FinTech et Services
                    ...
                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 max-w-xl mx-auto px-4">Résultats réels de
                        <!-- -->{{ __('services/fintech-platform-development-agency.text_181') }}<!-- -->{{ __('services/fintech-platform-development-agency.ml_923') }}
                    </p>
                </div>
            </div>
        </section>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>{{ __('services/fintech-platform-development-agency.ml_924') }}
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/fintech-platform-development-agency.text_8') }}<!-- -->: <!-- -->FinTech et
                        Services
                    ...
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/fintech-platform-development-agency.text_10') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/fintech-platform-development-agency.ml_926') }}</p>
                        </div>
                    </div>
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/fintech-platform-development-agency.text_11') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/fintech-platform-development-agency.ml_927') }}</p>
                        </div>
                    </div>
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/fintech-platform-development-agency.text_12') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/fintech-platform-development-agency.ml_928') }}</p>
                        </div>
                    </div>
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/fintech-platform-development-agency.text_13') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/fintech-platform-development-agency.ml_929') }}</p>
                        </div>
                    </div>
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/fintech-platform-development-agency.text_14') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/fintech-platform-development-agency.ml_930') }}</p>
                        </div>
                    </div>
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/fintech-platform-development-agency.text_15') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/fintech-platform-development-agency.ml_931') }}</p>
                        </div>
                    </div>
                </div>
                <div class="text-center mt-10 md:mt-12">
                    ...
                    <a class="h-10 px-6 text-base rounded-full inline-flex items-center justify-center font-medium transition-all duration-200 bg-gradient-to-r from-[var(--color-primary-orange)] to-[var(--color-orange-hover)] text-white hover:text-white shadow-[0_4px_16px_rgba(0,174,239,0.25)] hover:shadow-[0_6px_24px_rgba(0,174,239,0.35)] hover:-translate-y-0.5 [&amp;&gt;*]:text-white [&amp;&gt;*]:hover:text-white h-11 md:h-12 px-6 md:px-8 text-sm md:text-base"
                        style="color:white"
                        href="https://cal.com/pikasso/discovery">{{ __('services/fintech-platform-development-agency.text_16') }}</a>
                </div>
            </div>
        </section>
                ...
                <div class="text-center mb-16">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <path d="M22 4h-4"></path>
                            <circle cx="4" cy="20" r="2"></circle>
                        </svg>{{ __('services/fintech-platform-development-agency.text_17') }} <!-- -->FinTech et Services
                        Financiers
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                                ...
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/fintech-platform-development-agency.text_183') }}</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">
                                            {{ __('services/fintech-platform-development-agency.ml_932') }}</p>
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.text_19') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Tokenisation de carte et
                                                    coffre-fort</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Authentification 3D Secure
                                                    2.0</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_933') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div
                            ...
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/fintech-platform-development-agency.text_184') }}</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">
                                            {{ __('services/fintech-platform-development-agency.ml_934') }}</p>
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Flux de prix en direct et
                                                    graphiques</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Carnet d'ordres et visualisation
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Suivi de portefeuille et
                                                    P&L</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Outils de gestion des
                                                    risques</span></li>
                                        </ul>
                                    </div>
                                    <div
                            ...
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/fintech-platform-development-agency.text_20') }}</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">
                                            {{ __('services/fintech-platform-development-agency.ml_935') }}</p>
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">OCR de documents et
                                                    validation</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_936') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.text_21') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_937') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div
                                        ...
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                <path d="M22 4h-4"></path>
                                                <circle cx="4" cy="20" r="2"></circle>
                                            </svg>{{ __('services/fintech-platform-development-agency.ml_938') }}
                                        </div><img src="{{ asset('images/finance/finance-kyc-verification.webp') }}"
                                            alt="{{ __('services/fintech-platform-development-agency.attr_1522') }}"
                                            class="absolute inset-0 w-full h-full object-contain" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/fintech-platform-development-agency.text_22') }}</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">
                                            {{ __('services/fintech-platform-development-agency.ml_939') }}</p>
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Analyses de volume de
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_940') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_941') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.text_185') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div
                                        ...
                                        <img src="{{ asset('images/finance/finance-analytics-dashboard.webp') }}"
                                            alt="{{ __('services/fintech-platform-development-agency.attr_1523') }}"
                                            class="absolute inset-0 w-full h-full object-contain" />
                                    </div>
                                </div>
                            </div>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>{{ __('services/fintech-platform-development-agency.text_23') }} <!-- -->FinTech et Services
                        Financiers
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/fintech-platform-development-agency.text_24') }} <!-- -->FinTech et Services
                        Financiers</h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Projets réels, résultats réels. Découvrez
                        ...
                        <!-- -->{{ __('services/fintech-platform-development-agency.text_186') }}<!-- -->{{ __('services/fintech-platform-development-agency.ml_942') }}
                    </p>
                </div>
                    ...
                    <div><a class="block" href="{{ route('case-study', 'glamworlds') }}">
                            <div
                                ...
                                <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video
                                        src="{{ asset('images/our-work/glamworlds/glamworlds-hero.mp4') }}"
                                    ...
                                    <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span
                                            ...
                                            </svg>{{ __('services/fintech-platform-development-agency.text_25') }}</span>
                                    </div>
                                </div>
                                <div class="px-5 py-4">
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/fintech-platform-development-agency.text_26') }}<!-- --> for
                        <!-- -->FinTech et Services Financiers
                    </h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">
                        {{ __('services/fintech-platform-development-agency.ml_943') }}</p>
                </div>
                <div class="relative">
                                ...
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/fintech-platform-development-agency.ml_944') }}</h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_945') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_946') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/fintech-platform-development-agency.ml_947') }}</h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_948') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/fintech-platform-development-agency.text_27') }}</h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_949') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_950') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_951') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/fintech-platform-development-agency.text_28') }}</h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_952') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/fintech-platform-development-agency.ml_953') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <div class="text-center mt-12 md:mt-16 pt-8 md:pt-12 border-t border-[#0F0F0F]/8">
                    <p class="text-lg md:text-xl font-semibold text-[#0F0F0F] mb-5 md:mb-6 max-w-2xl mx-auto px-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/fintech-platform-development-agency.text_29') }} <!-- -->fintech et services
                        financiers<!-- --> {{ __('services/fintech-platform-development-agency.text_191') }}</p><a
                        ...
                        style="color:white"
                        href="https://cal.com/pikasso/discovery">{{ __('services/fintech-platform-development-agency.ml_954') }}</a>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-12 md:mb-16">
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-black mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/fintech-platform-development-agency.text_30') }}</h2>
                    <p class="text-lg md:text-xl text-black/70 max-w-3xl mx-auto">
                        {{ __('services/fintech-platform-development-agency.ml_955') }}</p>
                </div>
                    ...
                    <div class="relative bg-black rounded-[32px] p-3 text-white">
                        <div class="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
                            <div
                                ...
                                </svg>{{ __('services/fintech-platform-development-agency.ml_956') }}
                            </div>
                        </div>
                        <div class="relative rounded-[20px] p-6 md:p-8 mb-3 bg-[#1a1a1a] border border-transparent">
                            <div class="flex items-start justify-between mb-6">
                                <div class="flex items-center gap-3">
                                    ...
                                    <h3 class="text-3xl md:text-4xl font-bold text-white">
                                        {{ __('services/fintech-platform-development-agency.text_31') }}</h3>
                                </div>
                            </div>
                            <div class="mb-6 p-4 rounded-2xl bg-white/5">
                                <p class="text-white/70">{{ __('services/fintech-platform-development-agency.ml_957') }}
                                </p>
                            </div>
                            <div class="divide-y divide-white/10">
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="text-white/80">{{ __('services/fintech-platform-development-agency.ml_958') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('services/fintech-platform-development-agency.ml_959') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="text-white/80">{{ __('services/fintech-platform-development-agency.text_32') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('services/fintech-platform-development-agency.text_33') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('services/fintech-platform-development-agency.text_34') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('services/fintech-platform-development-agency.text_35') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('services/fintech-platform-development-agency.text_192') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-green-400 font-medium">{{ __('services/fintech-platform-development-agency.ml_960') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="px-6 md:px-8 pb-3">
                            <div class="mb-6">
                                <div class="flex flex-col"><span
                                        class="text-lg md:text-xl font-medium text-white/70 mb-1">{{ __('services/fintech-platform-development-agency.text_36') }}</span>
                                    <div class="flex items-end gap-2"><span
                                            class="text-5xl md:text-6xl font-bold">{{ __('services/fintech-platform-development-agency.text_37') }}</span><span
                                            class="text-white/50 text-xl mb-2"></span></div>
                                    <p class="text-white/60 text-sm mt-2">
                                        {{ __('services/fintech-platform-development-agency.ml_961') }}</p>
                                </div>
                            </div>
                            <div class="flex flex-col sm:flex-row gap-3"><a
                                    ...
                                    href="{{ route('get-quote') }}">{{ __('services/fintech-platform-development-agency.text_38') }}</a><a
                        ...
                        <div
                            ...
                            <div class="flex items-start justify-between gap-4 mb-6">
                                <div class="flex items-center gap-3 flex-shrink-0">
                                    ...
                                    <h3 class="text-3xl md:text-4xl font-bold text-black">
                                        {{ __('services/fintech-platform-development-agency.text_501') }}</h3>
                                </div><button
                                    ...
                                    <div class="relative rounded-full transition-all duration-400 ease-out w-11 h-7 bg-black/20"
                                        ...
                                        class="text-sm whitespace-nowrap overflow-hidden transition-all duration-400 ease-out opacity-100 w-auto">{{ __('services/fintech-platform-development-agency.ml_962') }}</span>
                                </button>
                            </div>
                            <div class="mb-6 p-4 rounded-2xl bg-black/5 flex items-center gap-3"><svg
                                ...
                                <p class="text-black/70 transition-all duration-300">
                                    {{ __('services/fintech-platform-development-agency.ml_963') }}</p>
                            </div>
                            <div class="divide-y divide-black/10">
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="text-black/80">{{ __('services/fintech-platform-development-agency.text_39') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/fintech-platform-development-agency.ml_964') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/fintech-platform-development-agency.text_40') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/fintech-platform-development-agency.text_41') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/fintech-platform-development-agency.text_42') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/fintech-platform-development-agency.text_43') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/fintech-platform-development-agency.text_44') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/fintech-platform-development-agency.text_45') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/fintech-platform-development-agency.text_46') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="px-6 md:px-8 pb-3">
                            <div class="mb-6">
                                <div class="flex flex-col"><span
                                        class="text-lg md:text-xl font-medium text-black/60 mb-1">{{ __('services/fintech-platform-development-agency.text_47') }}</span>
                                    <div class="flex items-end gap-2">
                                        <div class="relative overflow-hidden" style="height:fit-content"><span
                                            ...
                                            class="text-black/50 text-xl mb-2">{{ __('services/fintech-platform-development-agency.text_193') }}</span>
                                    </div>
                                    <p class="text-black/60 text-sm mt-2">
                                        {{ __('services/fintech-platform-development-agency.text_48') }}</p>
                                </div>
                            </div>
                            <div class="flex flex-col sm:flex-row gap-3"><button data-cal-link="pikasso/discovery"
                                    data-cal-config="{"layout":"month_view","useSlotsViewOnSmallScreen":"true"}"
                                    class="flex-1 px-4 py-3.5 rounded-full bg-black text-white text-sm font-semibold hover:bg-black/90 transition-colors text-center leading-tight">{{ __('services/fintech-platform-development-agency.ml_965') }}</button><a
                                    href="https://wa.me/212632582096?text=Hi%20CodeSommetStudio!%20I'm%20interested%20in%20learning%20more%20about%20your%20web%20development%20services."
                                    target="_blank" rel="noopener noreferrer"
                ...
                <div class="max-w-4xl mx-auto">
                    <div
                        ...
                        <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[var(--text-primary)]"
                            style="font-family:var(--font-heading)">
                            {{ __('services/fintech-platform-development-agency.ml_966') }}</h2>
                        <p class="text-base md:text-lg text-[var(--text-secondary)] mb-6 max-w-2xl mx-auto">
                            {{ __('services/fintech-platform-development-agency.ml_967') }}</p>
                        <div class="flex flex-wrap gap-3 justify-center mb-4">
                            ...
                            <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                                ...
                                <span>{{ __('services/fintech-platform-development-agency.ml_968') }}</span>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                                <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div>
                                <span>{{ __('services/fintech-platform-development-agency.text_49') }}</span>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                                <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div>
                                <span>{{ __('services/fintech-platform-development-agency.ml_969') }}</span>
                            </div>
                        </div><a
                        ...
                        <p class="text-xs text-[var(--text-secondary)] mt-4">
                            {{ __('services/fintech-platform-development-agency.ml_970') }}</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">CodeSommetStudio <!-- -->FinTech et Services
                        Financiers<!-- --> {{ __('services/fintech-platform-development-agency.text_50') }}</h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">
                        {{ __('services/fintech-platform-development-agency.text_51') }} <!-- -->FinTech et Services
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-4 bg-[#F8F8F8] border-b border-[#0F0F0F]/10">
                                <div class="p-3 md:p-4 font-semibold text-[#0F0F0F]/60 text-xs md:text-sm">
                                    {{ __('services/fintech-platform-development-agency.ml_972') }}</div>
                                ...
                                <div class="p-3 md:p-4 text-center font-semibold text-[#0F0F0F]/60 text-xs md:text-sm">
                                    Other
                                    <!-- -->{{ __('services/fintech-platform-development-agency.text_195') }}<!-- -->
                                    Agences
                                </div>
                                <div class="p-3 md:p-4 text-center font-semibold text-[#0F0F0F]/60 text-xs md:text-sm">
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/fintech-platform-development-agency.ml_973') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">{{ __('services/fintech-platform-development-agency.text_52') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/fintech-platform-development-agency.ml_974') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/fintech-platform-development-agency.ml_975') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/fintech-platform-development-agency.ml_976') }}</div>
                                ...
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/fintech-platform-development-agency.ml_977') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/fintech-platform-development-agency.ml_978') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/fintech-platform-development-agency.ml_979') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">{{ __('services/fintech-platform-development-agency.text_53') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/fintech-platform-development-agency.ml_980') }}</span>
                                </div>
                            ...
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/fintech-platform-development-agency.ml_981') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">{{ __('services/fintech-platform-development-agency.text_54') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/fintech-platform-development-agency.ml_982') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                            ...
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/fintech-platform-development-agency.ml_983') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                ...
                                <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Manuel
                                        uniquement</span></div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/fintech-platform-development-agency.ml_984') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/fintech-platform-development-agency.text_55') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">{{ __('services/fintech-platform-development-agency.text_56') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/fintech-platform-development-agency.ml_985') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/fintech-platform-development-agency.ml_986') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            ...
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/fintech-platform-development-agency.ml_988') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">AML, PCI-DSS, RGPD</span></div>
                    ...
                    <div class="mt-8 text-center">
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <circle cx="12" cy="12" r="10"></circle>
                                <path d="m9 12 2 2 4-4"></path>
                            </svg>{{ __('services/fintech-platform-development-agency.text_57') }}
                            <!-- -->{{ __('services/fintech-platform-development-agency.text_197') }}<!-- -->
                            Entreprises
                        </div>
                    </div>
                </div>
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/fintech-platform-development-agency.text_58') }}</h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Ne nous croyez pas sur parole. Écoutez les
                        entreprises en
                        <!-- -->{{ __('services/fintech-platform-development-agency.text_198') }}<!-- -->{{ __('services/fintech-platform-development-agency.ml_989') }}
                    </p>
                </div>
                        ...
                        <div class="testimonial-slide grid grid-cols-1 lg:grid-cols-2 gap-8" data-slide="0">
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('services/fintech-platform-development-agency.qb_2123') }}</blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('services/fintech-platform-development-agency.text_59') }}</div>
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('services/fintech-platform-development-agency.qb_2124') }}</blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('services/fintech-platform-development-agency.ml_990') }}</div>
                                            <div class="flex items-center gap-1.5 text-xs text-[#0F0F0F]/50"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <circle cx="12" cy="10" r="3"></circle>
                                                </svg><span>{{ __('services/fintech-platform-development-agency.text_60') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div
                        ...
                        <div class="testimonial-slide grid grid-cols-1 lg:grid-cols-2 gap-8" data-slide="1"
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('services/fintech-platform-development-agency.qb_2125') }}</blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('services/fintech-platform-development-agency.text_61') }}</div>
                                            <div class="flex items-center gap-1.5 text-xs text-[#0F0F0F]/50"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('services/fintech-platform-development-agency.qb_2126') }}</blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('services/fintech-platform-development-agency.ml_991') }}</div>
                                            <div class="flex items-center gap-1.5 text-xs text-[#0F0F0F]/50"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mt-10 text-center">
                    <p class="text-sm text-[#0F0F0F]/60">
                        {{ __('services/fintech-platform-development-agency.text_62') }}<!-- --> <a
                            href="{{ route('our-work') }}"
                            class="text-[#00AEEF] font-semibold hover:underline">{{ __('services/fintech-platform-development-agency.ml_992') }}</a>
                    </p>
                </div>
            </div>
        </section>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>{{ __('services/fintech-platform-development-agency.ml_993') }}
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/fintech-platform-development-agency.sw_2926') }}</h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Vous avez des questions ? Nous avons les
                        ...
                        <!-- -->{{ __('services/fintech-platform-development-agency.text_199') }}<!-- -->
                        entreprises.
                    </p>
                </div>
                <div class="max-w-4xl mx-auto bg-white rounded-2xl border border-[#0F0F0F]/10 p-6">
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">
                                    {{ __('services/fintech-platform-development-agency.ml_994') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">
                                    {{ __('services/fintech-platform-development-agency.ml_995') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">
                                    {{ __('services/fintech-platform-development-agency.ml_996') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">
                                    {{ __('services/fintech-platform-development-agency.ml_997') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">
                                    {{ __('services/fintech-platform-development-agency.ml_998') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mt-10 text-center">
                    <p class="text-sm text-[#0F0F0F]/60 mb-2">
                        {{ __('services/fintech-platform-development-agency.text_63') }}</p><a
                        href="{{ route('contact') }}"
                        class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2">Contactez
                        notre <!-- -->{{ __('services/fintech-platform-development-agency.text_200') }}<!-- --> team<svg
                ...
                <div class="text-center mb-12">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                            <path d="M2 12h20"></path>
                        </svg>{{ __('services/fintech-platform-development-agency.ml_999') }}
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/fintech-platform-development-agency.text_64') }}</h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            {{ __('services/fintech-platform-development-agency.ml_1001') }}</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/fintech-platform-development-agency.text_502') }}</span><span
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            Casablanca</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/fintech-platform-development-agency.text_503') }}</span><span
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            San Francisco</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/fintech-platform-development-agency.text_504') }}</span><span
                                                class="truncate">{{ __('services/fintech-platform-development-agency.text_65') }}</span>
                                        </p>
                                    </div>
                                </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            Londres</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/fintech-platform-development-agency.text_505') }}</span><span
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            Paris</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/fintech-platform-development-agency.text_506') }}</span><span
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            Marrakech</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/fintech-platform-development-agency.text_507') }}</span><span
                                                class="truncate">Maroc</span>
                                        </p>
                                    </div>
                                </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="text-center pt-5 md:pt-6 border-t border-[#0F0F0F]/8">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-3 md:gap-4 px-4"><a
                            ...
                            href="/#locations"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <circle cx="12" cy="10" r="3"></circle>
                            </svg>{{ __('services/fintech-platform-development-agency.text_67') }}<svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            class="inline-flex items-center gap-2 text-[#00AEEF] font-semibold hover:underline"
                            href="{{ route('contact') }}">{{ __('services/fintech-platform-development-agency.text_68') }}<svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4" aria-hidden="true">
                                <path d="M5 12h14"></path>
            ...
            <div class="max-w-7xl mx-auto px-4 md:px-6">
                <div class="text-center mb-8 md:mb-10">
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-semibold text-[#0F0F0F] mb-3 px-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/fintech-platform-development-agency.text_69') }}</h2>
                            ...
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3
                                        ...
                                        {{ __('services/fintech-platform-development-agency.ml_1003') }}</h3>
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/fintech-platform-development-agency.ml_1004') }}</p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex items-start justify-between gap-2">
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3
                                        class="text-base md:text-lg font-semibold text-[#0F0F0F] group-hover:text-[#00AEEF] transition-colors truncate">
                                        {{ __('services/fintech-platform-development-agency.ml_1005') }}</h3>
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/fintech-platform-development-agency.ml_1006') }}</p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex items-start justify-between gap-2">
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3
                                        class="text-base md:text-lg font-semibold text-[#0F0F0F] group-hover:text-[#00AEEF] transition-colors truncate">
                                        {{ __('services/fintech-platform-development-agency.ml_1007') }}</h3>
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/fintech-platform-development-agency.ml_1008') }}</p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex items-start justify-between gap-2">
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3
                                        class="text-base md:text-lg font-semibold text-[#0F0F0F] group-hover:text-[#00AEEF] transition-colors truncate">
                                        {{ __('services/fintech-platform-development-agency.ml_1009') }}</h3>
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/fintech-platform-development-agency.ml_1010') }}</p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3
                                        ...
                                        Plateformes SaaS</h3>
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/fintech-platform-development-agency.ml_1011') }}</p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="text-center mt-8 md:mt-10"><a
                        class="inline-flex items-center gap-2 text-[#00AEEF] font-semibold hover:underline"
                        href="/#industries">{{ __('services/fintech-platform-development-agency.text_70') }}<svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4" aria-hidden="true">
                            <path d="M5 12h14"></path>
            ...
            <div class="max-w-7xl mx-auto px-4 md:px-6">
                <div class="text-center mb-10">
                    <h2 class="text-3xl md:text-4xl font-semibold text-[var(--text-primary)] mb-3"
                        style="font-family:var(--font-heading)">
                        {{ __('services/fintech-platform-development-agency.text_71') }}</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6"><a
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">
                                {{ __('services/fintech-platform-development-agency.ml_1013') }}</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#00AEEF">{{ __('services/fintech-platform-development-agency.text_72') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <h3
                                class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">
                                {{ __('services/fintech-platform-development-agency.ml_1014') }}</h3>
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">
                                {{ __('services/fintech-platform-development-agency.ml_1015') }}</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#00AEEF">{{ __('services/fintech-platform-development-agency.text_73') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <h3
                                class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">
                                {{ __('services/fintech-platform-development-agency.ml_1016') }}</h3>
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">
                                {{ __('services/fintech-platform-development-agency.ml_1017') }}</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#8B5CF6">{{ __('services/fintech-platform-development-agency.text_74') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#10B981">{{ __('services/fintech-platform-development-agency.text_75') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <h3
                                class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">
                                {{ __('services/fintech-platform-development-agency.ml_1018') }}</h3>
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">Explorez tous nos services et
                                offres</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#3B82F6">{{ __('services/fintech-platform-development-agency.text_76') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
            ...
            <div class="max-w-7xl mx-auto">
                ...
                rgba(10, 10, 10, 0.95) 100%
                    ...
                    <div class="relative z-10 text-center space-y-3 md:space-y-4">
                        <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white px-4 pb-6 md:pb-8"
                            style="font-family:var(--font-display)">
                            {{ __('services/fintech-platform-development-agency.ml_1019') }}</h2>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px"
                                    ...
                                    <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('services/fintech-platform-development-agency.ml_1020') }}</span>
                                </a><a
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px">
                                    ...
                                    <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black"
                                        style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('services/fintech-platform-development-agency.ml_1021') }}</span>
                                </button><a
                                ...
                                <div class="absolute pointer-events-none animate-cursor-stops" style="left:50%;top:50%">
                                    ...
                                    <div class="absolute left-0 top-0 -translate-x-1/2 px-3 py-1 rounded-full border border-white/80 bg-black/90"
                                        style="font-size:10px"><span
                                            class="text-white font-medium whitespace-nowrap">{{ __('services/fintech-platform-development-agency.text_201') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/40">{{ __('services/fintech-platform-development-agency.text_508') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/40">{{ __('services/fintech-platform-development-agency.text_509') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/40">{{ __('services/fintech-platform-development-agency.text_510') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/90">{{ __('services/fintech-platform-development-agency.text_511') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/90">{{ __('services/fintech-platform-development-agency.text_512') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/90">{{ __('services/fintech-platform-development-agency.text_513') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
