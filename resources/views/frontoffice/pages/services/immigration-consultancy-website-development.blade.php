                ...
                <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                    <div class="space-y-6 lg:space-y-8 text-center">
                        <nav class="flex items-center justify-center gap-2 text-xs text-gray-400" aria-label="Breadcrumb"><a
                                ...
                                href="/#industries">Industries</a><span>/</span><span class="text-gray-600">Conseil en
                        ...
                        <div class="flex justify-center">
                            <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full">
                                <div class="relative">
                                    ...
                                    <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_166') }}<!-- -->
                                    ...
                                    class="text-xs sm:text-sm text-[#0F0F0F]/70">{{ __('services/immigration-consultancy-website-development-agency.text_493') }}<!-- -->
                                    <!-- -->Conseil en
                                    Immigration<!-- -->,
                                    <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_0') }}</span>
                            </div>
                        </div>
                        <div class="space-y-6">
                            <h1 class="leading-[1.15] tracking-tight uppercase text-[28px] sm:text-[40px] lg:text-[56px] font-extrabold max-w-5xl mx-auto"
                                ...
                                {{ __('services/immigration-consultancy-website-development-agency.text_1') }}<!-- -->
                            ...
                            <p
                                ...
                                {{ __('services/immigration-consultancy-website-development-agency.ml_906') }}</p>
                        </div>
                    ...
                    rgba(0, 0, 0, 0.02) 0px 150px 150px -3.75px"
                                href="https://cal.com/code-sommet/new-client-meeting"><span
                                    class="relative text-[15px] font-semibold text-white z-10">{{ __('services/immigration-consultancy-website-development-agency.ml_907') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                href="#pricing"><span class="text-[15px] font-semibold text-[#0F0F0F]">Voir les
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">{{ __('services/immigration-consultancy-website-development-agency.text_2') }}
                                    <!-- -->Conseil en
                                    Immigration</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">{{ __('services/immigration-consultancy-website-development-agency.text_167') }}</span>
                            </div>
                            <div class="w-px h-4 bg-[#0F0F0F]/20"></div>
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                            ...
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    <div class="mb-6 flex-shrink-0">
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-sparkles w-7 h-7" aria-hidden="true"
                                                style="color:#00AEEF">
                                                <path
                                                    d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z">
                                                </path>
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_909') }}</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_910') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_911') }}</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_912') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_913') }}</h3>
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_914') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_915') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                            <div
                                ...
                                <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                    ...
                                    <p class="text-gray-600 text-sm leading-relaxed flex-grow">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_916') }}</p>
                                    <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center">
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-8"
                        ...
                        {{ __('services/immigration-consultancy-website-development-agency.text_3') }}
                        <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_171') }}<!-- -->
                        Entreprises
                    </h2>
                    <div
                    ...
                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 max-w-xl mx-auto px-4">Résultats réels de
                        <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_172') }}<!-- -->{{ __('services/immigration-consultancy-website-development-agency.ml_917') }}
                    </p>
                </div>
            </div>
        </section>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>{{ __('services/immigration-consultancy-website-development-agency.ml_918') }}
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.text_8') }}<!-- -->:
                        <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_173') }}<!-- -->{{ __('services/immigration-consultancy-website-development-agency.ml_919') }}
                    </h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">
                        {{ __('services/immigration-consultancy-website-development-agency.ml_920') }}</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_921') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_922') }}</p>
                        </div>
                    </div>
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/immigration-consultancy-website-development-agency.text_9') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_923') }}</p>
                        </div>
                    </div>
                    <div>
                        <div
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-user-x w-5 h-5 md:w-6 md:h-6 text-[#00AEEF]" aria-hidden="true">
                                    <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
                                    <circle cx="9" cy="7" r="4"></circle>
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_924') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_925') }}</p>
                        </div>
                    </div>
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">Le Suivi Manuel des Dossiers Fait Perdre du Temps
                            </h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_926') }}</p>
                        </div>
                    </div>
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/immigration-consultancy-website-development-agency.text_10') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_927') }}</p>
                        </div>
                    </div>
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_928') }}</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_929') }}</p>
                        </div>
                    </div>
                </div>
                <div class="text-center mt-10 md:mt-12">
                    <p class="text-base md:text-lg font-semibold text-[#0F0F0F] mb-5 md:mb-6 max-w-2xl mx-auto px-4"
                        ...
                        style="color:white"
                        href="https://cal.com/code-sommet/new-client-meeting">{{ __('services/immigration-consultancy-website-development-agency.text_11') }}</a>
                </div>
            </div>
        </section>
                ...
                <div class="text-center mb-16">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <path d="M22 4h-4"></path>
                            <circle cx="4" cy="20" r="2"></circle>
                        </svg>{{ __('services/immigration-consultancy-website-development-agency.text_12') }}
                        <!-- -->Conseil en Immigration
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.text_13') }}<!-- --> for
                        <!-- -->Conseil en
                        Immigration<!-- --> Sites Web
                    </h2>
                                ...
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/immigration-consultancy-website-development-agency.text_14') }}
                                        </h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">
                                            {{ __('services/immigration-consultancy-website-development-agency.ml_930') }}
                                        </p>
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_931') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_932') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_933') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div
                                        class="flex-1 relative min-h-[280px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden">
                                        <img src="{{ asset('images/education/education-application-portal.webp') }}"
                                            alt="{{ __('services/immigration-consultancy-website-development-agency.attr_1532') }}"
                            ...
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/immigration-consultancy-website-development-agency.text_15') }}
                                        </h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">
                                            {{ __('services/immigration-consultancy-website-development-agency.ml_934') }}
                                        </p>
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_935') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_936') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_937') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Notifications par email et SMS
                                                    pour les changements de statut</span></li>
                                        </ul>
                                    </div>
                                    <div
                                        class="flex-1 relative min-h-[280px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden">
                                        <img src="{{ asset('images/education/education-crm-pipeline.webp') }}"
                                            alt="{{ __('services/immigration-consultancy-website-development-agency.attr_1533') }}"
                                            class="absolute inset-0 w-full h-full object-contain" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/immigration-consultancy-website-development-agency.text_16') }}
                                        </h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">
                                            {{ __('services/immigration-consultancy-website-development-agency.ml_938') }}
                                        </p>
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_939') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_940') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Suivi des dates d'expiration pour
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_941') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div
                                        ...
                                        <img src="{{ asset('images/education/education-student-dashboard.webp') }}"
                                            alt="Portail de Gestion de Documents"
                                            class="absolute inset-0 w-full h-full object-contain" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-2.5">
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">Chatbot IA d'Immigration</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">
                                            {{ __('services/immigration-consultancy-website-development-agency.ml_942') }}
                                        </p>
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_943') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_944') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_945') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_946') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>{{ __('services/immigration-consultancy-website-development-agency.text_17') }}
                        <!-- -->Conseil en Immigration
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.text_18') }}
                        <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_175') }}
                    </h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Projets réels, résultats réels. Découvrez
                        ...
                        <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_176') }}<!-- -->{{ __('services/immigration-consultancy-website-development-agency.ml_947') }}
                    </p>
                </div>
                <div class="grid md:grid-cols-2 gap-8 lg:gap-10 mb-10">
                    ...
                    <div><a class="block" href="{{ route('case-study', 'morocco-quest') }}">
                            <div
                                class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                                <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video
                                        src="{{ asset('videos/morocco-quest-travel-website-showcase.mp4') }}" autoplay
                                        loop muted playsinline webkit-playsinline
                                        class="w-full h-full object-cover"></video>
                                    <div
                                        class="absolute top-5 right-5 px-3 py-1.5 bg-black/30 backdrop-blur-md rounded-full border border-white/30">
                                ...
                                <div class="px-5 py-4">
                                    ...
                                    <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-2">Agence de voyage et circuits privés au Maroc</p>
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.text_19') }}<!-- --> for
                        <!-- -->Conseil en Immigration
                    </h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">
                        {{ __('services/immigration-consultancy-website-development-agency.ml_950') }}</p>
                </div>
                <div class="relative">
                                ...
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/immigration-consultancy-website-development-agency.ml_951') }}
                                        </h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Analyse des pays cibles et
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_952') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_953') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="hidden md:flex items-center justify-center flex-shrink-0 relative">
                                    ...
                                    <div class="absolute left-20 inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold whitespace-nowrap"
                                        style="font-family:var(--font-body);background-color:#FFF5F0;color:#00AEEF"><svg
                                            ...
                                            <rect width="18" height="18" x="3" y="4" rx="2"></rect>
                                            <path d="M3 10h18"></path>
                                        </svg>{{ __('services/immigration-consultancy-website-development-agency.text_177') }}
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/immigration-consultancy-website-development-agency.ml_954') }}
                                        </h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_955') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_956') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">Authentification utilisateur
                                ...
                                <div class="hidden md:flex items-center justify-center flex-shrink-0 relative">
                                    <div class="absolute right-20 inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold whitespace-nowrap"
                                        style="font-family:var(--font-body);background-color:#FFF5F0;color:#00AEEF"><svg
                                            ...
                                            <rect width="18" height="18" x="3" y="4" rx="2"></rect>
                                            <path d="M3 10h18"></path>
                                        </svg>{{ __('services/immigration-consultancy-website-development-agency.text_178') }}
                                    </div>
                                    <div
                                        class="w-16 h-16 rounded-full flex items-center justify-center shadow-lg ring-4 ring-white z-10 bg-[#00AEEF]">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/immigration-consultancy-website-development-agency.ml_957') }}
                                        </h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_958') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_959') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_960') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="hidden md:flex items-center justify-center flex-shrink-0 relative">
                                    ...
                                    <div class="absolute left-20 inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold whitespace-nowrap"
                                        style="font-family:var(--font-body);background-color:#00AEEF;color:#FFFFFF"><svg
                                            ...
                                            <rect width="18" height="18" x="3" y="4" rx="2"></rect>
                                            <path d="M3 10h18"></path>
                                        </svg>{{ __('services/immigration-consultancy-website-development-agency.text_179') }}
                                    </div>
                                </div>
                                <div class="flex-1 hidden md:block"></div>
                            </div>
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">
                                            {{ __('services/immigration-consultancy-website-development-agency.text_180') }}
                                        </h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_961') }}</span>
                                            </li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">Configuration de Google Analytics
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">{{ __('services/immigration-consultancy-website-development-agency.ml_962') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="hidden md:flex items-center justify-center flex-shrink-0 relative">
                                    <div class="absolute right-20 inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold whitespace-nowrap"
                                        style="font-family:var(--font-body);background-color:#00AEEF;color:#FFFFFF"><svg
                                            ...
                                            <rect width="18" height="18" x="3" y="4" rx="2"></rect>
                                            <path d="M3 10h18"></path>
                                        </svg>{{ __('services/immigration-consultancy-website-development-agency.text_181') }}
                                    </div>
                                    <div
                                        class="w-16 h-16 rounded-full flex items-center justify-center shadow-lg ring-4 ring-white z-10 bg-[#00AEEF]">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="text-center mt-12 md:mt-16 pt-8 md:pt-12 border-t border-[#0F0F0F]/8">
                    <p class="text-lg md:text-xl font-semibold text-[#0F0F0F] mb-5 md:mb-6 max-w-2xl mx-auto px-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.text_20') }} <!-- -->conseil en
                        immigration<!-- -->
                        {{ __('services/immigration-consultancy-website-development-agency.text_182') }}</p><a
                        class="h-10 px-6 text-base rounded-full inline-flex items-center justify-center font-medium transition-all duration-200 bg-gradient-to-r from-[var(--color-primary-orange)] to-[var(--color-orange-hover)] text-white hover:text-white shadow-[0_4px_16px_rgba(0,174,239,0.25)] hover:shadow-[0_6px_24px_rgba(0,174,239,0.35)] hover:-translate-y-0.5 [&amp;&gt;*]:text-white [&amp;&gt;*]:hover:text-white h-11 md:h-12 px-6 md:px-8 text-sm md:text-base"
                        style="color:white"
                        href="https://cal.com/code-sommet/new-client-meeting">{{ __('services/immigration-consultancy-website-development-agency.ml_963') }}</a>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-12 md:mb-16">
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-black mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.text_21') }}</h2>
                    <p class="text-lg md:text-xl text-black/70 max-w-3xl mx-auto">
                        {{ __('services/immigration-consultancy-website-development-agency.ml_964') }}</p>
                </div>
                    ...
                    <div class="relative bg-black rounded-[32px] p-3 text-white">
                        <div class="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
                            <div
                                ...
                                </svg>{{ __('services/immigration-consultancy-website-development-agency.ml_965') }}
                            </div>
                        </div>
                        <div class="relative rounded-[20px] p-6 md:p-8 mb-3 bg-[#1a1a1a] border border-transparent">
                            <div class="flex items-start justify-between mb-6">
                                <div class="flex items-center gap-3">
                                    ...
                                    <h3 class="text-3xl md:text-4xl font-bold text-white">
                                        {{ __('services/immigration-consultancy-website-development-agency.text_22') }}
                                    </h3>
                                </div>
                            </div>
                            <div class="mb-6 p-4 rounded-2xl bg-white/5">
                                <p class="text-white/70">
                                    {{ __('services/immigration-consultancy-website-development-agency.ml_966') }}</p>
                            </div>
                            <div class="divide-y divide-white/10">
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="text-white/80">{{ __('services/immigration-consultancy-website-development-agency.ml_967') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('services/immigration-consultancy-website-development-agency.ml_968') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="text-white/80">{{ __('services/immigration-consultancy-website-development-agency.text_23') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('services/immigration-consultancy-website-development-agency.text_24') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('services/immigration-consultancy-website-development-agency.text_25') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('services/immigration-consultancy-website-development-agency.text_26') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-white/80">{{ __('services/immigration-consultancy-website-development-agency.text_183') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-green-400 font-medium">{{ __('services/immigration-consultancy-website-development-agency.ml_969') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="px-6 md:px-8 pb-3">
                            <div class="mb-6">
                                <div class="flex flex-col"><span
                                        class="text-lg md:text-xl font-medium text-white/70 mb-1">{{ __('services/immigration-consultancy-website-development-agency.text_27') }}</span>
                                    <div class="flex items-end gap-2"><span
                                            class="text-5xl md:text-6xl font-bold">{{ __('services/immigration-consultancy-website-development-agency.text_28') }}</span><span
                                            class="text-white/50 text-xl mb-2"></span></div>
                                    <p class="text-white/60 text-sm mt-2">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_970') }}</p>
                                </div>
                            </div>
                            <div class="flex flex-col sm:flex-row gap-3"><a
                                    ...
                                    href="{{ route('get-quote') }}">{{ __('services/immigration-consultancy-website-development-agency.text_29') }}</a><a
                        ...
                        <div
                            ...
                            <div class="flex items-start justify-between gap-4 mb-6">
                                <div class="flex items-center gap-3 flex-shrink-0">
                                    ...
                                    <h3 class="text-3xl md:text-4xl font-bold text-black">
                                        {{ __('services/immigration-consultancy-website-development-agency.text_494') }}
                                    </h3>
                                </div><button
                                    ...
                                    <div class="relative rounded-full transition-all duration-400 ease-out w-11 h-7 bg-black/20"
                                        ...
                                        class="text-sm whitespace-nowrap overflow-hidden transition-all duration-400 ease-out opacity-100 w-auto">{{ __('services/immigration-consultancy-website-development-agency.ml_971') }}</span>
                                </button>
                            </div>
                            <div class="mb-6 p-4 rounded-2xl bg-black/5 flex items-center gap-3"><svg
                                ...
                                <p class="text-black/70 transition-all duration-300">
                                    {{ __('services/immigration-consultancy-website-development-agency.ml_972') }}</p>
                            </div>
                            <div class="divide-y divide-black/10">
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="text-black/80">{{ __('services/immigration-consultancy-website-development-agency.text_30') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/immigration-consultancy-website-development-agency.ml_973') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/immigration-consultancy-website-development-agency.text_31') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/immigration-consultancy-website-development-agency.text_32') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/immigration-consultancy-website-development-agency.text_33') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/immigration-consultancy-website-development-agency.text_34') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/immigration-consultancy-website-development-agency.text_35') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/immigration-consultancy-website-development-agency.text_36') }}</span>
                                </div>
                                <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        class="text-black/80">{{ __('services/immigration-consultancy-website-development-agency.text_37') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="px-6 md:px-8 pb-3">
                            <div class="mb-6">
                                <div class="flex flex-col"><span
                                        class="text-lg md:text-xl font-medium text-black/60 mb-1">{{ __('services/immigration-consultancy-website-development-agency.text_38') }}</span>
                                    <div class="flex items-end gap-2">
                                        <div class="relative overflow-hidden" style="height:fit-content"><span
                                            ...
                                            class="text-black/50 text-xl mb-2">{{ __('services/immigration-consultancy-website-development-agency.text_184') }}</span>
                                    </div>
                                    <p class="text-black/60 text-sm mt-2">
                                        {{ __('services/immigration-consultancy-website-development-agency.text_39') }}
                                    </p>
                                </div>
                            </div>
                            <div class="flex flex-col sm:flex-row gap-3"><button data-cal-link="code-sommet/new-client-meeting" data-cal-namespace="new-client-meeting"
                                    ...
                                    class="flex-1 h-11 px-5 rounded-full inline-flex items-center justify-center whitespace-nowrap bg-black text-white text-sm font-semibold hover:bg-black/90 transition-colors">{{ __('services/immigration-consultancy-website-development-agency.ml_974') }}</button><a
                                    href="https://wa.me/212632582096?text=Hi%20CodeSommet!%20I'm%20interested%20in%20learning%20more%20about%20your%20web%20development%20services."
                                    target="_blank" rel="noopener noreferrer"
                ...
                <div class="max-w-4xl mx-auto">
                    <div
                        ...
                        <h2 class="analyzer-cta__title text-2xl md:text-3xl lg:text-4xl font-bold mb-4"
                            style="font-family:var(--font-heading)">
                            {{ __('services/immigration-consultancy-website-development-agency.ml_975') }}</h2>
                        <p class="analyzer-cta__text text-base md:text-lg mb-6 max-w-2xl mx-auto">
                            {{ __('services/immigration-consultancy-website-development-agency.ml_976') }}</p>
                        <div class="flex flex-wrap gap-3 justify-center mb-4">
                            ...
                            <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                                ...
                                <span>{{ __('services/immigration-consultancy-website-development-agency.ml_977') }}</span>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                                <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div>
                                <span>{{ __('services/immigration-consultancy-website-development-agency.text_40') }}</span>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                                <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div>
                                <span>{{ __('services/immigration-consultancy-website-development-agency.ml_978') }}</span>
                            </div>
                        </div><a
                        ...
                        <p class="text-xs text-[var(--text-secondary)] mt-4">
                            {{ __('services/immigration-consultancy-website-development-agency.ml_979') }}</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        ...
                        <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_185') }}<!-- -->
                        vs
                        Autres
                    </h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">
                        {{ __('services/immigration-consultancy-website-development-agency.text_41') }} <!-- -->Conseil en
                        Immigration<!-- -->{{ __('services/immigration-consultancy-website-development-agency.ml_980') }}
                    </p>
                </div>
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-4 bg-[#F8F8F8] border-b border-[#0F0F0F]/10">
                                <div class="p-3 md:p-4 font-semibold text-[#0F0F0F]/60 text-xs md:text-sm">
                                    {{ __('services/immigration-consultancy-website-development-agency.ml_981') }}</div>
                                ...
                                <div class="p-3 md:p-4 text-center font-semibold text-[#0F0F0F]/60 text-xs md:text-sm break-words leading-tight">
                                    Other
                                    <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_187') }}<!-- -->
                                    Agences
                                </div>
                                <div class="p-3 md:p-4 text-center font-semibold text-[#0F0F0F]/60 text-xs md:text-sm break-words leading-tight">
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/immigration-consultancy-website-development-agency.text_42') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">{{ __('services/immigration-consultancy-website-development-agency.text_43') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/immigration-consultancy-website-development-agency.ml_982') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/immigration-consultancy-website-development-agency.ml_983') }}</span>
                                </div>
                            </div>
                            <div
                                ...
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/immigration-consultancy-website-development-agency.text_44') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/immigration-consultancy-website-development-agency.ml_986') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">{{ __('services/immigration-consultancy-website-development-agency.ml_987') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Formulaires
                                        basiques uniquement</span></div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/immigration-consultancy-website-development-agency.ml_988') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/immigration-consultancy-website-development-agency.ml_989') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">Pipeline visuel avec
                                        automatisation</span></div>
                                <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Tableurs
                                        manuels</span></div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/immigration-consultancy-website-development-agency.ml_990') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                                ...
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">{{ __('services/immigration-consultancy-website-development-agency.text_45') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/immigration-consultancy-website-development-agency.ml_991') }}</span>
                                </div>
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">{{ __('services/immigration-consultancy-website-development-agency.ml_992') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Un seul pays
                                        uniquement</span></div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/immigration-consultancy-website-development-agency.ml_993') }}</span>
                                </div>
                            </div>
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/immigration-consultancy-website-development-agency.ml_994') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                            ...
                            <div
                                class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">
                                    {{ __('services/immigration-consultancy-website-development-agency.ml_995') }}</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">{{ __('services/immigration-consultancy-website-development-agency.ml_996') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/immigration-consultancy-website-development-agency.ml_997') }}</span>
                                </div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">{{ __('services/immigration-consultancy-website-development-agency.text_46') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mt-8 text-center">
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <circle cx="12" cy="12" r="10"></circle>
                                <path d="m9 12 2 2 4-4"></path>
                            </svg>{{ __('services/immigration-consultancy-website-development-agency.text_47') }}
                            <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_189') }}<!-- -->
                            Entreprises
                        </div>
                    </div>
                </div>
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.text_48') }}</h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Ne nous croyez pas sur parole. Écoutez les
                        entreprises en
                        <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_190') }}<!-- -->{{ __('services/immigration-consultancy-website-development-agency.ml_998') }}
                    </p>
                </div>
                        ...
                        <div class="testimonial-slide grid grid-cols-1 lg:grid-cols-2 gap-8" data-slide="0">
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('services/immigration-consultancy-website-development-agency.qb_2133') }}
                                    </blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('services/immigration-consultancy-website-development-agency.text_49') }}
                                            </div>
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('services/immigration-consultancy-website-development-agency.qb_2134') }}
                                    </blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('services/immigration-consultancy-website-development-agency.ml_999') }}
                                            </div>
                        ...
                        <div class="testimonial-slide grid grid-cols-1 lg:grid-cols-2 gap-8" data-slide="1"
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('services/immigration-consultancy-website-development-agency.qb_2135') }}
                                    </blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('services/immigration-consultancy-website-development-agency.text_51') }}
                                            </div>
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">
                                        {{ __('services/immigration-consultancy-website-development-agency.qb_2136') }}
                                    </blockquote>
                                    <div class="flex items-start gap-4 pt-6 border-t border-[#0F0F0F]/5"><img
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-sm text-[#0F0F0F]/60 mb-2">
                                                {{ __('services/immigration-consultancy-website-development-agency.ml_1000') }}
                                            </div>
                ...
                <div class="mt-10 text-center">
                    <p class="text-sm text-[#0F0F0F]/60">
                        {{ __('services/immigration-consultancy-website-development-agency.text_52') }}<!-- --> <a
                            href="{{ route('our-work') }}"
                            class="text-[#00AEEF] font-semibold hover:underline">{{ __('services/immigration-consultancy-website-development-agency.ml_1001') }}</a>
                    </p>
                </div>
            </div>
        </section>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>{{ __('services/immigration-consultancy-website-development-agency.ml_1002') }}
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.sw_2936') }}</h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Vous avez des questions ? Nous avons les
                        ...
                        <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_191') }}<!-- -->
                        entreprises.
                    </p>
                </div>
                <div class="max-w-4xl mx-auto bg-white rounded-2xl border border-[#0F0F0F]/10 p-6">
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-1"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('services/immigration-consultancy-website-development-agency.faq_q1') }}</h3>
                            </div>
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-2"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('services/immigration-consultancy-website-development-agency.faq_q2') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-3"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('services/immigration-consultancy-website-development-agency.faq_q3') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-4"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('services/immigration-consultancy-website-development-agency.faq_q4') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-5"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('services/immigration-consultancy-website-development-agency.faq_q5') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-6"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('services/immigration-consultancy-website-development-agency.faq_q6') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-7"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('services/immigration-consultancy-website-development-agency.faq_q7') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="border-b border-[#0F0F0F]/10 last:border-0"><button aria-expanded="false" aria-controls="faq-answer-8"
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">{{ __('services/immigration-consultancy-website-development-agency.faq_q8') }}</h3>
                            </div>
                            <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mt-10 text-center">
                    <p class="text-sm text-[#0F0F0F]/60 mb-2">
                        {{ __('services/immigration-consultancy-website-development-agency.text_53') }}</p><a
                        href="{{ route('contact') }}"
                        class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2">Contactez
                        notre
                        <!-- -->{{ __('services/immigration-consultancy-website-development-agency.text_192') }}<!-- -->
                        team<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                            <path d="M2 12h20"></path>
                        </svg>{{ __('services/immigration-consultancy-website-development-agency.ml_1007') }}
                    </div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.text_54') }}</h2>
                    <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">
                        {{ __('services/immigration-consultancy-website-development-agency.ml_1008') }}</p>
                </div>
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            {{ __('services/immigration-consultancy-website-development-agency.ml_1009') }}
                                        </h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/immigration-consultancy-website-development-agency.text_495') }}</span><span
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            Casablanca</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/immigration-consultancy-website-development-agency.text_496') }}</span><span
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            San Francisco</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/immigration-consultancy-website-development-agency.text_497') }}</span><span
                                                class="truncate">{{ __('services/immigration-consultancy-website-development-agency.text_55') }}</span>
                                        </p>
                                    </div>
                                </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            Londres</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/immigration-consultancy-website-development-agency.text_498') }}</span><span
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            Paris</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/immigration-consultancy-website-development-agency.text_499') }}</span><span
                                ...
                                <div class="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            ...
                                            Marrakech</h3>
                                        <p class="text-xs md:text-sm text-[#0F0F0F]/60 flex items-center gap-1 truncate">
                                            <span>{{ __('services/immigration-consultancy-website-development-agency.text_500') }}</span><span
                                                class="truncate">Maroc</span>
                                        </p>
                                    </div>
                                </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="text-center pt-5 md:pt-6 border-t border-[#0F0F0F]/8">
                    <p class="text-sm md:text-base text-[#0F0F0F]/70 mb-3 md:mb-4 px-4">Vous cherchez <!-- -->conseil en
                        immigration<!-- -->
                        {{ __('services/immigration-consultancy-website-development-agency.text_56') }}</p>
                    <div class="flex flex-wrap items-center justify-center gap-3 md:gap-4 px-4"><a
                            ...
                            href="/#locations"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <circle cx="12" cy="10" r="3"></circle>
                            </svg>{{ __('services/immigration-consultancy-website-development-agency.text_57') }}<svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            class="inline-flex items-center gap-2 text-[#00AEEF] font-semibold hover:underline"
                            href="{{ route('contact') }}">{{ __('services/immigration-consultancy-website-development-agency.text_58') }}<svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4" aria-hidden="true">
                                <path d="M5 12h14"></path>
            ...
            <div class="max-w-7xl mx-auto px-4 md:px-6">
                <div class="text-center mb-8 md:mb-10">
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-semibold text-[#0F0F0F] mb-3 px-4"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.text_59') }}</h2>
                    <p class="text-base md:text-lg text-[#0F0F0F]/70 max-w-2xl mx-auto px-4">
                        {{ __('services/immigration-consultancy-website-development-agency.ml_1010') }}</p>
                </div>
                            ...
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3
                                        ...
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1011') }}
                                    </h3>
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1012') }}
                                    </p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <div class="flex items-start justify-between gap-2">
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3
                                        class="text-base md:text-lg font-semibold text-[#0F0F0F] group-hover:text-[#00AEEF] transition-colors truncate">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1013') }}
                                    </h3>
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1014') }}
                                    </p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            ...
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round"
                                        class="lucide lucide-book-open w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] group-hover:text-white transition-colors"
                                        aria-hidden="true">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3
                                        class="text-base md:text-lg font-semibold text-[#0F0F0F] group-hover:text-[#00AEEF] transition-colors truncate">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1015') }}
                                    </h3>
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1016') }}
                                    </p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <div class="flex items-start justify-between gap-2">
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1017') }}
                                    </p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <div class="flex items-start justify-between gap-2">
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3
                                        class="text-base md:text-lg font-semibold text-[#0F0F0F] group-hover:text-[#00AEEF] transition-colors truncate">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1018') }}
                                    </h3>
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1019') }}
                                    </p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <div class="flex items-start justify-between gap-2">
                            <div class="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3
                                        class="text-base md:text-lg font-semibold text-[#0F0F0F] group-hover:text-[#00AEEF] transition-colors truncate">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1020') }}
                                    </h3>
                                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 mt-1 line-clamp-2">
                                        {{ __('services/immigration-consultancy-website-development-agency.ml_1021') }}
                                    </p>
                                </div>
                            </div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <div class="text-center mt-8 md:mt-10"><a
                        class="inline-flex items-center gap-2 text-[#00AEEF] font-semibold hover:underline"
                        href="/#industries">{{ __('services/immigration-consultancy-website-development-agency.text_60') }}<svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4" aria-hidden="true">
                            <path d="M5 12h14"></path>
            ...
            <div class="max-w-7xl mx-auto px-4 md:px-6">
                <div class="text-center mb-10">
                    <h2 class="text-3xl md:text-4xl font-semibold text-[var(--text-primary)] mb-3"
                        style="font-family:var(--font-heading)">
                        {{ __('services/immigration-consultancy-website-development-agency.text_61') }}</h2>
                    <p class="text-lg text-[var(--text-secondary)]">
                        {{ __('services/immigration-consultancy-website-development-agency.ml_1022') }}</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6"><a
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_1023') }}</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#00AEEF">{{ __('services/immigration-consultancy-website-development-agency.text_62') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <h3
                                class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_1024') }}</h3>
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_1025') }}</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#00AEEF">{{ __('services/immigration-consultancy-website-development-agency.text_63') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <h3
                                class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_1026') }}</h3>
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_1027') }}</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#8B5CF6">{{ __('services/immigration-consultancy-website-development-agency.text_64') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#10B981">{{ __('services/immigration-consultancy-website-development-agency.text_65') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex flex-col h-full">
                            ...
                            <h3
                                class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">
                                {{ __('services/immigration-consultancy-website-development-agency.ml_1028') }}</h3>
                            <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">Explorez tous nos services et
                                offres</p>
                            <div
                                class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                                <span
                                    style="color:#3B82F6">{{ __('services/immigration-consultancy-website-development-agency.text_66') }}</span><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
            ...
            <div class="max-w-7xl mx-auto">
                ...
                rgba(10, 10, 10, 0.95) 100%
                    ...
                    <div class="relative z-10 text-center space-y-3 md:space-y-4">
                        <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white px-4 pb-6 md:pb-8"
                            style="font-family:var(--font-display)">
                            {{ __('services/immigration-consultancy-website-development-agency.ml_1029') }}</h2>
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px"
                                    ...
                                    <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('services/immigration-consultancy-website-development-agency.ml_1030') }}</span>
                                </a><a
                ...
                rgba(0, 0, 0, 0.024) 0px 150px 150px -3.75px">
                                    ...
                                    <div class="relative z-10 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="relative z-10 text-base md:text-lg font-medium tracking-tight text-black"
                                        style="font-family:Inter, sans-serif;font-weight:500;letter-spacing:-0.04em">{{ __('services/immigration-consultancy-website-development-agency.ml_1031') }}</span>
                                </button><a
                                ...
                                <div class="absolute pointer-events-none animate-cursor-stops" style="left:50%;top:50%">
                                    ...
                                    <div class="absolute left-0 top-0 -translate-x-1/2 px-3 py-1 rounded-full border border-white/80 bg-black/90"
                                        style="font-size:10px"><span
                                            class="text-white font-medium whitespace-nowrap">{{ __('services/immigration-consultancy-website-development-agency.text_193') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/40">{{ __('services/immigration-consultancy-website-development-agency.text_501') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/40">{{ __('services/immigration-consultancy-website-development-agency.text_502') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/40">{{ __('services/immigration-consultancy-website-development-agency.text_503') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/90">{{ __('services/immigration-consultancy-website-development-agency.text_504') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/90">{{ __('services/immigration-consultancy-website-development-agency.text_505') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
                                            ...
                                            <li class="flex-shrink-0">
                                                <div
                                                    ...
                                                    <div class="relative w-5 h-5">
                                                        ...
                                                        class="text-[10px] font-medium text-white/90">{{ __('services/immigration-consultancy-website-development-agency.text_506') }}</span>
                                                </div>
                                            </li>
                                            <li class="flex-shrink-0">
                                                <div
