...
@section('title', 'Développement Web à Zurich, Suisse | CodeSommet')
@section('meta_description', 'Studio de développement web basé au Maroc au service des entreprises du monde entier. Nous créons des sites web propulsés par l\'IA et des tableaux de bord intelligents à distance. Sites web de qualité premium livrés en 7 jours.')
...
@section('og_description', "Agence de développement web premium au Maroc spécialisée dans les sites web propulsés par
...
@section('twitter_description', "Agence de développement web premium spécialisée dans les sites web propulsés par l'IA,
les tableaux de bord intelligents et les plateformes SaaS. 50+ projets livrés.")
                ...
                <div class="space-y-6 lg:space-y-8 text-center">
                    ...
                    <div class="space-y-6">
                        ...
                        <p class="text-sm sm:text-base lg:text-lg text-[var(--text-secondary)] leading-relaxed max-w-3xl mx-auto">
                            Associez-vous au studio leader du développement web de Zurich pour des sites web alimentés
                            par l'IA et des tableaux de bord intelligents. Nous sommes spécialisés dans la création de
                            plateformes orientées conversion pour les secteurs de la fintech, de la santé et de la technologie dans la capitale de l'innovation suisse.</p>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">Basé à <!-- -->Zurich</span>
                        </div>
                        <div class="w-px h-4 bg-[#0F0F0F]/20"></div>
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">Livraison en 7 à 10 jours</span>
                        </div>
                        <div class="w-px h-4 bg-[#0F0F0F]/20"></div>
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">50+ clients à <!-- -->Zurich<!-- --></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Pourquoi Choisir CodeSommet in <!-- -->Zurich<!-- -->?</h2>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Créez des chatbots
                                    ...
                                    des moteurs de recommandation adaptés aux secteurs financiers et de la santé technologiquement avancés de Zurich.</p>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Concevez des portails
                                    ...
                                    plateformes SaaS qui évoluent avec les opérations de startups et de fintech de Zurich.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Axé Génération de
                                    Prospects</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Sites web optimisés SEO et axés conversion qui transforment les visiteurs de Zurich en clients payants pour les marchés suisses et européens.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Lancez votre MVP en 7 ? 14
                                    jours avec révisions illimitées. Parfait pour l'écosystème florissant de startups et d'innovation de Zurich.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Expertise approfondie dans la fintech, la santé et le SaaS, les secteurs à la croissance la plus rapide de Zurich et de l'économie d'innovation suisse.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Stack Technologique
                                    Moderne</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Next.js 15, React, TypeScript, Supabase, OpenAI, Claude - des technologies qui attirent les meilleurs talents en ingénierie de Zurich et les investisseurs européens.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center">
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-8" style="font-family:var(--font-heading)">Approuvé par <!-- -->Zurich<!-- --> Entreprises</h2>
                ...
                <p class="text-xs md:text-sm text-[#0F0F0F]/60 max-w-xl mx-auto px-4">Résultats concrets d'entreprises
                    basées à <!-- -->Zurich<!-- --> avec lesquelles nous avons collaboré</p>
            </div>
        </div>
    </section>
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Zurich<!-- --> Nos Secteurs de Spécialisation</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Une expertise approfondie dans les secteurs clés
                    de <!-- -->Zurich<!-- -->. Nous comprenons les défis propres à votre secteur et ses exigences de
                    conformité.</p>
            </div>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4">
                    ...
                    </svg>Nos réalisations à <!-- -->Zurich
                </div>
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Histoires de réussite à <!-- -->Zurich</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Des projets réels, des résultats concrets.
                    Découvrez comment nous avons aidé des entreprises basées à <!-- -->Zurich<!-- --> à atteindre leurs
                        ...
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video src="{{ asset('images/our-work/goausbildung/goausbildung-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video>
                                ...
                                <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        </svg>500+ étudiants placés</span></div>
                            </div>
                            <div class="px-5 py-4">
    ...
    <section class="w-full py-24 md:py-32 bg-white">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Zurich&#x27;s Fintech &amp; Crypto Innovation</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Comprendre l'écosystème numérique de
                    <!-- -->Zurich<!-- --> nous permet de créer des solutions qui résonnent réellement avec votre marché
                    local.
                </p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">2,600+</div>
                        <div class="text-base font-semibold text-[#0F0F0F] mb-1">Entreprises Tech</div>
                        <p class="text-sm text-[#0F0F0F]/60">Actif à Zurich</p>
                    </div>
                </div>
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">CHF 4.8B</div>
                ...
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">6</div>
                        <div class="text-base font-semibold text-[#0F0F0F] mb-1">Entreprises licornes</div>
                        <p class="text-sm text-[#0F0F0F]/60">Basé à Zurich</p>
                    </div>
                </div>
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">CHF 35B</div>
                        <div class="text-base font-semibold text-[#0F0F0F] mb-1">Secteur Fintech</div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-[#F8F8F8] border border-[#0F0F0F]/5 rounded-2xl p-6 hover:border-[#00AEEF]/20 hover:shadow-lg transition-all duration-300">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-[#0F0F0F]/80 leading-relaxed">Zurich allie l'excellence bancaire suisse à l'innovation crypto, levant 4,8 milliards CHF en 2024 à travers plus de 2 600 entreprises. En tant que berceau de la Crypto Valley (Zug) et des puissances financières traditionnelles, Zurich fait le pont unique entre l'ancienne et la nouvelle finance. La ville excelle dans la gestion de patrimoine technologique, l'infrastructure blockchain et la technologie réglementaire, avec un secteur fintech de 35 milliards CHF au service de la banque privée mondiale et des clients institutionnels.</p>
                    </div>
                </div>
                <div class="bg-[#F8F8F8] border border-[#0F0F0F]/5 rounded-2xl p-6 hover:border-[#00AEEF]/20 hover:shadow-lg transition-all duration-300">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-[#0F0F0F]/80 leading-relaxed">Les entreprises de Zurich exigent une sécurité de niveau suisse et
                            la conformité réglementaire. Avec les régulations crypto-friendly de la Suisse et l&#x27;héritage de la banque
                            privée, la demande pour des plateformes de patrimoine Next.js, des tableaux de bord crypto React et des intégrations
                            de paiement suisses a augmenté de 150%. Les entreprises ont besoin d&#x27;un support multi-devises (CHF, EUR, USD),
                            de la conformité FINMA et de plateformes servant à la fois la finance traditionnelle et le Web3 avec une
                            sécurité de niveau institutionnel.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Comment Nous Avons Construit une Plateforme de Patrimoine Crypto Gérant 2 Milliards CHF
                    d&#x27;Actifs Numériques</h2>
                <div class="flex items-center justify-center gap-6 text-sm text-[#0F0F0F]/60 flex-wrap">
                    ...
                    <div class="flex items-center gap-2"><span>Crypto / Gestion de Patrimoine</span></div>
                    <span>•</span>
            ...
            <div class="grid lg:grid-cols-2 gap-8 mb-12">
                <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/10 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <p class="text-[#0F0F0F]/70 leading-relaxed">Une société crypto de Zurich avait besoin d&#x27;une plateforme de niveau institutionnel
                        pour les gestionnaires de patrimoine offrant la crypto aux clients HNWI. Nécessitait une garde en stockage à froid avec
                        sécurité multi-sig, le support de plus de 50 cryptomonnaies, le suivi et rééquilibrage de portefeuille en temps réel,
                        un KYC/AML conforme FINMA, l&#x27;intégration avec la banque traditionnelle, la déclaration fiscale pour
                        les résidents suisses et européens, une solution en marque blanche pour les banques privées et une sécurité de niveau institutionnel
                        (ISO 27001, SOC 2).</p>
                </div>
                <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/10 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center gap-3 mb-4">
                    ...
                    <p class="text-[#0F0F0F]/70 leading-relaxed">Construction d&#x27;une plateforme de patrimoine
                        crypto en Next.js avec stockage à froid multi-sig, support de 50+ cryptomonnaies avec
                        intégration DeFi, analytique de portefeuille en temps réel, KYC conforme FINMA, intégration
                        bancaire traditionnelle pour CHF/EUR, déclaration fiscale automatisée pour la Suisse et
                        l&#x27;UE, framework en marque blanche, certifications ISO 27001 et SOC 2, et déploiement sur
                        AWS Zurich avec chiffrement de niveau bancaire.</p>
                </div>
            </div>
            <div class="bg-gradient-to-br from-[#00AEEF] to-[#0071BC] rounded-3xl p-8 md:p-10 text-white mb-12">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                        ...
                        <p class="text-base font-medium leading-snug">2 milliards CHF d&#x27;actifs numériques sous
                            garde</p>
                    </div>
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                        ...
                        <p class="text-base font-medium leading-snug">250+ clients HNWI et 8 partenaires de banques
                            privées</p>
                    </div>
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                        ...
                        <p class="text-base font-medium leading-snug">Zéro incident de sécurité depuis le lancement</p>
                    </div>
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                            <path d="m9 12 2 2 4-4"></path>
                ...
                <div class="relative z-10 max-w-3xl">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-[#00AEEF] text-sm font-medium">Gestionnaire de Patrimoine Crypto de Zurich</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="relative rounded-[20px] p-6 md:p-8 mb-3 bg-[#1a1a1a] border border-transparent">
                        ...
                        <div class="divide-y divide-white/10">
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                ...
                                </svg><span class="text-white/80">Intégration de fonctionnalités propulsées par
                                    l&#x27;IA</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                            ...
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-white/80">Prêt pour l'intégration des paiements</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-white/50 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                    ...
                    <div class="px-6 md:px-8 pb-3">
                        <div class="mb-6">
                            <div class="flex flex-col"><span class="text-lg md:text-xl font-medium text-white/70 mb-1">Demander un Devis</span>
                                ...
                                <p class="text-white/60 text-sm mt-2">Devis personnalisé selon le périmètre de votre
                                    projet</p>
                            </div>
                        </div>
                        <div class="flex flex-col sm:flex-row gap-3"><a class="flex-1 px-6 py-3.5 rounded-full bg-white text-black font-semibold hover:bg-white/90 transition-colors whitespace-nowrap text-center" href="{{ route('get-quote') }}">Obtenir un devis personnalisé</a><a href="https://wa.me/212632582096?text=Hi%20CodeSommet!%20I'm%20interested%20in%20learning%20more%20about%20your%20web%20development%20services." target="_blank" rel="noopener noreferrer" class="flex-1 px-6 py-3.5 rounded-full border-2 border-white/20 text-white font-semibold hover:bg-white/10 transition-colors text-center inline-flex items-center justify-center whitespace-nowrap">Échanger
                                sur WhatsApp</a></div>
                    </div>
                </div>
                <div class="relative bg-white rounded-[32px] p-3 text-black border border-black/10">
                    <div class="relative rounded-[20px] p-6 md:p-8 mb-3 transition-all duration-700 ease-in-out bg-[#F5F5F5] overflow-hidden border border-transparent">
                        ...
                        <div class="divide-y divide-black/10">
                            ...
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">Développement de tableau de bord sur mesure</span>
                            </div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                            ...
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
                                </svg><span class="text-black/80">Révisions illimitées jusqu&#x27;à la
                                    perfection</span></div>
                            <div class="flex items-start gap-3 py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check w-5 h-5 text-black/40 mt-0.5 flex-shrink-0" aria-hidden="true">
                                    <path d="M20 6 9 17l-5-5"></path>
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="max-w-4xl mx-auto">
                <div class="bg-gradient-to-br from-[#00AEEF]/5 to-orange-50 rounded-3xl p-8 md:p-12 border-2 border-[#00AEEF]/20 text-center">
                    ...
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[var(--text-primary)]" style="font-family:var(--font-heading)">Prêt ? améliorer votre site web ? Zurich ?</h2>
                    <p class="text-base md:text-lg text-[var(--text-secondary)] mb-6 max-w-2xl mx-auto">Obtenez
                        d'abord une analyse complète gratuite :</p>
                    <div class="flex flex-wrap gap-3 justify-center mb-4">
                        ...
                        <div class="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#22C55E]"></div><span>Recommandations propulsées
                                par l&#x27;IA</span>
                        </div>
                    ...
                    <p class="text-xs text-[var(--text-secondary)] mt-4">Aucune carte bancaire requise • Résultats en
    ...
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Découvrez pourquoi <!-- -->Zurich<!-- --> les
                ...
                <div class="overflow-x-auto -mx-4 md:mx-0 px-4 md:px-0">
                    <div class="bg-white rounded-2xl border border-[#0F0F0F]/10 overflow-hidden shadow-xl min-w-[600px]">
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            ...
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Coût
                                    supplémentaire</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Dépend de
                                    vos besoins</span></div>
                        </div>
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Délai 48-72h</div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 mx-auto text-[#22C55E]" aria-hidden="true">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="m9 12 2 2 4-4"></path>
                                </svg></div>
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            ...
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">€4,500+/month</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">€7,500+/month</span></div>
                        </div>
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                ...
                <div class="mt-8 text-center">
                    ...
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full text-sm font-semibold text-[#22C55E]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                            <path d="m9 12 2 2 4-4"></path>
                        </svg>Meilleur rapport qualité-prix pour <!-- -->Zurich<!-- --> Entreprises
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Ce que nos clients de <!-- -->Zurich<!-- --> disent de
                    nous</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Ne nous croyez pas sur parole. Écoutez les entreprises de
                    <!-- -->Zurich<!-- --> qui ont obtenu des résultats remarquables avec
                    CodeSommet.
                </p>
            </div>
                        ...
                        <div class="relative">
                            <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/5 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300 h-full">
                                ...
                                <blockquote class="text-[#0F0F0F]/80 leading-relaxed mb-6 text-base">&quot;Nous avions
                                    besoin d&#x27;une plateforme e-learning complexe avec vidéo en direct, suivi de
                                    progression et intégration de paiement. CodeSommet a tout livré en 3 semaines. Les
            ...
            <div class="mt-10 text-center">
                <p class="text-sm text-[#0F0F0F]/60">Vous voulez voir plus d'études de cas ?<!-- --> <a href="{{ route('our-work') }}" class="text-[#00AEEF] font-semibold hover:underline">Voir
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            ...
            <div class="max-w-4xl mx-auto bg-white rounded-2xl border border-[#0F0F0F]/10 p-6">
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Pourquoi choisir CodeSommet parmi les nombreuses agences de
                                développement web de Zurich ?</h3>
                        </div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Pouvez-vous vous intégrer aux
                                systèmes existants utilisés par les entreprises de Zurich ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Comment fonctionne le modèle de révisions illimitées
                                pour les clients de Zurich ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Fournissez-vous un support continu pour les projets
                                de Zurich après le lancement ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
    ...
    <section class="w-full bg-[#F5F5F5] py-16 md:py-20">
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="text-center mb-8 md:mb-10">
                <h2 class="text-2xl md:text-3xl lg:text-4xl font-semibold text-[var(--text-primary)] mb-3 px-4" style="font-family:var(--font-heading)">Nous Desservons Également</h2>
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6"><a class="group bg-white rounded-2xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-transparent hover:border-gray-200" href="{{ route('tool', 'website-analyzer') }}">
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <h3 class="text-lg font-semibold text-[var(--text-primary)] mb-2 group-hover:text-[#00AEEF] transition-colors">
                            Voir Nos Projets</h3>
                        <p class="text-sm text-[var(--text-secondary)] mb-4 flex-grow">Découvrez les études de cas et
                            les réussites de nos clients</p>
                        <div class="flex items-center text-sm font-medium group-hover:text-[#00AEEF] transition-colors">
                            <span style="color:#00AEEF">En savoir plus</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" aria-hidden="true" style="color:#00AEEF">
                                <path d="M5 12h14"></path>
                                <path d="m12 5 7 7-7 7"></path>
