            ...
            <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                <div class="space-y-6 lg:space-y-8 text-center">
                    <nav class="flex items-center justify-center gap-2 text-xs text-gray-400" aria-label="Breadcrumb"><a class="hover:text-gray-600 transition-colors" aria-label="Home" href="{{ route('home') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house w-3 h-3" aria-hidden="true">
                            ...
                            </svg></a><span>/</span><a class="hover:text-gray-600 transition-colors" href="{{ route('locations') }}">Emplacements</a><span>/</span><span class="text-gray-600">Amsterdam</span></nav>
                    <div class="flex justify-center">
                        <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full">
                            <div class="relative">
                                ...
                                les
                                <!-- -->Amsterdam<!-- --> Projets</span><span class="text-xs sm:text-sm text-[#0F0F0F]/40">•</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin w-3.5 h-3.5 text-[#00AEEF]" aria-hidden="true">
    ...
    <section class="w-full py-24 md:py-32 bg-white">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Hub d'Innovation Fintech &amp; SaaS d'Amsterdam</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">4,200+</div>
                ...
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">€5.8B</div>
                ...
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">14</div>
                ...
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">€28B</div>
