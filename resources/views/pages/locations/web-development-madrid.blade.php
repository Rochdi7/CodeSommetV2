                ...
                <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                    ...
                    rgba(0, 0, 0, 0.02) 0px 150px 150px -3.75px"
                                href="https://cal.com/codesommet/discovery"><span
                                    ...
                                    Gratuite Madrid</span><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">Basé à <!-- -->Madrid</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">50+ clients à <!-- -->Madrid<!-- --></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Pourquoi Choisir CodeSommet à <!-- -->Madrid<!-- --> ?</h2>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center">
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-8"
                        style="font-family:var(--font-heading)">Approuvé par les Entreprises de <!-- -->Madrid<!-- --></h2>
                    <div
                    ...
                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 max-w-xl mx-auto px-4">Résultats réels de
                        <!-- -->Madrid<!-- --> - des entreprises avec lesquelles nous avons collaboré</p>
                </div>
            </div>
        </section>
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Madrid<!-- --> Nos Secteurs de Spécialisation</h2>
                ...
                <div class="mt-10 text-center">
                    <p class="text-[#0F0F0F]/70 mb-4">Vous ne voyez pas votre secteur ? Nous travaillons avec des
                        entreprises de tous les secteurs à <!-- -->Madrid<!-- -->.</p><a
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>Nos réalisations à <!-- -->Madrid</div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Histoires de réussite à <!-- -->Madrid</h2>
        ...
        <section class="w-full py-24 md:py-32 bg-white">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Paysage de la Transformation Numérique de Madrid</h2>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                ...
                <div class="relative w-full max-w-5xl mx-auto mb-12">
                    <div class="relative aspect-[16/9]"><img
                            alt="Comment Nous Avons Aidé une Plateforme Immobilière de Madrid à Générer 250+ Prospects Qualifiés par Mois"
                ...
                <div class="max-w-4xl mx-auto">
                    <div
                        ...
                        <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[var(--text-primary)]"
                            style="font-family:var(--font-heading)">Prêt à Améliorer Votre Site Web à Madrid ?</h2>
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">CodeSommet <!-- -->Madrid<!-- --> vs Autres</h2>
                    ...
                    <div class="mt-8 text-center">
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <circle cx="12" cy="12" r="10"></circle>
                                <path d="m9 12 2 2 4-4"></path>
                            </svg>Meilleur rapport qualité-prix pour les entreprises de <!-- -->Madrid<!-- --></div>
                    </div>
                </div>
            </div>
        </section>
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Ce Que les Clients de <!-- -->Madrid<!-- --> Disent de
                        Nous</h2>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                ...
                <div class="mt-10 text-center">
                    <p class="text-sm text-[#0F0F0F]/60 mb-2">Vous avez encore des questions ?</p><a
                        ...
                        notre équipe de <!-- -->Madrid<!-- --><svg class="w-4 h-4" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
