...
@section('title', 'Développement Web à Copenhagen, Danemark | CodeSommet')
@section('meta_description', 'Associez-vous au studio de développement web leader de Copenhagen pour des sites web
alimentés par l\'IA et des tableaux de bord intelligents. Nous sommes spécialisés dans la création de plateformes axées
sur la conversion pour les secteurs SaaS, fintech et éducation dans l\'écosystème d\'innovation florissant du
Danemark.')
                ...
                <div class="space-y-6 lg:space-y-8 text-center">
                    ...
                    <div class="space-y-6">
                        ...
                        <p class="text-sm sm:text-base lg:text-lg text-[var(--text-secondary)] leading-relaxed max-w-3xl mx-auto">
                            Associez-vous au studio de développement web leader de Copenhagen pour des sites web
                            alimentés par l'IA et des tableaux de bord intelligents. Nous sommes spécialisés dans la
                            création de plateformes axées sur la conversion pour les secteurs SaaS, fintech et éducation
                            dans l'écosystème d'innovation florissant du Danemark.</p>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">Basé à <!-- -->Copenhagen</span>
                        </div>
                        ...
                        <div class="w-px h-4 bg-[#0F0F0F]/20"></div>
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">50+ clients à <!-- -->Copenhagen<!-- --></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Pourquoi Choisir CodeSommet à <!-- -->Copenhagen<!-- -->?
                </h2>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Créez des chatbots
                                    ...
                                    des moteurs de recommandation adaptés au public technophile de Copenhagen.</p>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Concevez des portails
                                    ...
                                    plateformes SaaS qui évoluent avec votre startup de Copenhagen.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Sites web optimisés pour le
                                    SEO et axés sur la conversion qui transforment les visiteurs de Copenhagen en
                                    clients payants.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Expertise approfondie dans
                                    le SaaS, la fintech et l'éducation - les secteurs à la croissance la plus rapide de
                                    Copenhagen.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Next.js 15, React,
                                    ...
                                    talents d'ingénierie de Copenhagen.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center">
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-8" style="font-family:var(--font-heading)">Approuvé par <!-- -->Copenhagen<!-- --> Entreprises</h2>
                ...
                <p class="text-xs md:text-sm text-[#0F0F0F]/60 max-w-xl mx-auto px-4">De vrais résultats de
                    <!-- -->Copenhagen<!-- --> - entreprises avec lesquelles nous avons collaboré
                </p>
            </div>
        </div>
    </section>
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Copenhagen<!-- --> Nos Secteurs de Spécialisation</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Expertise approfondie dans
                    <!-- -->Copenhagen<!-- --> . Nous comprenons les défis uniques de votre secteur et les exigences de
                    conformité.
                </p>
            </div>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4">
                    ...
                    </svg>Nos Projets à <!-- -->Copenhagen
                </div>
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Histoires de Succès de <!-- -->Copenhagen</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">De vrais projets, de vrais résultats. Découvrez
                    comment nous avons aidé les entreprises à <!-- -->Copenhagen<!-- --> atteindre leurs objectifs
                    numériques.</p>
            </div>
                        ...
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video src="{{ asset('images/our-work/goausbildung/goausbildung-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video>
                                ...
                                <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        </svg>Plus de 500 inscriptions d'étudiants</span></div>
                            </div>
                            <div class="px-5 py-4">
                ...
                <div><a class="block" href="{{ route('case-study', 'msingermany') }}">
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video src="{{ asset('images/our-work/msingermany/msingermany-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video>
                                ...
                                <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                        </svg>Plus de 2 000 candidatures traitées</span></div>
                            </div>
                            <div class="px-5 py-4">
                ...
                <div><a class="block" href="{{ route('case-study', 'qogent') }}">
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video src="{{ asset('images/our-work/qogent/qogent-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video>
                                ...
                                <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                        </svg>Augmentation de 300% des inscriptions</span></div>
                            </div>
                            <div class="px-5 py-4">
    ...
    <section class="w-full py-24 md:py-32 bg-white">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Innovation Greentech &amp; Design de Copenhagen</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Comprendre <!-- -->Copenhagen<!-- --> aide à
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">2,400+</div>
                        <div class="text-base font-semibold text-[#0F0F0F] mb-1">Startups Tech</div>
                        <p class="text-sm text-[#0F0F0F]/60">Actif à Copenhagen</p>
                    </div>
                </div>
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">€3.1B</div>
                ...
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <p class="text-sm text-[#0F0F0F]/60">Basé à Copenhagen</p>
                    </div>
                </div>
                <div class="group relative">
                    <div class="bg-gradient-to-br from-[#F5F5F5] to-white border border-[#0F0F0F]/10 rounded-2xl p-6 hover:border-[#00AEEF]/30 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-3xl md:text-4xl font-bold text-[#0F0F0F] mb-2" style="font-family:var(--font-heading)">€18B</div>
                        <div class="text-base font-semibold text-[#0F0F0F] mb-1">Marché Greentech</div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-[#F8F8F8] border border-[#0F0F0F]/5 rounded-2xl p-6 hover:border-[#00AEEF]/20 hover:shadow-lg transition-all duration-300">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-[#0F0F0F]/80 leading-relaxed">Copenhagen est en tête de la révolution greentech
                            en Europe, avec 3,1 milliards d'euros levés en 2024 auprès de plus de 2 400 startups. En
                            tant que leader mondial du développement durable (neutre en carbone d'ici 2025), Copenhagen
                            excelle dans la tech climatique, les logiciels d'énergie renouvelable et la mobilité urbaine
                            durable. L'héritage design de la ville (Lego, Bang &amp; Olufsen) combiné à l'innovation
                            tech crée des produits de classe mondiale avec l'esthétique danoise et l'excellence en
                            ingénierie.</p>
                    </div>
                </div>
                <div class="bg-[#F8F8F8] border border-[#0F0F0F]/5 rounded-2xl p-6 hover:border-[#00AEEF]/20 hover:shadow-lg transition-all duration-300">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-[#0F0F0F]/80 leading-relaxed">Les entreprises de Copenhagen privilégient la
                            durabilité et la qualité du design. Avec les objectifs climatiques ambitieux du Danemark et
                            le secteur greentech de 18 milliards d'euros, la demande de plateformes de suivi carbone
                            Next.js, de tableaux de bord de gestion énergétique React et d'intégrations MobilePay a
                            augmenté de 145%. Les entreprises ont besoin d'un support multilingue (danois, anglais), de
                            conformité RGPD et de systèmes mesurant l'impact environnemental parallèlement aux métriques
                            commerciales pour les rapports ESG.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Comment Nous Avons Construit une Plateforme de Suivi
                    Carbone pour Plus de 1 000 Entreprises Européennes</h2>
                <div class="flex items-center justify-center gap-6 text-sm text-[#0F0F0F]/60 flex-wrap">
                    <div class="flex items-center gap-2"><span class="font-semibold text-[#0F0F0F]">Plateforme de
                            comptabilité carbone d'entreprise et de reporting ESG</span></div><span>•</span>
            ...
            <div class="grid lg:grid-cols-2 gap-8 mb-12">
                <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/10 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <p class="text-[#0F0F0F]/70 leading-relaxed">Une entreprise de tech climatique de Copenhagen avait
                        besoin d'une plateforme aidant les entreprises européennes à suivre et réduire leurs émissions
                        de carbone. Calcul automatisé de l'empreinte carbone requis pour les Scopes 1/2/3, intégration
                        avec les systèmes comptables (SAP, NetSuite) pour les émissions basées sur les dépenses,
                        engagement fournisseurs pour les émissions de la chaîne d'approvisionnement, recommandations de
                        réduction alimentées par l'IA, conformité avec l'EU CSRD et le GHG Protocol, tableaux de bord de
                        reporting ESG pour les investisseurs et API pour les fournisseurs de compensation carbone.</p>
                </div>
                <div class="bg-white rounded-2xl p-8 border border-[#0F0F0F]/10 hover:border-[#00AEEF]/20 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center gap-3 mb-4">
                    ...
                    <p class="text-[#0F0F0F]/70 leading-relaxed">Plateforme de gestion carbone Next.js complète
                        construite avec calcul automatisé des émissions utilisant les données de dépenses et d'activité,
                        intégration de SAP, NetSuite et systèmes de gestion des dépenses, implémentation d'un portail
                        fournisseurs pour collecter les données d'émissions de la chaîne d'approvisionnement, ajout d'un
                        moteur IA recommandant des stratégies de réduction des émissions, reporting ESG conforme au CSRD
                        construit avec des métriques personnalisées, création d'un tableau de bord investisseurs avec
                        objectifs climatiques et suivi de progression, intégration de places de marché de compensation
                        carbone via API et déploiement sur AWS avec conformité ISO 27001 et SOC 2.</p>
                </div>
            </div>
            <div class="bg-gradient-to-br from-[#00AEEF] to-[#0071BC] rounded-3xl p-8 md:p-10 text-white mb-12">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                        ...
                        <p class="text-base font-medium leading-snug">Plus de 1 000 entreprises européennes utilisant
                            la plateforme</p>
                    </div>
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                        ...
                        <p class="text-base font-medium leading-snug">50M de tonnes de CO2e suivies et rapportées</p>
                    </div>
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                            <path d="m9 12 2 2 4-4"></path>
                        </svg>
                        <p class="text-base font-medium leading-snug">Le client moyen a réduit ses émissions de 18% la
                            première année</p>
                    </div>
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-6 h-6 flex-shrink-0 mt-1" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                        ...
                        <p class="text-base font-medium leading-snug">Financement Série A (12M€) avec des VCs
                            climatiques</p>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="max-w-4xl mx-auto">
                <div class="bg-gradient-to-br from-[#00AEEF]/5 to-orange-50 rounded-3xl p-8 md:p-12 border-2 border-[#00AEEF]/20 text-center">
                    ...
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[var(--text-primary)]" style="font-family:var(--font-heading)">Prêt à Améliorer Votre Site Web à Copenhagen ?</h2>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">CodeSommet <!-- -->Copenhagen<!-- --> vs Autres</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Découvrez pourquoi <!-- -->Copenhagen<!-- -->
                ...
                <div class="mt-8 text-center">
                    ...
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full text-sm font-semibold text-[#22C55E]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                            <path d="m9 12 2 2 4-4"></path>
                        </svg>Meilleur Rapport Qualité-Prix pour <!-- -->Copenhagen<!-- --> Entreprises
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Ne vous fiez pas seulement à notre parole.
                    Écoutez les entreprises de <!-- -->Copenhagen<!-- --> qui ont obtenu des résultats remarquables avec
                    CodeSommet.</p>
            </div>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Pourquoi choisir CodeSommet plutôt
                                que les nombreuses agences de développement web de Copenhagen ?</h3>
                        </div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Travaillez-vous avec les startups de
                                Copenhagen et les entreprises en phase de démarrage ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Quelles technologies utilisez-vous
                                pour les projets à Copenhagen ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Pouvez-vous intégrer les systèmes
                                existants utilisés par les entreprises de Copenhagen ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Comment fonctionne le modèle de
                                révisions illimitées à Copenhagen ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Fournissez-vous un support continu
                                après le lancement à Copenhagen ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
            ...
            <div class="mt-10 text-center">
                <p class="text-sm text-[#0F0F0F]/60 mb-2">Vous avez encore des questions ?</p><a href="{{ route('contact') }}" class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2">Contactez
                    notre <!-- -->Copenhagen<!-- --> équipe<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
