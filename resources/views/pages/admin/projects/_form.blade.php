...
<div class="grid lg:grid-cols-2 gap-6">
    ...
    <div class="space-y-5">
        <div class="admin-card">
            <div class="admin-card-header"><h3 class="text-sm font-semibold">Informations du Projet</h3></div>
        ...
        <div class="admin-card">
            <div class="admin-card-header"><h3 class="text-sm font-semibold">URLs & Repos</h3></div>
            <div class="admin-card-body space-y-4">
    ...
    <div class="space-y-5">
        ...
        <div class="admin-card">
            <div class="admin-card-header"><h3 class="text-sm font-semibold">Planification & Budget</h3></div>
            <div class="admin-card-body space-y-4">
                <div class="grid grid-cols-2 gap-4">
