...
@section('title', 'Étude de Cas GoAusbildung - Plateforme EdTech SaaS Alimentée par l\'IA | CodeSommet')
...
@section('og_title', 'Étude de Cas GoAusbildung - Plateforme EdTech SaaS Alimentée par l\'IA')
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        ...
        <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16">
            <div class="space-y-4 md:space-y-6">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight" style="font-family:var(--font-heading)">GoAusbildung</h1>
                <p class="text-xl md:text-2xl text-[var(--text-secondary)] font-medium">Place de Marché d'Emplois Alimentée par l'IA</p>
            ...
            <div class="relative">
                ...
                <div class="relative aspect-[16/9] rounded-2xl md:rounded-3xl overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 md:border-2 shadow-xl md:shadow-2xl"><video src="{{ asset('images/our-work/goausbildung/goausbildung-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video></div>
            </div>
        </div>
    </div>
</section>
...
<section class="py-12 md:py-16 lg:py-20 bg-white">
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        ...
        <div class="relative mb-8 md:mb-12 max-w-5xl mx-auto">
            <div class="relative aspect-[3/2] rounded-2xl md:rounded-3xl overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 shadow-[0_4px_20px_rgba(0,0,0,0.08)]"><img src="{{ asset('images/our-work/goausbildung/homepage.webp') }}" alt="Place de Marché" class="w-full h-full object-cover" /></div>
        </div>
                        ...
                        <div class="px-5 md:px-6 py-6 md:py-7"><svg class="w-8 h-8 md:w-10 md:h-10 text-white/30 mb-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-white/90 text-xs md:text-sm">Fondateur, GoAusbildung</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="pt-12 md:pt-16 lg:pt-20 pb-3 md:pb-4 bg-[#F5F5F5] border-t border-gray-200">
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        <div class="grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-4 max-w-4xl mx-auto"><a class="group" href="/our-work/msingermany">
            ...
            </a><a class="group" href="/our-work/qogent">
