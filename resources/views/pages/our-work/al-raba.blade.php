...
@section('title', 'Étude de Cas Al-Raba Technologies - Développement de Site Web B2B Tech | CodeSommet')
@section('meta_description', 'Comment nous avons créé un site web B2B professionnel pour Al-Raba Technologies, distributeur leader d\'onduleurs et d\'infrastructures IT, atteignant une augmentation de 180% des prospects avec Next.js 15, Supabase CMS et l\'intégration WhatsApp.')
...
@section('og_title', 'Étude de Cas Al-Raba Technologies - Développement de Site Web B2B Tech')
@section('og_description', 'Comment nous avons créé un site web B2B professionnel pour Al-Raba Technologies, distributeur leader d\'onduleurs et d\'infrastructures IT, atteignant une augmentation de 180% des prospects avec Next.js 15, Supabase CMS et l\'intégration WhatsApp.')
@section('twitter_description', 'Comment nous avons créé un site web B2B professionnel pour Al-Raba Technologies, distributeur leader d\'onduleurs et d\'infrastructures IT, atteignant une augmentation de 180% des prospects avec Next.js 15, Supabase CMS et l\'intégration WhatsApp.')
    ...
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
        ...
        <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16">
            <div class="space-y-4 md:space-y-6">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight" style="font-family:var(--font-heading)">Al-Raba Technologies</h1>
                <p class="text-xl md:text-2xl text-[var(--text-secondary)] font-medium">Solutions Énergétiques B2B &amp; Infrastructure IT</p>
            ...
            <div class="relative">
                ...
                <div class="relative aspect-[16/9] rounded-2xl md:rounded-3xl overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 md:border-2 shadow-xl md:shadow-2xl"><video src="{{ asset('images/our-work/al-raba/al-raba-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video></div>
            </div>
        </div>
    </div>
</section>
...
<section class="py-12 md:py-16 lg:py-20 bg-white">
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        ...
        <div class="relative mb-8 md:mb-12 max-w-5xl mx-auto">
            <div class="relative aspect-[3/2] rounded-2xl md:rounded-3xl overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 shadow-[0_4px_20px_rgba(0,0,0,0.08)]"><img src="{{ asset('images/our-work/al-raba/homepage.webp') }}" alt="Accueil" class="w-full h-full object-cover" /></div>
        </div>
                ...
                <div class="group relative bg-white rounded-lg p-3 shadow-lg hover:shadow-2xl transition-all duration-300">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-600 font-medium">Produits Référencés</p>
                        </div>
                    </div>
                </div>
                <div class="group relative bg-white rounded-lg p-3 shadow-lg hover:shadow-2xl transition-all duration-300">
                    ...
                    <div class="relative rounded-lg md:rounded-[16px] overflow-hidden" style="background:linear-gradient(to top, #00AEEF 0%, #0071BC 100%);box-shadow:0 8px 20px rgba(0, 0, 0, 0.08), 0 3px 6px rgba(0, 0, 0, 0.04)">
                        <div class="px-5 md:px-6 py-6 md:py-7"><svg class="w-8 h-8 md:w-10 md:h-10 text-white/30 mb-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-bold text-white text-sm md:text-base">Mohammed Al-Raba</p>
                                    <p class="text-white/90 text-xs md:text-sm">Directeur Général, Al-Raba Technologies</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="pt-12 md:pt-16 lg:pt-20 pb-3 md:pb-4 bg-[#F5F5F5] border-t border-gray-200">
    <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
        <div class="grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-4 max-w-4xl mx-auto"><a class="group" href="/our-work/doctor-hubli">
            ...
            </a><a class="group" href="/our-work/msingermany">
