...
@section('title', 'Développement de Sites Web FinTech | Conception Web de Services Financiers | CodeSommetStudio')
@section('meta_description', 'Développement de sites web FinTech spécialisé. Plus de 35 sites web de services financiers
construits avec des intégrations de paiement sécurisées, des designs conformes à la réglementation et des pages de
destination optimisées pour la conversion. Contactez-nous pour les tarifs.')
@section('meta_keywords', 'développement site web fintech,conception site web services financiers,page de destination
fintech,développement site bancaire,conception site web financier,agence de conception web fintech,site web société de
paiement,développement site web néobanque')
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                <div class="space-y-6 lg:space-y-8 text-center">
                    ...
                    <div class="flex justify-center">
                        <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full">
                            <div class="relative">
                                ...
                                <!-- -->FinTech et Services Financiers<!-- --> Projets</span><span class="text-xs sm:text-sm text-[#0F0F0F]/40">•</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin w-3.5 h-3.5 text-[#00AEEF]" aria-hidden="true">
                                <path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0">
                                </path>
                                <circle cx="12" cy="10" r="3"></circle>
                            </svg><span class="text-xs sm:text-sm text-[#0F0F0F]/70">💰<!-- --> <!-- -->FinTech et
                                Services Financiers<!-- -->, <!-- -->Industrie Spécialisée</span>
                        </div>
                    </div>
                    <div class="space-y-6">
                        <h1 class="leading-[1.15] tracking-tight uppercase text-[28px] sm:text-[40px] lg:text-[56px] font-extrabold max-w-5xl mx-auto" style="font-family:var(--font-display)">NOUS CRÉONS DES SITES WEB QUI GÉNÈRENT DES<!-- -->
                            <span class="jsx-5c81c8c63985dc3f inline-block relative text-black"><span style="min-height:1.2em" class="jsx-5c81c8c63985dc3f relative inline-flex items-center justify-center px-3 py-3"><span style="border-color:var(--color-primary-orange);z-index:1" class="jsx-5c81c8c63985dc3f absolute inset-0 border-2 pointer-events-none animate-[scaleIn_0.3s_ease-out]"><span style="background-color:var(--color-primary-orange)" class="jsx-5c81c8c63985dc3f absolute w-3 h-3 -top-[6px] -left-[6px]"></span><span style="background-color:var(--color-primary-orange)" class="jsx-5c81c8c63985dc3f absolute w-3 h-3 -top-[6px] -right-[6px]"></span><span style="background-color:var(--color-primary-orange)" class="jsx-5c81c8c63985dc3f absolute w-3 h-3 -bottom-[6px] -left-[6px]"></span><span style="background-color:var(--color-primary-orange)" class="jsx-5c81c8c63985dc3f absolute w-3 h-3 -bottom-[6px] -right-[6px]"></span></span><span class="jsx-5c81c8c63985dc3f inline-block opacity-0 pointer-events-none">CROISSANCE
                                        FINANCIÈRE</span><span class="jsx-5c81c8c63985dc3f absolute inset-0 inline-flex items-center justify-center animate-[textFadeIn_0.3s_ease-in-out,textReveal_1.2s_cubic-bezier(0.22,1,0.36,1)]">CROISSANCE
                                        FINANCIÈRE</span></span></span>
                        </h1>
                        <p class="text-sm sm:text-base lg:text-lg text-[var(--text-secondary)] leading-relaxed max-w-3xl mx-auto">
                            Développement de sites web FinTech spécialisé pour les sociétés de paiement, les banques
                            numériques, les sociétés d'investissement et les services financiers. Nous avons construit
                            plus de 35 sites web FinTech avec des intégrations de paiement sécurisées, des designs
                            conformes à la réglementation et des expériences utilisateur optimisées pour la conversion.
                            Augmentation moyenne de 280% des leads qualifiés.</p>
                    </div>
                    ...
                    rgba(0, 0, 0, 0.02) 0px 150px 150px -3.75px" href="https://cal.com/pikasso/discovery"><span class="relative text-[15px] font-semibold text-white z-10">Réserver une Consultation
                                FinTech Gratuite</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-5 h-5 text-white relative z-10 group-hover:translate-x-1 transition-transform" aria-hidden="true">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">Basé dans le secteur <!-- -->FinTech et Services
                                Financiers</span>
                        </div>
                        ...
                        <div class="w-px h-4 bg-[#0F0F0F]/20"></div>
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">50+ <!-- -->FinTech et Services Financiers<!-- -->
                                Clients</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Expertise approfondie dans
                                    la conception de sites web pour les sociétés de paiement, les banques numériques et
                                    les sociétés d'investissement. Nous comprenons la conformité financière, les signaux
                                    de confiance et l'optimisation de conversion pour les audiences fintech.</p>
                    ...
                    <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Fonctionnalités FinTech
                                    Alimentées par l'IA</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Chatbots alimentés par l'IA
                                    pour les conseils financiers, la qualification intelligente de leads et la livraison
                                    de contenu personnalisé. Moteurs de recommandation de produits intelligents et flux
                                    d'intégration client automatisés.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Parcours de Paiement
                                    Complet</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Des pages de destination aux
                                    vitrines de produits - nous construisons la présence web complète : pages de
                                    services, calculateurs de prix, études de cas inspirant confiance, documentation de
                                    conformité et entonnoirs de génération de leads.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Optimisation des
                                    Transactions</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Sites web FinTech optimisés
                                    pour la confiance, la vitesse et les conversions. Nos clients obtiennent 280% de
                                    leads qualifiés en plus avec des temps de chargement inférieurs à 2 secondes et
                                    99,99% de disponibilité.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Multi-Devises et
                                    Transfrontalier</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Support pour plus de 150
                                    devises avec des taux de change en temps réel. Rails de paiement transfrontaliers,
                                    intégration SWIFT et conversion de devises automatisée avec des spreads compétitifs.
                                </p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    ...
                    <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Conformité Réglementaire
                                    Rapide</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Lancez des sites web FinTech
                                    conformes en 7-10 jours avec des designs prêts pour la conformité, des intégrations
                                    sécurisées et des éléments inspirant confiance. Optimisés pour le SEO et axés sur la
                                    conversion.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center">
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-8" style="font-family:var(--font-heading)">Adopté par les <!-- -->FinTech et Services
                ...
                <p class="text-xs md:text-sm text-[#0F0F0F]/60 max-w-xl mx-auto px-4">Résultats réels de
                    <!-- -->FinTech et Services Financiers<!-- --> avec lesquelles nous avons collaboré
                </p>
            </div>
        </div>
    </section>
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Le Défi<!-- -->: <!-- -->FinTech et Services
                    Financiers<!-- --> Les Entreprises Font Face à des Défis Web Uniques</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Les développeurs web généralistes ne comprennent
                    pas ces problématiques spécifiques à la fintech et aux services financiers</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]" style="font-family:var(--font-heading)">La Sécurité des Paiements est Critique</h3>
                        <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm" style="font-family:var(--font-body)">Les intégrations de paiement génériques vous exposent
                            à la fraude et aux violations de données. Vous avez besoin d'une infrastructure conforme
                            PCI-DSS Niveau 1 avec tokenisation, 3D Secure, chiffrement et notation de fraude dès le
                            premier jour.</p>
                    </div>
                </div>
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]" style="font-family:var(--font-heading)">Le KYC Manuel est Lent et Coûteux</h3>
                        <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm" style="font-family:var(--font-body)">La vérification manuelle de l'identité des clients
                            prend des jours et coûte des montants significatifs par utilisateur. Vous avez besoin d'un
                            KYC automatisé avec OCR de documents, détection de vivacité, filtrage des sanctions et
                            vérification instantanée.</p>
                    </div>
                </div>
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]" style="font-family:var(--font-heading)">Taux Élevés de Rétrofacturation et de Fraude</h3>
                        <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm" style="font-family:var(--font-body)">Perdre des milliers en transactions frauduleuses et en
                            rétrofacturation. Vous avez besoin d'une détection de fraude en temps réel avec
                            vérifications de vélocité, empreinte digitale d'appareil, analyse comportementale et
                            notation de risque.</p>
                    </div>
                </div>
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]" style="font-family:var(--font-heading)">Le Règlement Prend des Jours</h3>
                        <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm" style="font-family:var(--font-body)">Les rails de paiement traditionnels prennent 3 à 5
                            jours pour le règlement, tuant la trésorerie. Vous avez besoin d'une infrastructure de
                            règlement instantané avec des versements T+0, une réconciliation en temps réel et une
                            gestion de la liquidité.</p>
                    </div>
                </div>
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]" style="font-family:var(--font-heading)">Les Rapports de Conformité Sont Manuels</h3>
                        <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm" style="font-family:var(--font-body)">Passer des semaines à préparer des rapports
                            réglementaires et des pistes d'audit. Vous avez besoin d'une surveillance automatisée de la
                            conformité avec le dépôt SAR, la surveillance des transactions et un tableau de bord
                            réglementaire pour FINTRAC/FinCEN.</p>
                    </div>
                </div>
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]" style="font-family:var(--font-heading)">Les Frais de Transaction Rongent les Marges</h3>
                        <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm" style="font-family:var(--font-body)">Les frais de traitement des paiements s'accumulent.
                            Vous avez besoin d'une intégration directe avec le processeur de paiement ou de rails de
                            paiement personnalisés pour réduire les coûts de transaction de 40-60%.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mb-16">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sparkles w-4 h-4 mr-2" aria-hidden="true">
                        ...
                        <path d="M22 4h-4"></path>
                        <circle cx="4" cy="20" r="2"></circle>
                    </svg>Conçu sur Mesure pour <!-- -->FinTech et Services Financiers
                </div>
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Fonctionnalités Essentielles<!-- --> for <!-- -->FinTech et
                        ...
                        <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                            <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                    <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10" style="font-family:var(--font-heading)">Passerelle de Paiement</h3>
                                    <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg" style="font-family:var(--font-body)">Sites web de sociétés de paiement
                                        sécurisés avec badges de confiance, certifications de conformité, démos de
                                        produits et support multilingue.</p>
                                    <ul class="space-y-3 md:space-y-4 relative z-10">
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                            ...
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Conformité PCI-DSS Niveau 1</span>
                                        </li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                        ...
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Notation de fraude en temps
                                                réel</span></li>
                                    </ul>
                                </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-2.5">
                        <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                            <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                    <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10" style="font-family:var(--font-heading)">Tableau de Bord de Trading</h3>
                                    <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg" style="font-family:var(--font-body)">Interface de trading en temps réel avec
                                        graphiques, carnets d'ordres, gestion de portefeuille et analyses de marché.</p>
                                    <ul class="space-y-3 md:space-y-4 relative z-10">
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                ...
                <div>
                    <div class="bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-2.5">
                        <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                            <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                    <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10" style="font-family:var(--font-heading)">Vérification KYC</h3>
                                    <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg" style="font-family:var(--font-body)">Vérification d'identité automatisée avec
                                        OCR de documents, détection de vivacité et filtrage des sanctions.</p>
                                    <ul class="space-y-3 md:space-y-4 relative z-10">
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                        ...
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Reconnaissance faciale et
                                                détection de vivacité</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Filtrage des sanctions AML</span>
                                        </li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Résultats de vérification
                                                instantanés</span></li>
                                    </ul>
                                </div>
                                <div class="flex-1 relative min-h-[280px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden">
                                    ...
                                    </div><img src="{{ asset('images/finance/finance-kyc-verification.webp') }}" alt="Vérification KYC" class="absolute inset-0 w-full h-full object-contain" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-2.5">
                        <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                            <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                    <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10" style="font-family:var(--font-heading)">Analyses Financières</h3>
                                    <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg" style="font-family:var(--font-body)">Tableau de bord financier complet avec
                                        analyses de transactions, rapports de revenus et surveillance de la conformité.
                                    </p>
                                    <ul class="space-y-3 md:space-y-4 relative z-10">
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                        ...
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Rapports de revenus et de
                                                rétrofacturation</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Tableau de bord de
                                                conformité</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Exporter en CSV, PDF, Excel</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="flex-1 relative min-h-[280px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden">
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4">
                    ...
                    </svg>Nos Réalisations en <!-- -->FinTech et Services Financiers
                </div>
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Histoires de Succès en <!-- -->FinTech et Services
                    Financiers</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Projets réels, résultats réels. Découvrez
                    comment nous avons aidé les entreprises en <!-- -->FinTech et Services Financiers<!-- --> à
                        ...
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video src="{{ asset('images/our-work/al-raba/al-raba-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video>
                                ...
                                <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        </svg>+Millions Traités</span></div>
                            </div>
                            <div class="px-5 py-4">
                                <h3 class="text-xl font-semibold text-[var(--text-primary)] mb-1.5">Al-Raba
                                    Technologies</h3>
                                <p class="text-sm text-[var(--text-secondary)] leading-relaxed mb-2">Site web de
                                    société de paiement B2B</p>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Du concept au lancement en 4 semaines, optimisé
                    pour les entreprises fintech et de services financiers</p>
            </div>
            <div class="relative">
                                ...
                                <div class="bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:shadow-lg transition-all duration-200">
                                    ...
                                    <ul class="space-y-2">
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Analyse des exigences
                                                réglementaires</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                        ...
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Liste de contrôle de sécurité et
                                                conformité</span></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                            <div class="flex-1">
                                <div class="bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:shadow-lg transition-all duration-200">
                                    ...
                                    <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4" style="font-family:var(--font-heading)">Design et Architecture de Sécurité
                                    </h3>
                                    <ul class="space-y-2">
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                        ...
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Architecture de sécurité
                                                (chiffrement, tokenisation)</span></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="hidden md:flex items-center justify-center flex-shrink-0 relative">
                                ...
                                <div class="bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:shadow-lg transition-all duration-200">
                                    ...
                                    <ul class="space-y-2">
                                        ...
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Intégration système
                                                KYC/AML</span></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                            <div class="flex-1">
                                <div class="bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:shadow-lg transition-all duration-200">
                                    ...
                                    <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4" style="font-family:var(--font-heading)">Audit de Sécurité et Lancement</h3>
                                    <ul class="space-y-2">
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Tests de pénétration et audit de
                                                sécurité</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Certification de conformité
                                                PCI-DSS</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
            ...
            <div class="text-center mt-12 md:mt-16 pt-8 md:pt-12 border-t border-[#0F0F0F]/8">
                <p class="text-lg md:text-xl font-semibold text-[#0F0F0F] mb-5 md:mb-6 max-w-2xl mx-auto px-4" style="font-family:var(--font-heading)">Prêt à démarrer votre <!-- -->fintech et services
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="max-w-4xl mx-auto">
                <div class="bg-gradient-to-br from-[#00AEEF]/5 to-orange-50 rounded-3xl p-8 md:p-12 border-2 border-[#00AEEF]/20 text-center">
                    ...
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[var(--text-primary)]" style="font-family:var(--font-heading)">Prêt à Transformer Votre Site Web FinTech et de
                        Services Financiers ?</h2>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">CodeSommetStudio <!-- -->FinTech et Services
                    Financiers<!-- --> vs Autres</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Découvrez pourquoi <!-- -->FinTech et Services
                    Financiers<!-- --> entreprises choisissent CodeSommetStudio plutôt que d'autres agences locales et
            ...
            <div class="max-w-5xl mx-auto">
                <div class="overflow-x-auto -mx-4 md:mx-0 px-4 md:px-0">
                    <div class="bg-white rounded-2xl border border-[#0F0F0F]/10 overflow-hidden shadow-xl min-w-[600px]">
                            ...
                            <div class="p-3 md:p-4 text-center">
                                <div class="inline-flex items-center gap-1 md:gap-2 px-2 md:px-3 py-1 md:py-1.5 bg-[#00AEEF]/10 rounded-full">
                                    <div class="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-[#00AEEF]"></div><span class="font-bold text-xs md:text-sm text-[#00AEEF] whitespace-nowrap">CodeSommetStudio
                                        <!-- -->FinTech et Services Financiers</span>
                                </div>
                            </div>
                            <div class="p-3 md:p-4 text-center font-semibold text-[#0F0F0F]/60 text-xs md:text-sm">
                                Other <!-- -->FinTech et Services Financiers<!-- --> Agences</div>
                            <div class="p-3 md:p-4 text-center font-semibold text-[#0F0F0F]/60 text-xs md:text-sm">
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Expérience FinTech
                            </div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span class="text-sm font-bold text-[#0F0F0F]">Plus de 35 projets FinTech</span></div>
                            ...
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Pas de
                                    connaissances en conformité</span></div>
                        </div>
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            ...
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Intégration
                                    Stripe uniquement</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Coût
                                    supplémentaire</span></div>
                        </div>
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Conformité PCI-DSS
                            </div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span class="text-sm font-bold text-[#0F0F0F]">Certifié Niveau 1</span></div>
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Détection de Fraude
                                par IA</div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span class="text-sm font-bold text-[#0F0F0F]">Modèles ML en temps réel</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Règles
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Intégration KYC
                            </div>
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Support
                                Réglementaire</div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-[#0F0F0F]/60 mb-4">* Comparaison basée sur les prix moyens et les offres de
                        services des 10 meilleures agences en <!-- -->FinTech et Services Financiers</p>
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full text-sm font-semibold text-[#22C55E]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                            <path d="m9 12 2 2 4-4"></path>
                        </svg>Meilleur Rapport Qualité-Prix pour <!-- -->FinTech et Services Financiers<!-- -->
                        Entreprises
                    </div>
                </div>
            </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Ce que Nos Clients en FinTech et Services Financiers Disent de Nous</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Ne nous croyez pas sur parole. Écoutez les
                    entreprises en <!-- -->FinTech et Services Financiers<!-- --> qui ont obtenu des résultats
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Vous avez des questions ? Nous avons les
                    réponses. Voici les questions les plus courantes de <!-- -->FinTech et Services Financiers<!-- -->
                    entreprises.</p>
            </div>
            <div class="max-w-4xl mx-auto bg-white rounded-2xl border border-[#0F0F0F]/10 p-6">
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Gérez-vous la certification de
                                conformité PCI-DSS ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Pouvez-vous intégrer des processeurs
                                de paiement comme Stripe, Adyen ou Checkout.com ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Pouvez-vous construire un site web
                                fintech avec des intégrations de données en temps réel ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Qu'est-ce qui vous différencie des
                                autres développeurs FinTech ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Pouvez-vous aider avec la conformité
                                réglementaire et les licences ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
            ...
            <div class="mt-10 text-center">
                <p class="text-sm text-[#0F0F0F]/60 mb-2">Vous avez encore des questions ?</p><a href="{{ route('contact') }}" class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2">Contactez
                    notre <!-- -->FinTech et Services Financiers<!-- --> team<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section class="w-full py-24 md:py-32 bg-white">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Nous avons construit des sites web fintech et
                    de services financiers pour des clients à travers le monde. Que vous soyez au Maroc ou ailleurs,
                    nous livrons des solutions de classe mondiale.</p>
            </div>
            ...
            <div class="text-center pt-5 md:pt-6 border-t border-[#0F0F0F]/8">
                <p class="text-sm md:text-base text-[#0F0F0F]/70 mb-3 md:mb-4 px-4">Vous cherchez <!-- -->fintech et
                    services financiers<!-- --> développement web dans une ville spécifique ?</p>
