                ...
                <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                        ...
                        <div class="flex justify-center">
                            <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full">
                                <div class="relative">
                                    ...
                                    <!-- -->EdTech et E-Learning<!-- --> Projets</span><span
                            ...
                            <h1 class="leading-[1.15] tracking-tight uppercase text-[28px] sm:text-[40px] lg:text-[56px] font-extrabold max-w-5xl mx-auto"
                                ...
                                <span class="jsx-5c81c8c63985dc3f inline-block relative text-black"><span
                                        ...
                                        class="jsx-5c81c8c63985dc3f relative inline-flex items-center justify-center px-3 py-3"><span
                                            ...
                                            class="jsx-5c81c8c63985dc3f inline-block opacity-0 pointer-events-none">SYSTÈMES
                                            DE GESTION D'APPRENTISSAGE</span><span
                                            class="jsx-5c81c8c63985dc3f absolute inset-0 inline-flex items-center justify-center animate-[textFadeIn_0.3s_ease-in-out,textReveal_1.2s_cubic-bezier(0.22,1,0.36,1)]">SYSTÈMES
                                            DE GESTION D'APPRENTISSAGE</span></span></span></h1>
                            <p
                    ...
                    rgba(0, 0, 0, 0.02) 0px 150px 150px -3.75px"
                                href="https://cal.com/pikasso/discovery"><span
                                    class="relative text-[15px] font-semibold text-white z-10">Réserver une Démo LMS
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">Basé dans le secteur <!-- -->EdTech et
                                    E-Learning</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">50+ <!-- -->EdTech et E-Learning<!-- -->
                                    Clients</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center">
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-8"
                        style="font-family:var(--font-heading)">Adopté par les <!-- -->EdTech et E-Learning<!-- -->
                        Entreprises</h2>
                    <div
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Le Défi<!-- -->: <!-- -->EdTech et E-Learning<!-- --> Les
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">Les Plateformes LMS Génériques Sont Limitantes</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">Teachable, Thinkific et Kajabi facturent 5-10% de
                    ...
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">Des Frais de Transaction Élevés Rongent les Profits
                            </h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">Les frais de plateforme et les pourcentages de
                    ...
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">Faibles Taux de Complétion de Cours</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">La moyenne de l'industrie est de 15% de complétion de
                    ...
                    <div>
                        <div
                            ...
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">Vos étudiants voient le branding &quot;Powered by
                    ...
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">Vous Ne Possédez Pas les Données Étudiantes</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">Les fournisseurs de plateformes contrôlent votre liste
                    ...
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">Options d'Intégration Limitées</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">Impossible de se connecter avec votre CRM existant,
                ...
                <div class="text-center mt-10 md:mt-12">
                    <p class="text-base md:text-lg font-semibold text-[#0F0F0F] mb-5 md:mb-6 max-w-2xl mx-auto px-4"
                        ...
                        exacts pour plus de 40 <!-- -->edtech et e-learning<!-- --> entreprises.</p><a
                ...
                <div class="text-center mb-16">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <path d="M22 4h-4"></path>
                            <circle cx="4" cy="20" r="2"></circle>
                        </svg>Conçu sur Mesure pour <!-- -->EdTech et E-Learning</div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Fonctionnalités Essentielles<!-- --> for <!-- -->EdTech et
                                ...
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">Plateforme d'Apprentissage Vidéo</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">Lecteur vidéo en streaming avec chapitres,
                                        ...
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Quiz intégrés aux vidéos</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Ressources téléchargeables</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div
                                        ...
                                        <div
                                            ...
                                            alt="Plateforme d'Apprentissage Vidéo"
                            ...
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        ...
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">Hub d'apprentissage personnalisé avec
                                        ...
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Badges gagnés et
                                                    certificats</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Recommandations de cours
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Forums de discussion</span></li>
                                        </ul>
                                    </div>
                                    <div
                                        class="flex-1 relative min-h-[280px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden">
                        ...
                        <div class="bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-2.5">
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">Marketplace de Cours</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                        ...
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Codes promo et promotions</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Lots de cours</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    style="font-family:var(--font-body)">Suivi d'affiliation</span></li>
                                        </ul>
                                    </div>
                                    <div
                                        class="flex-1 relative min-h-[280px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden">
                        ...
                        <div class="bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-2.5">
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">Analytique des Instructeurs</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">Suivi des revenus, métriques d'engagement
                                        ...
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Taux de complétion vidéo</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Analyse d'abandon étudiant</span>
                                            </li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>Nos Réalisations en <!-- -->EdTech et E-Learning</div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Histoires de Succès en <!-- -->EdTech et E-Learning</h2>
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Notre Processus de Développement<!-- --> for <!-- -->EdTech
                        et E-Learning</h2>
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">Développement LMS Principal</h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Intégration de lecteur
                                                    vidéo</span></li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">Monétisation et Engagement</h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">Intégration de passerelle de
                                                    paiement</span></li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">Configuration du système de
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">Lancement et Formation</h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Migration de contenu</span></li>
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round"
                ...
                <div class="text-center mt-12 md:mt-16 pt-8 md:pt-12 border-t border-[#0F0F0F]/8">
                    <p class="text-lg md:text-xl font-semibold text-[#0F0F0F] mb-5 md:mb-6 max-w-2xl mx-auto px-4"
                        style="font-family:var(--font-heading)">Prêt à démarrer votre <!-- -->edtech et e-learning<!-- -->
                ...
                <div class="max-w-4xl mx-auto">
                    <div
                        ...
                        <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[var(--text-primary)]"
                            style="font-family:var(--font-heading)">Prêt à Transformer Votre Site Web EdTech et E-Learning
                            ?</h2>
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">CodeSommetStudio <!-- -->EdTech et E-Learning<!-- --> vs
                        Autres</h2>
                    ...
                    <div class="overflow-x-auto -mx-4 md:mx-0 px-4 md:px-0">
                        <div
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">Tableaux de bord avancés</span></div>
                    ...
                    <div class="mt-8 text-center">
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <circle cx="12" cy="12" r="10"></circle>
                                <path d="m9 12 2 2 4-4"></path>
                            </svg>Meilleur Rapport Qualité-Prix pour <!-- -->EdTech et E-Learning<!-- --> Entreprises</div>
                    </div>
                </div>
            </div>
        </section>
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">What <!-- -->EdTech et E-Learning<!-- --> Les Clients
                        Disent de Nous</h2>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                ...
                <div class="mt-10 text-center">
                    <p class="text-sm text-[#0F0F0F]/60 mb-2">Vous avez encore des questions ?</p><a
                        ...
                        notre <!-- -->EdTech et E-Learning<!-- --> team<svg class="w-4 h-4" fill="none"
