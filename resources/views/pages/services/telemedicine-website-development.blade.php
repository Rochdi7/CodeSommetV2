...
@section('title', 'Développement de Sites Web de Télémédecine | Plateformes de Soins Virtuels | CodeSommetStudio')
@section('meta_description', 'Développement spécialisé de plateformes de télémédecine. Plus de 20 plateformes de soins
virtuels créées avec consultations vidéo, portails patients et conformité HIPAA. Contactez-nous pour les tarifs.')
@section('meta_keywords', 'développement site web télémédecine,plateforme soins virtuels,consultation médicale en
ligne,développement logiciel télésanté,plateforme consultation vidéo,surveillance patient à distance,développement
application santé,plateforme conforme HIPAA')
            ...
            <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                <div class="space-y-6 lg:space-y-8 text-center">
                    <nav class="flex items-center justify-center gap-2 text-xs text-gray-400" aria-label="Breadcrumb"><a class="hover:text-gray-600 transition-colors" aria-label="Home" href="{{ route('home') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house w-3 h-3" aria-hidden="true">
                            ...
                            </svg></a><span>/</span><a class="hover:text-gray-600 transition-colors" href="/#industries">Industries</a><span>/</span><span class="text-gray-600">Télémédecine
                            &amp; Virtual Care</span></nav>
                    <div class="flex justify-center">
                        <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full">
                            <div class="relative">
                                ...
                                <!-- -->Télémédecine &amp; Virtual Care<!-- --> Projets</span><span class="text-xs sm:text-sm text-[#0F0F0F]/40">•</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin w-3.5 h-3.5 text-[#00AEEF]" aria-hidden="true">
                                <path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0">
                                </path>
                                <circle cx="12" cy="10" r="3"></circle>
                            </svg><span class="text-xs sm:text-sm text-[#0F0F0F]/70">📹<!-- --> <!-- -->Télémédecine
                                &amp; Virtual Care<!-- -->, <!-- -->Industrie Spécialisée</span>
                        </div>
                    </div>
                    <div class="space-y-6">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">Basé dans le secteur <!-- -->Télémédecine &amp;
                                Virtual Care</span>
                        </div>
                        ...
                        <div class="w-px h-4 bg-[#0F0F0F]/20"></div>
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span class="font-semibold text-[#0F0F0F]">50+ clients dans <!-- -->Télémédecine &amp;
                                Virtual Care<!-- --></span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">50% de Nos Clients sont
                                    des Prestataires de Télémédecine</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Expertise approfondie des
                                    plateformes de soins virtuels, des systèmes de consultation en ligne et du suivi ?
                                    distance des patients. Nous maîtrisons la conformité HIPAA, les exigences de qualité
                                    vidéo et les parcours d'engagement patient.</p>
                    ...
                    <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Fonctionnalités Santé
                                    Alimentées par l'IA</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Vérificateurs de symptômes
                                    IA personnalisés et chatbots pour le triage des patients. Le dépistage
                                    pré-consultation réduit le temps du médecin de 40% tout en améliorant la précision
                                    diagnostique.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    ...
                    <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Conforme HIPAA par
                                    Défaut</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Toutes les plateformes de
                                    télémédecine incluent vidéo chiffrée, messagerie sécurisée, journaux d'audit et
                                    accords BAA. Nous gérons la conformité pour que vous puissiez vous concentrer sur
                    ...
                    <div class="relative group opacity-100 translate-y-0 transition-all duration-700 ease-out h-full">
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">De la vérification des
                                    symptômes à la consultation vidéo en passant par la livraison de prescriptions -
                                    nous construisons l'écosystème complet : portails patients, tableaux de bord
                                    médecins, intégrations pharmacies et systèmes de facturation.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Support de plus de 50
                                    langues et 20+ devises. Essentiel pour les services de télémédecine internationaux
                                    et les plateformes de tourisme médical.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-full bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                            <div class="relative z-10 p-8 h-full flex flex-col min-h-[240px]">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 flex-shrink-0">Déploiement Rapide pour
                                    la Santé</h3>
                                <p class="text-gray-600 text-sm leading-relaxed flex-grow">Lancez votre plateforme de
                                    télémédecine en 10-14 jours. Processus agile conçu pour les délais de conformité
                                    santé et les besoins urgents des patients.</p>
                                <div class="mt-6 pt-6 border-t border-gray-50 flex-shrink-0"></div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F5F5F5]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center">
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-8" style="font-family:var(--font-heading)">Adopté par les <!-- -->Télémédecine &amp; Virtual
                    Care<!-- --> Entreprises</h2>
                ...
                <p class="text-xs md:text-sm text-[#0F0F0F]/60 max-w-xl mx-auto px-4">Résultats réels de
                    <!-- -->Télémédecine &amp; Virtual Care<!-- --> avec lesquelles nous avons collaboré
                </p>
            </div>
        </div>
    </section>
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Le Défi<!-- -->: <!-- -->Télémédecine &amp; Virtual
                    Care<!-- --> Les Entreprises Font Face à des Défis Web Uniques</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Les développeurs web généralistes ne comprennent
                    pas ces problèmes spécifiques à la télémédecine &amp; soins virtuels</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]" style="font-family:var(--font-heading)">Les Plateformes Génériques ne sont pas Conformes
                            HIPAA</h3>
                        <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm" style="font-family:var(--font-body)">Zoom and Google Meet don&#x27;t meet HIPAA
                            requirements pour protected health information. You need BAA-signed video platforms with
                            encrypted storage. We build HIPAA-compliant video platforms with end-to-end encryption,
                            secure data storage, audit logs, and signed Business Associate Agreements.</p>
                    </div>
                </div>
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]" style="font-family:var(--font-heading)">Les Médecins Perdent du Temps avec les Absences
                        </h3>
                ...
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]" style="font-family:var(--font-heading)">Mauvaise Gestion des Dossiers Patients</h3>
                ...
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm" style="font-family:var(--font-body)">Gérer les demandes patients sur WhatsApp, e-mail,
                            téléphone et visites en clinique devient vite ingérable. Les patients posent les mêmes
                            questions en boucle. Des chatbots IA entraînés sur vos FAQ médicales traitent 70 % des
                            demandes (prise de rendez-vous, questions de sant? de base, renouvellements d'ordonnance) et
                            orientent les cas complexes vers les médecins.</p>
                    </div>
                </div>
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm" style="font-family:var(--font-body)">Encaisser après la consultation entraîne 20 ? 30 % de
                            factures impayées. Le traitement des demandes d'assurance prend des semaines et mobilise du
                            personnel dédié. Nous mettons en place l'encaissement avant consultation, la vérification
                            automatisée des assurances, l'envoi des demandes aux principaux assureurs et une
                            tarification transparente avec estimation des coûts avant la consultation.</p>
                    </div>
                </div>
                <div>
                    <div class="h-full bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:border-[#00AEEF]/30 hover:shadow-lg transition-all duration-200">
                        ...
                        <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]" style="font-family:var(--font-heading)">Faible Rétention &amp; Engagement des Patients</h3>
                        <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm" style="font-family:var(--font-body)">Les patients utilisent la télémédecine une fois puis
                            ne reviennent pas. Sans système pour suivre les résultats de sant? ou encourager les
                            consultations de suivi, la rétention chute. Nous ajoutons des outils d'engagement incluant
                            rappels sant?, suivi d'observance, réservation automatique de suivi et programmes de
                            fidélité pour les consultations répétées.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mb-16">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sparkles w-4 h-4 mr-2" aria-hidden="true">
                        ...
                        <path d="M22 4h-4"></path>
                        <circle cx="4" cy="20" r="2"></circle>
                    </svg>Conçu sur Mesure pour <!-- -->Télémédecine &amp; Virtual Care
                </div>
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Fonctionnalités Essentielles<!-- --> pour
                    <!-- -->Télémédecine &amp; Virtual Care<!-- --> Sites Web
                </h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Tout ce dont votre entreprise de télémédecine
                    &amp; soins virtuels a besoin en une seule plateforme</p>
            </div>
                        ...
                        <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                            <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                    <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10" style="font-family:var(--font-heading)">Plateforme de Consultation Vidéo</h3>
                                    <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg" style="font-family:var(--font-body)">Appels vidéo HD conformes HIPAA avec
                                        partage d'écran, téléchargement de fichiers et enregistrement de consultation.
                                    </p>
                                    <ul class="space-y-3 md:space-y-4 relative z-10">
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                            ...
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Vidéo chiffrée de bout en bout
                                                (WebRTC)</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Partage d'écran pour la revue de
                                                rapports</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Chat en temps réel pendant les
                                                appels</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                        ...
                        <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                            <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                    ...
                                    <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg" style="font-family:var(--font-body)">Tableau de bord personnalisé pour la prise
                                        de rendez-vous, la consultation des dossiers médicaux et la gestion des
                                        prescriptions.</p>
                                    <ul class="space-y-3 md:space-y-4 relative z-10">
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                        ...
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Télécharger les rapports médicaux
                                                &amp; résultats de laboratoire</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Messagerie sécurisée avec les
                                                médecins</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Historique de paiement &amp;
                                                réclamations d'assurance</span></li>
                                    </ul>
                                </div>
                                <div class="flex-1 relative min-h-[280px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden">
                ...
                <div>
                    <div class="bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-2.5">
                        <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                            <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                    <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10" style="font-family:var(--font-heading)">Vérificateur de Symptômes IA</h3>
                                    <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg" style="font-family:var(--font-body)">Système de triage pré-consultation qui
                                        recommande le spécialiste et le niveau d'urgence.</p>
                                    <ul class="space-y-3 md:space-y-4 relative z-10">
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Évaluation conversationnelle des
                                                symptômes</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Moteur de recommandation de
                                                spécialistes</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                        ...
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Prise de rendez-vous
                                                automatisée</span></li>
                                    </ul>
                                </div>
                                <div class="flex-1 relative min-h-[280px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden">
                                    ...
                                    </div><img src="{{ asset('images/healthcare/healthcare-appointment-booking.webp') }}" alt="AI Symptom Checker" class="absolute inset-0 w-full h-full object-contain" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                    <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10" style="font-family:var(--font-heading)">Tableau de Bord de Rendez-vous &amp;
                                        Analytiques</h3>
                                    <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg" style="font-family:var(--font-body)">Tableau de bord médecin pour la gestion
                                        des emplois du temps, dossiers patients et analytiques de revenus.</p>
                                    <ul class="space-y-3 md:space-y-4 relative z-10">
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                        ...
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Accès à l'historique médical du
                                                patient</span></li>
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                        ...
                                        <li class="flex items-start gap-2 md:gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4 md:w-5 md:h-5 text-[#00AEEF] flex-shrink-0 mt-0.5 md:mt-1" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-sm md:text-base text-[#0F0F0F]/80 leading-relaxed" style="font-family:var(--font-body)">Système de gestion des
                                                prescriptions</span></li>
                                    </ul>
                                </div>
                                <div class="flex-1 relative min-h-[280px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden">
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                <div class="inline-flex items-center rounded-full font-medium transition-all duration-200 bg-[var(--color-primary-orange)]/10 text-[var(--color-primary-orange)] border border-[var(--color-primary-orange)]/20 text-xs px-3 py-1 mb-4">
                    ...
                    </svg>Nos Réalisations en <!-- -->Télémédecine &amp; Virtual Care
                </div>
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Histoires de Succès en <!-- -->Télémédecine &amp; Virtual
                    Care</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Projets réels, résultats réels. Découvrez
                    comment nous avons aidé les entreprises en <!-- -->Télémédecine &amp; Virtual Care<!-- --> à
                    atteindre leurs objectifs numériques.</p>
            </div>
            <div class="grid md:grid-cols-2 gap-8 lg:gap-10 mb-10">
                        ...
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]"><video src="{{ asset('images/our-work/doctor-hubli/doctor-hubli-hero.mp4') }}" autoPlay="" loop="" muted="" playsInline="" class="w-full h-full object-cover"></video>
                                <div class="absolute top-5 right-5 px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30">
                                    <span class="text-xs font-bold text-white tracking-wide uppercase">PLATEFORME DE
                                        TÉLÉMÉDECINE</span>
                                </div>
                                <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        </svg>+500% de Visites Virtuelles</span></div>
                            </div>
                            <div class="px-5 py-4">
                ...
                <div><a class="block" href="{{ route('case-study', 'msingermany') }}">
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]">
                                <div class="absolute inset-0 from-blue-500 via-indigo-500 to-purple-600"></div><img src="{{ asset('images/our-work/msingermany/msingermany-dashboard.webp') }}" alt="MS in Germany" class="absolute inset-0 w-full h-full object-cover" />
                                <div class="absolute top-5 right-5 px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30">
                                    <span class="text-xs font-bold text-white tracking-wide uppercase">WEBINAIRES
                                        ÉDUCATIFS</span>
                                </div>
                                <div class="absolute top-5 left-5 px-3 py-1.5 bg-[#22C55E] rounded-full"><span class="text-xs font-bold text-white tracking-wide flex items-center gap-1.5"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                        </svg>+150% de Participation aux Webinaires</span></div>
                            </div>
                            <div class="px-5 py-4">
    ...
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Notre Processus de Développement<!-- --> pour
                    <!-- -->Télémédecine &amp; Virtual Care
                </h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Du concept au lancement en 4 semaines, optimisé
                    pour les entreprises de télémédecine &amp; soins virtuels</p>
            </div>
            <div class="relative">
                        ...
                        <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row">
                            <div class="flex-1">
                                <div class="bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:shadow-lg transition-all duration-200">
                                    ...
                                    <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4" style="font-family:var(--font-heading)">Discovery &amp; Télémédecine Strategy
                                    </h3>
                                    <ul class="space-y-2">
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Analyse du flux de travail de
                                                télémédecine et définition des cas d'utilisation</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Exigences de conformité HIPAA pour
                                                les consultations vidéo</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Stratégie de remboursement
                                                d'assurance pour les services de télésanté</span></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                            <div class="flex-1">
                                <div class="bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:shadow-lg transition-all duration-200">
                                    ...
                                    <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4" style="font-family:var(--font-heading)">Design &amp; Expérience Patient</h3>
                                    <ul class="space-y-2">
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Interface personnalisée pour la
                                                salle d'attente virtuelle et l'interface de consultation</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Flux d'intégration patient pour
                                                les nouveaux utilisateurs de télésanté</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                        ...
                        <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row">
                            <div class="flex-1">
                                <div class="bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:shadow-lg transition-all duration-200">
                                    ...
                                    <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4" style="font-family:var(--font-heading)">Développement &amp; Intégration Vidéo
                                    </h3>
                                    <ul class="space-y-2">
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Système de consultation vidéo
                                                chiffré de bout en bout</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Intégration d'e-prescription avec
                                                les réseaux de pharmacies</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Intégration de stéthoscope
                                                numérique et dispositifs de surveillance à distance</span></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="hidden md:flex items-center justify-center flex-shrink-0 relative">
                        ...
                        <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                            <div class="flex-1">
                                <div class="bg-white rounded-xl p-5 md:p-8 border border-[#0F0F0F]/8 hover:shadow-lg transition-all duration-200">
                                    ...
                                    <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4" style="font-family:var(--font-heading)">Tests, Conformité &amp; Lancement</h3>
                                    <ul class="space-y-2">
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Audit de conformité HIPAA et BAA
                                                (Business Associate Agreement)</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Tests de charge pour les
                                                consultations vidéo simultanées</span></li>
                                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 mt-0.5 text-[#00AEEF]" aria-hidden="true">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <path d="m9 12 2 2 4-4"></path>
                                            </svg><span class="text-xs md:text-sm text-[#0F0F0F]/70" style="font-family:var(--font-body)">Formation des prestataires sur
                                                les fonctionnalités de la plateforme de télésanté</span></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="hidden md:flex items-center justify-center flex-shrink-0 relative">
            ...
            <div class="text-center mt-12 md:mt-16 pt-8 md:pt-12 border-t border-[#0F0F0F]/8">
                <p class="text-lg md:text-xl font-semibold text-[#0F0F0F] mb-5 md:mb-6 max-w-2xl mx-auto px-4" style="font-family:var(--font-heading)">Prêt à démarrer votre <!-- -->télémédecine &amp; soins
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 max-w-6xl mx-auto">
                ...
                <div class="relative bg-white rounded-[32px] p-3 text-black border border-black/10">
                    ...
                    <div class="px-6 md:px-8 pb-3">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3"><button data-cal-link="pikasso/discovery" data-cal-config="{&quot;layout&quot;:&quot;month_view&quot;}" class="flex-1 px-6 py-3.5 rounded-full bg-black text-white font-semibold hover:bg-black/90 transition-colors whitespace-nowrap">Réserver
                                un Appel Découverte</button><a href="https://wa.me/212632582096?text=Hi%20CodeSommetStudio!%20I'm%20interested%20in%20learning%20more%20about%20your%20web%20development%20services." target="_blank" rel="noopener noreferrer" class="flex-1 px-6 py-3.5 rounded-full border-2 border-black/20 text-black font-semibold hover:bg-black/5 transition-colors text-center inline-flex items-center justify-center whitespace-nowrap">Connectez-vous
                                sur WhatsApp</a></div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="max-w-4xl mx-auto">
                <div class="bg-gradient-to-br from-[#00AEEF]/5 to-orange-50 rounded-3xl p-8 md:p-12 border-2 border-[#00AEEF]/20 text-center">
                    ...
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[var(--text-primary)]" style="font-family:var(--font-heading)">Prêt à Transformer Votre Site Web de Télémédecine
                        &amp; Soins Virtuels ?</h2>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">CodeSommetStudio <!-- -->Télémédecine &amp; Virtual
                    Care<!-- --> vs Autres</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Découvrez pourquoi <!-- -->Télémédecine &amp;
                    Virtual Care<!-- --> entreprises choisissent CodeSommetStudio plutôt que d'autres agences locales et
            ...
            <div class="max-w-5xl mx-auto">
                <div class="overflow-x-auto -mx-4 md:mx-0 px-4 md:px-0">
                    <div class="bg-white rounded-2xl border border-[#0F0F0F]/10 overflow-hidden shadow-xl min-w-[600px]">
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Télémédecine
                                Experience</div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span class="text-sm font-bold text-[#0F0F0F]">Plus de 20 plateformes de télésanté
                                    créées</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Développement web généraliste</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Aucune
                                    expérience en santé</span></div>
                        </div>
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            ...
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span class="text-sm font-bold text-[#0F0F0F]">Intégré avec signature BAA</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Coût de
                                    conformité supplémentaire</span></div>
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Plateforme de
                                Consultation Vidéo</div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span class="text-sm font-bold text-[#0F0F0F]">Vidéo HD avec enregistrement</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Intégration
                                    Zoom basique</span></div>
                            <div class="p-3 md:p-4 text-center"><span class="text-sm text-[#0F0F0F]/60">Tiers
                                    uniquement</span></div>
                        </div>
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Vérificateur de
                                Symptômes IA</div>
                            <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span class="text-sm font-bold text-[#0F0F0F]">Formé sur des données médicales</span>
                            </div>
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-white">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Intégration DME
                            </div>
                        ...
                        <div class="grid grid-cols-4 border-b border-[#0F0F0F]/5 hover:bg-[#F8F8F8]/50 transition-colors bg-[#F8F8F8]/30">
                            <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Healthcare Support
                                de Conformité</div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-[#0F0F0F]/60 mb-4">* Comparaison basée sur les prix moyens et les offres de
                        services des 10 meilleures agences en <!-- -->Télémédecine &amp; Virtual Care</p>
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full text-sm font-semibold text-[#22C55E]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check w-4 h-4" aria-hidden="true">
                            <circle cx="12" cy="12" r="10"></circle>
                            <path d="m9 12 2 2 4-4"></path>
                        </svg>Meilleur Rapport Qualité-Prix pour <!-- -->Télémédecine &amp; Virtual Care<!-- -->
                        Entreprises
                    </div>
                </div>
            </div>
    ...
    <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4" style="font-family:var(--font-heading)">Ce que Nos Clients en Télémédecine &amp; Virtual Care Disent de Nous</h2>
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Ne nous croyez pas sur parole. Écoutez les
                    entreprises en <!-- -->Télémédecine &amp; Virtual Care<!-- --> qui ont obtenu des résultats
                    remarquables avec CodeSommetStudio.</p>
            </div>
        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Vous avez des questions ? Nous avons les
                    réponses. Voici les questions les plus courantes de <!-- -->Télémédecine &amp; Virtual Care<!-- -->
                    entreprises.</p>
            </div>
            <div class="max-w-4xl mx-auto bg-white rounded-2xl border border-[#0F0F0F]/10 p-6">
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Combien de temps faut-il pour créer
                                une plateforme de télémédecine ?</h3>
                        </div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Votre plateforme de télémédecine
                                est-elle conforme HIPAA ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Le vérificateur de symptômes IA
                                peut-il gérer le triage médical ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Quelle plateforme vidéo
                                utilisez-vous pour les consultations ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Pouvez-vous vous intégrer à notre
                                système DME existant ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Supportez-vous les services de
                                télémédecine internationaux ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Comment gérez-vous la gestion des
                                prescriptions ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                ...
                <div class="border-b border-[#0F0F0F]/10 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-[#00AEEF]/5 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-semibold text-[#0F0F0F] mb-1">Pouvez-vous aider à commercialiser
                                notre plateforme de télémédecine ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-[#0F0F0F]/40" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
            ...
            <div class="mt-10 text-center">
                <p class="text-sm text-[#0F0F0F]/60 mb-2">Vous avez encore des questions ?</p><a href="{{ route('contact') }}" class="text-[#00AEEF] font-semibold hover:underline inline-flex items-center gap-2">Contactez
                    notre <!-- -->Télémédecine &amp; Virtual Care<!-- --> équipe<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section class="w-full py-24 md:py-32 bg-white">
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
            <div class="text-center mb-12">
                ...
                <p class="text-[#0F0F0F]/70 text-lg max-w-2xl mx-auto">Nous avons créé des sites web de télémédecine
                    &amp; soins virtuels pour des clients du monde entier. Que vous soyez au Maroc ou ailleurs, nous
                    livrons des solutions de classe mondiale.</p>
            </div>
            ...
            <div class="text-center pt-5 md:pt-6 border-t border-[#0F0F0F]/8">
                <p class="text-sm md:text-base text-[#0F0F0F]/70 mb-3 md:mb-4 px-4">Vous cherchez <!-- -->télémédecine
                    &amp; soins virtuels<!-- --> développement web dans une ville spécifique ?</p>
