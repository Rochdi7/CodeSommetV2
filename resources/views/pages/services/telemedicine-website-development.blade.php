                ...
                <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                    <div class="space-y-6 lg:space-y-8 text-center">
                        <nav class="flex items-center justify-center gap-2 text-xs text-gray-400" aria-label="Breadcrumb"><a
                                ...
                                href="/#industries">Industries</a><span>/</span><span class="text-gray-600">Télémédecine
                        ...
                        <div class="flex justify-center">
                            <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 rounded-full">
                                <div class="relative">
                                    ...
                                    <!-- -->Télémédecine &amp; Virtual Care<!-- --> Projets</span><span
                            ...
                            <h1 class="leading-[1.15] tracking-tight uppercase text-[28px] sm:text-[40px] lg:text-[56px] font-extrabold max-w-5xl mx-auto"
                                ...
                                <span class="jsx-5c81c8c63985dc3f inline-block relative text-black"><span
                                        ...
                                        class="jsx-5c81c8c63985dc3f relative inline-flex items-center justify-center px-3 py-3"><span
                                            ...
                                            class="jsx-5c81c8c63985dc3f inline-block opacity-0 pointer-events-none">CONSULTATIONS
                                            VIDÉO</span><span
                                            class="jsx-5c81c8c63985dc3f absolute inset-0 inline-flex items-center justify-center animate-[textFadeIn_0.3s_ease-in-out,textReveal_1.2s_cubic-bezier(0.22,1,0.36,1)]">CONSULTATIONS
                                            VIDÉO</span></span></span></h1>
                            <p
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base pt-4">
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">Basé dans le secteur <!-- -->Télémédecine &amp;
                                    Virtual Care</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-[#00AEEF]"></div><span
                                    class="font-semibold text-[#0F0F0F]">50+ clients dans <!-- -->Télémédecine &amp;
                                    Virtual Care<!-- --></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center">
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-8"
                        style="font-family:var(--font-heading)">Adopté par les <!-- -->Télémédecine &amp; Virtual
                        Care<!-- --> Entreprises</h2>
                    <div
                    ...
                    <p class="text-xs md:text-sm text-[#0F0F0F]/60 max-w-xl mx-auto px-4">Résultats réels de
                        <!-- -->Télémédecine &amp; Virtual Care<!-- --> avec lesquelles nous avons collaboré</p>
                </div>
            </div>
        </section>
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Le Défi<!-- -->: <!-- -->Télémédecine &amp; Virtual
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">Les Plateformes Génériques ne sont pas Conformes
                                HIPAA</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">Zoom and Google Meet don&#x27;t meet HIPAA
                    ...
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">Les Médecins Perdent du Temps avec les Absences
                            </h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                    ...
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">Mauvaise Gestion des Dossiers Patients</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                    ...
                    <div>
                        <div
                            ...
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">Gérer les demandes patients sur WhatsApp, e-mail,
                    ...
                    <div>
                        <div
                            ...
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">Encaisser après la consultation entraîne 20 ? 30 % de
                    ...
                    <div>
                        <div
                            ...
                            <h3 class="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-[#0F0F0F]"
                                style="font-family:var(--font-heading)">Faible Rétention &amp; Engagement des Patients</h3>
                            <p class="text-[#0F0F0F]/70 leading-relaxed text-xs md:text-sm"
                                style="font-family:var(--font-body)">Les patients utilisent la télémédecine une fois puis
                ...
                <div class="text-center mt-10 md:mt-12">
                    <p class="text-base md:text-lg font-semibold text-[#0F0F0F] mb-5 md:mb-6 max-w-2xl mx-auto px-4"
                        ...
                        exacts pour plus de 40 <!-- -->télémédecine &amp; soins virtuels<!-- --> entreprises.</p><a
                ...
                <div class="text-center mb-16">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <path d="M22 4h-4"></path>
                            <circle cx="4" cy="20" r="2"></circle>
                        </svg>Conçu sur Mesure pour <!-- -->Télémédecine &amp; Virtual Care</div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Fonctionnalités Essentielles<!-- --> pour
                        <!-- -->Télémédecine &amp; Virtual Care<!-- --> Sites Web</h2>
                                ...
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">Plateforme de Consultation Vidéo</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">Appels vidéo HD conformes HIPAA avec
                                        ...
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Vidéo chiffrée de bout en bout
                                                    (WebRTC)</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Partage d'écran pour la revue de
                                                    rapports</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Chat en temps réel pendant les
                                                    appels</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            ...
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        ...
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">Tableau de bord personnalisé pour la prise
                                        ...
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Télécharger les rapports médicaux
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Messagerie sécurisée avec les
                                                    médecins</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Historique de paiement &amp;
                        ...
                        <div class="bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-2.5">
                            <div class="bg-[#F8F8F8] rounded-[20px] overflow-hidden relative">
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            style="font-family:var(--font-heading)">Vérificateur de Symptômes IA</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">Système de triage pré-consultation qui
                                        ...
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Évaluation conversationnelle des
                                                    symptômes</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    style="font-family:var(--font-body)">Moteur de recommandation de
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Prise de rendez-vous
                                                    automatisée</span></li>
                                        </ul>
                                    </div>
                                    <div
                                ...
                                <div class="flex flex-col md:flex-row gap-0" style="flex-direction:row-reverse">
                                    <div class="flex-1 p-6 md:p-10 lg:p-12 relative overflow-hidden">
                                        <h3 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#0F0F0F] relative z-10"
                                            ...
                                            Analytiques</h3>
                                        <p class="text-base md:text-lg text-[#0F0F0F]/70 mb-6 md:mb-8 leading-relaxed relative z-10 max-w-lg"
                                            style="font-family:var(--font-body)">Tableau de bord médecin pour la gestion
                                        ...
                                        <ul class="space-y-3 md:space-y-4 relative z-10">
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Accès à l'historique médical du
                                                    patient</span></li>
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            ...
                                            <li class="flex items-start gap-2 md:gap-3"><svg
                                                    ...
                                                    style="font-family:var(--font-body)">Système de gestion des
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    <div
                        ...
                        </svg>Nos Réalisations en <!-- -->Télémédecine &amp; Virtual Care</div>
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">Histoires de Succès en <!-- -->Télémédecine &amp; Virtual
                        Care</h2>
                            ...
                            <div
                                ...
                                <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]">
                                    <div class="absolute inset-0 from-orange-500 via-red-500 to-pink-600"></div><img
                                        src="{{ asset('images/our-work/qogent/qogent-hero-caricature.webp') }}"
                                        alt="Qogent Global" class="absolute inset-0 w-full h-full object-cover" />
                                    <div
                                        class="absolute top-5 right-5 px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30">
                            ...
                            <div
                                ...
                                <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]">
                                    <div class="absolute inset-0 from-blue-500 via-indigo-500 to-purple-600"></div><img
                                        src="{{ asset('images/our-work/msingermany/msingermany-dashboard.webp') }}"
                                        alt="MS in Germany" class="absolute inset-0 w-full h-full object-cover" />
                                    <div
                                        class="absolute top-5 right-5 px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30">
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                                ...
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">Discovery &amp; Télémédecine Strategy
                                        </h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Analyse du flux de travail de
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Exigences de conformité HIPAA pour
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Stratégie de remboursement
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">Design &amp; Expérience Patient</h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">Interface personnalisée pour la
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Flux d'intégration patient pour
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">Développement &amp; Intégration Vidéo
                                        </h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    style="font-family:var(--font-body)">Système de consultation vidéo
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Intégration d'e-prescription avec
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Intégration de stéthoscope
                            ...
                            <div class="flex flex-col md:flex-row gap-6 md:gap-8" style="flex-direction:row-reverse">
                                <div class="flex-1">
                                    <div
                                        ...
                                        <h3 class="text-lg md:text-xl lg:text-2xl font-semibold text-[#0F0F0F] mb-3 md:mb-4"
                                            style="font-family:var(--font-heading)">Tests, Conformité &amp; Lancement</h3>
                                        <ul class="space-y-2">
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    ...
                                                    style="font-family:var(--font-body)">Audit de conformité HIPAA et BAA
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Tests de charge pour les
                                            ...
                                            <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="font-family:var(--font-body)">Formation des prestataires sur
                ...
                <div class="text-center mt-12 md:mt-16 pt-8 md:pt-12 border-t border-[#0F0F0F]/8">
                    <p class="text-lg md:text-xl font-semibold text-[#0F0F0F] mb-5 md:mb-6 max-w-2xl mx-auto px-4"
                        style="font-family:var(--font-heading)">Prêt à démarrer votre <!-- -->télémédecine &amp; soins
                        virtuels<!-- --> projet de site web ?</p><a
                        class="h-10 px-6 text-base rounded-full inline-flex items-center justify-center font-medium transition-all duration-200 bg-gradient-to-r from-[var(--color-primary-orange)] to-[var(--color-orange-hover)] text-white hover:text-white shadow-[0_4px_16px_rgba(0,174,239,0.25)] hover:shadow-[0_6px_24px_rgba(0,174,239,0.35)] hover:-translate-y-0.5 [&amp;&gt;*]:text-white [&amp;&gt;*]:hover:text-white h-11 md:h-12 px-6 md:px-8 text-sm md:text-base"
                ...
                <div class="max-w-4xl mx-auto">
                    <div
                        ...
                        <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[var(--text-primary)]"
                            style="font-family:var(--font-heading)">Prêt à Transformer Votre Site Web de Télémédecine
                            &amp; Soins Virtuels ?</h2>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">Plus de 20 plateformes de télésanté
                                        créées</span></div>
                                <div class="p-3 md:p-4 text-center"><span
                                        class="text-sm text-[#0F0F0F]/60">Développement web généraliste</span></div>
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">Intégré avec signature BAA</span></div>
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">Vidéo HD avec enregistrement</span></div>
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 font-medium text-xs md:text-sm text-[#0F0F0F]">Vérificateur de
                                    Symptômes IA</div>
                                <div class="p-3 md:p-4 text-center bg-[#00AEEF]/5"><span
                                        class="text-sm font-bold text-[#0F0F0F]">Formé sur des données médicales</span>
                                </div>
        ...
        <section class="w-full py-24 md:py-32 bg-[#F8F8F8]">
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                <div class="text-center mb-12">
                    ...
                    <h2 class="font-heading font-semibold tracking-tight text-[var(--text-3xl)] md:text-[var(--text-4xl)] lg:text-[var(--text-5xl)] mb-4"
                        style="font-family:var(--font-heading)">What <!-- -->Télémédecine &amp; Virtual Care<!-- --> Les
                        Clients Disent de Nous</h2>
            ...
            <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)]">
                ...
                <div class="mt-10 text-center">
                    <p class="text-sm text-[#0F0F0F]/60 mb-2">Vous avez encore des questions ?</p><a
                        ...
                        notre <!-- -->Télémédecine &amp; Virtual Care<!-- --> équipe<svg class="w-4 h-4" fill="none"
