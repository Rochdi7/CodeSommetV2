        ...
        <div class="w-full mx-auto px-[var(--container-padding)] max-w-[var(--container-max)] relative z-10">
            <div class="grid lg:grid-cols-1 gap-6 lg:gap-8 items-center">
                <div class="space-y-6 lg:space-y-8 text-center">
                    ...
                    rgba(0, 0, 0, 0.02) 0px 150px 150px -3.75px" href="https://cal.com/code-sommet/new-client-meeting"><span class="relative text-[15px] font-semibold text-white z-10">Réserver une Démo Éducation
...
<div><a class="block" href="{{ route('case-study', 'gls-sprachenzentrum') }}">
                ...
                <div><a class="block" href="{{ route('case-study', 'morocco-quest') }}">
                        <div class="w-full bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden p-2.5">
                            <div class="relative aspect-[16/9] overflow-hidden rounded-[14px] bg-[#F3F4F6]">
                                <div class="absolute inset-0 from-blue-500 via-indigo-500 to-purple-600"></div><img src="{{ asset('images/our-work/morocco-quest/homepage.webp') }}" alt="Morocco Quest" class="absolute inset-0 w-full h-full object-cover" />
                                <div class="absolute top-5 right-5 px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/30">
