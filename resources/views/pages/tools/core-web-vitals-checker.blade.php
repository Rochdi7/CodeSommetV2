...
@section('title', 'Vérificateur Core Web Vitals - Outil Gratuit de Performance Web | CodeSommet')
@section('meta_description', 'Mesurez les Core Web Vitals de votre site web (LCP, FID, CLS, INP) pour améliorer les classements Google et les performances. Obtenez des métriques mobile et desktop avec des recommandations concrètes.')
...
@section('og_title', 'Vérificateur Core Web Vitals - Outil Gratuit de Performance Web')
@section('og_description', 'Mesurez les Core Web Vitals de votre site web (LCP, FID, CLS, INP) pour améliorer les classements Google et les performances. Obtenez des métriques mobile et desktop avec des recommandations concrètes.')
@section('twitter_description', 'Mesurez les Core Web Vitals de votre site pour améliorer les classements Google et les performances. Outil gratuit.')
...
<section class="relative overflow-hidden pt-28 pb-16 bg-white">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <nav class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-8"><a class="hover:text-[#00AEEF] transition-colors" href="/">Accueil</a><span>/</span><a class="hover:text-[#00AEEF] transition-colors" href="/tools">Outils</a><span>/</span><span class="text-black font-medium">Vérificateur Core Web Vitals</span></nav>
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">Vérificateur Core Web Vitals</h1>
            <p class="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">Mesurez les Core Web Vitals de votre site (LCP, FID, CLS, INP) pour améliorer les classements Google, l'expérience utilisateur et les performances. Obtenez des métriques mobile et desktop avec des recommandations concrètes.</p>
        </div>
