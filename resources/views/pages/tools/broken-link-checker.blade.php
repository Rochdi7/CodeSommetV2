...
@section('title', 'Vérificateur de Liens Brisés - Détecteur de Liens Morts Gratuit | CodeSommet')
@section('meta_description', 'Trouvez et corrigez les liens brisés, les URL mortes et les erreurs 404 sur votre site web. Outil gratuit de vérification de liens brisés pour améliorer le SEO, l\'expérience utilisateur et maintenir un site web sain. Scannez n\'importe quelle page instantanément.')
@section('meta_keywords', 'broken link checker,dead link finder,404 checker,link validator,broken URL checker,link tester')
@section('og_title', 'Vérificateur de Liens Brisés - Détecteur de Liens Morts Gratuit')
@section('og_description', 'Trouvez et corrigez les liens brisés, les URL mortes et les erreurs 404 sur votre site web. Outil gratuit de vérification de liens brisés pour améliorer le SEO, l\'expérience utilisateur et maintenir un site web sain. Scannez n\'importe quelle page instantanément.')
@section('twitter_description', 'Trouvez et corrigez les liens brisés, les URL mortes et les erreurs 404 sur votre site web. Outil gratuit de vérification de liens brisés pour améliorer le SEO, l\'expérience utilisateur et maintenir un site web sain. Scannez n\'importe quelle page instantanément.')
...
<section class="relative overflow-hidden pt-28 pb-16 bg-white">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <nav class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-8"><a class="hover:text-[#00AEEF] transition-colors" href="/">Accueil</a><span>/</span><a class="hover:text-[#00AEEF] transition-colors" href="/tools">Outils</a><span>/</span><span class="text-black font-medium">Vérificateur de Liens Brisés</span></nav>
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">Vérificateur de Liens Brisés</h1>
            <p class="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">Scannez votre page web pour les liens brisés et les redirections. Trouvez et corrigez les erreurs 404, les délais d'attente et les URL obsolètes pour améliorer le SEO et l'expérience utilisateur.</p>
        </div>
    ...
    <div class="space-y-6">
        <div class="space-y-4">
            <div class="space-y-2"><label class="block text-sm font-medium text-black">URL du site web<span class="text-[#00AEEF] ml-1">*</span></label>
                ...
                <p class="text-sm text-gray-500">Entrez l'URL de la page web à scanner pour les liens brisés</p>
                ...
                </svg>Vérifier les Liens Brisés</button>
        </div>
    </div>
</section>
