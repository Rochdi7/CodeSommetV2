...
@section('title', 'Générateur Lorem Ipsum - Outil de Texte de Remplissage Gratuit | CodeSommet')
@section('meta_description', 'Générez du texte de remplissage Lorem Ipsum instantanément. Créez des paragraphes, phrases ou mots pour les maquettes de design. Générateur Lorem Ipsum gratuit.')
@section('meta_keywords', 'lorem ipsum generator,placeholder text,dummy text,lorem ipsum,text generator,design placeholder')
@section('og_title', 'Générateur Lorem Ipsum - Outil de Texte de Remplissage Gratuit')
@section('og_description', 'Générez du texte Lorem Ipsum pour les maquettes de design instantanément')
@section('twitter_description', 'Générez du texte Lorem Ipsum pour les maquettes de design instantanément')
...
<section class="relative overflow-hidden pt-28 pb-16 bg-white">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <nav class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-8"><a class="hover:text-[#00AEEF] transition-colors" href="/">Accueil</a><span>/</span><a class="hover:text-[#00AEEF] transition-colors" href="/tools">Outils</a><span>/</span><span class="text-black font-medium">Générateur Lorem Ipsum</span></nav>
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">Générateur Lorem Ipsum</h1>
            <p class="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">Générez du texte de remplissage pour les maquettes et prototypes de design</p>
        </div>
...
<section class="max-w-5xl mx-auto px-4 py-12">
    <div class="space-y-8">
        <div class="bg-white rounded-2xl border-2 border-gray-200 p-8">
            <div class="space-y-6">
                <div class="space-y-2"><label class="text-sm font-medium text-black flex items-center justify-between"><span>Nombre de Paragraphes</span><span class="text-[#00AEEF] font-bold">3</span></label><input type="range" min="1" max="20" class="w-full h-2 bg-gray-200 rounded-full appearance-none cursor-pointer accent-[#00AEEF]" value="3" />
                    <div class="flex justify-between text-xs text-gray-500"><span>1</span><span>20</span></div>
                </div>
                <div class="space-y-2"><label class="text-sm font-medium text-black flex items-center justify-between"><span>Mots par Paragraphe</span><span class="text-[#00AEEF] font-bold">100</span></label><input type="range" min="50" max="500" step="10" class="w-full h-2 bg-gray-200 rounded-full appearance-none cursor-pointer accent-[#00AEEF]" value="100" />
                    <div class="flex justify-between text-xs text-gray-500"><span>50</span><span>500</span></div>
                </div>
                <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-lg"><input type="checkbox" id="classicStart" class="w-5 h-5 rounded accent-[#00AEEF] cursor-pointer" checked="" /><label for="classicStart" class="text-sm text-gray-700 cursor-pointer">Start with classic &quot;Lorem ipsum dolor sit amet...&quot;</label></div><button class="inline-flex items-center justify-center font-medium transition-all duration-200 cursor-pointer disabled:pointer-events-none disabled:opacity-50 relative overflow-hidden transform-gpu focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-primary)] bg-gradient-to-r from-[var(--color-primary-orange)] to-[var(--color-orange-hover)] text-white shadow-[0_8px_20px_rgba(0,174,239,0.3),0_4px_10px_rgba(0,174,239,0.2)] hover:-translate-y-0.5 hover:shadow-[0_12px_30px_rgba(0,174,239,0.4),0_6px_15px_rgba(0,174,239,0.3)] active:translate-y-0 active:shadow-[0_4px_15px_rgba(0,174,239,0.3)] h-10 px-6 text-base rounded-full w-full" tabindex="0">Générer Lorem Ipsum</button>
            </div>
        </div>
        <div class="bg-gradient-to-br from-gray-50 to-white rounded-2xl border-2 border-gray-200 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Qu'est-ce que Lorem Ipsum ?</h3>
            <div class="space-y-4 text-sm text-gray-700">
                <p>Lorem Ipsum est un texte de remplissage couramment utilisé en design et en édition pour démontrer la forme visuelle d'un document sans s'appuyer sur un contenu significatif.</p>
                <div class="space-y-2">
                    <h4 class="font-semibold text-gray-900">Cas d'Utilisation Courants :</h4>
                    <ul class="list-disc list-inside space-y-1 text-gray-600">
                        <li>Maquettes et wireframes de sites web</li>
                        <li>Mises en page de design graphique</li>
                        <li>Démonstrations de typographie</li>
                        <li>Conceptions de modèles</li>
                        <li>Tests de systèmes de gestion de contenu</li>
                    </ul>
                </div>
                <div class="space-y-2">
                    <h4 class="font-semibold text-gray-900">Pourquoi Utiliser Lorem Ipsum ?</h4>
                    <ul class="list-disc list-inside space-y-1 text-gray-600">
                        <li>Concentre l'attention sur le design plutôt que sur le contenu</li>
                        <li>Fournit une distribution de texte réaliste</li>
                        <li>Standard de l'industrie pour les designers et développeurs</li>
                        <li>Évite la distraction du lecteur par le contenu réel</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4 md:p-6">
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Qu'est-ce que Lorem Ipsum et d'où vient-il ?</h3>
                        </div>
                    ...
                    <div class="faq-answer hidden px-4 pb-6 text-sm text-gray-700 leading-relaxed" style="padding-left:3.5rem">
                        <p>Le Lorem Ipsum est un texte latin brouillé dérivé des sections 1.10.32 et 1.10.33 of 'de Finibus Bonorum et Malorum' by Cicero, written in 45 BC. It has been used as placeholder text since the 1500s when an unknown printer scrambled a galley of type to make a specimen book. Today, it's the industry standard for dummy text in design and publishing.</p>
                    </div>
                </div>
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Pourquoi les designers et développeurs utilisent-ils Lorem Ipsum au lieu de vrai contenu ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                    ...
                    <div class="faq-answer hidden px-4 pb-6 text-sm text-gray-700 leading-relaxed" style="padding-left:3.5rem">
                        <p>Le Lorem Ipsum aide les spectateurs à se concentrer sur le design visuel, la typographie et la mise en page sans être distraits par un contenu lisible. It provides realistic text distribution and word length variation that mimics natural language, making it ideal for testing how actual content will look once it's added. Using nonsensical text also prevents clients from prematurely critiquing content when the focus should be on design approval.</p>
                    </div>
                </div>
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Quand dois-je utiliser Lorem Ipsum plutôt que du vrai contenu ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                    ...
                    <div class="faq-answer hidden px-4 pb-6 text-sm text-gray-700 leading-relaxed" style="padding-left:3.5rem">
                        <p>Utilisez Lorem Ipsum pendant les premières phases de design et de prototypage when content isn't ready or when you need to test layouts quickly. However, always replace it with real content before final testing and launch. Real content reveals actual length issues, readability problems, and helps with SEO. Lorem Ipsum should never appear on live production websites.</p>
                    </div>
                </div>
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Quelle est la différence entre la génération Lorem Ipsum basée sur les paragraphes et celle basée sur les mots ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                    ...
                    <div class="faq-answer hidden px-4 pb-6 text-sm text-gray-700 leading-relaxed" style="padding-left:3.5rem">
                        <p>La génération basée sur les paragraphes crée des blocs de texte complets avec une structure de phrase appropriée and punctuation, ideal for testing article layouts, blog posts, and multi-section content. Word-based generation gives you exact word counts, useful for character limits in UI elements like headlines, buttons, or social media posts. Most designers prefer paragraph-based for realistic content simulation.</p>
                    </div>
                </div>
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Existe-t-il des alternatives à Lorem Ipsum ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                ...
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">Comment savoir quand passer de Lorem Ipsum à du vrai contenu ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
                    ...
                    <div class="faq-answer hidden px-4 pb-6 text-sm text-gray-700 leading-relaxed" style="padding-left:3.5rem">
                        <p>Passez au vrai contenu pendant les phases de stratégie de contenu et d'architecture de l'information, typically after initial design approval but before usability testing. Real content is essential for: SEO optimization, accessibility testing, accurate translation work, legal compliance review, and final client approval. Set a hard deadline to replace all placeholder text at least 2 weeks before launch.</p>
                    </div>
                </div>
                <div class="border-b border-gray-200 last:border-0"><button class="w-full py-6 flex items-start gap-4 text-left hover:bg-gray-50 -mx-4 px-4 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-black">L'utilisation de Lorem Ipsum peut-elle affecter le SEO de mon site web ?</h3>
                        </div>
                        <div class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down w-5 h-5 text-gray-400" aria-hidden="true">
                                <path d="m6 9 6 6 6-6"></path>
                            </svg></div>
...
<section class="py-16 bg-white border-t border-gray-100">
    <div class="max-w-5xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-8"><a class="group relative bg-white rounded-xl border border-gray-200 p-6 hover:border-[#00AEEF] hover:shadow-lg transition-all duration-300 hover:-translate-y-1" href="/tools/readability-analyzer">
                <div class="mb-4">
                ...
                <p class="text-sm text-gray-600 leading-relaxed mb-4">Convertissez le HTML en texte brut lisible et propre instantanément</p>
                <div class="flex items-center gap-2 text-[#00AEEF] font-semibold text-sm group-hover:gap-3 transition-all"><span>Essayer gratuitement</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4" aria-hidden="true">
                        <path d="M5 12h14"></path>
                        <path d="m12 5 7 7-7 7"></path>
                    </svg></div>
...
<script src="{{ asset('js/tools/lorem-ipsum-generator.js') }}" defer></script>
@endpush