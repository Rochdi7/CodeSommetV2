...
@section('title', 'Analyseur de Texte Alt d\'Image - Outil SEO d\'Image Gratuit | CodeSommet')
@section('meta_description', "Analysez et optimisez le texte alt des images pour un meilleur SEO et une meilleure accessibilité. Outil gratuit pour vérifier les balises alt manquantes, détecter le bourrage de mots-clés et améliorer les descriptions d'images pour les moteurs de recherche et les lecteurs d'écran.")
@section('meta_keywords', 'image alt analyzer,alt text checker,image SEO,alt tag optimizer,image accessibility,alt text tool,missing alt text checker,alt attribute analyzer,image SEO audit,accessibility checker,screen reader optimization,image optimization tool')
@section('og_title', 'Analyseur de Texte Alt d\'Image - Outil SEO d\'Image Gratuit')
@section('og_description', "Analysez et optimisez le texte alt des images pour un meilleur SEO et une meilleure accessibilité. Outil gratuit pour vérifier les balises alt manquantes, détecter le bourrage de mots-clés et améliorer les descriptions d'images pour les moteurs de recherche et les lecteurs d'écran.")
@section('twitter_description', "Analysez et optimisez le texte alt des images pour un meilleur SEO et une meilleure accessibilité. Outil gratuit pour vérifier les balises alt manquantes, détecter le bourrage de mots-clés et améliorer les descriptions d'images pour les moteurs de recherche et les lecteurs d'écran.")
...
<section class="relative overflow-hidden pt-28 pb-16 bg-white">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <nav class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-8"><a class="hover:text-[#00AEEF] transition-colors" href="/">Accueil</a><span>/</span><a class="hover:text-[#00AEEF] transition-colors" href="/tools">Outils</a><span>/</span><span class="text-black font-medium">Analyseur de Texte Alt d'Image</span></nav>
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">Analyseur de Texte Alt d'Image</h1>
            <p class="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">Analysez votre page web pour détecter les textes alt d'image manquants ou de mauvaise qualité. Améliorez l'accessibilité, le SEO et assurez-vous que toutes les images ont un texte alternatif descriptif.</p>
        </div>
    ...
    <div class="space-y-6">
        <div class="space-y-4">
            <div class="space-y-2"><label class="block text-sm font-medium text-black">URL du Site Web<span class="text-[#00AEEF] ml-1">*</span></label>
                ...
                <p class="text-sm text-gray-500">Entrez l'URL de la page web pour analyser le texte alt des images</p>
                ...
                </svg>Analyser le Texte Alt des Images</button>
        </div>
    </div>
</section>
