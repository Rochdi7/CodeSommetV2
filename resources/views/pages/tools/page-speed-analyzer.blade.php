...
@section('title', 'Analyseur de Vitesse de Page - Test de Vitesse de Site Gratuit | CodeSommet')
@section('meta_description', 'Analysez la vitesse de chargement de votre site web, les Core Web Vitals et les métriques de performance. Obtenez des informations détaillées sur LCP, FID, CLS et des recommandations concrètes pour améliorer la vitesse et le classement SEO.')
@section('meta_keywords', 'analyseur vitesse page,test vitesse site web,Core Web Vitals,insights vitesse page,analyseur performance,vérificateur vitesse,LCP,FID,CLS,performance SEO')
@section('og_title', 'Analyseur de Vitesse de Page - Test de Vitesse Gratuit')
@section('og_description', 'Analysez la vitesse de chargement et les Core Web Vitals avec des informations détaillées sur les performances')
@section('twitter_description', 'Analysez la vitesse de chargement et les Core Web Vitals avec des informations détaillées sur les performances')
...
<section class="relative overflow-hidden pt-28 pb-16 bg-white">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <nav class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-8"><a class="hover:text-[#00AEEF] transition-colors" href="/">Accueil</a><span>/</span><a class="hover:text-[#00AEEF] transition-colors" href="/tools">Outils</a><span>/</span><span class="text-black font-medium">Analyseur de Vitesse de Page</span></nav>
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">Analyseur de Vitesse de Page</h1>
            <p class="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">Analysez les performances de chargement de votre site web et obtenez des recommandations concrètes pour améliorer les Core Web Vitals, le classement SEO et l'expérience utilisateur.</p>
        </div>
    ...
    <div class="space-y-6">
        <div class="space-y-4">
            <div class="space-y-2"><label class="block text-sm font-medium text-black">URL du Site Web<span class="text-[#00AEEF] ml-1">*</span></label>
                ...
                <p class="text-sm text-gray-500">Entrez l'URL de la page que vous souhaitez analyser</p>
                ...
                </svg>Analyser la Vitesse de Page</button>
        </div>
...
<section class="py-16 bg-white border-t border-gray-100">
    <div class="max-w-5xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-8"><a class="group relative bg-white rounded-xl border border-gray-200 p-6 hover:border-[#00AEEF] hover:shadow-lg transition-all duration-300 hover:-translate-y-1" href="/tools/html-minifier">
                ...
                <p class="text-sm text-gray-600 leading-relaxed mb-4">Minifiez le code pour réduire la taille des fichiers et améliorer la vitesse de page</p>
                ...
                <p class="text-sm text-gray-600 leading-relaxed mb-4">Identifiez les images trop volumineuses et obtenez des recommandations de compression</p>
                <div class="flex items-center gap-2 text-[#00AEEF] font-semibold text-sm group-hover:gap-3 transition-all"><span>Essayez gratuitement</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4" aria-hidden="true">
                        <path d="M5 12h14"></path>
                        <path d="m12 5 7 7-7 7"></path>
                    </svg></div>
