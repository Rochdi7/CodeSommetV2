...
@section('title', 'Générateur de Schéma FAQ - Balisage JSON-LD FAQ Gratuit | CodeSommet')
@section('meta_description', 'Générez du balisage de schéma FAQ (JSON-LD) pour votre site web. Améliorez la visibilité avec des rich snippets. Générateur de données structurées FAQ gratuit.')
@section('meta_keywords', 'FAQ schema generator,FAQ markup,JSON-LD FAQ,structured data,FAQ rich snippets,schema markup')
@section('og_title', 'Générateur de Schéma FAQ - Balisage JSON-LD Gratuit')
@section('og_description', 'Générez du balisage JSON-LD FAQ pour une meilleure visibilité')
@section('twitter_description', 'Générez du balisage JSON-LD FAQ pour une meilleure visibilité')
...
<section class="relative overflow-hidden pt-28 pb-16 bg-white">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <nav class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-8"><a class="hover:text-[#00AEEF] transition-colors" href="/">Accueil</a><span>/</span><a class="hover:text-[#00AEEF] transition-colors" href="/tools">Outils</a><span>/</span><span class="text-black font-medium">Générateur de Schéma FAQ</span></nav>
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">Générateur de Schéma FAQ</h1>
            <p class="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">Convertissez votre contenu FAQ en balisage JSON-LD compatible Google. Augmentez la visibilité dans les résultats et apparaissez dans les encadrés &#x27;Autres questions posées&#x27;.</p>
        </div>
            ...
            <div class="space-y-6">
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-question-mark w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" aria-hidden="true">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-900 mb-2">Comment utiliser :</p>
                            <ol class="text-sm text-gray-700 space-y-1 list-decimal list-inside">
                                <li>Copiez votre contenu FAQ depuis votre site ou document</li>
                                <li>Collez-le dans la zone de texte ci-dessous</li>
                                <li>Cliquez sur &quot;Générer le Schéma&quot;</li>
                                <li>Copiez le code généré et ajoutez-le à la section &lt;head&gt; de votre site</li>
                            </ol>
                            <p class="text-xs text-gray-600 mt-3"><strong>Formats supportés :</strong> Q: / R:, listes numérotées, gras markdown ou questions simples se terminant par ?</p>
                        </div>
                    </div>
                </div>
                <div class="space-y-2">
                    <div class="flex items-center justify-between"><label class="block text-sm font-medium text-black">Collez Votre Contenu FAQ<span class="text-[#00AEEF] ml-1">*</span></label></div><textarea placeholder="Q : Qu'est-ce que le balisage FAQ ?
...
<section class="py-16 bg-white border-t border-gray-100">
    <div class="max-w-5xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-8"><a class="group relative bg-white rounded-xl border border-gray-200 p-6 hover:border-[#00AEEF] hover:shadow-lg transition-all duration-300 hover:-translate-y-1" href="/tools/readability-analyzer">
                ...
                <p class="text-sm text-gray-600 leading-relaxed mb-4">Convertissez le HTML en texte brut lisible instantanément</p>
                <div class="flex items-center gap-2 text-[#00AEEF] font-semibold text-sm group-hover:gap-3 transition-all"><span>Essayer gratuitement</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-4 h-4" aria-hidden="true">
                        <path d="M5 12h14"></path>
                        <path d="m12 5 7 7-7 7"></path>
                    </svg></div>
